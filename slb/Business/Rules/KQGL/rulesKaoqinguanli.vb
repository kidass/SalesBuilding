...
Namespace Josco.JSOA.BusinessRules
    ...
    ' 类名    ：rulesKaoqinguanli
    '
    ' 功能描述： 
    '   　提供对二手业务处理的业务规则
    '----------------------------------------------------------------
    Public Class rulesKaoqinguanli
        Implements System.IDisposable

        Private m_objdacKaoqinguanli As Josco.JSOA.DataAccess.dacKaoqinguanli
        ...
        Public Sub New()
            MyBase.New()
            m_objdacKaoqinguanli = New Josco.JSOA.DataAccess.dacKaoqinguanli
        End Sub

        '----------------------------------------------------------------
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessRules.rulesKaoqinguanli)
            Try
        ...
        Protected Overridable Sub Dispose(ByVal disposing As Boolean)
            If (Not disposing) Then
                Exit Sub
            End If
            If Not (m_objdacKaoqinguanli Is Nothing) Then
                m_objdacKaoqinguanli.Dispose()
                m_objdacKaoqinguanli = Nothing
            End If
        End Sub
        ...
        Public Function doExportToExcel( _
            ...
            With New Josco.JSOA.DataAccess.dacKaoqinguanli
