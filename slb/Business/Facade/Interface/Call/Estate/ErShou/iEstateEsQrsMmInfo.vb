...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IEstateEsQrsMmInfo
    '
    ' 功能描述： 
    '     estate_es_qrsmm_info.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IEstateEsQrsMmInfo
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IEstateEsQrsMmInfo)
            Try
