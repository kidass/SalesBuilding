...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IEstateEsHetongJssList
    '
    ' 功能描述： 
    '     estate_es_hetong_jss_list.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IEstateEsHetongJssList
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IEstateEsHetongJssList)
            Try
