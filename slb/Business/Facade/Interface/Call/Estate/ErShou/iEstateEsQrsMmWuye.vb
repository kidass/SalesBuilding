...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IEstateEsQrsMmWuye
    '
    ' 功能描述： 
    '     estate_es_qrsmm_wuye.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IEstateEsQrsMmWuye
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IEstateEsQrsMmWuye)
            Try
