...
Namespace Josco.JSOA.BusinessFacade
    ...
    <Serializable()> Public Class IFlowXgwjljAdd
        ...
        '输入参数
        '----------------------------------------------------------------
        Private m_objDataSet_XGWJ_I As Josco.JSOA.Common.Data.FlowData '相关文件数据
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IFlowXgwjljAdd)
            Try
        ...
        ' iDataSet_XGWJ属性
        '----------------------------------------------------------------
        Public Property iDataSet_XGWJ() As Josco.JSOA.Common.Data.FlowData
            Get
        ...
        ' oDataSet_XGWJ属性
        '----------------------------------------------------------------
        Public Property oDataSet_XGWJ() As Josco.JSOA.Common.Data.FlowData
            Get
