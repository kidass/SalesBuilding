...
Namespace Josco.JSOA.BusinessFacade
    ...
    <Serializable()> Public Class IFlowEditWord
        Inherits Josco.JSOA.BusinessFacade.ICallInterface
        ...
        Private m_objDataSet_FJ_I As Josco.JSOA.Common.Data.FlowData                 '进入稿件编辑时的附件数据
        Private m_objDataSet_XGWJ_I As Josco.JSOA.Common.Data.FlowData               '进入稿件编辑时的相关文件数据
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IFlowEditWord)
            Try
        ...
        ' iobjDataSet_FJ属性
        '----------------------------------------------------------------
        Public Property iobjDataSet_FJ() As Josco.JSOA.Common.Data.FlowData
            Get
        ...
        ' iobjDataSet_XGWJ属性
        '----------------------------------------------------------------
        Public Property iobjDataSet_XGWJ() As Josco.JSOA.Common.Data.FlowData
            Get
