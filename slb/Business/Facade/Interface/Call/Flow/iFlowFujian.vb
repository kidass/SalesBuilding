...
Namespace Josco.JSOA.BusinessFacade
    ...
    <Serializable()> Public Class IFlowFujian
        ...
        Private m_objDataSet_FJ_I As Josco.JSOA.Common.Data.FlowData '附件数据
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IFlowFujian)
            Try
        ...
        ' iDataSet_FJ属性
        '----------------------------------------------------------------
        Public Property iDataSet_FJ() As Josco.JSOA.Common.Data.FlowData
            Get
        ...
        ' oDataSet_FJ属性
        '----------------------------------------------------------------
        Public Property oDataSet_FJ() As Josco.JSOA.Common.Data.FlowData
            Get
