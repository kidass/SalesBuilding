...
Namespace Josco.JSOA.BusinessFacade
    ...
    <Serializable()> Public Class IFlowFujianInfo
        ...
        '输入参数
        '----------------------------------------------------------------
        Private m_objEditType_I As Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType       '输入编辑类型
        ...
        Public Sub New()
            ...
            '初始化输入参数
            m_objEditType_I = JsKernal.Common.Utilities.PulicParameters.enumEditType.eSelect
            m_objRow_I = Nothing
            m_strFlowTypeName_I = ""
            m_strWJBS_I = ""
            m_strWJXH_I = ""
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IFlowFujianInfo)
            Try
        ...
        ' iEditType属性
        '----------------------------------------------------------------
        Public Property iEditType() As Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType
            Get
