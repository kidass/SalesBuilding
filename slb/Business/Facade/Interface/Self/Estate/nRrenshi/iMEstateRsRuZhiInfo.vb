...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsRuZhiInfo
    '
    ' 功能描述： 
    '     estate_rs_ruzhi_info.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsRuZhiInfo
        ...
        Private m_objDataSet_KQXX As Josco.JSOA.Common.Data.kaoqinguanliData
        ...
        Private m_intSelectedIndex_ddlZPSM As Integer      'ddlZPSM
        ...
        Private m_strtxtJDXX As String                   'htxtJDXX
        Private m_strtxtZY As String                   'htxtZY
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsRuZhiInfo)
            Try
        ...
        ' txtZY属性
        '----------------------------------------------------------------
        Public Property txtZY() As String
            Get
                txtZY = m_strtxtZY
            End Get
            Set(ByVal Value As String)
        ...
        ' txtJDXX属性
        '----------------------------------------------------------------
        Public Property txtJDXX() As String
            Get
                txtJDXX = m_strtxtJDXX
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtJDXX = Value
        ...
        ' objDataSet_KQXX属性
        '----------------------------------------------------------------
        Public Property objDataSet_KQXX() As Josco.JSOA.Common.Data.kaoqinguanliData
            Get
                objDataSet_KQXX = m_objDataSet_KQXX
            End Get
            Set(ByVal Value As Josco.JSOA.Common.Data.kaoqinguanliData)
                Try
                    m_objDataSet_KQXX = Value
                Catch ex As Exception
                    m_objDataSet_KQXX = Nothing
                End Try
            End Set
        ...
        '----------------------------------------------------------------
        ' ddlZPSM_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlZPSM_SelectedIndex() As Integer
            Get
                ddlZPSM_SelectedIndex = m_intSelectedIndex_ddlZPSM
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlZPSM = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlZPSM = -1
                End Try
            End Set
