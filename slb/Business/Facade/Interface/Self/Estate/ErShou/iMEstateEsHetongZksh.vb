...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsHetongZksh
    '
    ' 功能描述： 
    '     estate_es_hetong_zksh.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsHetongZksh
        ...
        Private m_strtxtYJ_Min As String                            'txtYJ_Min
        Private m_strtxtYJ_Max As String                            'txtYJ_Max
        Private m_strtxtEJ_Min As String                            'txtEJ_Min
        Private m_strtxtEJ_Max As String                            'txtEJ_Max
        Private m_strtxtSJ_Min As String                            'txtSJ_Min
        Private m_strtxtSJ_Max As String                            'txtSJ_Max
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsHetongZksh)
            Try
        ...
        ' txtYJ_Min属性
        '----------------------------------------------------------------
        Public Property txtYJ_Min() As String
            Get
                txtYJ_Min = m_strtxtYJ_Min
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtYJ_Min = Value
                Catch ex As Exception
                    m_strtxtYJ_Min = ""
                End Try
            End Set
        ...
        ' txtYJ_Max属性
        '----------------------------------------------------------------
        Public Property txtYJ_Max() As String
            Get
                txtYJ_Max = m_strtxtYJ_Max
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtYJ_Max = Value
                Catch ex As Exception
                    m_strtxtYJ_Max = ""
                End Try
            End Set
        ...
        ' txtEJ_Min属性
        '----------------------------------------------------------------
        Public Property txtEJ_Min() As String
            Get
                txtEJ_Min = m_strtxtEJ_Min
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtEJ_Min = Value
                Catch ex As Exception
                    m_strtxtEJ_Min = ""
                End Try
            End Set
        ...
        ' txtEJ_Max属性
        '----------------------------------------------------------------
        Public Property txtEJ_Max() As String
            Get
                txtEJ_Max = m_strtxtEJ_Max
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtEJ_Max = Value
                Catch ex As Exception
                    m_strtxtEJ_Max = ""
                End Try
            End Set
        ...
        ' txtSJ_Min属性
        '----------------------------------------------------------------
        Public Property txtSJ_Min() As String
            Get
                txtSJ_Min = m_strtxtSJ_Min
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSJ_Min = Value
                Catch ex As Exception
                    m_strtxtSJ_Min = ""
                End Try
            End Set
        ...
        ' txtSJ_Max属性
        '----------------------------------------------------------------
        Public Property txtSJ_Max() As String
            Get
                txtSJ_Max = m_strtxtSJ_Max
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSJ_Max = Value
                Catch ex As Exception
                    m_strtxtSJ_Max = ""
                End Try
            End Set
