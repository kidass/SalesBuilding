...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsBbKyxxb
    '
    ' 功能描述： 
    '     estate_es_bb_kyxxb.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsBbKyxxb
        ...
        Private m_strtxtKHDZ As String                            'txtKHDZ
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsBbKyxxb)
            Try
        ...
        ' txtKHDZ属性
        '----------------------------------------------------------------
        Public Property txtKHDZ() As String
            Get
                txtKHDZ = Me.m_strtxtKHDZ
            End Get
            Set(ByVal Value As String)
                Try
                    Me.m_strtxtKHDZ = Value
                Catch ex As Exception
                    Me.m_strtxtKHDZ = ""
                End Try
            End Set
