...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsQrsZlWuye
    '
    ' 功能描述： 
    '     estate_es_qrszl_wuye.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsQrsZlWuye
        ...
        Private m_strtxtYZJ As String                         'txtYZJ
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsQrsZlWuye)
            Try
        ...
        ' txtYZJ属性
        '----------------------------------------------------------------
        Public Property txtYZJ() As String
            Get
                txtYZJ = Me.m_strtxtYZJ
            End Get
            Set(ByVal Value As String)
                Try
                    Me.m_strtxtYZJ = Value
                Catch ex As Exception
                    Me.m_strtxtYZJ = ""
                End Try
            End Set
