...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsBbEsphbryyj
    '
    ' 功能描述： 
    '     estate_es_bb_esphbryyj.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsBbEsphbryyj
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsBbEsphbryyj)
            Try
