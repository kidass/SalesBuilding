...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsBbEsdljsqkbGyd
    '
    ' 功能描述： 
    '     estate_es_bb_esdljsqkb_gyd.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsBbEsdljsqkbGyd
        ...
        '----------------------------------------------------------------
        Private m_intSelectedIndex_ddlYD As Integer               'ddlYD_SelectedIndex
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsBbEsdljsqkbGyd)
            Try
        ...
        '----------------------------------------------------------------
        ' ddlYD_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlYD_SelectedIndex() As Integer
            Get
                ddlYD_SelectedIndex = m_intSelectedIndex_ddlYD
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlYD = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlYD = 0
                End Try
            End Set
        End Property
