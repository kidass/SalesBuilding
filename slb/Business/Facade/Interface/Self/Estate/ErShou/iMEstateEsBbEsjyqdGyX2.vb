...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsBbEsjyqdGyX2
    '
    ' 功能描述： 
    '     estate_es_bb_esjyqd_gy_x2.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsBbEsjyqdGyX2
        ...
        '----------------------------------------------------------------
        Private m_intSelectedIndex_ddlTJYD As Integer             'ddlTJYD_SelectedIndex
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGyX2)
            Try
        ...
        '----------------------------------------------------------------
        ' ddlTJYD_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlTJYD_SelectedIndex() As Integer
            Get
                ddlTJYD_SelectedIndex = m_intSelectedIndex_ddlTJYD
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlTJYD = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlTJYD = 0
                End Try
            End Set
        End Property
