...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateEsBbEsYjfpb
    '
    ' 功能描述： 
    '     estate_es_bb_esyjfpb.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateEsBbEsYjfpb
        ...
        Private m_strtxtLVBL As String                            'txtLVBL
        '----------------------------------------------------------------
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateEsBbEsYjfpb)
            Try
        ...
        ' txtLVBL属性
        '----------------------------------------------------------------
        Public Property txtLVBL() As String
            Get
                txtLVBL = m_strtxtLVBL
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtLVBL = Value
