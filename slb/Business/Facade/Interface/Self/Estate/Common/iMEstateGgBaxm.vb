...
Namespace Josco.JSOA.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     estate_gg_baxm.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateGgBaxm
        ...
        Private m_strtxtSearch_XMDM As String               'txtSearch_XMDM
        Private m_strtxtSearch_XMMC As String               'txtSearch_XMMC

        Private m_strtxtXMDM As String                      'txtXMDM
        Private m_strtxtXMMC As String                      'txtXMMC
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateGgBaxm)
            Try
        ...
        ' txtSearch_XMDM属性
        '----------------------------------------------------------------
        Public Property txtSearch_XMDM() As String
            Get
                txtSearch_XMDM = m_strtxtSearch_XMDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_XMDM = Value
                Catch ex As Exception
                    m_strtxtSearch_XMDM = ""
                End Try
            End Set
        ...
        ' txtSearch_XMMC属性
        '----------------------------------------------------------------
        Public Property txtSearch_XMMC() As String
            Get
                txtSearch_XMMC = m_strtxtSearch_XMMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_XMMC = Value
                Catch ex As Exception
                    m_strtxtSearch_XMMC = ""
                End Try
            End Set
        ...
        ' txtXMDM属性
        '----------------------------------------------------------------
        Public Property txtXMDM() As String
            Get
                txtXMDM = m_strtxtXMDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtXMDM = Value
        ...
        ' txtXMMC属性
        '----------------------------------------------------------------
        Public Property txtXMMC() As String
            Get
                txtXMMC = m_strtxtXMMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtXMMC = Value
