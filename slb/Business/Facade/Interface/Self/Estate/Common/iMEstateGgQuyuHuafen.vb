...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateGgQuyuHuafen
    '
    ' 功能描述： 
    '     estate_gg_quyuhuafen.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateGgQuyuHuafen
        ...
        Private m_strtxtSearch_QYDM As String               'txtSearch_QYDM
        Private m_strtxtSearch_QYMC As String               'txtSearch_QYMC

        Private m_strtxtQYDM As String                      'txtQYDM
        Private m_strtxtQYMC As String                      'txtQYMC
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateGgQuyuHuafen)
            Try
        ...
        ' txtSearch_QYDM属性
        '----------------------------------------------------------------
        Public Property txtSearch_QYDM() As String
            Get
                txtSearch_QYDM = m_strtxtSearch_QYDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_QYDM = Value
                Catch ex As Exception
                    m_strtxtSearch_QYDM = ""
                End Try
            End Set
        ...
        ' txtSearch_QYMC属性
        '----------------------------------------------------------------
        Public Property txtSearch_QYMC() As String
            Get
                txtSearch_QYMC = m_strtxtSearch_QYMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_QYMC = Value
                Catch ex As Exception
                    m_strtxtSearch_QYMC = ""
                End Try
            End Set
        ...
        ' txtQYDM属性
        '----------------------------------------------------------------
        Public Property txtQYDM() As String
            Get
                txtQYDM = m_strtxtQYDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtQYDM = Value
        ...
        ' txtQYMC属性
        '----------------------------------------------------------------
        Public Property txtQYMC() As String
            Get
                txtQYMC = m_strtxtQYMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtQYMC = Value
