...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateCwPiaojuJiankong
    '
    ' 功能描述： 
    '     estate_cw_piaoju_jiankong.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateCwPiaojuJiankong
        ...
        Private m_strtxtPIAOJUSearch_FGFH As String                'txtPIAOJUSearch_FGFH
        ...
        Private m_strtxtPIAOJUSearch_PJPC As String                'txtPIAOJUSearch_PJPC
        'zengxianglin 2009-05-17
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateCwPiaojuJiankong)
            Try
        ...
        '----------------------------------------------------------------
        ' txtPIAOJUSearch_FGFH属性
        '----------------------------------------------------------------
        Public Property txtPIAOJUSearch_FGFH() As String
            Get
                txtPIAOJUSearch_FGFH = m_strtxtPIAOJUSearch_FGFH
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtPIAOJUSearch_FGFH = Value
                Catch ex As Exception
                    m_strtxtPIAOJUSearch_FGFH = ""
                End Try
            End Set
        ...
        'zengxianglin 2009-05-17
        '----------------------------------------------------------------
        ' txtPIAOJUSearch_PJPC属性
        '----------------------------------------------------------------
        Public Property txtPIAOJUSearch_PJPC() As String
            Get
                txtPIAOJUSearch_PJPC = m_strtxtPIAOJUSearch_PJPC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtPIAOJUSearch_PJPC = Value
                Catch ex As Exception
                    m_strtxtPIAOJUSearch_PJPC = ""
                End Try
            End Set
