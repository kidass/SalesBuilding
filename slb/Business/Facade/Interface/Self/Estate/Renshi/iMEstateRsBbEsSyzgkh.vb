...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsBbEsSyzgkh
    '
    ' 功能描述： 
    '     estate_rs_bb_essyzgkh.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsBbEsSyzgkh
        ...
        '----------------------------------------------------------------
        Private m_intSelectedIndex_ddlXSJB As Integer             'ddlXSJB_SelectedIndex
        Private m_intSelectedIndex_ddlRYDM As Integer             'ddlRYDM_SelectedIndex
        Private m_strtxtKSRQ As String                            'txtKSRQ
        Private m_strtxtZZRQ As String                            'txtZZRQ
        Private m_strtxtSYQY As String                            'txtSYQY
        '----------------------------------------------------------------
        ...
        Public Sub New()
            ...
            m_strtxtPageSize = ""
            '----------------------------------------------------------------
            m_intSelectedIndex_ddlXSJB = -1
            m_intSelectedIndex_ddlRYDM = -1
            m_strtxtKSRQ = ""
            m_strtxtZZRQ = ""
            m_strtxtSYQY = ""
            '----------------------------------------------------------------
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsBbEsSyzgkh)
            Try
        ...
        ' txtSYQY属性
        '----------------------------------------------------------------
        Public Property txtSYQY() As String
            Get
                txtSYQY = m_strtxtSYQY
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSYQY = Value
        ...
        '----------------------------------------------------------------
        ' ddlXSJB_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlXSJB_SelectedIndex() As Integer
            Get
                ddlXSJB_SelectedIndex = m_intSelectedIndex_ddlXSJB
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlXSJB = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlXSJB = 0
                End Try
            End Set
        End Property

        '----------------------------------------------------------------
        ' ddlRYDM_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlRYDM_SelectedIndex() As Integer
            Get
                ddlRYDM_SelectedIndex = m_intSelectedIndex_ddlRYDM
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlRYDM = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlRYDM = 0
                End Try
            End Set
        End Property
