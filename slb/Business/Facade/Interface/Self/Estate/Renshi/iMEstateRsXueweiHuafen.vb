...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsXueweiHuafen
    '
    ' 功能描述： 
    '     estate_rs_xueweihuafen.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsXueweiHuafen
        ...
        Private m_strtxtSearch_XWDM As String               'txtSearch_XWDM
        Private m_strtxtSearch_XWMC As String               'txtSearch_XWMC

        Private m_strtxtXWDM As String                      'txtXWDM
        Private m_strtxtXWMC As String                      'txtXWMC
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsXueweiHuafen)
            Try
        ...
        ' txtSearch_XWDM属性
        '----------------------------------------------------------------
        Public Property txtSearch_XWDM() As String
            Get
                txtSearch_XWDM = m_strtxtSearch_XWDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_XWDM = Value
                Catch ex As Exception
                    m_strtxtSearch_XWDM = ""
                End Try
            End Set
        ...
        ' txtSearch_XWMC属性
        '----------------------------------------------------------------
        Public Property txtSearch_XWMC() As String
            Get
                txtSearch_XWMC = m_strtxtSearch_XWMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_XWMC = Value
                Catch ex As Exception
                    m_strtxtSearch_XWMC = ""
                End Try
            End Set
        ...
        ' txtXWDM属性
        '----------------------------------------------------------------
        Public Property txtXWDM() As String
            Get
                txtXWDM = m_strtxtXWDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtXWDM = Value
        ...
        ' txtXWMC属性
        '----------------------------------------------------------------
        Public Property txtXWMC() As String
            Get
                txtXWMC = m_strtxtXWMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtXWMC = Value
