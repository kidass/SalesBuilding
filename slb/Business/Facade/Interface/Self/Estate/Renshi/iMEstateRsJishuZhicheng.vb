...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsJishuZhicheng
    '
    ' 功能描述： 
    '     estate_rs_jishuzhicheng.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsJishuZhicheng
        ...
        Private m_strtxtSearch_ZCDM As String               'txtSearch_ZCDM
        Private m_strtxtSearch_ZCMC As String               'txtSearch_ZCMC

        Private m_strtxtZCDM As String                      'txtZCDM
        Private m_strtxtZCMC As String                      'txtZCMC
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsJishuZhicheng)
            Try
        ...
        ' txtSearch_ZCDM属性
        '----------------------------------------------------------------
        Public Property txtSearch_ZCDM() As String
            Get
                txtSearch_ZCDM = m_strtxtSearch_ZCDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_ZCDM = Value
                Catch ex As Exception
                    m_strtxtSearch_ZCDM = ""
                End Try
            End Set
        ...
        ' txtSearch_ZCMC属性
        '----------------------------------------------------------------
        Public Property txtSearch_ZCMC() As String
            Get
                txtSearch_ZCMC = m_strtxtSearch_ZCMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_ZCMC = Value
                Catch ex As Exception
                    m_strtxtSearch_ZCMC = ""
                End Try
            End Set
        ...
        ' txtZCDM属性
        '----------------------------------------------------------------
        Public Property txtZCDM() As String
            Get
                txtZCDM = m_strtxtZCDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtZCDM = Value
        ...
        ' txtZCMC属性
        '----------------------------------------------------------------
        Public Property txtZCMC() As String
            Get
                txtZCMC = m_strtxtZCMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtZCMC = Value
