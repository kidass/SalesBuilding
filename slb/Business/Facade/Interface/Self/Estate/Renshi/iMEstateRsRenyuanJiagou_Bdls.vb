...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsRenyuanJiagou_Bdls
    '
    ' 功能描述： 
    '     estate_rs_renyuanjiagou_bdls.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsRenyuanJiagou_Bdls
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsRenyuanJiagou_Bdls)
            Try
