...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsRenyuanJiagouX2
    '
    ' 功能描述： 
    '     estate_rs_renyuanjiagou_x2.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsRenyuanJiagouX2
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsRenyuanJiagouX2)
            Try
