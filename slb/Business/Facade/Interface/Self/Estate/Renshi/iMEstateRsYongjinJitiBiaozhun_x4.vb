...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsYongjinJitiBiaozhun_X4
    '
    ' 功能描述： 
    '     estate_rs_yongjinjitibiaozhun_x4.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsYongjinJitiBiaozhun_X4
        ...
        Private m_strhtxtDivLeftSYZJ As String                  'htxtDivLeftSYZJ
        Private m_strhtxtDivTopSYZJ As String                   'htxtDivTopSYZJ
        ...
        Private m_strhtxtDivLeftGYXGZJ As String                'htxtDivLeftGYXGZJ
        Private m_strhtxtDivTopGYXGZJ As String                 'htxtDivTopGYXGZJ
        ...
        Private m_strhtxtSessionId_GYXGZJ As String             'htxtSessionId_GYXGZJ
        ...
        Private m_intCurrentPageIndex_grdGYXGZJ As Integer      'grdGYXGZJ_CurrentPageIndex
        Private m_intSelectedIndex_grdGYXGZJ As Integer         'grdGYXGZJ_SelectedIndex
        Private m_intPageSize_grdGYXGZJ As Integer              'grdGYXGZJ_PageSize
        ...
        Public Sub New()
            ...
            m_strhtxtDivTopGYXG = ""
            m_strhtxtDivLeftGYXGZJ = ""
            m_strhtxtDivTopGYXGZJ = ""
            ...
            m_intCurrentPageIndex_grdGYXGZJ = 0
            m_intSelectedIndex_grdGYXGZJ = -1
            m_intPageSize_grdGYXGZJ = 30
        ...
        ' htxtDivLeftSYZJ属性
        '----------------------------------------------------------------
        Public Property htxtDivLeftSYZJ() As String
            Get
                htxtDivLeftSYZJ = m_strhtxtDivLeftSYZJ
            End Get
            Set(ByVal Value As String)
                Try
                    m_strhtxtDivLeftSYZJ = Value
                Catch ex As Exception
                    m_strhtxtDivLeftSYZJ = ""
                End Try
            End Set
        ...
        ' htxtDivTopSYZJ属性
        '----------------------------------------------------------------
        Public Property htxtDivTopSYZJ() As String
            Get
                htxtDivTopSYZJ = m_strhtxtDivTopSYZJ
            End Get
            Set(ByVal Value As String)
                Try
                    m_strhtxtDivTopSYZJ = Value
                Catch ex As Exception
                    m_strhtxtDivTopSYZJ = ""
                End Try
            End Set
        ...
        ' htxtDivLeftGYXGZJ属性
        '----------------------------------------------------------------
        Public Property htxtDivLeftGYXGZJ() As String
            Get
                htxtDivLeftGYXGZJ = m_strhtxtDivLeftGYXGZJ
            End Get
            Set(ByVal Value As String)
                Try
                    m_strhtxtDivLeftGYXGZJ = Value
                Catch ex As Exception
                    m_strhtxtDivLeftGYXGZJ = ""
                End Try
            End Set
        ...
        ' htxtDivTopGYXGZJ属性
        '----------------------------------------------------------------
        Public Property htxtDivTopGYXGZJ() As String
            Get
                htxtDivTopGYXGZJ = m_strhtxtDivTopGYXGZJ
            End Get
            Set(ByVal Value As String)
                Try
                    m_strhtxtDivTopGYXGZJ = Value
                Catch ex As Exception
                    m_strhtxtDivTopGYXGZJ = ""
                End Try
            End Set
        ...
        '----------------------------------------------------------------
        ' htxtSessionId_GYXGZJ属性
        '----------------------------------------------------------------
        Public Property htxtSessionId_GYXGZJ() As String
            Get
                htxtSessionId_GYXGZJ = m_strhtxtSessionId_GYXGZJ
            End Get
            Set(ByVal Value As String)
                Try
                    m_strhtxtSessionId_GYXGZJ = Value
                Catch ex As Exception
                    m_strhtxtSessionId_GYXGZJ = ""
                End Try
            End Set
        ...
        '----------------------------------------------------------------
        ' grdGYXGZJ_CurrentPageIndex属性
        '----------------------------------------------------------------
        Public Property grdGYXGZJ_CurrentPageIndex() As Integer
            Get
                grdGYXGZJ_CurrentPageIndex = m_intCurrentPageIndex_grdGYXGZJ
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intCurrentPageIndex_grdGYXGZJ = Value
                Catch ex As Exception
                    m_intCurrentPageIndex_grdGYXGZJ = 0
                End Try
            End Set
        ...
        '----------------------------------------------------------------
        'grdGYXGZJ_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property grdGYXGZJ_SelectedIndex() As Integer
            Get
                grdGYXGZJ_SelectedIndex = m_intSelectedIndex_grdGYXGZJ
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_grdGYXGZJ = Value
                Catch ex As Exception
                    m_intSelectedIndex_grdGYXGZJ = 0
                End Try
            End Set
        End Property

        '----------------------------------------------------------------
        ' grdGYXGZJ_PageSize属性
        '----------------------------------------------------------------
        Public Property grdGYXGZJ_PageSize() As Integer
            Get
                grdGYXGZJ_PageSize = m_intPageSize_grdGYXGZJ
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intPageSize_grdGYXGZJ = Value
                Catch ex As Exception
                    m_intPageSize_grdGYXGZJ = 0
                End Try
            End Set
        End Property
