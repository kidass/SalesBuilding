...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsZhigongShuxing
    '
    ' 功能描述： 
    '     estate_rs_zhigongshuxing.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsZhigongShuxing
        ...
        Private m_strtxtSearch_SXDM As String               'txtSearch_SXDM
        Private m_strtxtSearch_SXMC As String               'txtSearch_SXMC

        Private m_strtxtSXDM As String                      'txtSXDM
        Private m_strtxtSXMC As String                      'txtSXMC
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsZhigongShuxing)
            Try
        ...
        ' txtSearch_SXDM属性
        '----------------------------------------------------------------
        Public Property txtSearch_SXDM() As String
            Get
                txtSearch_SXDM = m_strtxtSearch_SXDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_SXDM = Value
                Catch ex As Exception
                    m_strtxtSearch_SXDM = ""
                End Try
            End Set
        ...
        ' txtSearch_SXMC属性
        '----------------------------------------------------------------
        Public Property txtSearch_SXMC() As String
            Get
                txtSearch_SXMC = m_strtxtSearch_SXMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSearch_SXMC = Value
                Catch ex As Exception
                    m_strtxtSearch_SXMC = ""
                End Try
            End Set
        ...
        ' txtSXDM属性
        '----------------------------------------------------------------
        Public Property txtSXDM() As String
            Get
                txtSXDM = m_strtxtSXDM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSXDM = Value
        ...
        ' txtSXMC属性
        '----------------------------------------------------------------
        Public Property txtSXMC() As String
            Get
                txtSXMC = m_strtxtSXMC
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtSXMC = Value
