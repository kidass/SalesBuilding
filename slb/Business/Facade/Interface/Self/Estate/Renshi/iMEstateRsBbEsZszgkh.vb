...
Namespace Josco.JSOA.BusinessFacade
    ...
    ' 类名    ：IMEstateRsBbEsZszgkh
    '
    ' 功能描述： 
    '     estate_rs_bb_eszszgkh.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMEstateRsBbEsZszgkh
        ...
        Private m_intSelectedIndex_ddlJD As Integer               'ddlJD_SelectedIndex
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.BusinessFacade.IMEstateRsBbEsZszgkh)
            Try
        ...
        '----------------------------------------------------------------
        ' ddlJD_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlJD_SelectedIndex() As Integer
            Get
                ddlJD_SelectedIndex = m_intSelectedIndex_ddlJD
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlJD = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlJD = 0
                End Try
            End Set
        End Property
