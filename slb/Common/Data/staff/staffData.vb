...
Namespace Josco.JSOA.Common.Data
    ...
    ' 更改记录：
    '----------------------------------------------------------------
    <System.ComponentModel.DesignerCategory("BASE"), SerializableAttribute()> Public Class staffData
        ...
        Public Const FIELD_GG_B_RENYUAN_YGMS As String = "用工模式"
        Public Const FIELD_GG_B_RENYUAN_SFZH As String = "身份证号"
        Public Const FIELD_GG_B_RENYUAN_SFYX As String = "是否有效"
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Josco.JSOA.Common.Data.staffData)
            Try
        ...
        Private Function createDataTables_Renyuan(ByRef strErrMsg As String) As System.Data.DataTable
            ...
            Try
                ...
                With table.Columns
                    ...
                    .Add(FIELD_GG_B_RENYUAN_YGMS, GetType(System.String))
                    .Add(FIELD_GG_B_RENYUAN_SFZH, GetType(System.String))
                    .Add(FIELD_GG_B_RENYUAN_SFYX, GetType(System.String))
