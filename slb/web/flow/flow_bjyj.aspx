<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_bjyj.aspx.vb" Inherits="Josco.JSOA.web.flow_bjyj"%>
		...
		<form id="frmFLOW_BJYJ" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									<TD><TEXTAREA id="textareaBJYJ" runat="server" class="textbox-search" readOnly></TEXTAREA></TD>
								</TR>
								<TR>
									<TD height="6"></TD>
								</TR>
					...
					<TR>
						<TD align="center" colSpan="3"><asp:Button id="btnClose" Runat="server" Height="30px" Text=" 返  回 " CssClass="button" ></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
