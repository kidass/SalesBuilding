<%@ Page Language="vb" AutoEventWireup="false" Codebehind="areaLeft.aspx.vb" Inherits="Josco.JsKernal.web.areaLeft" %>
            ...
            function openChat() 
            {
				try {
					if (m_objChatWindowId)
					{
						...
						{
							m_objChatWindowId = window.open("./secure/chat/chat_main.aspx","_blank","left=700,width=312,height=700,fullscreen=no,menubar=no,resizable=yes,scrollbars=no,status=no,titlebar=no"); 
