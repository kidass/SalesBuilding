		...
		<td colSpan="3">
			<table cellSpacing="0" cellPadding="0" width="100%" border="0">
				<tr>
					...
					<!--曾祥林 2008-03-29--><td style="FONT-SIZE: 11pt; COLOR: white; FONT-FAMILY: Courier New,宋体,新宋体" nowrap><input id="btnFullScreen" type="button" class="button" value="全屏" onclick="btnFullScreen_onClick();"><input id="htxtFullScreen" type="hidden" value="0" runat="server" size="1" NAME="htxtFullScreen"><input id="btnLockApp" type="button" class="button" value="锁定" onclick="btnLockApp_onClick();"><input id="htxtLockApp" type="hidden" value="0" runat="server" size="1" NAME="htxtLockApp"></td><!--曾祥林 2008-03-29-->
				</tr>
			</table>
		</td>
	</tr>
