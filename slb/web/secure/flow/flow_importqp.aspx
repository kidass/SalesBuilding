<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_importqp.aspx.vb" Inherits="Josco.JSOA.web.flow_importqp"%>
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD width="800"><INPUT class="textbox-text" id="fileUpload" style="WIDTH: 100%" type="file" runat="server"></TD>
											</TR>
											<TR>
												<TD height="6"></TD>
											</TR>
