<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_fujian_info.aspx.vb" Inherits="Josco.JSOA.web.flow_fujian_info" %>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" vAlign="top" align="center">
										<DIV id="divContent" style="DISPLAY:none">
											<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TR vAlign="middle">
													<TD>&nbsp;&nbsp;</TD>
													<TD class="label-text" align="right" nowrap>选择附件：</TD>
												...
												<TR vAlign="middle">
													<TD>&nbsp;&nbsp;</TD>
													<TD class="labelNotNull" align="right" nowrap>附件说明：</TD>
												...
												<TR vAlign="middle">
													...
													<TD class="label-text" align="left" nowrap><asp:textbox id="txtWJYS" runat="server"  Columns="8" CssClass="textbox-text"></asp:textbox><span class="labelAuto" style="DISPLAY: none;">&nbsp;&nbsp;&nbsp;&nbsp;缓存文件：<asp:textbox id="txtWEBURL" runat="server"  Columns="49" CssClass="textbox" ReadOnly="True"></asp:textbox></span></TD>
													<TD>&nbsp;&nbsp;</TD>
												</TR>
												<TR>
													<TD colSpan="4" height="2"></TD>
