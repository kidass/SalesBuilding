<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_ckcbqk.aspx.vb" Inherits="Josco.JSOA.web.flow_ckcbqk"%>
		...
		<form id="frmFLOW_CKCBQK" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<TD colSpan="3">
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD><TEXTAREA id="textareaQBJG" runat="server" class="textbox-text" readOnly></TEXTAREA></TD>
											</TR>
											<TR>
												<TD height="3"></TD>
											</TR>
					...
					<TR>
						<TD colSpan="3" align="center"><asp:Button id="btnCancel" Runat="server"  CssClass="button" Text=" 返    回 " Height="30px"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
