<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_importzs.aspx.vb" Inherits="Josco.JSOA.web.flow_importzs"%>
		...
		<form id="frmFLOW_IMPORTZS" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TR>
						<TD width="5"></TD>
						<TD class="tips" vAlign="middle" align="center" height="30"><B><asp:Label id="lblTitle" Runat="server" CssClass="title" ></asp:Label></B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
						<TD width="5"></TD>
					</TR>
					<TR>
						<TD width="5"></TD>
								...
								<TR>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" vAlign="top" align="center">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label-text">请指定要上传的文件(文件大小≤<%=Josco.JsKernal.Common.jsoaConfiguration.MaxRequestLength/1024%>MB)：</TD>
											</TR>
											<TR>
												<TD height="6"></TD>
											</TR>
											<TR>
												<TD width="800"><INPUT class="textbox-text" id="fileUpload" style="WIDTH: 100%" type="file" name="fileUpload" runat="server"></TD>
											</TR>
											<TR>
												<TD height="6"></TD>
											</TR>
