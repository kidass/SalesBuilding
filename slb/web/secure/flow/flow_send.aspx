				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;文件准备发送给以下人员处理</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label ID="lblJSRXXGridLocInfo" Runat="server" CssClass="label-text"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
													...
													<DIV id="divJSRXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 280px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 280px">
														<asp:datagrid id="grdJSRXX" runat="server"  CssClass="labelGrid" 
															...
															<Columns>
																...
																<asp:ButtonColumn DataTextField="接收人" SortExpression="接收人" HeaderText="接收人" CommandName="Select" ItemStyle-VerticalAlign="Bottom">
																...
																<asp:TemplateColumn HeaderText="办理期限" HeaderStyle-ForeColor="White">
											...
											<TR align="left">
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR align="center">
															<TD class="label" vAlign="bottom"><asp:linkbutton id="lnkSelectAll" runat="server" CssClass="labelBlack">全选</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;</TD>
															<TD class="label" vAlign="bottom"><asp:linkbutton id="lnkDeSelectAll" runat="server" CssClass="labelBlack">不选</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;</TD>
															<TD class="labelBlack" vAlign="bottom"><asp:linkbutton id="lnkMovePrev" runat="server" CssClass="labelBlack">前页</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;</TD>
															<TD class="labelBlack" vAlign="bottom" ><asp:linkbutton id="lnkMoveNext" runat="server" CssClass="labelBlack">下页</asp:linkbutton></TD>															
														</TR>
													</TABLE>
												</TD>
											</TR>		
								...
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;委托信息一览表</B><asp:Label ID="lblWTXXGridLocInfo" Runat="server" CssClass="label-text"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divWTXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 120px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 120px">
														<asp:datagrid id="grdWTXX" runat="server"  Font-Size="12px" Font-Names="宋体" AllowPaging="False"
                                                           ...
                                                           <SelectedItemStyle Font-Size="12px" Font-Names="宋体" Font-Bold="False" VerticalAlign="top" ForeColor="RED" ></SelectedItemStyle>
					...
					<TR>
						<TD align="left" colSpan="3">&nbsp;&nbsp;&nbsp;&nbsp;
							...
							</asp:DropDownList><asp:button id="btnPLTJSY" Runat="server" CssClass="button" Text="批量添加"></asp:button>
						</td>
					</TR>
					<TR>
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnSend" Runat="server" CssClass="button"  Height="30px" Text=" 发  送 "></asp:Button>
							<asp:Button id="btnSelectRY" Runat="server" CssClass="button"  Height="30px" Text=" 选  人 "></asp:Button>
							<asp:Button id="btnAddFSR" Runat="server" CssClass="button"  Height="30px" Text=" 返  送 "></asp:Button>							
							<asp:Button id="btnDeleteRY" Runat="server" CssClass="button"  Height="30px" Text=" 删  除 "></asp:Button>
