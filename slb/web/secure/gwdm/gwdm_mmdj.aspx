<%@ Page Language="vb" AutoEventWireup="false" Codebehind="gwdm_mmdj.aspx.vb" Inherits="Josco.JsKernal.web.gwdm_mmdj" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>秘密等级代码编辑窗</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()" background="../../images/bgmain.gif">
		<form id="frmGWDM_MMDJ" method="post" runat="server">
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right">秘密代码</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_MMDM" runat="server" Font-Size="11pt" Columns="14" CssClass="textbox" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">秘密等级</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_MMDJ" runat="server" Font-Size="11pt" Columns="44" CssClass="textbox" Font-Names="宋体"></asp:textbox></TD>
													...
													<DIV id="divObjects" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 100%; CLIP: rect(0px 100% 300px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 300px">
														<asp:datagrid id="grdObjects" runat="server" Font-Size="11pt" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn DataTextField="代码" SortExpression="代码" HeaderText="秘密代码" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn DataTextField="秘密等级" SortExpression="秘密等级" HeaderText="秘密等级" CommandName="Select">
											...
											<TR>
												<TD class="label" align="center">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20"><B>秘密等级代码编辑窗</B></TD>
														</TR>
														<TR>
															<TD class="label" align="center">
																<TABLE cellSpacing="0" cellPadding="0" border="0">
																	...
																	<TR>
																		<TD class="labelNotNull" align="right" width="40%">秘密代码：</TD>
																		<TD class="label" align="left" width="60%"><asp:textbox id="txtMMDM" Runat="server" Font-Size="11pt" Font-Name="宋体" Columns="8" CssClass="textbox"></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
																	<TR>
																		<TD class="labelNotNull" align="right">秘密等级：</TD>
																		<TD class="label" align="left"><asp:textbox id="txtMMDJ" Runat="server" Font-Size="11pt" Font-Name="宋体" Columns="24" CssClass="textbox"></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2">
																			...
																			<asp:button id="btnCancel" Runat="server" Font-Size="11pt" Font-Name="宋体" Height="24px" Width="96px" CssClass="button" Text="取消"></asp:button></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
