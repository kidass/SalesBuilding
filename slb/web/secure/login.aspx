						...
						<TD vAlign="middle" align="center" width="100%">
							<TABLE style="BORDER-RIGHT: #3399ff 2px outset; BORDER-TOP: #FFFFFF 2px outset; FONT-SIZE: 11pt; FILTER: progid: DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr='#99CCFF', EndColorStr='#99CCFF'); BORDER-LEFT: #ffffff 2px outset; BORDER-BOTTOM: #3399ff 2px outset; FONT-FAMILY: 宋体" cellSpacing="0" cellPadding="0" border="0" background="../images/passbk.jpg">
								...
								<TR>
									...
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" height="24"><INPUT id="txtUserId" style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" type="text" size="18" name="txtUserId" runat="server">&nbsp;&nbsp;&nbsp;&nbsp;</TD>
								</TR>
								<TR>
								...
								<TR>
									<TD align="center" colSpan="2" height="24"><INPUT id="btnLogin" style="FONT-SIZE: 11pt; WIDTH: 100px; FONT-FAMILY: 宋体; HEIGHT: 36px" type="button" value=" 登  录 " name="btnLogin" onclick="javascript:btnLogin_onClick();">&nbsp;&nbsp;&nbsp;&nbsp;<INPUT style="FONT-SIZE: 11pt; WIDTH: 100px; FONT-FAMILY: 宋体; HEIGHT: 36px" type="reset" value=" 重  设 "></TD>
								</TR>
								<TR>
