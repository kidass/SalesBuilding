<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_receive.aspx.vb" Inherits="Josco.JsKernal.web.flow_receive"%>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>文件接收处理窗口</title>
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmFLOW_RECEIVE" method="post" runat="server">
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;需要接收确认的信息一览表&nbsp;&nbsp;&nbsp;&nbsp;</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblFSRXXGridLocInfo" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="label"></asp:Label><B>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label id="lblZZTS" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="labelNotNull"></asp:Label></B></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divFSRXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 470px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 470px">
														<asp:datagrid id="grdFSRXX" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体" CellPadding="4"
															AllowSorting="False" BorderWidth="0px" BorderColor="#DEDFDE" PageSize="10" BorderStyle="None"
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="接收日期">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSRQ" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																...
																<asp:TemplateColumn HeaderText="接收纸质文件份数">
																	<HeaderStyle HorizontalAlign="Center" Width="40px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSWJZZFS" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="接收电子文件份数">
																	<HeaderStyle HorizontalAlign="Center" Width="40px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSWJDZFS" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="接收纸质附件份数">
																	<HeaderStyle HorizontalAlign="Center" Width="40px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSFJZZFS" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="接收电子附件份数">
																	<HeaderStyle HorizontalAlign="Center" Width="40px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSFJDZFS" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnJieshou" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 接  收 " Height="30px"></asp:Button>
							<asp:Button id="btnTuihui" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 退  回 " Height="30px"></asp:Button>
			...
			<table cellSpacing="0" cellPadding="0" align="center" border="0">
				<tr>
					<td>
						<input id="htxtSessionIdFSRXX" type="hidden" runat="server">
