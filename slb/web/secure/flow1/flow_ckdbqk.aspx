<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_ckdbqk.aspx.vb" Inherits="Josco.JsKernal.web.flow_ckdbqk"%>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>文件督办情况查看窗</title>
		...
		<!--
			function window_onresize() 
			{
				...
				if (document.all("textareaQBJG") == null)
					return;
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0"  onresize="return window_onresize()">
		<form id="frmFLOW_CKDBQK" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									<TD colSpan="3">
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="tips"><B>本文件的督办情况如下：</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
											</TR>
											<TR>
												<TD height="3"></TD>
											</TR>
											<TR>
												<TD><TEXTAREA id="textareaQBJG" runat="server" class="textbox" readonly>test</TEXTAREA></TD>
											</TR>
											<TR>
												<TD height="3"></TD>
											</TR>
					...
					<TR>
						<TD align="center" colSpan="3"><asp:Button id="btnCancel" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 返    回 " Height="30px"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
