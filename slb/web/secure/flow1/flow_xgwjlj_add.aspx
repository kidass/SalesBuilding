		...
		<form id="frmFLOW_XGWJLJ_ADD" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle">年度&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtFILESearch_NDMIN" runat="server" Font-Size="12px" CssClass="textbox" Columns="4" Font-Names="宋体"></asp:textbox>~<asp:textbox id="txtFILESearch_NDMAX" runat="server" Font-Size="12px" CssClass="textbox" Columns="4" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;流水号&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtFILESearch_LSH" runat="server" Font-Size="12px" CssClass="textbox" Columns="12" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;标题&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtFILESearch_WJBT" runat="server" Font-Size="12px" CssClass="textbox" Columns="24" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;文号&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtFILESearch_WJZH" runat="server" Font-Size="12px" CssClass="textbox" Columns="16" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" noWrap>&nbsp;&nbsp;主送/来文/主办单位&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtFILESearch_ZBDW" runat="server" Font-Size="12px" CssClass="textbox" Columns="24" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label">&nbsp;&nbsp;<asp:button id="btnFILESearch" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="搜索"></asp:button><asp:button id="btnFILEFullSearch" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="全文搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divFILE" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 400px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 400px">
														<asp:datagrid id="grdFILE" runat="server" Width="980px" Font-Size="12px" CssClass="label" Font-Names="宋体"
												...
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															...
															<TD class="label" vAlign="middle" noWrap align="left"><asp:linkbutton id="lnkCZFILEGotoPage" runat="server" Font-Size="12px" Font-Name="宋体">前往</asp:linkbutton><asp:textbox id="txtFILEPageIndex" runat="server" Font-Size="12px" Font-Name="宋体" CssClass="textbox" Columns="3">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" noWrap align="left"><asp:linkbutton id="lnkCZFILESetPageSize" runat="server" Font-Size="12px" Font-Name="宋体">每页</asp:linkbutton><asp:textbox id="txtFILEPageSize" runat="server" Font-Size="12px" Font-Name="宋体" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="label" vAlign="middle" align="right"><asp:label id="lblFILEGridLocInfo" runat="server" Font-Size="12px" Font-Name="宋体" CssClass="label">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
					...
					<TR>
						<TD colSpan="3" align="center"><asp:Button ID="btnOK" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="button" Text="加入选定文件到链接" Height="40px"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnOpenFile" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="button" Text=" 查看文件 " Height="40px"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnCancel" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="button" Text=" 返    回 " Height="40px"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
