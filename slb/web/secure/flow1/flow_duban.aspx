<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_duban.aspx.vb" Inherits="Josco.JsKernal.web.flow_duban"%>
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;本次准备督办以下人员</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblKDBXXGridLocInfo" Runat="server" CssClass="label" Font-Name="宋体" Font-Size="12px"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divKDBXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 280px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 280px">
														<asp:datagrid id="grdKDBXX" runat="server" CssClass="label" Font-Size="12px" UseAccessibleHeader="True"
															AllowPaging="True" AutoGenerateColumns="False" GridLines="Vertical" BackColor="White" BorderStyle="None"
															PageSize="7" BorderColor="#DEDFDE" BorderWidth="0px" AllowSorting="False" CellPadding="4"
															Font-Names="宋体">
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="督办日期">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtDBRQ" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="督办要求">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtDBYQ" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
								...
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;我已经督办的信息一览表</B><asp:Label id="lblYDBXXGridLocInfo" Runat="server" CssClass="label" Font-Name="宋体" Font-Size="12px"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divYDBXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 160px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 160px">
														<asp:datagrid id="grdYDBXX" runat="server" CssClass="label" Font-Size="12px" UseAccessibleHeader="True"
