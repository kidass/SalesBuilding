<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_bjyj.aspx.vb" Inherits="Josco.JsKernal.web.flow_bjyj"%>
...
<HTML>
	<HEAD>
		...
		<!--
			function window_onresize() 
			{
				...
				if (document.all("textareaBJYJ") == null)
					return;
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmFLOW_BJYJ" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="center"><B>便笺意见查看窗</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<TR>
									<TD height="3"></TD>
								</TR>
								<TR>
									<TD><TEXTAREA id="textareaBJYJ" runat="server" class="textbox" readOnly></TEXTAREA></TD>
								</TR>
								<TR>
									<TD height="6"></TD>
								</TR>
					...
					<TR>
						<TD align="center" colSpan="3"><asp:Button id="btnClose" Runat="server" Height="30px" Text=" 返  回 " CssClass="button" Font-Name="宋体" Font-Size="12px"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
