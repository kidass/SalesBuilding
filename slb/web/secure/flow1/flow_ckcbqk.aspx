<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_ckcbqk.aspx.vb" Inherits="Josco.JsKernal.web.flow_ckcbqk"%>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>文件催办情况查看窗</title>
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmFLOW_CKCBQK" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									<TD colSpan="3">
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="tips"><B>本文件的催办情况如下：</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
											</TR>
											<TR>
												<TD height="3"></TD>
											</TR>
					...
					<TR>
						<TD colSpan="3" align="center"><asp:Button id="btnCancel" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 返    回 " Height="30px"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
