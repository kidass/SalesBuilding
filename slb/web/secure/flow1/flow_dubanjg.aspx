<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_dubanjg.aspx.vb" Inherits="Josco.JsKernal.web.flow_dubanjg"%>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;我被督办的情况一览表</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblBDBXXGridLocInfo" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="label"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD>
													<DIV id="divBDBXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 280px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 280px">
														<asp:datagrid id="grdBDBXX" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体" CellPadding="4"
															AllowSorting="False" BorderWidth="0px" BorderColor="#DEDFDE" PageSize="30" BorderStyle="None"
															BackColor="White" GridLines="Vertical" AutoGenerateColumns="False" AllowPaging="False" UseAccessibleHeader="True" Width="1200px">
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button ID="btnSave" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="button" Text=" 暂  存 " Height="30px"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;
