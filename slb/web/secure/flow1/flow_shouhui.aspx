<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_shouhui.aspx.vb" Inherits="Josco.JsKernal.web.flow_shouhui"%>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;我准备从以下人员中收回文件&nbsp;&nbsp;&nbsp;&nbsp;</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblJSRXXGridLocInfo" Runat="server" CssClass="label" Font-Name="宋体" Font-Size="12px"></asp:Label><B>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label id="lblZZTS" Runat="server" CssClass="labelNotNull" Font-Name="宋体" Font-Size="12px"></asp:Label></B></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divJSRXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 450px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 450px">
														<asp:datagrid id="grdJSRXX" runat="server" CssClass="label" Font-Size="12px" UseAccessibleHeader="True"
															AllowPaging="True" AutoGenerateColumns="False" GridLines="Vertical" BackColor="White" BorderStyle="None"
															PageSize="10" BorderColor="#DEDFDE" BorderWidth="0px" AllowSorting="False" CellPadding="4"
															Font-Names="宋体">
								...
								<TR>
									<TD colSpan="5" height="3"><asp:CheckBox ID="chkSHTZ" Runat="server" Font-Name="宋体" Font-Size="12px" CssClass="textbox" Text="向被收回人发送收回文件通知"></asp:CheckBox></TD>
								</TR>
							</TABLE>
						</TD>
						<TD width="5"></TD>
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnShouhui" Runat="server" CssClass="button" Font-Name="宋体" Font-Size="12px" Height="30px" Text=" 收  回 "></asp:Button>
							<asp:Button id="btnRefresh" Runat="server" CssClass="button" Font-Name="宋体" Font-Size="12px" Height="30px" Text=" 刷  新 "></asp:Button>
