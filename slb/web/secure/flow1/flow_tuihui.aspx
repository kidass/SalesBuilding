<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_tuihui.aspx.vb" Inherits="Josco.JsKernal.web.flow_tuihui"%>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;可以退回的信息一览表&nbsp;&nbsp;&nbsp;&nbsp;</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblFSRXXGridLocInfo" Runat="server" CssClass="label" Font-Name="宋体" Font-Size="12px"></asp:Label><B>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label id="lblZZTS" Runat="server" CssClass="labelNotNull" Font-Name="宋体" Font-Size="12px"></asp:Label></B></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divFSRXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 470px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 470px">
														<asp:datagrid id="grdFSRXX" runat="server" CssClass="label" Font-Size="12px" UseAccessibleHeader="True"
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnTuihui" Runat="server" CssClass="button" Font-Name="宋体" Font-Size="12px" Height="30px" Text=" 退  回 "></asp:Button>
