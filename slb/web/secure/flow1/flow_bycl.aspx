<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_bycl.aspx.vb" Inherits="Josco.JsKernal.web.flow_bycl"%>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;我送出或转送的文件补阅请求/我主动进行的文件补阅操作</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblWSCXXGridLocInfo" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="label"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divWSCXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 700px; CLIP: rect(0px 700px 220px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 220px">
														<asp:datagrid id="grdWSCXX" runat="server" Width="1320px" Font-Size="12px" CssClass="label" Font-Names="宋体"
												...
												<td valign="top">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<tr>
															<td><asp:Button id="btnSendRequest" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="发出请求" Height="30px"></asp:Button></td>
														</tr>
														<tr>
															<td height="10"></td>
														</tr>
														<tr>
															<td><asp:Button id="btnShouRequest" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="收回请求" Height="30px"></asp:Button></td>
														</tr>
														<tr>
															<td height="10"></td>
														</tr>
														<tr>
															<td><asp:Button id="btnSendTongzhi" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="给…补阅" Height="30px"></asp:Button></td>
														</tr>
													</table>
												</td>
											</TR>
								...
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;送给我的文件补阅请求</B><asp:Label id="lblSGWXXGridLocInfo" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="label"></asp:Label></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divSGWXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 700px; CLIP: rect(0px 700px 220px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 220px">
														<asp:datagrid id="grdSGWXX" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体" CellPadding="4"
															AllowSorting="False" BorderWidth="0px" BorderColor="#DEDFDE" PageSize="30" BorderStyle="None"
															BackColor="White" GridLines="Vertical" AutoGenerateColumns="False" AllowPaging="False" UseAccessibleHeader="True" Width="1320px">
															<SelectedItemStyle Font-Size="12px" Font-Names="宋体" Font-Bold="False" VerticalAlign="Middle" ForeColor="#CC0000" BackColor="#FFFFDD"></SelectedItemStyle>
															<EditItemStyle Font-Size="12px" Font-Names="宋体" VerticalAlign="Middle" BackColor="#FFCC00"></EditItemStyle>
															<AlternatingItemStyle Font-Size="12px" Font-Names="宋体" BorderWidth="0px" BorderStyle="Solid" BorderColor="Gold" VerticalAlign="Middle" BackColor="White"></AlternatingItemStyle>
															<ItemStyle Font-Size="12px" Font-Names="宋体" BorderWidth="0px" BorderStyle="Solid" BorderColor="Gold" VerticalAlign="Middle" BackColor="#F7F7F7" ForeColor="Black"></ItemStyle>
												...
												<td valign="top">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<tr>
															<td><asp:Button id="btnPizhun" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="同意请求" Height="30px"></asp:Button></td>
														</tr>
														<tr>
															<td height="10"></td>
														</tr>
														<tr>
															<td><asp:Button id="btnJujue" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="拒绝请求" Height="30px"></asp:Button></td>
														</tr>
														<tr>
															<td height="10"></td>
														</tr>
														<tr>
															<td><asp:Button id="btnZhuanfa" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="转发请求" Height="30px"></asp:Button></td>
														</tr>
														<tr>
															<td height="10"></td>
														</tr>
														<tr>
															<td><asp:Button id="btnHasRead" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="我已看过" Height="30px"></asp:Button></td>
														</tr>
													</table>
												</td>
											</TR>
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnRefresh" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 刷  新 " Height="30px"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:Button id="btnCancel" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 返  回 " Height="30px"></asp:Button>
						</TD>
					</TR>
				</TABLE>
			</asp:panel>
