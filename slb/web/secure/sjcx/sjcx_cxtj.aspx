				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR vAlign="middle" height="28">
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid;" align="left">&nbsp;&nbsp;<asp:TextBox id="txtZKHZ" Runat="server" CssClass="textbox" Columns="6" Font-Size="11pt" Font-Names="宋体"></asp:TextBox>(个)</TD>
									<TD>&nbsp;&nbsp;</TD>
								</TR>
								<TR vAlign="middle" height="28">
									<TD>&nbsp;&nbsp;</TD>
									<TD class="label" style="BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid;" noWrap align="right">比较运算符：</TD>
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid;" align="left">&nbsp;&nbsp;<asp:RadioButtonList id="rblBJF" Runat="server" CssClass="textbox" RepeatLayout="Flow" RepeatDirection="Horizontal" Font-Size="11pt" Font-Names="宋体" AutoPostBack="True"></asp:RadioButtonList></TD>
									<TD>&nbsp;&nbsp;</TD>
								</TR>
								<TR vAlign="middle">
									<TD height="28">&nbsp;&nbsp;</TD>
									<TD class="label" style="BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid;" noWrap align="right" rowSpan="2">准备查询值：</TD>
									<TD class="label" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid;" align="left">&nbsp;&nbsp;值1(小值)<asp:TextBox id="txtVal1" Runat="server" CssClass="textbox" Columns="60" Font-Size="11pt" Font-Names="宋体"></asp:TextBox></TD>
									<TD>&nbsp;&nbsp;</TD>
								</TR>
								<TR>
									<TD height="28">&nbsp;&nbsp;</TD>
									<TD class="label" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid;" align="left">&nbsp;&nbsp;值2(大值)<asp:TextBox id="txtVal2" Runat="server" CssClass="textbox" Columns="60" Font-Size="11pt" Font-Names="宋体"></asp:TextBox></TD>
									<TD>&nbsp;&nbsp;</TD>
								</TR>
								<TR vAlign="middle" height="28">
									<TD style="HEIGHT: 25px">&nbsp;&nbsp;</TD>
									<TD class="label" style="BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; HEIGHT: 25px" noWrap align="right">右边括弧：</TD>
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; HEIGHT: 25px" align="left">&nbsp;&nbsp;<asp:TextBox id="txtYKHZ" Runat="server" CssClass="textbox" Columns="6" Font-Size="11pt" Font-Names="宋体"></asp:TextBox>(个)</TD>
									<TD style="HEIGHT: 25px">&nbsp;&nbsp;</TD>
								</TR>
								<TR vAlign="middle" height="28">
									<TD>&nbsp;&nbsp;</TD>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" align="left">&nbsp;&nbsp;<asp:RadioButtonList id="rblLJF" Runat="server" CssClass="textbox" RepeatLayout="Flow" RepeatDirection="Horizontal" Font-Size="11pt" Font-Names="宋体"></asp:RadioButtonList></TD>
									<TD>&nbsp;&nbsp;</TD>
								</TR>
								<TR>
									<TD>&nbsp;&nbsp;</TD>
									<TD colSpan="2" align="center" valign="top" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD vAlign="top" align="left"><asp:ListBox id="lstField" Runat="server" Width="200px" Height="266px" CssClass="textbox" AutoPostBack="True" Font-Name="宋体" Font-Size="11pt"></asp:ListBox></TD>
												<TD>&nbsp;</TD>
													...
													<TABLE cellSpacing="0" cellPadding="0" border="0">
															...
															<TD vAlign="top" align="left">
																<DIV id="divTJ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 592px; CLIP: rect(0px 592px 266px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 266px">
																	<asp:datagrid id="grdTJ" runat="server" CssClass="label" BorderColor="#DEDFDE" BorderWidth="0px"
																		...
																		<AlternatingItemStyle Font-Size="11pt" Font-Names="宋体" VerticalAlign="Middle" BackColor="White"></AlternatingItemStyle>
														...
														<TR>
															<TD vAlign="middle" align="center" height="28">
																...
																<asp:Button id="btnModify" Runat="server" CssClass="button" Text=" 更改条件 " Height="24px"></asp:Button>
					...
					<TR>
						...
						<TD class="label" vAlign="middle" align="center" height="32">
							<asp:Button id="btnOK"     Runat="server" Height="32px" CssClass="button" Text=" 确  定 "></asp:Button>
							<asp:Button id="btnCancel" Runat="server" Height="32px" CssClass="button" Text=" 取  消 "></asp:Button>
						<TD width="4"></TD>
					</TR>
				</TABLE>
			</asp:panel>
