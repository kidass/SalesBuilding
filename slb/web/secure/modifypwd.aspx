				...
				<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%" height="98%">
					<TR>
						<TD vAlign="middle" align="center">
							<TABLE style="BORDER-RIGHT: #3399ff 2px outset; BORDER-TOP: #3399ff 2px outset; FONT-SIZE: 11pt; BORDER-LEFT: #3399ff 2px outset; BORDER-BOTTOM: #3399ff 2px outset; FONT-FAMILY: 宋体" cellSpacing="0" cellPadding="0" border="0">
								<TR>
								...
								<TR>
									...
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" height="24"><INPUT id="txtNewUserPwd" style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" type="password" size="18" runat="server">&nbsp;(最少<%=Josco.JsKernal.Common.jsoaConfiguration.MinPasswordLength%>个字符)&nbsp;</TD>
								</TR>
								<TR>
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" colSpan="2" height="20"></TD>
								</TR>
								<TR>
									...
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" height="24"><INPUT id="txtNewUserPwdQR" style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" type="password" size="18" runat="server">&nbsp;(最少<%=Josco.JsKernal.Common.jsoaConfiguration.MinPasswordLength%>个字符)&nbsp;</TD>
								</TR>
								<TR>
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" colSpan="2" height="20"></TD>
								</TR>
								<TR>
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" height="24">&nbsp;&nbsp;&nbsp;&nbsp;验&nbsp;证&nbsp;码：</TD>
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" height="24" valign="middle"><INPUT id="txtValidPwd" style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体; height:22px" type="text" size="8" name="txtValidPwd" runat="server"><asp:image ID="imgValidPwd" Runat="server" ImageUrl="../randimg.aspx" Height="22px" ImageAlign="AbsMiddle"></asp:image>&nbsp;&nbsp;&nbsp;&nbsp;</TD>
								</TR>
								<TR>
									<TD style="FONT-SIZE: 11pt; FONT-FAMILY: 宋体" colSpan="2" height="20"></TD>
								</TR>
								<TR>
									<TD align="center" colSpan="2" height="24">
										<INPUT id="btnModify" style="FONT-SIZE: 11pt; WIDTH: 100px; FONT-FAMILY: 宋体; HEIGHT: 36px" type="button" value=" 更  改 " runat="server">
										<INPUT id="btnReset" style="FONT-SIZE: 11pt; WIDTH: 100px; FONT-FAMILY: 宋体; HEIGHT: 36px" type="reset"  value=" 重  设 " runat="server">
										<INPUT id="btnCancel" style="FONT-SIZE: 11pt; WIDTH: 100px; FONT-FAMILY: 宋体; HEIGHT: 36px" type="button" value=" 返  回 " runat="server">
									</TD>
								</TR>
								<TR>
