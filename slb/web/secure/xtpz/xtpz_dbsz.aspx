						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									...
									<TD align="right"><asp:Button id="btnClose" Runat="server" Text=" 安全返回 " CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:Button></TD>
									<TD width="3"></TD>
								</TR>
								<TR>
									<TD width="3"></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtDBSZSearch_ZWMC" runat="server" CssClass="textbox" Font-Size="11pt" Columns="12" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" noWrap align="right">&nbsp;&nbsp;督办范围</TD>
															<TD class="label" align="left"><asp:textbox id="txtDBSZSearch_DBFW" runat="server" CssClass="textbox" Font-Size="11pt" Columns="16" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" noWrap align="right">&nbsp;&nbsp;补充说明</TD>
															<TD class="label" align="left"><asp:textbox id="txtDBSZSearch_BCSM" runat="server" CssClass="textbox" Font-Size="11pt" Columns="16" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label"><asp:button id="btnDBSZQuery" Runat="server" Text="搜索" CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divDBSZ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 550px; CLIP: rect(0px 550px 430px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 430px">
														<asp:datagrid id="grdDBSZ" runat="server" CssClass="label" Font-Size="11pt" Font-Names="宋体"
											...
											<TR align="center">
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR align="center">
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZDBSZDeSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">不选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZDBSZSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">全选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZDBSZMoveFirst" runat="server" Font-Size="11pt" Font-Name="宋体">最前</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZDBSZMovePrev" runat="server" Font-Size="11pt" Font-Name="宋体">前页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZDBSZMoveNext" runat="server" Font-Size="11pt" Font-Name="宋体">下页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZDBSZMoveLast" runat="server" Font-Size="11pt" Font-Name="宋体">最后</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" noWrap><asp:linkbutton id="lnkCZDBSZGotoPage" runat="server" Font-Size="11pt" Font-Name="宋体">前往</asp:linkbutton><asp:textbox id="txtDBSZPageIndex" runat="server" CssClass="textbox" Font-Size="11pt" Font-Name="宋体" Columns="2">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" noWrap><asp:linkbutton id="lnkCZDBSZSetPageSize" runat="server" Font-Size="11pt" Font-Name="宋体">每页</asp:linkbutton><asp:textbox id="txtDBSZPageSize" runat="server" CssClass="textbox" Font-Size="11pt" Font-Name="宋体" Columns="3">30</asp:textbox>条</TD>
															<TD class="label" vAlign="middle" align="right"><asp:label id="lblDBSZGridLocInfo" runat="server" CssClass="label" Font-Size="11pt" Font-Name="宋体">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											...
											<TR>
												<TD align="center">
													<asp:Button id="btnDBSZAddNew" Runat="server" Text=" 新增设定 " CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:Button>
													<asp:Button id="btnDBSZModify" Runat="server" Text=" 更改设定 " CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:Button>
													<asp:Button id="btnDBSZDelete" Runat="server" Text=" 删除设定 " CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:Button>
													<asp:Button id="btnDBSZSearch" Runat="server" Text=" 全文检索 " CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:Button>
												</TD>
											</TR>
											<TR>
												<TD height="3"></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="left" width="240">
													<asp:DropDownList id="ddlDBFW" Runat="server" Font-Size="11pt" Font-Name="宋体" Width="100%">
											...
											<TR>
												<TD class="label" align="left">
													<asp:DropDownList id="ddlBCSM" Runat="server" Font-Size="11pt" Font-Name="宋体" Width="100%">
											...
											<TR>
												<TD class="label" align="center">
													<asp:button id="btnSave" Runat="server" Height="24px" Width="96px" Text="保存" CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:button>
													<asp:button id="btnCancel" Runat="server" Height="24px" Width="96px" Text="取消" CssClass="button" Font-Size="11pt" Font-Name="宋体"></asp:button>
												</TD>
											</TR>
											<TR>
