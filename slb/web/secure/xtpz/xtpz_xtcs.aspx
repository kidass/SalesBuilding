				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0" height="98%">
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0" height="100%">
								...
								<TR vAlign="middle">
									...
									<TD class="label" align="left"><SPAN class="label"><asp:textbox id="txtZNBZYWZ" runat="server" Height="24px" CssClass="textbox" Columns="48" Font-Names="宋体" Font-Size="11pt" Wrap="False"></asp:textbox></SPAN></TD>
								</TR>
								<TR vAlign="middle">
									<TD class="labelNotNull" noWrap align="right" height="36">主FTP服务器名：</TD>
									<TD class="labelNotNull" align="left"><SPAN class="labelNotNull"><asp:textbox id="txtZFTPFWQ" runat="server" Height="24px" CssClass="textbox" Columns="48" Font-Names="宋体" Font-Size="11pt" Wrap="False"></asp:textbox><FONT color="#ff0000">*</FONT></SPAN></TD>
								</TR>
								<TR vAlign="middle">
									<TD class="labelNotNull" noWrap align="right" height="36">主FTP服务器端口：</TD>
									<TD class="labelNotNull" align="left"><asp:textbox id="txtZFTPDK" runat="server" Height="24px" CssClass="textbox" Columns="12" Font-Names="宋体" Font-Size="11pt"></asp:textbox><FONT color="#ff0000">*</FONT></TD>
								</TR>
								<TR vAlign="middle">
									<TD class="labelNotNull" noWrap align="right" height="36">主FTP服务器用户：</TD>
									<TD class="labelNotNull" align="left"><asp:textbox id="txtZFTPYH" runat="server" Height="24px" CssClass="textbox" Columns="36" Font-Names="宋体" Font-Size="11pt"></asp:textbox><FONT color="#ff0000">*</FONT></TD>
								</TR>
								<TR vAlign="middle">
								...
								<TR vAlign="middle">
									...
									<TD class="label" align="left"><SPAN class="label"><asp:textbox id="txtCNBZYWZ" runat="server" Height="24px" CssClass="textbox" Columns="48" Font-Names="宋体" Font-Size="11pt" Wrap="False"></asp:textbox></SPAN></TD>
								</TR>
								<TR vAlign="middle">
									<TD class="label" noWrap align="right" height="36">备用FTP服务器名：</TD>
									<TD class="label" align="left"><SPAN class="label"><asp:textbox id="txtCFTPFWQ" runat="server" Height="24px" CssClass="textbox" Columns="48" Font-Names="宋体" Font-Size="11pt" Wrap="False"></asp:textbox></SPAN></TD>
								</TR>
								<TR vAlign="middle">
									<TD class="label" noWrap align="right" height="36">备用FTP服务器端口：</TD>
									<TD class="label" align="left"><asp:textbox id="txtCFTPDK" runat="server" Height="24px" CssClass="textbox" Columns="12" Font-Names="宋体" Font-Size="11pt"></asp:textbox></TD>
								</TR>
								<TR vAlign="middle">
									<TD class="label" noWrap align="right" height="36">备用FTP服务器用户：</TD>
									<TD class="label" align="left"><asp:textbox id="txtCFTPYH" runat="server" Height="24px" CssClass="textbox" Columns="36" Font-Names="宋体" Font-Size="11pt"></asp:textbox></TD>
								</TR>
								<TR vAlign="middle">
					...
					<TR vAlign="middle">
						<TD align="center" colspan="3" style="BORDER-TOP: #99cccc 1px solid">
							<asp:button id="btnOK" Runat="server" Width="94" Height="36" CssClass="button" Font-Names="宋体" Font-Size="11pt" Text=" 保  存 "></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<asp:button id="btnClose" Runat="server" Width="94px" Height="36px" CssClass="button" Font-Names="宋体" Font-Size="11pt" Text=" 关  闭 "></asp:button>
						</TD>
					</TR>
				</TABLE>
			</asp:Panel>
