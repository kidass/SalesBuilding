										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtBDKZSearch_ZWMC" runat="server" Font-Size="11pt" CssClass="textbox" Columns="12" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" noWrap align="right">&nbsp;&nbsp;补登范围</TD>
															<TD class="label" align="left"><asp:textbox id="txtBDKZSearch_BDFW" runat="server" Font-Size="11pt" CssClass="textbox" Columns="16" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" noWrap align="right">&nbsp;&nbsp;补充说明</TD>
															<TD class="label" align="left"><asp:textbox id="txtBDKZSearch_BCSM" runat="server" Font-Size="11pt" CssClass="textbox" Columns="16" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label"><asp:button id="btnBDKZQuery" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="button" Text="搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divBDKZ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 520px; CLIP: rect(0px 520px 430px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 430px">
														<asp:datagrid id="grdBDKZ" runat="server" Font-Size="11pt" CssClass="label" Font-Names="宋体" UseAccessibleHeader="True"
											...
											<TR align="center">
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR align="center">
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZBDKZDeSelectAll" runat="server" Font-Name="宋体" Font-Size="11pt">不选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZBDKZSelectAll" runat="server" Font-Name="宋体" Font-Size="11pt">全选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZBDKZMoveFirst" runat="server" Font-Name="宋体" Font-Size="11pt">最前</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZBDKZMovePrev" runat="server" Font-Name="宋体" Font-Size="11pt">前页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZBDKZMoveNext" runat="server" Font-Name="宋体" Font-Size="11pt">下页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle"><asp:linkbutton id="lnkCZBDKZMoveLast" runat="server" Font-Name="宋体" Font-Size="11pt">最后</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" noWrap><asp:linkbutton id="lnkCZBDKZGotoPage" runat="server" Font-Name="宋体" Font-Size="11pt">前往</asp:linkbutton><asp:textbox id="txtBDKZPageIndex" runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="2">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" noWrap><asp:linkbutton id="lnkCZBDKZSetPageSize" runat="server" Font-Name="宋体" Font-Size="11pt">每页</asp:linkbutton><asp:textbox id="txtBDKZPageSize" runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="label" vAlign="middle" align="right"><asp:label id="lblBDKZGridLocInfo" runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="label">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											...
											<TR>
												<TD align="center">
													<asp:Button id="btnBDKZAddNew" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="button" Text=" 新增设定 "></asp:Button>
													<asp:Button id="btnBDKZModify" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="button" Text=" 更改设定 "></asp:Button>
													<asp:Button id="btnBDKZDelete" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="button" Text=" 删除设定 "></asp:Button>
													<asp:Button id="btnBDKZSearch" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="button" Text=" 全文检索 "></asp:Button>
												</TD>
											</TR>
											<TR>
												<TD height="3"></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="left" width="270">
													<asp:DropDownList id="ddlBDFW" Runat="server" Width="100%" Font-Name="宋体" Font-Size="11pt">
											...
											<TR>
												<TD class="label" align="left">
													<asp:DropDownList id="ddlBCSM" Runat="server" Width="100%" Font-Name="宋体" Font-Size="11pt">
