<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="staff_manager.aspx.vb" Inherits="Josco.JSOA.web.staff_manager" %>
											...
											<TR>
												<TD>
													<DIV id="divBMRY" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 550px; CLIP: rect(0px 550px 420px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 420px">
														<asp:datagrid id="grdBMRY" runat="server" Width="1750px" Cssclass="label"  Font-Size="12px" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn DataTextField="是否有效" SortExpression="是否有效" HeaderText="是否有效" CommandName="Select">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn DataTextField="用工模式" SortExpression="用工模式" HeaderText="用工模式" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn DataTextField="身份证号" SortExpression="身份证号" HeaderText="身份证号" CommandName="Select">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
