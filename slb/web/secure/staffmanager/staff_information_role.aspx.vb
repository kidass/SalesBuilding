...
Namespace Josco.JSOA.web
    ...
    Partial Public Class staff_information_role
        ...
        Private m_objDataSet_ZW As Josco.JsKernal.Common.Data.CustomerData
        Private m_objDataSet_AllRole As Josco.JsKernal.Common.Data.AppManagerData
        Private m_objDataSet_ChoiceRole As Josco.JsKernal.Common.Data.AppManagerData
        Private m_strSessionId_ChoiceRole As String '缓存m_strSessionId_ChoiceRole的SessionId
        Private m_objDataSet_AllCYFW As Josco.JsKernal.Common.Data.FenfafanweiData
        Private m_objDataSet_ChoiceCYFW As Josco.JsKernal.Common.Data.FenfafanweiData
        ...
        Private m_objenumEditType As Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType '具体操作模式                                                   '显示模块
        ...
        Private Function showGongzuogangweiData(ByRef strErrMsg As String) As Boolean
            ...
            Dim objsystemGongzuogangwei As Josco.JsKernal.BusinessFacade.systemGongzuogangwei
            Dim objGongzuogangweiData As Josco.JsKernal.Common.Data.GongzuogangweiData
            ...
            Try
                ...
                objsystemGongzuogangwei = New Josco.JsKernal.BusinessFacade.systemGongzuogangwei
                ...
                Dim i As Integer
                With objGongzuogangweiData.Tables(Josco.JsKernal.Common.Data.GongzuogangweiData.TABLE_GG_B_GONGZUOGANGWEI)
                    intCount = .Rows.Count
                    For i = 0 To intCount - 1 Step 1
                        objListItem = New System.Web.UI.WebControls.ListItem
                        objListItem.Text = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JsKernal.Common.Data.GongzuogangweiData.FIELD_GG_B_GONGZUOGANGWEI_GWMC), " ")
                        objListItem.Value = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JsKernal.Common.Data.GongzuogangweiData.FIELD_GG_B_GONGZUOGANGWEI_GWDM), " ")
            ...
            Josco.JsKernal.Common.Data.GongzuogangweiData.SafeRelease(objGongzuogangweiData)
            Josco.JsKernal.BusinessFacade.systemGongzuogangwei.SafeRelease(objsystemGongzuogangwei)
...
errProc:
        ...
        Private Function docheckID(ByRef strErrMsg As String) As Boolean
            ...
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            Dim objdacStaff As New Josco.JSOA.DataAccess.dacStaff
            ...
            Try
                ...
                '检查ID是否存在
                If objdacStaff.doCheckId(strErrMsg, m_blnBS, MyBase.UserId, MyBase.UserPassword, strLoginId) = True Then
...
errProc:
        ...
        Private Sub doApplyId(ByVal strControlId As String)
            ...
            Try
                ...
                '申请处理
                Dim objConnectionProperty As Josco.JsKernal.Common.Utilities.ConnectionProperty
                Dim strServerName As String = Josco.JsKernal.Common.jsoaConfiguration.DatabaseServerName
                Dim strDBName As String = Josco.JsKernal.Common.jsoaConfiguration.DatabaseServerUserDB
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    '记录审计日志
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]为[" + strLoginId + "]申请了用户标识！")
                    ...
                    '记录审计日志
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]授权[" + strLoginId + "]存取[" + objConnectionProperty.DataSource + "]数据库！")
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtSFZH.Text = .txtFTPDZ
                    Me.ddlYGMS.SelectedIndex = .ddlSSFZ_SelectedIndex
                    ...
                    If Not (.cblDRZW Is Nothing) Then
                        ...
                        Dim intCount As Integer
                        Dim i As Integer
                        objGongzuogangweiData = CType(.cblDRZW, Josco.JsKernal.Common.Data.GongzuogangweiData)
                        With objGongzuogangweiData.Tables(Josco.JsKernal.Common.Data.GongzuogangweiData.TABLE_GG_B_GONGZUOGANGWEI)
                            intCount = .Rows.Count
                            For i = 0 To intCount - 1 Step 1
                                objListItem = Me.cblDRZW.Items.FindByValue(objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JsKernal.Common.Data.GongzuogangweiData.FIELD_GG_B_GONGZUOGANGWEI_GWDM), ""))
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    .txtFTPDZ = Me.txtSFZH.Text
                    .ddlSSFZ_SelectedIndex = Me.ddlYGMS.SelectedIndex
                    ...
                    For i = 0 To intCount - 1 Step 1
                        If Me.cblDRZW.Items(i).Selected = True Then
                            If intSelected = 0 Then
                                objGongzuogangweiData = New Josco.JsKernal.Common.Data.GongzuogangweiData(Josco.JsKernal.Common.Data.GongzuogangweiData.enumTableType.GG_B_GONGZUOGANGWEI)
                            End If
                            With objGongzuogangweiData.Tables(Josco.JsKernal.Common.Data.GongzuogangweiData.TABLE_GG_B_GONGZUOGANGWEI)
                                objDataRow = .NewRow()
                                objDataRow.Item(Josco.JsKernal.Common.Data.GongzuogangweiData.FIELD_GG_B_GONGZUOGANGWEI_GWDM) = Me.cblDRZW.Items(i).Value
                                objDataRow.Item(Josco.JsKernal.Common.Data.GongzuogangweiData.FIELD_GG_B_GONGZUOGANGWEI_GWMC) = Me.cblDRZW.Items(i).Text
                                .Rows.Add(objDataRow)
                            End With
                            intSelected += 1
                        End If
        ...
        Private Function getDataFromCallModule( _
            ...
            Dim objsystemXingzhengjibie As New Josco.JsKernal.BusinessFacade.systemXingzhengjibie
            ...
            Josco.JsKernal.BusinessFacade.systemXingzhengjibie.SafeRelease(objsystemXingzhengjibie)
                    ...
                    If strSessionId = "" Then
                        ...
                        With Me.m_objDataSet.Tables(Josco.JSOA.Common.Data.staffData.TABLE_GG_B_RENYUAN_FULLJOIN)
                            ...
                            Else
                                ...
                                Me.txtRYDM.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM), "")
                                Me.txtRYMC.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC), "")
                                Me.txtZZMC.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_ZZMC), "")
                                Me.htxtZZDM.Value = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZZDM), "")
                                Me.txtRYXH.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYXH), "")
                                Me.txtJBMC.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.XingzhengjibieData.FIELD_GG_B_XINGZHENGJIBIE_JBMC), "")
                                Me.htxtJBDM.Value = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JBDM), "")
                                Me.txtMSMC.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FULLJOIN_MSMC), "")
                                Me.htxtMSDM.Value = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_MSDM), "")
                                Me.txtLXDH.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_LXDH), "")
                                Me.txtSJHM.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SJHM), "")
                                Me.txtFTPDZ.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FTPDZ), "")
                                Me.txtYXDZ.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_YXDZ), "")
                                If objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS), "") = Josco.JsKernal.Common.Utilities.PulicParameters.CharTrue Then
                                    Me.chkZDQS.Checked = True
                                Else
                                    Me.chkZDQS.Checked = False
                                End If
                                Me.txtKZSRY.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KZSRY), "")
                                Me.txtQTYZS.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FULLJOIN_QTYZSMC), "")
                                Me.htxtQTYZS.Value = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_QTYZS), "")
                                Me.txtKCKXM.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KCKXM), "")
                                Me.txtJJXSMC.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JJXSMC), "")

                                Me.txtRYZM.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYZM), "")

                                Me.txtSFZH.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.staffData.FIELD_GG_B_RENYUAN_SFZH), "")
                                ...
                                If objsystemCustomer.getRenyuanData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.txtRYDM.Text, "0010", objCustomerData) = False Then
                                    GoTo errProc
                                End If
                                With objCustomerData.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_SHANGGANG)
                                    intCount = .Rows.Count
                                    For i = 0 To intCount - 1 Step 1
                                        strValue = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_SHANGGANG_GWDM), " ")
                                        objListItem = Nothing
        ...
        Private Sub doSelectJBDM(ByVal strControlId As String)
            ...
            Try
                ...
                With objIDmxzJbdm
                    ...
                    .iCodeField = Josco.JsKernal.Common.Data.XingzhengjibieData.FIELD_GG_B_XINGZHENGJIBIE_JBDM
                    .iNameField = Josco.JsKernal.Common.Data.XingzhengjibieData.FIELD_GG_B_XINGZHENGJIBIE_JBMC
        ...
        Private Sub doConfirm(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM, Me.txtRYDM.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC, Me.txtRYMC.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZZDM, Me.htxtZZDM.Value)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYXH, Me.txtRYXH.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JBDM, Me.htxtJBDM.Value)

                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_MSDM, Me.htxtMSDM.Value)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_LXDH, Me.txtLXDH.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SJHM, Me.txtSJHM.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FTPDZ, Me.txtFTPDZ.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_YXDZ, Me.txtYXDZ.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KZSRY, Me.txtKZSRY.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_QTYZS, Me.htxtQTYZS.Value)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KCKXM, Me.txtKCKXM.Text)
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JJXSMC, Me.txtJJXSMC.Text)

                    If Me.txtRYZM.Text.Trim = "" Then Me.txtRYZM.Text = Me.txtRYMC.Text
                    objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYZM, Me.txtRYZM.Text)

                    If Me.chkZDQS.Checked = True Then
                        objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, Josco.JsKernal.Common.Utilities.PulicParameters.CharTrue)
                    Else
                        objNewData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, Josco.JsKernal.Common.Utilities.PulicParameters.CharFalse)
                    End If

                    objNewData.Add(Josco.JSOA.Common.Data.staffData.FIELD_GG_B_RENYUAN_SFZH, Me.txtSFZH.Text)
                    objNewData.Add(Josco.JSOA.Common.Data.staffData.FIELD_GG_B_RENYUAN_YGMS, Me.ddlYGMS.SelectedValue)

                    Dim objNewDataSG As Josco.JsKernal.Common.Data.CustomerData
                    Dim objDataRow As System.Data.DataRow
                    ...
                    For i = 0 To intCount - 1 Step 1
                        If Me.cblDRZW.Items(i).Selected = True Then
                            If intSelected = 0 Then
                                objNewDataSG = New Josco.JsKernal.Common.Data.CustomerData(Josco.JsKernal.Common.Data.CustomerData.enumTableType.GG_B_SHANGGANG)
                            End If

                            With objNewDataSG.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_SHANGGANG)
                                objDataRow = .NewRow()
                                objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_SHANGGANG_RYDM) = Me.txtRYDM.Text
                                objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_SHANGGANG_GWDM) = Me.cblDRZW.Items(i).Value
                                .Rows.Add(objDataRow)
                            End With
                    ...
                    With New Josco.JSOA.DataAccess.dacStaff
                        If .doVerifyRenyuanData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.txtRYDM.Text, Me.htxtZZDM.Value, intType, objCustomerData) = False Then
                            GoTo errProc
                        End If
                    End With
                    ...
                    With New Josco.JsKernal.BusinessFacade.systemCustomer
                        Select Case Me.m_objenumEditType
                                ...
                                Else
                                    ...
                                    Else
                                        ...
                                        If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                                            ...
                                            objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM, Me.txtRYDM.Text)
                                            objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZZDM, Me.htxtZZDM.Value)
                                            objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYXH, Me.txtRYXH.Text)

                                            With (objCustomerData.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_RENYUAN_FULLJOIN).Rows(0))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JBDM, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JBDM), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_MSDM, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_MSDM), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_LXDH, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_LXDH), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SJHM, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SJHM), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FTPDZ, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FTPDZ), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_YXDZ, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_YXDZ), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KZSRY, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KZSRY), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_QTYZS, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_QTYZS), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KCKXM, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KCKXM), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JJXSMC, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JJXSMC), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYZM, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYZM), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS), ""))
                                                objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SFJM, objPulicParameters.getObjectValue(.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SFJM), ""))
                                            End With
                            ...
                            Case Else
                                ...
                                Else
                                    'objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM, Me.txtRYDM.Text)
                                    'objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC, Me.txtRYMC.Text)
                                    'objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZZDM, Me.htxtZZDM.Value)
                                    'objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYXH, Me.txtRYXH.Text)
                                    'objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JBDM, Me.htxtJBDM.Value)
                                    ...
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_MSDM, Me.htxtMSDM.Value)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_LXDH, Me.txtLXDH.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SJHM, Me.txtSJHM.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FTPDZ, Me.txtFTPDZ.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_YXDZ, Me.txtYXDZ.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KZSRY, Me.txtKZSRY.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_QTYZS, Me.htxtQTYZS.Value)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KCKXM, Me.txtKCKXM.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JJXSMC, Me.txtJJXSMC.Text)
                                    objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYZM, Me.txtRYZM.Text)
                                    If Me.chkZDQS.Checked = True Then
                                        objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, Josco.JsKernal.Common.Utilities.PulicParameters.CharTrue)
                                    Else
                                        objNewData_Temp.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, Josco.JsKernal.Common.Utilities.PulicParameters.CharFalse)
                                    End If

                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM, Me.txtRYDM.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC, Me.txtRYMC.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JBDM, Me.htxtJBDM.Value)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_MSDM, Me.htxtMSDM.Value)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_LXDH, Me.txtLXDH.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_SJHM, Me.txtSJHM.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_FTPDZ, Me.txtFTPDZ.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_YXDZ, Me.txtYXDZ.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KZSRY, Me.txtKZSRY.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_QTYZS, Me.htxtQTYZS.Value)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_KCKXM, Me.txtKCKXM.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_JJXSMC, Me.txtJJXSMC.Text)
                                    objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYZM, Me.txtRYZM.Text)
                                    If Me.chkZDQS.Checked = True Then
                                        objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, Josco.JsKernal.Common.Utilities.PulicParameters.CharTrue)
                                    Else
                                        objUpdateData.Add(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZDQS, Josco.JsKernal.Common.Utilities.PulicParameters.CharFalse)
                                    End If
...
errProc:
        ...
        Private Sub doModifyPassword(ByVal strControlId As String)
            ...
            If Josco.JsKernal.Common.jsoaConfiguration.CheckPassword = True Then
                Dim intMinLen As Integer = Josco.JsKernal.Common.jsoaConfiguration.MinPasswordLength
                ...
                If blnFoundSign = True Then
                    intLevel += 1
                End If
                If intLevel < Josco.JsKernal.Common.jsoaConfiguration.PasswordLevel Then
                    strErrMsg = "错误：密码强度不够，必须有大写字母、小写字母、数字、特殊字符四种类型中的[" + Josco.JsKernal.Common.jsoaConfiguration.PasswordLevel.ToString + "]种！"
                    GoTo errProc
                End If
            End If
            ...
            Else
                '记录审计日志
                Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]修改了[" + strUserId + "]用户标识的密码！")
            End If
...
errProc:
        ...
        Private Function getAllRole(ByRef strErrMsg As String) As Boolean
            ...
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            Dim objDataGridProcess As New Josco.JsKernal.web.DataGridProcess
            Dim objAppManagerData As Josco.JsKernal.Common.Data.AppManagerData
            Dim intStep As Integer
            ...
            Josco.JsKernal.BusinessFacade.systemAppManager.SafeRelease(objsystemAppManager)
            Josco.JsKernal.Common.Utilities.PulicParameters.SafeRelease(objPulicParameters)
            Josco.JsKernal.Common.Data.AppManagerData.SafeRelease(objAppManagerData)
            Josco.JsKernal.web.DataGridProcess.SafeRelease(objDataGridProcess)
...
errProc:
        ...
        Private Function showAllRole(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Else
                    With Me.m_objDataSet_AllRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE)
        ...
        Private Function getChoiceRole(ByRef strErrMsg As String) As Boolean
            ...
            Try
                If m_blnClick = True Then
                    ...
                    With New Josco.JSOA.DataAccess.dacStaff
                        If .getRoleData(strErrMsg, objConnectionProperty, strWhere, Me.m_objDataSet_ChoiceRole, blnNone) = False Then
                            GoTo errProc
                        End If
                    End With
                ...
                Else
                    '直接引用数据
                    Me.m_objDataSet_ChoiceRole = CType(Session.Item(Me.m_strSessionId_ChoiceRole), Josco.JsKernal.Common.Data.AppManagerData)
                End If
...
errProc:
        ...
        Private Function showChoiceRole(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Else
                    With Me.m_objDataSet_ChoiceRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE)
...
errProc:
        ...
        Private Function getAllCYFW(ByRef strErrMsg As String) As Boolean
            Dim objsystemFenfafanwei As New Josco.JsKernal.BusinessFacade.systemFenfafanwei
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            Dim objDataGridProcess As New Josco.JsKernal.web.DataGridProcess
            Dim objFenfafanweiData As Josco.JsKernal.Common.Data.FenfafanweiData
            Dim strWhere As String = ""
            ...
            Josco.JsKernal.BusinessFacade.systemFenfafanwei.SafeRelease(objsystemFenfafanwei)
            Josco.JsKernal.Common.Utilities.PulicParameters.SafeRelease(objPulicParameters)
            Josco.JsKernal.Common.Data.FenfafanweiData.SafeRelease(objFenfafanweiData)
            Josco.JsKernal.web.DataGridProcess.SafeRelease(objDataGridProcess)
...
errProc:
        ...
        Private Function showAllCYFW(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Else
                    With Me.m_objDataSet_AllCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI)
        ...
        Private Function getChoiceCYFW(ByRef strErrMsg As String) As Boolean
            ...
            Try
                If m_blnClick = True Then
                    ...
                    '重新检索数据
                    m_objDataSet_ChoiceCYFW = New Josco.JsKernal.Common.Data.FenfafanweiData(Josco.JsKernal.Common.Data.FenfafanweiData.enumTableType.GW_B_FENFAFANWEI)
                    Dim blnNone As Boolean
                    strWhere = "  a." + Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_CYMC + "='" + Trim(Me.m_objInterface.oRYMC) + "'"
                    With New Josco.JSOA.DataAccess.dacStaff
                        If .getFenfafanweiData(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet_ChoiceCYFW, blnNone) = False Then
                            GoTo errProc
                        End If
                    End With
                ...
                Else
                    '直接引用数据
                    Me.m_objDataSet_ChoiceCYFW = CType(Session.Item(Me.m_strSessionId_ChoiceCYFW), Josco.JsKernal.Common.Data.FenfafanweiData)
                End If
...
errProc:
        ...
        Private Function showChoiceCYFW(ByRef strErrMsg As String) As Boolean
            ...
            Try
                objSortType = CType(Me.htxtChoiceCYFWSortType.Value, Josco.JsKernal.Common.Utilities.PulicParameters.enumSortType)
            Catch ex As Exception
            ...
            Try
                ...
                Else
                    With Me.m_objDataSet_ChoiceCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI)
...
errProc:
        ...
        Private Sub grdAllRole_SortCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridSortCommandEventArgs) Handles grdAllRole.SortCommand
            ...
            Try
                ...
                '获取原排序命令
                strOldCommand = Me.m_objDataSet_AllRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE).DefaultView.Sort
                ...
                '执行排序
                Me.m_objDataSet_AllRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE).DefaultView.Sort = strFinalCommand
...
errProc:
        ...
        Private Sub grdChoiceRole_SortCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridSortCommandEventArgs) Handles grdChoiceRole.SortCommand
            ...
            Try
                ...
                '获取原排序命令
                strOldCommand = Me.m_objDataSet_ChoiceRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE).DefaultView.Sort
                ...
                '执行排序
                Me.m_objDataSet_ChoiceRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE).DefaultView.Sort = strFinalCommand
...
errProc:
        ...
        Private Sub grdAllCYFW_SortCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridSortCommandEventArgs) Handles grdAllCYFW.SortCommand
            ...
            Try
                ...
                '获取原排序命令
                strOldCommand = Me.m_objDataSet_AllCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI).DefaultView.Sort
                ...
                '执行排序
                Me.m_objDataSet_AllCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI).DefaultView.Sort = strFinalCommand
...
errProc:
        ...
        Private Sub grdChoiceCYFW_SortCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridSortCommandEventArgs) Handles grdChoiceCYFW.SortCommand
            ...
            Try
                ...
                '获取原排序命令
                strOldCommand = Me.m_objDataSet_ChoiceCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI).DefaultView.Sort
                ...
                '执行排序
                Me.m_objDataSet_ChoiceCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI).DefaultView.Sort = strFinalCommand
        ...
        Private Sub doSelectOne(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.grdAllRole.SelectedIndex < 0 Then
                    ...
                    GoTo errProc
                End If
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdAllRole, Josco.JsKernal.Common.Data.AppManagerData.FIELD_GL_B_SHUJUKU_JIAOSE_NAME)
                ...
                If objsystemCommon.doFindInDataTable(strErrMsg, _
                    Me.m_objDataSet_ChoiceRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE), _
                    Josco.JsKernal.Common.Data.AppManagerData.FIELD_GL_B_SHUJUKU_JIAOSE_NAME, _
                ...
                With Me.m_objDataSet_ChoiceRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE)
                    Dim objDataRow As System.Data.DataRow
                    objDataRow = .NewRow()
                    objDataRow.Item(Josco.JsKernal.Common.Data.AppManagerData.FIELD_GL_B_SHUJUKU_JIAOSE_NAME) = strZTC
                    .Rows.Add(objDataRow)
                End With
...
errProc:
        ...
        Private Sub doAddRoleMember(ByVal strControlId As String)
            ...
            Dim objsystemAppManager As New Josco.JsKernal.BusinessFacade.systemAppManager
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            Dim m_objOldDataSet_ChoiceRole As Josco.JsKernal.Common.Data.AppManagerData
            Dim objDataGridProcess As New Josco.JsKernal.web.DataGridProcess
            Dim objMessageProcess As New Josco.JsKernal.web.MessageProcess
            Dim strErrMsg As String
            Dim intStep As Integer
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    '获取旧的数据集
                    With New Josco.JSOA.DataAccess.dacStaff
                        If .getRoleData(strErrMsg, objConnectionProperty, strWhere, m_objOldDataSet_ChoiceRole, blnNone) = False Then
                            GoTo errProc
                        End If

                        '保存数据
                        If .doAddRoleMember(strErrMsg, objConnectionProperty, strLoginId, Me.m_objDataSet_ChoiceRole, m_objOldDataSet_ChoiceRole) = False Then
                            strErrMsg = strErrMsg + " [请确认用户是否已申请标识！]"
                            GoTo errProc
                        End If
                    End With
                    ...
                    With m_objDataSet_ChoiceRole.Tables(Josco.JsKernal.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_JIAOSE)
                        ...
                        For i = 0 To intCount - 1 Step 1
                            If .Rows(i).RowState <> DataRowState.Deleted Then
                                ...
                                Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]向[" + strRoleName + "]角色增加了[" + strLoginId + "]成员！")
                            End If
                        Next i
                    End With
            ...
            Josco.JsKernal.BusinessFacade.systemAppManager.SafeRelease(objsystemAppManager)
            Josco.JsKernal.Common.Data.AppManagerData.SafeRelease(m_objOldDataSet_ChoiceRole)
            Josco.JsKernal.web.DataGridProcess.SafeRelease(objDataGridProcess)
            Josco.JsKernal.web.MessageProcess.SafeRelease(objMessageProcess)
            Exit Sub
        ...
        Private Sub doSelectCYFWOne(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.grdAllCYFW.SelectedIndex < 0 Then
                    ...
                    GoTo errProc
                End If
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdAllCYFW, Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_FWMC)
                ...
                Dim blnDo As Boolean
                If objsystemCommon.doFindInDataTable(strErrMsg, _
                    Me.m_objDataSet_ChoiceCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI), _
                    Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_FWMC, _
                    strZTC, blnDo) = False Then
                    GoTo errProc
                End If
                If blnDo = True Then
                ...
                With Me.m_objDataSet_ChoiceCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI)
                    Dim objDataRow As System.Data.DataRow
                    objDataRow = .NewRow()
                    objDataRow.Item(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_FWMC) = strZTC
                    .Rows.Add(objDataRow)
                End With
...
errProc:
        ...
        Private Sub doAddCYFWMember(ByVal strControlId As String)
            ...
            Dim objSystemFenfafanwei As New Josco.JsKernal.BusinessFacade.systemFenfafanwei
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            Dim m_objOldDataSet_ChoiceCYFW As Josco.JsKernal.Common.Data.FenfafanweiData
            Dim objDataGridProcess As New Josco.JsKernal.web.DataGridProcess
            Dim objMessageProcess As New Josco.JsKernal.web.MessageProcess
            Dim strErrMsg As String
            Dim intStep As Integer
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    strWhere = "  a." + Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_CYMC + "='" + Trim(Me.m_objInterface.oRYMC) + "'"
                    With New Josco.JSOA.DataAccess.dacStaff
                        If .getFenfafanweiData(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, m_objOldDataSet_ChoiceCYFW, blnNone) = False Then
                            GoTo errProc
                        End If
                    End With
                    ...
                    With objPulicParameters
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_LSH, "")
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_FWBZ, CType(Josco.JsKernal.Common.Data.FenfafanweiData.enumFWBZ.CHENGYUAN, Integer).ToString())
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_CYLX, Josco.JsKernal.Common.Data.FenfafanweiData.CYLX_GEREN)
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_CYMC, strRYMC)
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_LXDH, strLXDH)
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_SJHM, strSJHM)
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_FTPDZ, strFTPDZ)
                        objNewRYData.Add(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_YXDZ, strYXDZ)
                    End With

                    '准备范围接口
                    With New Josco.JSOA.DataAccess.dacStaff
                        If .doSaveFenfafanweiData(strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                    ...
                    '记录审计日志
                    Dim strRoleName As String = ""
                    With m_objDataSet_ChoiceCYFW.Tables(Josco.JsKernal.Common.Data.FenfafanweiData.TABLE_GW_B_FENFAFANWEI)
                        intCount = .Rows.Count
                        strRoleName = ""
                        For i = 0 To intCount - 1 Step 1
                            If .Rows(i).RowState <> DataRowState.Deleted Then
                                strRoleName = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JsKernal.Common.Data.FenfafanweiData.FIELD_GW_B_FENFAFANWEI_FWMC), " ")
                                Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]向[" + strRoleName + "]范围增加了[" + strLoginId + "]成员！")
                            End If
                        Next i
                    End With
            ...
            Josco.JsKernal.BusinessFacade.systemFenfafanwei.SafeRelease(objSystemFenfafanwei)
            Josco.JsKernal.Common.Data.FenfafanweiData.SafeRelease(m_objOldDataSet_ChoiceCYFW)
            Josco.JsKernal.web.DataGridProcess.SafeRelease(objDataGridProcess)
            Josco.JsKernal.web.MessageProcess.SafeRelease(objMessageProcess)
            Exit Sub
