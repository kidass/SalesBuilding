<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="staff_information_role.aspx.vb" Inherits="Josco.JSOA.web.staff_information_role" %>
...
<HTML>
	<HEAD>
		...
		<link href="../../css/StylePerson.css" type="text/css" rel="stylesheet">		
		<style>
												...
												<tr>
													<td align="center">
														<TABLE cellSpacing="0" cellPadding="0" border="0">
															...
															<TR vAlign="middle">
																<TD class="label" align="right" nowrap>身份证号：</TD>
																<TD class="label" align="left"><asp:textbox id="txtSFZH" runat="server" Height="24px" CssClass="textbox" Columns="16" Font-Names="宋体" Font-Size="12px"></asp:textbox></TD>
															</TR>
															<tr vAlign="middle">
													            <TD class="label" align="right">用工模式：</TD>													
												                 <td align="left"><asp:DropDownList id="ddlYGMS" Runat="server" CssClass="textbox" Columns="12">
												...
												<TD align="center">
													<TABLE  cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															...
															<TD class="label" height="24"><INPUT id="txtNewUserPwd" class="label" type="password" size="28" runat="server" NAME="txtNewUserPwd">&nbsp;(最少<%=Josco.JsKernal.Common.jsoaConfiguration.MinPasswordLength%>个字符)&nbsp;</TD>
														</TR>
														<TR>
															<TD class="label" colSpan="2" height="20"></TD>
														</TR>
														<TR>
															...
															<TD class="label" height="24"><INPUT id="txtNewUserPwdQR" class="label" type="password" size="28" runat="server" NAME="txtNewUserPwdQR">&nbsp;(最少<%=Josco.JsKernal.Common.jsoaConfiguration.MinPasswordLength%>个字符)&nbsp;</TD>
														</TR>
														<TR>
															<TD class="label" colSpan="2" height="20"></TD>
														</TR>
