						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc solid 2px">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWOpen" runat="server" Font-Size="11pt" Font-Name="宋体">查看单位</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWAddNewTJ" runat="server" Font-Size="11pt" Font-Name="宋体">增加同级</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWAddNewXJ" runat="server" Font-Size="11pt" Font-Name="宋体">增加下级</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWUpdate" runat="server" Font-Size="11pt" Font-Name="宋体">更改单位</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWDelete" runat="server" Font-Size="11pt" Font-Name="宋体">删除单位</asp:linkbutton></TD>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" vAlign="top" align="left">
										<iewc:treeview id="tvwBMLIST" runat="server" Font-Size="11pt" Font-Name="宋体" Width="240px" Height="464px" CssClass="label" AutoPostBack="true"></iewc:treeview></TD>
									<TD width="5"></TD>
									<TD style="" vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtBMRYSearch_RYMC" runat="server" Font-Size="11pt" CssClass="textbox" Columns="12" Font-Names="宋体"></asp:textbox></TD>
															<!-- 曾祥林 2008-05-23 -->
