...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ggdm_gwsz.aspx.vb" Inherits="Josco.JsKernal.web.ggdm_gwsz" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>岗位设置代码编辑窗</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()" background="../../images/bgmain.gif">
		<form id="frmJBDM_GWSZ" method="post" runat="server">
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									...
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLClose" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/CLOSE.GIF" alt="返回上级" border="0" width="16" height="16">返回上级</asp:linkbutton></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right">岗位代码</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_GWDM" runat="server" Font-Size="11pt" CssClass="textbox" Columns="14" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">岗位名称</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_GWMC" runat="server" Font-Size="11pt" CssClass="textbox" Columns="44" Font-Names="宋体"></asp:textbox></TD>
													...
													<DIV id="divObjects" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 100%; CLIP: rect(0px 100% 300px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 300px">
														<asp:datagrid id="grdObjects" runat="server" Font-Size="11pt" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn DataTextField="岗位代码" SortExpression="岗位代码" HeaderText="岗位代码" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn DataTextField="岗位名称" SortExpression="岗位名称" HeaderText="岗位名称" CommandName="Select">
																	<HeaderStyle Width="760px"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
											...
											<TR>
												<TD class="label" align="center">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20"><B>岗位设置代码编辑窗</B></TD>
														</TR>
														<TR>
															<TD class="label" align="center">
																<TABLE cellSpacing="0" cellPadding="0" border="0">
																	...
																	<TR>
																		<TD class="labelNotNull" align="right" width="40%">岗位代码：</TD>
																		<TD class="label" align="left" width="60%"><asp:textbox id="txtGWDM" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="8"></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
																	<TR>
																		<TD class="labelNotNull" align="right">岗位名称：</TD>
																		<TD class="label" align="left"><asp:textbox id="txtGWMC" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="24"></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2"><asp:button id="btnSave" Runat="server" Font-Name="宋体" Font-Size="11pt" Width="96px" Height="24px" CssClass="button" Text="保存"></asp:button>&nbsp;&nbsp;<asp:button id="btnCancel" Runat="server" Font-Name="宋体" Font-Size="11pt" Width="96px" Height="24px" CssClass="button" Text="取消"></asp:button></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
