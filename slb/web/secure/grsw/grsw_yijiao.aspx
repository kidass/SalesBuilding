<%@ Page Language="vb" AutoEventWireup="false" Codebehind="grsw_yijiao.aspx.vb" Inherits="Josco.JsKernal.web.grsw_yijiao" %>
...
<HTML>
    ...
    <body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmgrsw_yijiao" method="post" runat="server">
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                    <TR>
                        ...
                        <TD vAlign="top" align="center">
                            <TABLE cellSpacing="0" cellPadding="0" border="0">
                                <TR id="trRow1">
                                    <TD class="title" align="center" colSpan="3" height="30">移交我的文件<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                                </TR>
                                <TR id="trRow2">
                                    <TD colspan="3">
                                        <TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
                                            <TR>
                                                <TD class="label" align="left" bgColor="#ccff99" colSpan="6"><B>&gt;&gt;&gt;&gt;步骤一：确定文件移交给谁？</B></TD>
                                            </TR>
                                            <TR>
                                                <TD class="labelNotNull" noWrap align="right">接收人：</TD>
                                                <TD align="left"><asp:TextBox id="txtJSR" Runat="server" CssClass="textbox" Columns="14"></asp:TextBox></TD>
                                                <TD align="left"><asp:Button id="btnSelect_JSR" Runat="server" CssClass="button" Text="选择"></asp:Button></TD>
                                                <TD class="label" noWrap align="right">移交说明：</TD>
                                                <TD align="left"><asp:TextBox id="txtYJSM" Runat="server" CssClass="textbox" Columns="64">工作交接</asp:TextBox></TD>
                                                <td width="100%"></td>
                                            </TR>
                                        </TABLE>
                                    </TD>
                                ...
                                <TR id="trRow3">
                                    <TD class="label" align="left" bgColor="#ccff99" colSpan="3"><B>&gt;&gt;&gt;&gt;步骤二：确定要移交哪些文件？</B></TD>
                                </TR>
                                <TR>
                                    <TD width="4"></TD>
                                    <TD vAlign="top">
                                                ...
                                                <TD class="label" align="left">
                                                    <TABLE cellSpacing="0" cellPadding="0" border="0">
                                                        <TR>
                                                            ...
                                                            <TD class="label" vAlign="middle">&nbsp;&nbsp;已经移交&nbsp;</TD>
                                                            <TD class="label" align="left"><asp:DropDownList id="ddlFILESearch_SFYJ" Runat="server" CssClass="textbox"><asp:ListItem Value=""></asp:ListItem><asp:ListItem Value="×">×</asp:ListItem><asp:ListItem Value="√">√</asp:ListItem></asp:DropDownList></TD>
                                            ...
                                            <TR>
                                                <TD>
                                                    <DIV id="divFILE" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 420px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 420px">
                                                        <asp:datagrid id="grdFILE" runat="server" Width="1590px" CssClass="label" UseAccessibleHeader="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:ButtonColumn DataTextField="是否移交" SortExpression="是否移交" HeaderText="移交" CommandName="Select">
                                                                    <HeaderStyle Width="50px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                                <asp:ButtonColumn Visible="False" DataTextField="是否接收" SortExpression="是否接收" HeaderText="是否接收" CommandName="Select">
                                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                                ...
                                                                <asp:ButtonColumn Visible="False" DataTextField="移交人" SortExpression="移交人" HeaderText="移交人" CommandName="Select">
                                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                                <asp:ButtonColumn Visible="False" DataTextField="移交日期" SortExpression="移交日期" HeaderText="移交日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
                                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                                <asp:ButtonColumn Visible="False" DataTextField="移交说明" SortExpression="移交说明" HeaderText="移交说明" CommandName="Select">
                                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                                <asp:ButtonColumn Visible="False" DataTextField="接收人" SortExpression="接收人" HeaderText="接收人" CommandName="Select">
                                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                                <asp:ButtonColumn Visible="False" DataTextField="接收日期" SortExpression="接收日期" HeaderText="接收日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
                                                                    <HeaderStyle Width="0px"></HeaderStyle>
                                                                </asp:ButtonColumn>
                                                            </Columns>
                    ...
                    <TR id="trRow6">
                        <TD align="center" colSpan="3">
                            <asp:Button id="btnYijiao" Runat="server" CssClass="button" Text=" 移交文件 " Height="36px"></asp:Button>
