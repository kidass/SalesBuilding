						...
						<TD vAlign="top" align="center">
							<div id="divMAIN" style="OVERFLOW: auto; WIDTH: 820px; CLIP: rect(0px 820px 470px 0px); HEIGHT: 470px">
								<TABLE cellSpacing="0" cellPadding="0" border="0">
									<TR>
										<TD class="tips" align="left" colSpan="5" height="30">&nbsp;&nbsp;单击网格列头可进行排序，单击1次为升序排列，再单击1次为降序排列，再单击1次恢复到原始排序。<asp:LinkButton id="lnkBlank" Runat="server" Width="0px" Height="5px"></asp:LinkButton></TD>
									</TR>
									<TR>
										<TD width="3"></TD>
										<TD vAlign="top" align="left" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
											<iewc:treeview id="tvwBMLIST" runat="server" CssClass="label" Width="240px" Height="516px" Font-Size="11pt" Font-Name="宋体" AutoPostBack="true"></iewc:treeview></TD>
										<TD width="3"></TD>
											...
											<TABLE cellSpacing="0" cellPadding="0" border="0">
													...
													<TD class="label" align="left">
														<TABLE cellSpacing="0" cellPadding="0" border="0">
															<TR>
																...
																<TD class="label" align="left"><asp:textbox id="txtFWLISTSearch_FWMC" runat="server" CssClass="textbox" Font-Size="11pt" Columns="36" Font-Names="宋体"></asp:textbox></TD>
																<TD class="label"><asp:button id="btnFWLISTSearch" Runat="server" CssClass="button" Height="22px" Font-Size="11pt" Font-Name="宋体" Text="搜索"></asp:button><asp:button id="btnFWLISTAdd" Runat="server" CssClass="button" Height="22px" Font-Size="11pt" Font-Name="宋体" Text="选定加入"></asp:button></TD>
															</TR>
														</TABLE>
													</TD>
												</TR>
												...
												<TR>
													<TD>
														<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
															<TR align="center">
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTDeSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">不选</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">全选</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTMoveFirst" runat="server" Font-Size="11pt" Font-Name="宋体">最前</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTMovePrev" runat="server" Font-Size="11pt" Font-Name="宋体">前页</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTMoveNext" runat="server" Font-Size="11pt" Font-Name="宋体">下页</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTMoveLast" runat="server" Font-Size="11pt" Font-Name="宋体">最后</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTGotoPage" runat="server" Font-Size="11pt" Font-Name="宋体">前往</asp:linkbutton><asp:textbox id="txtFWLISTPageIndex" runat="server" CssClass="textbox" Font-Size="11pt" Font-Name="宋体" Columns="3">1</asp:textbox>页</TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZFWLISTSetPageSize" runat="server" Font-Size="11pt" Font-Name="宋体">每页</asp:linkbutton><asp:textbox id="txtFWLISTPageSize" runat="server" CssClass="textbox" Font-Size="11pt" Font-Name="宋体" Columns="3">30</asp:textbox>条</TD>
																<TD class="label" vAlign="middle" align="right" width="140"><asp:label id="lblFWLISTGridLocInfo" runat="server" CssClass="label" Font-Size="11pt" Font-Name="宋体">1/10 N/15</asp:label></TD>
															</TR>
														</TABLE>
													</TD>
												</TR>
												<TR align="center">
													<TD class="label" align="left" style="BORDER-TOP: #99cccc 1px solid">
														<TABLE cellSpacing="0" cellPadding="0" border="0">
															<TR>
																<TD class="label" vAlign="middle" align="left">名称</TD>
																<TD class="label" align="left"><asp:textbox id="txtSELBMSearch_BMMC" runat="server" CssClass="textbox" Font-Size="11pt" Columns="36" Font-Names="宋体"></asp:textbox></TD>
																<TD class="label"><asp:button id="btnSELBMSearch" Runat="server" CssClass="button" Height="22px" Font-Size="11pt" Font-Name="宋体" Text="搜索"></asp:button><asp:button id="btnSELBMDelete" Runat="server" CssClass="button" Height="22px" Font-Size="11pt" Font-Name="宋体" Text="选定移出"></asp:button></TD>
															</TR>
														</TABLE>
													</TD>
												</TR>
												<TR>
													<TD>
														<DIV id="divSELBM" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 550px; CLIP: rect(0px 550px 200px 0px); HEIGHT: 200px">
															<asp:datagrid id="grdSELBM" runat="server" CssClass="label" Width="1440px" Font-Size="11pt" Font-Names="宋体"
																UseAccessibleHeader="True" CellPadding="4" AllowSorting="True" BorderWidth="0px" BorderColor="#DEDFDE"
																PageSize="30" BorderStyle="None" BackColor="White" GridLines="Vertical" AutoGenerateColumns="False"
																AllowPaging="True">
																<FooterStyle BackColor="#CCCC99"></FooterStyle>
												...
												<TR>
													<TD class="label">
														<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
															<TR>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMDeSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">不选</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">全选</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMMoveFirst" runat="server" Font-Size="11pt" Font-Name="宋体">最前</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMMovePrev" runat="server" Font-Size="11pt" Font-Name="宋体">前页</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMMoveNext" runat="server" Font-Size="11pt" Font-Name="宋体">下页</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMMoveLast" runat="server" Font-Size="11pt" Font-Name="宋体">最后</asp:linkbutton></TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMGotoPage" runat="server" Font-Size="11pt" Font-Name="宋体">前往</asp:linkbutton><asp:textbox id="txtSELBMPageIndex" runat="server" CssClass="textbox" Font-Size="11pt" Font-Name="宋体" Columns="3">1</asp:textbox>页</TD>
																<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSELBMSetPageSize" runat="server" Font-Size="11pt" Font-Name="宋体">每页</asp:linkbutton><asp:textbox id="txtSELBMPageSize" runat="server" CssClass="textbox" Font-Size="11pt" Font-Name="宋体" Columns="3">30</asp:textbox>条</TD>
																<TD class="label" vAlign="middle" align="right" width="140"><asp:label id="lblSELBMGridLocInfo" runat="server" CssClass="label" Font-Size="11pt" Font-Name="宋体">1/10 N/15</asp:label></TD>
															</TR>
														</TABLE>
													</TD>
												</TR>
												<TR>
													<TD class="label" style="BORDER-TOP: #99cccc 1px solid">&nbsp;输入新的
														<asp:RadioButtonList id="rblXZLX" Runat="server" Font-Size="11pt" Font-Name="宋体" RepeatColumns="3" RepeatDirection="Horizontal" RepeatLayout="Flow">
															<asp:ListItem>范围</asp:ListItem>
															<asp:ListItem Selected="True">单位</asp:ListItem>
														</asp:RadioButtonList>
														<asp:TextBox id="txtNewDWMC" Runat="server" Height="22px" Font-Size="11pt" Font-Name="宋体" Columns="36"></asp:TextBox>
														<asp:Button id="btnAddNew" Runat="server" Width="60px" Height="22px" Font-Size="11pt" Font-Name="宋体" Text="加入"></asp:Button>
													</TD>
												</TR>
											</TABLE>
										</TD>
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR vAlign="middle" align="left">
									<TD class="label" vAlign="middle" align="center" height="30">
										<asp:Button id="btnOK" Runat="server" Height="30px" Font-Size="11pt" Font-Name="宋体" Text=" 确  定 "></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:Button id="btnCancel" Runat="server" Height="30px" Font-Size="11pt" Font-Name="宋体" Text=" 取  消 "></asp:Button>
									</TD>
								</TR>
							</TABLE>
						</TD>
