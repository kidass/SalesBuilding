										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR align="center">
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZDeSelectAll" runat="server" Font-Name="宋体" Font-Size="12px">不选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSelectAll" runat="server" Font-Name="宋体" Font-Size="12px">全选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZMoveFrst" runat="server" Font-Name="宋体" Font-Size="12px">最前</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZMovePrev" runat="server" Font-Name="宋体" Font-Size="12px">前页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZMoveNext" runat="server" Font-Name="宋体" Font-Size="12px">下页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZMoveLast" runat="server" Font-Name="宋体" Font-Size="12px">最后</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZGotoPage" runat="server" Font-Name="宋体" Font-Size="12px">前往</asp:linkbutton><asp:textbox id="txtPageIndex" runat="server" Font-Name="宋体" Font-Size="12px" Width="60px" CssClass="textbox" Columns="2">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSetPageSize" runat="server" Font-Name="宋体" Font-Size="12px">每页</asp:linkbutton><asp:textbox id="txtPageSize" runat="server" Font-Name="宋体" Font-Size="12px" Width="60px" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="label" vAlign="middle" align="right" width="200"><asp:label id="lblGridLocInfo" runat="server" Font-Name="宋体" Font-Size="12px" CssClass="label">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											...
											<TR>
												<TD>
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" align="left">&nbsp;&nbsp;输入新代码：<asp:TextBox id="txtNewDM" Runat="server" Font-Name="宋体" Font-Size="12px" Columns="60" Height="24px"></asp:TextBox><asp:Button id="btnAddNew" Runat="server" Font-Name="宋体" Font-Size="12px" Text=" 输入确认 " Height="24px"></asp:Button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											...
											<TR>
												<TD class="label" align="center">
													...
													<asp:button id="btnOKNull" Runat="server" Font-Name="宋体" Font-Size="12px" Width="120px" CssClass="button" Text="空值确定" Height="36px"></asp:button>&nbsp;&nbsp;
													<asp:button id="btnCancel" Runat="server" Font-Name="宋体" Font-Size="12px" Width="96px" CssClass="button" Text="取消" Height="36px"></asp:button></TD>
											</TR>
											<TR>
												<TD height="3"></TD>
											</TR>
