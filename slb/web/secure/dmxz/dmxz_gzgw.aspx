						...
						<TD align="center">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="30">
									<TD class="label" vAlign="middle" align="center"><asp:Label id="lblTitle" Runat="server" Font-Bold="True" Font-Size="11pt" Font-Name="宋体">职务选择窗</asp:Label><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
							</TABLE>
						</TD>
						<TD width="5"></TD>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									<TD align="center" colSpan="3">
										<asp:button id="btnOK" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text=" 确  定 " Height="36px" Width="96px"></asp:button>
										<asp:button id="btnCancel" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text=" 取  消 " Height="36px" Width="96px"></asp:button>
									</TD>
								</TR>
								<TR>
									<TD colSpan="3" height="3"></TD>
