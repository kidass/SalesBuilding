...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_gzsp_previlege_param"
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtRYXM.Text = .txtRSLYGLSearch_JBRQMin
                    Me.txtRZDW.Text = .txtRSLYGLSearch_JBRQMax
                    Me.txtSearch_APRQMin.Text = .txtRSLYGLSearch_QFRQMin
                    Me.txtSearch_APRQMAX.Text = .txtRSLYGLSearch_QFRQMax
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    .txtRSLYGLSearch_JBRQMin = Me.txtRYXM.Text
                    .txtRSLYGLSearch_JBRQMax = Me.txtRZDW.Text
                    .txtRSLYGLSearch_QFRQMin = Me.txtSearch_APRQMin.Text
                    .txtRSLYGLSearch_QFRQMax = Me.txtSearch_APRQMAX.Text
...
errProc:
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                '初始化工作流
                If Me.doInitializeWorkflow(strErrMsg, "", False, Me.m_objsystemFlowObjectRenshiLiZhi) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        '     strWJBS                         ：文件标识
        '     blnFill                         ：填充数据
        '     objsystemFlowObjectRenshiLiZhi ：工作流对象
        ' 返回
        '     True                            ：成功
        '     False                           ：失败
        '----------------------------------------------------------------
        Private Function doInitializeWorkflow( _
            ...
            ByRef objsystemFlowObjectRenshiLiZhi As Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi) As Boolean
            ...
            Try
                '释放现有资源
                Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi.SafeRelease(objsystemFlowObjectRenshiLiZhi)
                ...
                objsystemFlowObject = Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi.Create(strType, strName)
                ...
                '返回
                objsystemFlowObjectRenshiLiZhi = CType(objsystemFlowObject, Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYDM
                If Me.txtRSLYGLSearch_WJBT.Text.Length > 0 Then Me.txtRSLYGLSearch_WJBT.Text = Me.txtRSLYGLSearch_WJBT.Text.Trim()
                strTEMP = Me.txtRSLYGLSearch_WJBT.Text
                If Me.txtRSLYGLSearch_WJBT.Text <> "" Then
                    strTEMP = objPulicParameters.getNewSearchString(Me.txtRSLYGLSearch_WJBT.Text)
                    If strQuery = "" Then
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPZT
                ...
                strTEMP = ""
                strRYXM = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYXM
                If txtRYXM.Text.Length > 0 Then txtRYXM.Text = txtRYXM.Text.Trim()
                strTEMP = Me.txtRYXM.Text
                If Me.txtRSLYGLSearch_WJBT.Text <> "" Then
                    strTEMP = objPulicParameters.getNewSearchString(Me.txtRSLYGLSearch_WJBT.Text)
                    If strQuery = "" Then
                        strQuery = strRYXM + " like '" + strTEMP + "%'"
                    Else
                        strQuery = strQuery + " and " + strRYXM + " like '" + strTEMP + "%'"
                    End If
                End If


                '按“单位”搜索
                Dim strRZDW As String
                strTEMP = ""
                strRZDW = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_DWMC
                If txtRZDW.Text.Length > 0 Then txtRZDW.Text = txtRZDW.Text.Trim()
                strTEMP = Me.txtRZDW.Text
                If Me.txtRSLYGLSearch_WJBT.Text <> "" Then
                    strTEMP = objPulicParameters.getNewSearchString(Me.txtRSLYGLSearch_WJBT.Text)
                    If strQuery = "" Then
                        strQuery = strRZDW + " like '" + strTEMP + "%'"
                    Else
                        strQuery = strQuery + " and " + strRZDW + " like '" + strTEMP + "%'"
                    End If
                End If

                ''按“调入单位”搜索
                'Dim strDRDW As String
                'strTEMP = ""
                'strDRDW = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YDWMC
                'If txtDRDW.Text.Length > 0 Then txtDRDW.Text = txtDRDW.Text.Trim()
                'strTEMP = Me.txtDRDW.Text
                'If Me.txtDRDW.Text <> "" Then
                '    strTEMP = objPulicParameters.getNewSearchString(Me.txtDRDW.Text)
                '    If strQuery = "" Then
                '        strQuery = strDRDW + " like '" + strTEMP + "%'"
                '    Else
                '        strQuery = strQuery + " and " + strDRDW + " like '" + strTEMP + "%'"
                '    End If
                'End If

                '按“经办日期”搜索
                Dim strJBRQ As String
                strJBRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHISHENPI_JBRQ + ",120)"
                If Me.txtSearch_APRQMin.Text.Length > 0 Then Me.txtSearch_APRQMin.Text = Me.txtSearch_APRQMin.Text.Trim()
                If Me.txtSearch_APRQMAX.Text.Length > 0 Then Me.txtSearch_APRQMAX.Text = Me.txtSearch_APRQMAX.Text.Trim()
                If Me.txtSearch_APRQMin.Text <> "" And Me.txtSearch_APRQMAX.Text <> "" Then
                    Try
                        dateMin = CType(Me.txtSearch_APRQMin.Text, System.DateTime)
                    Catch ex As Exception
                        strErrMsg = "错误：无效的日期！"
                        GoTo errProc
                    End Try
                    Try
                        dateMax = CType(Me.txtSearch_APRQMAX.Text, System.DateTime)
                    Catch ex As Exception
                        strErrMsg = "错误：无效的日期！"
                        GoTo errProc
                    End Try
                    If dateMin > dateMax Then
                        Me.txtSearch_APRQMin.Text = Format(dateMax, "yyyy-MM-dd")
                        Me.txtSearch_APRQMAX.Text = Format(dateMin, "yyyy-MM-dd")
                    Else
                        Me.txtSearch_APRQMin.Text = Format(dateMin, "yyyy-MM-dd")
                        Me.txtSearch_APRQMAX.Text = Format(dateMax, "yyyy-MM-dd")
                    End If
                    If strQuery = "" Then
                        strQuery = strJBRQ + " between '" + Me.txtSearch_APRQMin.Text + "' and '" + Me.txtSearch_APRQMAX.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strJBRQ + " between '" + Me.txtSearch_APRQMin.Text + "' and '" + Me.txtSearch_APRQMAX.Text + "'"
                    End If
                ElseIf Me.txtSearch_APRQMin.Text <> "" Then
                    Try
                        dateMin = CType(Me.txtSearch_APRQMin.Text, System.DateTime)
                    Catch ex As Exception
                        strErrMsg = "错误：无效的日期！"
                    ...
                    Me.txtSearch_APRQMin.Text = Format(dateMin, "yyyy-MM-dd")
                    If strQuery = "" Then
                        strQuery = strJBRQ + " >= '" + Me.txtSearch_APRQMin.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strJBRQ + " >= '" + Me.txtSearch_APRQMin.Text + "'"
                    End If
                ElseIf Me.txtSearch_APRQMAX.Text <> "" Then
                    Try
                        dateMax = CType(Me.txtSearch_APRQMAX.Text, System.DateTime)
                    Catch ex As Exception
                        strErrMsg = "错误：无效的日期！"
                    ...
                    Me.txtSearch_APRQMAX.Text = Format(dateMax, "yyyy-MM-dd")
                    If strQuery = "" Then
                        strQuery = strJBRQ + " <= '" + Me.txtSearch_APRQMAX.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strJBRQ + " <= '" + Me.txtSearch_APRQMAX.Text + "'"
                    End If
                Else
                End If
            Catch ex As Exception
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectRenshiLiZhi.getDataSet_ListMain(strErrMsg, MyBase.UserId, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL, Me.m_blnPrevilegeParams(1)) = False Then
                    GoTo errProc
                End If
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                ...
                If Me.m_blnSaveScence = False Then
                    ...
                    If objPulicParameters.getMonthStartAndEndDay(strErrMsg, Now, date1, date2) = False Then
                        GoTo errProc
                    Else
                        Me.txtSearch_APRQMin.Text = date1.ToString("yyyy-MM-dd")
                        Me.txtSearch_APRQMAX.Text = date2.ToString("yyyy-MM-dd")
                    End If
...
errProc:
        ...
        Private Function doCreateWorkflow( _
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRSLYGL, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHISHENPI_WJBS)
...
errProc:
        ...
        Private Function getPrintWjbs(ByRef strErrMsg As String, ByRef strWJBS As String) As Boolean
            ...
            Try
                ...
                Dim i As Integer
                intRows = Me.grdRSLYGL.Items.Count
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    For i = 0 To intRows - 1 Step 1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdRSLYGL.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RSLYGL) = True Then
                            intSelect += 1
                        End If
                    Next
                    If intSelect < 1 Then
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdRSLYGL.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RSLYGL) = True Then
                            ...
                            If strWJBS = "" Then
                                strWJBS = "'" + objDataGridProcess.getDataGridCellValue(Me.grdRSLYGL.Items(i), intColIndex) + "'"
                            Else
                                strWJBS = strWJBS + "," + "'" + objDataGridProcess.getDataGridCellValue(Me.grdRSLYGL.Items(i), intColIndex) + "'"
                            End If
                        End If
                    Next
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                If getPrintWjbs(strErrMsg, strWYBS) = False Then
                    GoTo errProc
                End If

                '获取数据集
                strWhere = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WJBS + " in (" + strWYBS + ")"
                ...
                '检查模版文件
                Dim strMBURL As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "人事_离职_人员_审批一览表.xls"
