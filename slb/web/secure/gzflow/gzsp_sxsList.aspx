<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="gzsp_sxsList.aspx.vb" Inherits="Josco.JSOA.web.gzsp_sxsList" %>
		...
		<form id="frmestate_rs_luyong_main" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD width="4">
                        <TD id="trRow0" height="30" class="title" vAlign="middle" align="left">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;综合流程管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;人事实习生入职人员一览表</TD>
                        <TD width="4">
                    </TR>					
                    <TR id="trRow1">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR id="trRow3">
															...
															<TD class="label" align="left"><asp:textbox id="txtRSLYGLSearch_WJBT" runat="server" CssClass="textbox" Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;人员姓名&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtRYXM" runat="server" CssClass="textbox" Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;入职单位&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtRZDW" runat="server" CssClass="textbox" Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox></TD>
