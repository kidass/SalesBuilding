<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="gzsp_rzryList.aspx.vb" Inherits="Josco.JSOA.web.gzsp_rzryList" %>
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>人事入职人员一览表</title>            
		...
		<form id="frmestate_rs_luyong_main" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD width="4">
                        <TD id="trRow0" height="30" class="title" vAlign="middle" align="left">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;综合流程管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;人事入职人员一览表</TD>
                        <TD width="4">
                    </TR>					
                    <TR id="trRow1">
											...
											<TR>
												<TD>
													<DIV id="divRSLYGL" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 420px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 420px">
														 <asp:datagrid id="grdRSLYGL" runat="server" Width="2800px" CssClass="labelGrid" 
