<%@ Page Language="vb" AutoEventWireup="false" Codebehind="gzsp_admin_spxx.aspx.vb" Inherits="Josco.JSOA.web.gzsp_admin_spxx"%>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
													...
													<DIV id="divSPYJ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 980px; CLIP: rect(0px 980px 524px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 524px;">
														<asp:datagrid id="grdSPYJ" runat="server" Width="1700px" Font-Size="12px" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="领导">
																	<HeaderStyle HorizontalAlign="Center" Width="80px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtSPYJ_BLR" Runat="server" CssClass="textbox" Width="80px"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="办理事宜">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtSPYJ_BLZL" Runat="server" CssClass="textbox" Width="100px"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
											...
											<TR id="trRow3">
												<TD>
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJDeSelectAll" runat="server">不选</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJSelectAll" runat="server">全选</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMoveFirst" runat="server">最前</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMovePrev" runat="server">前页</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMoveNext" runat="server">下页</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMoveLast" runat="server">最后</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJGotoPage" runat="server">前往</asp:linkbutton><asp:textbox id="txtSPYJPageIndex" runat="server" Columns="3" CssClass="textbox">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJSetPageSize" runat="server">每页</asp:linkbutton><asp:textbox id="txtSPYJPageSize" runat="server" Columns="3" CssClass="textbox">30</asp:textbox>条</TD>
