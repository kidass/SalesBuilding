<%@ Page Language="vb" AutoEventWireup="false" Codebehind="gzsp_admin_jjxx.aspx.vb" Inherits="Josco.JSOA.web.gzsp_admin_jjxx"%>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<asp:datagrid id="grdLZXX" runat="server" Width="2320px" Font-Size="12px" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="接收人">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtLZXX_JSR" Runat="server" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																...
																<asp:TemplateColumn HeaderText="交接标识">
																	<HeaderStyle HorizontalAlign="Center" Width="100px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtLZXX_JJBS" Runat="server" CssClass="textbox" Width="100%"></asp:TextBox>
																	</ItemTemplate>																	
																</asp:TemplateColumn>
															</Columns>
											...
											<TR id="trRow3">
												<TD>
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXDeSelectAll" runat="server">不选</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXSelectAll" runat="server">全选</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXMoveFirst" runat="server">最前</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXMovePrev" runat="server">前页</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXMoveNext" runat="server">下页</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXMoveLast" runat="server">最后</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXGotoPage" runat="server">前往</asp:linkbutton><asp:textbox id="txtLZXXPageIndex" runat="server" CssClass="textbox" Columns="3">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZLZXXSetPageSize" runat="server">每页</asp:linkbutton><asp:textbox id="txtLZXXPageSize" runat="server" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="labelBlack" vAlign="middle" noWrap align="right"><asp:label id="lblLZXXGridLocInfo" runat="server" CssClass="labelBlack">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
