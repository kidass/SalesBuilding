...
errProc:
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                '初始化工作流
                If Me.doInitializeWorkflow(strErrMsg, "", False, Me.m_objsystemFlowObjectRenshiRuZhi) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_RENYUANXINXI_RYDM
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_RENYUANXINXI_SPZT
                ...
                strTEMP = ""
                strRYXM = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_RENYUANXINXI_RYXM
                ...
                strTEMP = ""
                strRZDW = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_RENYUANXINXI_NFPBM
                ...
                strJBRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_JBRQ + ",120)"
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectRenshiRuZhi.getDataSet_ListMain(strErrMsg, MyBase.UserId, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL, Me.m_blnPrevilegeParams(1)) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function doCreateWorkflow( _
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRSLYGL, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_WJBS)
