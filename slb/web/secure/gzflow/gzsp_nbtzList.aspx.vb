...
errProc:
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                '初始化工作流
                If Me.doInitializeWorkflow(strErrMsg, "", False, Me.m_objsystemFlowObjectRenshiTiaozheng) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        '     strWJBS                         ：文件标识
        '     blnFill                         ：填充数据
        '     objsystemFlowObjectRenshiTiaozheng ：工作流对象
        ' 返回
        '     True                            ：成功
        '     False                           ：失败
        '----------------------------------------------------------------
        Private Function doInitializeWorkflow( _
            ...
            ByRef objsystemFlowObjectRenshiTiaozheng As Josco.JSOA.BusinessFacade.systemFlowObjectRenshiTiaozheng) As Boolean
            ...
            Try
                '释放现有资源
                Josco.JSOA.BusinessFacade.systemFlowObjectRenshiTiaozheng.SafeRelease(objsystemFlowObjectRenshiTiaozheng)
                ...
                objsystemFlowObject = Josco.JSOA.BusinessFacade.systemFlowObjectRenshiTiaozheng.Create(strType, strName)
                ...
                '返回
                objsystemFlowObjectRenshiTiaozheng = CType(objsystemFlowObject, Josco.JSOA.BusinessFacade.systemFlowObjectRenshiTiaozheng)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENG_RENYUANXINXI_RYDM
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENG_RENYUANXINXI_SPZT
                ...
                strTEMP = ""
                strRYXM = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENG_RENYUANXINXI_RYXM
                ...
                strTEMP = ""
                strRZDW = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENG_RENYUANXINXI_YDWMC
                ...
                strTEMP = ""
                strDRDW = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENG_RENYUANXINXI_YDWMC
                ...
                strJBRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENGSHENPI_JBRQ + ",120)"
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectRenshiTiaozheng.getDataSet_ListMain(strErrMsg, MyBase.UserId, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL, Me.m_blnPrevilegeParams(1)) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function doCreateWorkflow( _
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRSLYGL, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_TIAOZHENGSHENPI_WJBS)
