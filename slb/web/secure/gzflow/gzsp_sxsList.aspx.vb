...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_rs_rsbd_previlege_param"
...
errProc:
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                '初始化工作流
                If Me.doInitializeWorkflow(strErrMsg, "", False, Me.m_objsystemFlowObjectRenshiShiXisheng) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        '     strWJBS                         ：文件标识
        '     blnFill                         ：填充数据
        '     objsystemFlowObjectRenshiShiXisheng ：工作流对象
        ' 返回
        '     True                            ：成功
        '     False                           ：失败
        '----------------------------------------------------------------
        Private Function doInitializeWorkflow( _
            ...
            ByRef objsystemFlowObjectRenshiShiXisheng As Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng) As Boolean
            ...
            Try
                '释放现有资源
                Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng.SafeRelease(objsystemFlowObjectRenshiShiXisheng)
                ...
                objsystemFlowObject = Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng.Create(strType, strName)
                ...
                '返回
                objsystemFlowObjectRenshiShiXisheng = CType(objsystemFlowObject, Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYDM
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPZT
                ...
                strTEMP = ""
                strRYXM = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXM
                If txtRYXM.Text.Length > 0 Then txtRYXM.Text = txtRYXM.Text.Trim()
                strTEMP = Me.txtRYXM.Text
                If Me.txtRSLYGLSearch_WJBT.Text <> "" Then
                    strTEMP = objPulicParameters.getNewSearchString(Me.txtRYXM.Text)
                    If strQuery = "" Then
                ...
                strTEMP = ""
                strRZDW = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NFPBM
                If txtRZDW.Text.Length > 0 Then txtRZDW.Text = txtRZDW.Text.Trim()
                strTEMP = Me.txtRZDW.Text
                If Me.txtRSLYGLSearch_WJBT.Text <> "" Then
                    strTEMP = objPulicParameters.getNewSearchString(Me.txtRZDW.Text)
                    If strQuery = "" Then
                ...
                strJBRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBRQ + ",120)"
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getDataSet_ListMain(strErrMsg, MyBase.UserId, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL, Me.m_blnPrevilegeParams(1)) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function doCreateWorkflow( _
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRSLYGL, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBS)
