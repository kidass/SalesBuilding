<%@ Page Language="vb" AutoEventWireup="false" Codebehind="xtgl_mkqx_yh.aspx.vb" Inherits="Josco.JsKernal.web.xtgl_mkqx_yh" %>
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									...
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLGrant" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/grant.ico" alt="open" border="0" width="16" height="16">授权执行</asp:linkbutton></TD>
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtSearchMKDM" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="11"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right" width="36">名称</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKMC" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="15"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right" width="36">说明</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKSM" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="15"></asp:textbox></TD>
