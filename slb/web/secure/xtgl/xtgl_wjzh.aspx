					...
					<TR>
						...
						<TD align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="label" align="left"><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton>请指定要转换的目录：<asp:TextBox id="txtDIR" Runat="server" Columns="60" Font-Size="11pt" Font-Name="宋体" CssClass="textbox"></asp:TextBox><asp:Button id="btnGetFile" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text="获取目录下的文件"></asp:Button></TD>
								</TR>
								<TR>
									<TD height="4"></TD>
								</TR>
								...
								<TR>
									<TD><asp:ListBox id="lstFILE" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Width="100%" Rows="30" SelectionMode="Multiple"></asp:ListBox></TD>
								</TR>
								<TR>
									<TD height="4"></TD>
								</TR>
								<TR>
									<TD align="center">
										<asp:Button id="btnZhuanhuan" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text="执行转换" Height="36px"></asp:Button>
										<asp:Button id="btnFanZhuanhuan" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text="执行反转换" Height="36px"></asp:Button>
										<asp:Button id="btnCancel" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text=" 取    消 " Height="36px"></asp:Button>
									</TD>
								</TR>
							</TABLE>
						</TD>
