						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLSelect" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/OPEN.GIF" alt="open" border="0" width="16" height="16">查看模块</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAddNewTJ" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/NEW.GIF" alt="open" border="0" width="16" height="16">增加同级</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAddNewXJ" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/NEW.GIF" alt="open" border="0" width="16" height="16">增加下级</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUpdate" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/MODIFY.ICO" alt="open" border="0" width="16" height="16">修改模块</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLDelete" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/DELETE.GIF" alt="open" border="0" width="16" height="16">删除模块</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRefresh" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/REFRESH.ICO" alt="open" border="0" width="16" height="16">刷新数据</asp:linkbutton></TD>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									...
									<TD vAlign="top" align="left" width="220" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD><iewc:treeview id="tvwObject" runat="server" Font-Name="宋体" Font-Size="11pt" Height="460px" Width="260px" AutoPostBack="True" CssClass="label"></iewc:treeview></TD>
											</TR>
										</TABLE>
									</TD>
									<TD width="5"></TD>
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtSearchDM" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="8"></asp:textbox></TD>
															<TD class="label" vAlign="middle">名称</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMC" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="10"></asp:textbox></TD>
															<TD class="label" vAlign="middle">级别</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchJBMin" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="2"></asp:textbox><asp:textbox id="txtSearchJBMax" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="2"></asp:textbox></TD>
															<TD class="label" vAlign="middle">说明</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchSM" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" CssClass="textbox" Columns="10"></asp:textbox></TD>
