						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" style="HEIGHT: 22px" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtMKDM" runat="server" Height="24px" Wrap="False" Font-Size="11pt" Font-Names="宋体" Columns="36" CssClass="textbox"></asp:textbox><FONT color="#ff0000">*</FONT></SPAN><INPUT id="htxtMKBS" type="hidden" name="htxtMKBS" runat="server"></TD>
								</TR>
								<TR vAlign="middle" align="center" height="20">
									<TD class="label" colSpan="2"></TD>
								</TR>
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtMKMC" runat="server" Width="408px" Height="24px" Wrap="False" Font-Size="11pt" Font-Names="宋体" Columns="60" CssClass="textbox"></asp:textbox><FONT color="#ff0000">*</FONT></SPAN></TD>
								</TR>
								<TR vAlign="middle" align="center" height="20">
									<TD class="label" colSpan="2"></TD>
								</TR>
								...
								<TR vAlign="middle">
									...
									<TD class="label" align="left" height="32"><asp:textbox id="txtMKSM" runat="server" Width="540px" Height="136px" Font-Size="11pt" Font-Names="宋体" Columns="80" CssClass="textbox" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR vAlign="middle" align="center" height="20">
									<TD class="label" colSpan="2"></TD>
								</TR>
