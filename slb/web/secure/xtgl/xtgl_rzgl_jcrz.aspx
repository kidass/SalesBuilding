				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtJCRZSearch_YHBS" runat="server" Font-Size="11pt" CssClass="textbox" Columns="8" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">用户名称</TD>
															<TD class="label" align="left"><asp:textbox id="txtJCRZSearch_YHMC" runat="server" Font-Size="11pt" CssClass="textbox" Columns="8" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">IP</TD>
															<TD class="label" align="left"><asp:textbox id="txtJCRZSearch_JQDZ" runat="server" Font-Size="11pt" CssClass="textbox" Columns="8" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">操作类型</TD>
															<TD class="label" align="left"><asp:DropDownList ID="ddlJCRZSearch_CZLX" Runat="server" Font-Size="11pt" CssClass="textbox" Font-Names="宋体">
																<asp:ListItem Value=""></asp:ListItem>
																<asp:ListItem Value="登录">登录</asp:ListItem>
																<asp:ListItem Value="退出">退出</asp:ListItem>
															</asp:DropDownList></TD>
															<TD class="label" vAlign="middle">操作时间</TD>
															<TD class="label" align="left"><asp:textbox id="txtJCRZSearch_CZSJMin" runat="server" Font-Size="11pt" CssClass="textbox" Columns="10" Font-Names="宋体"></asp:textbox><asp:textbox id="txtJCRZSearch_CZSJMax" runat="server" Font-Size="11pt" CssClass="textbox" Columns="10" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label"><asp:button id="btnJCRZSearch" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text="快速搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divJCRZ" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 800px; CLIP: rect(0px 800px 390px 0px); HEIGHT: 390px">
														<asp:datagrid id="grdJCRZ" runat="server" Font-Size="11pt" CssClass="label" Font-Names="宋体" CellPadding="4"
											...
											<TR>
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZDeSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">不选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">全选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZMoveFirst" runat="server" Font-Size="11pt" Font-Name="宋体">最前</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZMovePrev" runat="server" Font-Size="11pt" Font-Name="宋体">前页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZMoveNext" runat="server" Font-Size="11pt" Font-Name="宋体">下页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZMoveLast" runat="server" Font-Size="11pt" Font-Name="宋体">最后</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZGotoPage" runat="server" Font-Size="11pt" Font-Name="宋体">前往</asp:linkbutton><asp:textbox id="txtJCRZPageIndex" runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Columns="3">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZJCRZSetPageSize" runat="server" Font-Size="11pt" Font-Name="宋体">每页</asp:linkbutton><asp:textbox id="txtJCRZPageSize" runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="label" vAlign="middle" noWrap align="right"><asp:label id="lblJCRZGridLocInfo" runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="label">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD align="center" height="28">清理开始时间：<asp:TextBox id="txtJCRZ_QSRQ" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Columns="12"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;清理结束时间：<asp:TextBox id="txtJCRZ_ZZRQ" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Columns="12"></asp:TextBox></TD>
											</TR>
										</TABLE>
									</TD>
									<TD width="5"></TD>
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnDeleteSelect" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text=" 选定清除 " Height="36px"></asp:Button>
							<asp:Button id="btnDeleteInterval" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text=" 清除时段 " Height="36px"></asp:Button>
							<asp:Button id="btnClearAll" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text=" 全部清除 " Height="36px"></asp:Button>
