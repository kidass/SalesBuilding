						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRoleQX" runat="server" Enabled="False" Font-Size="11pt" Font-Name="宋体"><img src="../../images/users.ico" alt="open" border="0" width="16" height="16">角色授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUserQX" runat="server" Font-Size="11pt" Font-Name="宋体"><img src="../../images/user.ico" alt="open" border="0" width="16" height="16">用户授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLGrant" runat="server" Font-Size="11pt" Font-Name="宋体"><img src="../../images/grant.ico" alt="open" border="0" width="16" height="16">授权执行</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRevoke" runat="server" Font-Size="11pt" Font-Name="宋体"><img src="../../images/revoke.ico" alt="open" border="0" width="16" height="16">回收权限</asp:linkbutton></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right" width="36">代码</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKDM" runat="server" Font-Size="11pt" Font-Name="宋体" Height="22px" CssClass="textbox" Columns="11"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right" width="36">名称</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKMC" runat="server" Font-Size="11pt" Font-Name="宋体" Height="22px" CssClass="textbox" Columns="15"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right" width="36">说明</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKSM" runat="server" Font-Size="11pt" Font-Name="宋体" Height="22px" CssClass="textbox" Columns="15"></asp:textbox></TD>
