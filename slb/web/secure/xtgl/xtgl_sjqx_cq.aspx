<%@ Page Language="vb" AutoEventWireup="false" Codebehind="xtgl_sjqx_cq.aspx.vb" Inherits="Josco.JsKernal.web.xtgl_sjqx_cq" %>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									...
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUserQX" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/user.ico" alt="open" border="0" width="16" height="16">用户授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAccsQX" runat="server" Font-Name="宋体" Font-Size="11pt" Enabled="False"><img src="../../images/access.ico" alt="open" border="0" width="16" height="16">存取授权</asp:linkbutton></TD>
												...
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															...
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZYRGotoPage" runat="server" Font-Name="宋体" Font-Size="11pt">前往</asp:linkbutton><asp:textbox id="txtYRPageIndex" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" Width="40px" CssClass="textbox" Columns="2">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZYRSetPageSize" runat="server" Font-Name="宋体" Font-Size="11pt">每页</asp:linkbutton><asp:textbox id="txtYRPageSize" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" Width="40px" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
												...
												<TD class="label" style="">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															...
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZWRGotoPage" runat="server" Font-Name="宋体" Font-Size="11pt">前往</asp:linkbutton><asp:textbox id="txtWRPageIndex" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" Width="40px" CssClass="textbox" Columns="2">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZWRSetPageSize" runat="server" Font-Name="宋体" Font-Size="11pt">每页</asp:linkbutton><asp:textbox id="txtWRPageSize" runat="server" Font-Name="宋体" Font-Size="11pt" Height="22px" Width="40px" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
					...
					<TR>
						...
						<TD align="center" style="BORDER-TOP: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRoleQXB" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/users.ico" alt="open" border="0" width="16" height="16">角色授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUserQXB" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/user.ico" alt="open" border="0" width="16" height="16">用户授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAccsQXB" runat="server" Font-Name="宋体" Font-Size="11pt" Enabled="False"><img src="../../images/access.ico" alt="open" border="0" width="16" height="16">存取授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLGrantB" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/grant.ico" alt="open" border="0" width="16" height="16">赋予权限</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRevokeB" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../images/revoke.ico" alt="open" border="0" width="16" height="16">回收权限</asp:linkbutton></TD>
