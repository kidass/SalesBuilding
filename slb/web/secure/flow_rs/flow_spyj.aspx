<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_spyj.aspx.vb" Inherits="Josco.JSOA.web.flow_spyj"%>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label-text" vAlign="middle">领导&nbsp;</TD>
															<TD class="label-text" align="left"><asp:textbox id="txtSPYJSearch_JSR" runat="server"  Columns="16" CssClass="textbox-text" ></asp:textbox></TD>
															<TD class="label-text" vAlign="middle">&nbsp;&nbsp;代理&nbsp;</TD>
															<TD class="label-text" align="left"><asp:textbox id="txtSPYJSearch_DLR" runat="server"  Columns="16" CssClass="textbox-text" ></asp:textbox></TD>
															<TD class="label-text" vAlign="middle">&nbsp;&nbsp;事宜&nbsp;</TD>
															<TD class="label-text" align="left"><asp:textbox id="txtSPYJSearch_BLSY" runat="server"  Columns="16" CssClass="textbox-text" ></asp:textbox></TD>
															<TD class="label-text" vAlign="middle">&nbsp;&nbsp;签批日期&nbsp;</TD>
															<TD class="label-text" align="left"><asp:textbox id="txtSPYJSearch_QPRQMin" runat="server"  Columns="12" CssClass="textbox-text" ></asp:textbox>~<asp:textbox id="txtSPYJSearch_QPRQMax" runat="server"  Columns="12" CssClass="textbox-text" ></asp:textbox></TD>
															<TD class="label-text">&nbsp;&nbsp;<asp:button id="btnSPYJSearch" Runat="server"   CssClass="button" Text="快速搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divSPYJ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 440px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 440px;">
														<asp:datagrid id="grdSPYJ" runat="server" Width="1120px" CssClass="labelGrid" Font-Size="13px" Font-Names="宋体"
											...
											<TR>
												<TD>
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJDeSelectAll" runat="server" CssClass="labelBlack">不选</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJSelectAll" runat="server" CssClass="labelBlack">全选</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMoveFirst" runat="server" CssClass="labelBlack">最前</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMovePrev" runat="server" CssClass="labelBlack">前页</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMoveNext" runat="server" CssClass="labelBlack">下页</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJMoveLast" runat="server" CssClass="labelBlack">最后</asp:linkbutton></TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJGotoPage" runat="server" CssClass="labelBlack">前往</asp:linkbutton><asp:textbox id="txtSPYJPageIndex" runat="server"   Columns="3" CssClass="textbox-text">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSPYJSetPageSize" runat="server" CssClass="labelBlack">每页</asp:linkbutton><asp:textbox id="txtSPYJPageSize" runat="server"   Columns="3" CssClass="textbox-text">30</asp:textbox>条</TD>
															<TD class="labelBlack" vAlign="middle" noWrap align="right"><asp:label id="lblSPYJGridLocInfo" runat="server" CssClass="labelBlack">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
