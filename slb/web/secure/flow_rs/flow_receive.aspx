<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_receive.aspx.vb" Inherits="Josco.JSOA.web.flow_receive"%>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									<TD class="tips" align="left" colSpan="3" height="26"><B>&nbsp;&nbsp;需要接收确认的信息一览表&nbsp;&nbsp;&nbsp;&nbsp;</B><asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton><asp:Label id="lblFSRXXGridLocInfo" Runat="server"  CssClass="label-text"></asp:Label><B>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label id="lblZZTS" Runat="server"  CssClass="labelNotNull"></asp:Label></B></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
											...
											<TR>
												<TD>
													<DIV id="divFSRXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 470px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 470px">
														<asp:datagrid id="grdFSRXX" runat="server" CssClass="labelGrid" Font-Size="13px" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="接收日期">
																	<HeaderStyle HorizontalAlign="Left" Width="160px" ForeColor="White" Font-Size="14px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Bottom"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSRQ" Runat="server"  CssClass="textbox-text" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																...
																<asp:TemplateColumn HeaderText="接收纸质文件份数">
																	<HeaderStyle HorizontalAlign="Center" Width="40px" ForeColor="White" Font-Size="14px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Bottom"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSWJZZFS" Runat="server"  CssClass="textbox-text" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="接收电子文件份数">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Bottom"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSWJDZFS" Runat="server"  CssClass="textbox-text" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="接收纸质附件份数">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Bottom"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSFJZZFS" Runat="server"  CssClass="textbox-text" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="接收电子附件份数">
																	...
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Bottom"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtJSFJDZFS" Runat="server"  CssClass="textbox-text" Width="100%"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
					...
					<TR>
						<TD align="center" colSpan="3">
							<asp:Button id="btnJieshou" Runat="server"  CssClass="button" Text=" 接  收 " Height="30px"></asp:Button>
							<asp:Button id="btnTuihui" Runat="server"  CssClass="button" Text=" 退  回 " Height="30px"></asp:Button>
