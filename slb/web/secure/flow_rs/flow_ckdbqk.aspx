<%@ Page Language="vb" AutoEventWireup="false" Codebehind="flow_ckdbqk.aspx.vb" Inherits="Josco.JSOA.web.flow_ckdbqk"%>
		...
		<form id="frmFLOW_CKDBQK" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<TD colSpan="3">
										<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<TR>
												<TD><TEXTAREA id="textareaQBJG" runat="server" class="textbox-text" readonly>test</TEXTAREA></TD>
											</TR>
											<TR>
												<TD height="3"></TD>
											</TR>
					...
					<TR>
						<TD align="center" colSpan="3"><asp:Button id="btnCancel" Runat="server"  CssClass="button" Text=" 返    回 " Height="30px"></asp:Button></TD>
					</TR>
				</TABLE>
			</asp:panel>
