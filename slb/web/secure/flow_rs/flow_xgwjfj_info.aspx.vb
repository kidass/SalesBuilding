...
Namespace Josco.JSOA.web
    ...
    '
    ' 接口参数：
    '     参见接口类IFlowXgwjfjInfo描述
    '----------------------------------------------------------------

    Public Class flow_xgwjfj_info
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMFlowXgwjfjInfo
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IFlowXgwjfjInfo
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMFlowXgwjfjInfo
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String, ByRef blnContinue As Boolean) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IFlowXgwjfjInfo)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMFlowXgwjfjInfo)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    '标记是否从现场恢复数据
...
errProc:
        ...
        Private Function getNewData( _
            ...
            Try
                ...
                '获取数据
                objNewData.Add(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_WJXH, Me.txtWJXH.Text)
                objNewData.Add(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_WJSM, Me.txtWJSM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_WJYS, Me.txtWJYS.Text)
                objNewData.Add(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_BDWJ, Me.htxtWEBLOC.Value)
        ...
        Private Function setNewData( _
            ...
            Try
                ...
                With objPulicParameters
                    Me.txtWJXH.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_WJXH), "")
                    Me.txtWJSM.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_WJSM), "")
                    Me.txtWJYS.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.FlowData.FIELD_GW_B_XIANGGUANWENJIANFUJIAN_WJYS), "")
                End With
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                End If
                '校验要保存的数据
                If Me.m_objsystemFlowObject.doVerifyXgwjFujian(strErrMsg, objNewData) = False Then
                    GoTo errProc
                End If
                '校验后的数据重新设置
                ...
                Select Case Me.m_objInterface.iEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eUpdate, _
                        ...
                        If Me.m_objInterface.iAutoSave = True Then
                            '需要保存当前附件到数据库
                            If Me.m_objsystemFlowObject.doSaveXgwjFujian(strErrMsg, Me.m_objInterface.iEnforeEdit, MyBase.UserXM, objNewData) = False Then
                                GoTo errProc
                            End If
                            '写审计日志
                            If Me.m_objsystemFlowObject.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "改动了[" + Me.m_objsystemFlowObject.FlowData.WJBS + "]文件的第[" + Me.txtWJXH.Text + "]个相关文件！") = False Then
                                '忽略
                            End If
                            '删除缓存文件
                            If Me.htxtWEBLOC.Value.Trim <> "" Then
        ...
        Private Sub doDownloadFile(ByVal strControlId As String)
            ...
            Try
                ...
                Select Case strFileExt
                    ...
                    Case Else
                        '记录访问审计日志
                        If objsystemFlowObject.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "下载了文件[" + objsystemFlowObject.FlowData.WJBS + "]的第[" + Me.txtWJXH.Text + "]个相关文件！") = False Then
                            '忽略
                        End If
