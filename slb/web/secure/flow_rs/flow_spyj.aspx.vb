...
#End Region
        ...
        Private m_strQuery_SPYJ As String '记录m_objDataSet_SPYJ搜索串
        Private m_intRows_SPYJ As Integer '记录m_objDataSet_SPYJ的DefaultView记录数
...
errProc:
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    If Me.m_objsystemFlowObject.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "访问了文件[" + Me.m_objsystemFlowObject.FlowData.WJBS + "]的[审批意见情况]！") = False Then
                        '忽略
                    End If
                End If
            End If
