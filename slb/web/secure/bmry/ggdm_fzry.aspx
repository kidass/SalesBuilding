<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ggdm_fzry.aspx.vb" Inherits="Josco.JsKernal.web.ggdm_fzry"%>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>分组和人员信息处理窗</title>
						...
						<TD style="BORDER-BOTTOM: #99cccc 2px solid" align="center">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWOpen" runat="server" Font-Size="11pt" Font-Name="宋体">查看分组</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWAddNewFZ" runat="server" Font-Size="11pt" Font-Name="宋体">增加分组</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWUpdate" runat="server" Font-Size="11pt" Font-Name="宋体">更改分组</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDWDelete" runat="server" Font-Size="11pt" Font-Name="宋体">删除分组</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLRYOpen" runat="server" Font-Size="11pt" Font-Name="宋体">查看人员</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLRYAddNew" runat="server" Font-Size="11pt" Font-Name="宋体">增加人员</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLRYUpdate" runat="server" Font-Size="11pt" Font-Name="宋体">更改人员</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLRYDelete" runat="server" Font-Size="11pt" Font-Name="宋体">删除人员</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLRYMoveUp" runat="server" Font-Size="11pt" Font-Name="宋体">人员上移</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLRYMoveDn" runat="server" Font-Size="11pt" Font-Name="宋体">人员下移</asp:linkbutton></TD>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" vAlign="top" align="left">
										<iewc:treeview id="tvwBMLIST" runat="server" Font-Size="11pt" Font-Name="宋体" Width="240px" Height="464px" CssClass="label" AutoPostBack="true"></iewc:treeview>
									</TD>
									<TD width="5"></TD>
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtBMRYSearch_RYMC" runat="server" Font-Size="11pt" CssClass="textbox" Columns="12" Font-Names="宋体"></asp:textbox></TD> <!-- 曾祥林 2008-05-23 -->
															<TD class="label" vAlign="middle">&nbsp;&nbsp;有效</TD>
															<TD class="label" align="left">
																<asp:DropDownList id="ddlBMRYSearch_SFYX" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox">
															...
															<TD class="label" align="left"><asp:textbox id="txtBMRYSearch_RYXHMin" runat="server" Font-Size="11pt" CssClass="textbox" Columns="2" Font-Names="宋体"></asp:textbox>~<asp:textbox id="txtBMRYSearch_RYXHMax" runat="server" Font-Size="11pt" CssClass="textbox" Columns="2" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;级别</TD>
															<TD class="label" align="left"><asp:textbox id="txtBMRYSearch_RYJBMC" runat="server" Font-Size="11pt" CssClass="textbox" Columns="12" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle">&nbsp;&nbsp;职务</TD>
															<TD class="label" align="left"><asp:textbox id="txtBMRYSearch_RYDRZW" runat="server" Font-Size="11pt" CssClass="textbox" Columns="16" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label"><asp:button id="btnBMRYSearch" Runat="server" Font-Size="11pt" Font-Name="宋体" Width="50px" CssClass="button" Text="搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											...
											<TR>
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYDeSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">不选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYSelectAll" runat="server" Font-Size="11pt" Font-Name="宋体">全选</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYMoveFirst" runat="server" Font-Size="11pt" Font-Name="宋体">最前</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYMovePrev" runat="server" Font-Size="11pt" Font-Name="宋体">前页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYMoveNext" runat="server" Font-Size="11pt" Font-Name="宋体">下页</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYMoveLast" runat="server" Font-Size="11pt" Font-Name="宋体">最后</asp:linkbutton></TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYGotoPage" runat="server" Font-Size="11pt" Font-Name="宋体">前往</asp:linkbutton><asp:textbox id="txtBMRYPageIndex" runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Columns="3">1</asp:textbox>页</TD>
															<TD class="label" vAlign="middle" align="left"><asp:linkbutton id="lnkCZBMRYSetPageSize" runat="server" Font-Size="11pt" Font-Name="宋体">每页</asp:linkbutton><asp:textbox id="txtBMRYPageSize" runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="label" vAlign="middle" align="right" width="200"><asp:label id="lblBMRYGridLocInfo" runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="label">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
