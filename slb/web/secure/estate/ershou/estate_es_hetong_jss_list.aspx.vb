...
errProc:
        ...
        Private Sub doAddNew(ByVal strControlId As String)
            ...
            Try
                ...
                End If
                If blnIS = False Then
                    strErrMsg = "错误：确认书[" + strQRSH + "]还没有审核！"
                    GoTo errProc
                End If
                ...
                End If
                If blnIS = False Then
                    strErrMsg = "错误：确认书[" + strQRSH + "]还没有指定[私人业绩分配方案]！"
                    GoTo errProc
                End If
                If blnIS_GY = False Then
                    strErrMsg = "错误：确认书[" + strQRSH + "]还没有指定[公佣业绩分配方案]！"
                    GoTo errProc
                End If
                'zengxianglin 2008-11-22
