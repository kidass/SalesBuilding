<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_esjyqd_sy.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_esjyqd_sy" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_esjyqd_sy" method="post" runat="server">
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 794px; CLIP: rect(0px 794px 445px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 445px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															GridLines="Vertical" AutoGenerateColumns="False" Width="3600px">
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属业务经理" SortExpression="所属业务经理" HeaderText="业务经理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属营业经理" SortExpression="所属营业经理" HeaderText="营业经理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属中级营业经理" SortExpression="所属中级营业经理" HeaderText="中级营业经理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属高级营业经理" SortExpression="所属高级营业经理" HeaderText="高级营业经理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属资深营业经理" SortExpression="所属资深营业经理" HeaderText="资深营业经理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属区域经理" SortExpression="所属区域经理" HeaderText="区域经理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属行政助理" SortExpression="所属行政助理" HeaderText="行政助理" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="所属区域总监" SortExpression="所属区域总监" HeaderText="区域总监" CommandName="Select">
																	<HeaderStyle Width="130px"></HeaderStyle>
																</asp:ButtonColumn>
