<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_hetong_list.aspx.vb" Inherits="Josco.JSOA.web.estate_es_hetong_list" %>
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
									<TD class="title" align="center" colSpan="3" height="30">【<%=propRYMC%>】能查看的各类合同一览表<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
