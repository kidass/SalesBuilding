<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_esjyqd_gy_x2.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_esjyqd_gy_x2" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_esjyqd_gy_x2" method="post" runat="server">
												...
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 994px; CLIP: rect(0px 994px 445px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 445px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															GridLines="Both" AutoGenerateColumns="False" Width="4790px">
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="220px" DataTextField="显示名称" SortExpression="显示名称" HeaderText="显示名称" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="70px" DataTextField="计佣年月" SortExpression="计佣年月" HeaderText="计佣年月" CommandName="Select">
																	<HeaderStyle Width="70px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="70px" DataTextField="接案年月" SortExpression="接案年月" HeaderText="接案年月" CommandName="Select">
																	<HeaderStyle Width="70px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="70px" DataTextField="计佣标准" SortExpression="计佣标准" HeaderText="计佣标准" CommandName="Select">
																	<HeaderStyle Width="70px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="160px" DataTextField="人均业绩" SortExpression="人均业绩" HeaderText="人均业绩" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="160px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
