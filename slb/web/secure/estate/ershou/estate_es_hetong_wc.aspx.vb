...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_hetong_wc
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongWc
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongWc
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongWc)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongWc
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongWc)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongWc)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
        ...
        Private Function showModuleData_Main( _
            ...
            Try
                ...
                If strQRSH <> "" Then
                    ...
                    End If
                End If
                Me.btnJiean.Visible = Me.m_blnPrevilegeParams(10) And blnComplete = False And strQRSH <> ""
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
                ...
                Try
                    ...
                    If Me.m_blnSaveScence = False Then
                        If Me.m_strQRSH = "" Then
                            ...
                            Me.ddlHTSearch_HTZT.SelectedIndex = 3
...
errProc:
        ...
        Private Sub doJiean(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定本合同全部办理完毕，可以结案吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '结案
                    If objsystemEstateErshou.doMarkComplete_ES_HETONG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub btnJiean_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnJiean.Click
            Me.doJiean("btnJiean")
        End Sub
