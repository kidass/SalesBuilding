...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_bb_esjyqd_gy_x2
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGyX2
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbEsjyqdGyX2
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGyX2
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbEsjyqdGyX2)
                Catch ex As Exception
                ...
                '计算分组列索引
                Me.m_intFZJBColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESJYQD_GY_X2_XSJB)
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGyX2)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[显示级别]搜索
                Dim strXSJB As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESJYQD_GY_X2_XSJB
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_ESJYQD_GY_X2
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateErshouData(Josco.JSOA.Common.Data.estateErshouData.enumTableType.DC_VT_ES_BB_ESJYQD_GY_X2)
                    Else
                        '获取参数
                        'zengxianglin 2010-04-27
                        ...
                        'End If
                        ''重新检索数据
                        'If objsystemEstateErshou.getDataSet_BB_ESJYQD_GY_X2(strErrMsg, MyBase.UserId, MyBase.UserPassword, MyBase.UserId, intTJND, intTJYD, intYJZR, Me.m_objDataSet) = False Then
                        '    GoTo errProc
                        'End If
                        ...
                        End If
                        '重新检索数据
                        If objsystemEstateErshou.getDataSet_BB_ESJYQD_GY_X2(strErrMsg, MyBase.UserId, MyBase.UserPassword, MyBase.UserId, strKSRQ, strZZRQ, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                        'zengxianglin 2010-04-27
                    End If
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                End If
                'zengxianglin 2010-04-27
                Dim strFName As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESJYQD_GY_X2_XSJB
                ...
                objColors.Add("5", System.Drawing.Color.White)

                '准备Excel文件
                Dim strDesExcelPath As String = Request.ApplicationPath + Me.m_cstrUrlBaseToDownloadFile
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手计佣清单(公佣)_X2.xls"
                ...
                'zengxianglin 2010-04-27
                'strMacroValue = intTJND.ToString + "," + intTJYD.ToString
