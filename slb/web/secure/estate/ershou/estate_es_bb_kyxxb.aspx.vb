...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_bb_kyxxb
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbKyxxb
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbKyxxb
        ...
        Private Function getPrevilegeParams( _
            ...
            Try
                ...
                '是否继续执行
                If Me.m_blnPrevilegeParams(0) = True And Me.m_blnPrevilegeParams(25) = True Then
                    blnContinueExecute = True
                Else
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbKyxxb
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbKyxxb)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbKyxxb)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[合同日期]搜索
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtHTRQMin, Me.txtHTRQMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_HTRQ, strTempWhere) = False Then
                    GoTo errProc
                End If
                If strQuery = "" Then
                ...
                If Me.txtQRSH.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_JYBH + " like '" + Me.txtQRSH.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtHTBH.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_HTBH + " like '" + Me.txtHTBH.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtWYDZ.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_WYDZ + " like '" + Me.txtWYDZ.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtKHMC.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_KHMC + " like '" + Me.txtKHMC.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                '按[联系地址]搜索
                If Me.txtKHDZ.Text.Trim <> "" Then
                    Me.txtKHDZ.Text = objPulicParameters.getNewSearchString(Me.txtKHDZ.Text)
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_YFLXDZ + " like '" + Me.txtKHDZ.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtLXDH.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_YFLXDH + " like '" + Me.txtLXDH.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtZZHM.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_KYXXB_YFZZHM + " like '" + Me.txtZZHM.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_KYXXB
            ...
            Try
                ...
                Else
                    ...
                    Josco.JSOA.Common.Data.estateErshouData.SafeRelease(Me.m_objDataSet)
                    '重新检索数据
                    If objsystemEstateErshou.getDataSet_BB_KYXXB(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    objControlProcess.doTranslateKey(Me.txtKHDZ)
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                '准备Excel文件
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "广州兴业_二手报表_中介部二手客源信息表.xls"
