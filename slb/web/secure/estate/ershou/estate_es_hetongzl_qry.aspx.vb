...
Namespace Josco.JSOA.web
    ...
    Partial Public Class estate_es_hetongzl_qry
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongZlQry
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongZlQry
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongZlQry)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongZlQry
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongZlQry)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongZlQry)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                If Me.IsPostBack = False Then
                    ...
                    objControlProcess.doTranslateKey(Me.txtJYZZJMin)
                    objControlProcess.doTranslateKey(Me.txtJYZZJMax)
                    objControlProcess.doTranslateKey(Me.txtJYYZJMin)
                    objControlProcess.doTranslateKey(Me.txtJYYZJMax)
                    ...
                    objControlProcess.doTranslateKey(Me.txtYZJEMin)
                    objControlProcess.doTranslateKey(Me.txtYZJEMax)
                    ...
                    objControlProcess.doTranslateKey(Me.txtZLKSMin)
                    objControlProcess.doTranslateKey(Me.txtZLKSMax)
                    objControlProcess.doTranslateKey(Me.txtZLJSMin)
                    objControlProcess.doTranslateKey(Me.txtZLJSMax)
                    objControlProcess.doTranslateKey(Me.txtZLBZJMin)
                    objControlProcess.doTranslateKey(Me.txtZLBZJMax)
                    objControlProcess.doTranslateKey(Me.txtZQYSMin)
                    objControlProcess.doTranslateKey(Me.txtZQYSMax)
                    objControlProcess.doTranslateKey(Me.txtJZRMin)
                    objControlProcess.doTranslateKey(Me.txtJZRMax)
                    objControlProcess.doTranslateKey(Me.txtZNJBLMin)
                    objControlProcess.doTranslateKey(Me.txtZNJBLMax)
                    objControlProcess.doTranslateKey(Me.txtNDZBLMin)
                    objControlProcess.doTranslateKey(Me.txtNDZBLMax)
...
errProc:
        ...
        Private Sub doReset(ByVal strControlId As String)
            ...
            Try
                ...
                Me.txtZLJSMin.Text = ""
                Me.txtZLJSMax.Text = ""
                objCheckBoxListProcess.doNoneSelection(Me.cblSDMQ)
                objCheckBoxListProcess.doNoneSelection(Me.cblDHF)
                objCheckBoxListProcess.doNoneSelection(Me.cblGLF)
                objCheckBoxListProcess.doNoneSelection(Me.cblZLFP)
                ...
                objCheckBoxListProcess.doNoneSelection(Me.cblZJTGYD)
                Me.txtJLZKSM.Text = ""
                Me.txtZLBZJMin.Text = ""
                Me.txtZLBZJMax.Text = ""
                Me.txtZQYSMin.Text = ""
                ...
                Me.txtNDZBLMin.Text = ""
                Me.txtNDZBLMax.Text = ""
                objCheckBoxListProcess.doNoneSelection(Me.cblFZFSYD)
        ...
        Private Sub doOK(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.txtQRSH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_QRSH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_QRSH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtKYBH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KYBH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KYBH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtDGRQMin, Me.txtDGRQMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_DGRQ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtCCDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_CCDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_CCDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtCCFMin, Me.txtCCFMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_CCF, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJYZZJMin, Me.txtJYZZJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JYZZJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJYYZJMin, Me.txtJYYZJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JYYZJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJFDLFMin, Me.txtJFDLFMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFDLF, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtYFDLFMin, Me.txtYFDLFMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFDLF, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtSSYJMin, Me.txtSSYJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_SSYJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtHZYJMin, Me.txtHZYJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_HZYJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtDLFZKMin, Me.txtDLFZKMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_DLFZK + " * 100.0", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtJFMC.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFMC + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFMC + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFDLR.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFDLR + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFDLR + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFZZHM.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFZZHM + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFZZHM + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFLXDH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFLXDH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFLXDH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYZQN.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YZQN + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YZQN + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYYQT.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YYQT + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YYQT + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFLXDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFLXDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFLXDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYZDY.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YZDY + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YZDY + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFMC.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFMC + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFMC + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFDLR.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFDLR + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFDLR + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFZZHM.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFZZHM + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFZZHM + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFLXDH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFLXDH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFLXDH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtMJQN.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_MJQN + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_MJQN + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtKYQT.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KYQT + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KYQT + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFLXDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFLXDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFLXDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtKHDY.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KHDY + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KHDY + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJYZMJMin, Me.txtJYZMJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JYZMJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtHTFWDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_FWDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_FWDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtJLRQMin, Me.txtJLRQMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JHJLRQ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZJTGYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZJTGYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblSFZFYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_SFZFYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblKHLY, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_KHLY, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblMJQC, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_MJQC, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblYFZJLB, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFZJLX, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJFZJLB, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFZJLX, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblSYWY, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_SYWY, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblYZLY, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YZLY, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblYZQC, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YZQC, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJLZKSM.Text.Trim <> "" Then
                    strValue = objPulicParameters.getNewSearchString(Me.txtJLZKSM.Text)
                    If strQueryHT = "" Then
                        strQueryHT = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JLZKSM + " like '" + strValue + "'"
                    Else
                        strQueryHT = strQueryHT + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JLZKSM + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblFZFSYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_FZFSYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblSDMQ, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_SDMQ, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblGLF, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_GLF, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblDHF, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_DHF, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZLFP, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZLFP, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtZLBZJMin, Me.txtZLBZJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZLBZJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtZNJBLMin, Me.txtZNJBLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZNJBL + " * 100.0", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtNDZBLMin, Me.txtNDZBLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_NDZBL + " * 100.0", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtZQYSMin, Me.txtZQYSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZQYS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtJZRMin, Me.txtJZRMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JZR, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtZLKSMin, Me.txtZLKSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZLKS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtZLJSMin, Me.txtZLJSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_ZLJS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtFYBH.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FYBH + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FYBH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtFCZH.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FCZH + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FCZH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtFWDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FWDZ + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FWDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtFCZDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FCZDZ + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FCZDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtLP.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LP + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LP + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtLD.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LD + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LD + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtDY.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_DY + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_DY + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtMJMin, Me.txtMJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_MJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtJCSJMin, Me.txtJCSJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_JCSJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLLMin, Me.txtLLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLGMin, Me.txtLGMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LG, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtDTSLMin, Me.txtDTSLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_DTSL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLCHSMin, Me.txtLCHSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LCHS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLPQSMin, Me.txtLPQSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LPQS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtJGFSMin, Me.txtJGFSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_JGFS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLCMin, Me.txtLCMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LC, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtWSSLMin, Me.txtWSSLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_WSSL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtYTSLMin, Me.txtYTSLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_YTSL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtYZJEMin, Me.txtYZJEMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_YZJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJGLX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_JGLX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblFWJG, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FWJG, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblLYJT, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_LYJT, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJJSB, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_JJSB, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZYYX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_ZYYX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZXNX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_ZXNX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZXDC, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_ZXDC, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblWYSX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_WYXZ, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblCX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_ZX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblFWXZ, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_FWXZ, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblKJLX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_KJLX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                If Me.txtSZQYList.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_SZQY + " in (" + strValue + ")"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_SZQY + " in (" + strValue + ")"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJGList.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_JG + " in (" + strValue + ")"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_ZL_JG + " in (" + strValue + ")"
                    End If
                End If
