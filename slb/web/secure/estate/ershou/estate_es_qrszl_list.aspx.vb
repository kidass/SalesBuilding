...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_qrszl_list
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_es_qrszl_previlege_param"
        Private m_blnPrevilegeParams(5) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsQrsZlList
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsQrsZlList
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsQrsZlList)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsQrsZlList
        ...
        Private Function getDataFromCallModule(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                '==========================================================================================================================================================
                Dim objIEstateEsQrsZlInfo As Josco.JSOA.BusinessFacade.IEstateEsQrsZlInfo = Nothing
                Try
                    objIEstateEsQrsZlInfo = CType(Session.Item(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId)), Josco.JSOA.BusinessFacade.IEstateEsQrsZlInfo)
                Catch ex As Exception
                    objIEstateEsQrsZlInfo = Nothing
                End Try
                If Not (objIEstateEsQrsZlInfo Is Nothing) Then
                    Session.Remove(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId))
                    Josco.JSOA.BusinessFacade.IEstateEsQrsZlInfo.SafeRelease(objIEstateEsQrsZlInfo)
                    Exit Try
                End If
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsQrsZlList)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsQrsZlList)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_QRS( _
            ...
            Try
                '按“确认书号”搜索
                Dim strQRSH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_QRSH
                ...
                '按“甲方名称”搜索
                Dim strJFMC As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_JFMC
                ...
                '按“乙方名称”搜索
                Dim strYFMC As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_YFMC
                ...
                '按“房屋地址”搜索
                Dim strFWDZ As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_FWDZ
                ...
                '按“订购状态”搜索
                Dim strDGZT As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_DGZT
                ...
                strDGRQ = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_DGRQ
...
errProc:
        ...
        Private Function getModuleData_QRS( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_QRS_ZL(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, blnControl, Me.m_objDataSet_QRS) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function getModuleData_QRS_PRN( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_B_ES_QUERENSHU_ZL_PRN
            Dim objsystemEstateErshou As New Josco.JSOA.BusinessFacade.systemEstateErshou
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_QRS_ZL_PRN(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, blnControl, objDataSet) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doAddNew(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objIEstateEsQrsZlInfo As Josco.JSOA.BusinessFacade.IEstateEsQrsZlInfo = Nothing
                Dim strUrl As String = ""
                objIEstateEsQrsZlInfo = New Josco.JSOA.BusinessFacade.IEstateEsQrsZlInfo
                With objIEstateEsQrsZlInfo
                ...
                If strNewSessionId = "" Then
                    ...
                    GoTo errProc
                End If
                Session.Add(strNewSessionId, objIEstateEsQrsZlInfo)

                strUrl = ""
                strUrl += "estate_es_qrszl_info.aspx"
                strUrl += "?"
                strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                strUrl += "="
...
errProc:
        ...
        Private Sub doUpdate(ByVal strControlId As String)
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdQRS, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_QRSH)
...
errProc:
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strQRSH As String = ""
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdQRS, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_WYBS)
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '删除处理
                    If objsystemEstateErshou.doDeleteData_ES_QRS_ZL(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWYBS) = False Then
                        GoTo errProc
                    End If

                    '记录审计日志
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[二手_租赁确认书]中[删除]了[" + strQRSH + "]！")
...
errProc:
        ...
        Private Sub doTading(ByVal strControlId As String)
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdQRS, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_QRSH)
                strQRSH = objDataGridProcess.getDataGridCellValue(Me.grdQRS.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdQRS, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_ZL_DGZT)
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理
                    If objsystemEstateErshou.doTading_ES_QRS_ZL(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWYBS) = False Then
                        GoTo errProc
                    End If

                    '记录审计日志
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[二手_租赁确认书]中[挞定]了[" + strQRSH + "]！")
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "广州兴业_合同管理_租赁确认书.xls"
