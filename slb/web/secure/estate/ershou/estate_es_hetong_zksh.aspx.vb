...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_hetong_zksh
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongZksh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongZksh
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongZksh)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtYJ_Min.Text = .txtYJ_Min
                    Me.txtYJ_Max.Text = .txtYJ_Max
                    Me.txtEJ_Min.Text = .txtEJ_Min
                    Me.txtEJ_Max.Text = .txtEJ_Max
                    Me.txtSJ_Min.Text = .txtSJ_Min
                    Me.txtSJ_Max.Text = .txtSJ_Max
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongZksh
                ...
                With Me.m_objSaveScence
                    ...
                    .txtYJ_Min = Me.txtYJ_Min.Text
                    .txtYJ_Max = Me.txtYJ_Max.Text
                    .txtEJ_Min = Me.txtEJ_Min.Text
                    .txtEJ_Max = Me.txtEJ_Max.Text
                    .txtSJ_Min = Me.txtSJ_Min.Text
                    .txtSJ_Max = Me.txtSJ_Max.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongZksh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongZksh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getModuleData_SHQK( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_B_ES_HETONG_ZHEKOUSHENHE
            Dim objsystemEstateErshou As New Josco.JSOA.BusinessFacade.systemEstateErshou
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_HETONG_ZKSH(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, strWhere, Me.m_objDataSet_SHQK) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function showModuleData_Main( _
            ...
            Try
                ...
                Me.txtHTZK.Text = ""
                If strQRSH <> "" Then
                    If objsystemEstateErshou.getHtzkByQrsh(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, dblHTZK) = True Then
                        Me.txtHTZK.Text = (dblHTZK * 100).ToString("#.00")
                    End If
                End If

                '计算各级审核范围
                Dim dblYJ() As Double = {0.0, 0.0}
                Dim dblEJ() As Double = {0.0, 0.0}
                Dim dblSJ() As Double = {0.0, 0.0}
                Dim intSHLX As Integer = 0
                intSHLX = Josco.JSOA.Common.Data.estateErshouData.enumZhekouShenheType.YJ
                Me.txtYJ_Min.Text = ""
                Me.txtYJ_Max.Text = ""
                If objsystemEstateErshou.getHetongZhekouSXX(strErrMsg, MyBase.UserId, MyBase.UserPassword, intSHLX, dblYJ(0), dblYJ(1)) = True Then
                    Me.txtYJ_Min.Text = (dblYJ(0) * 100).ToString("#.00")
                    Me.txtYJ_Max.Text = (dblYJ(1) * 100).ToString("#.00")
                End If

                intSHLX = Josco.JSOA.Common.Data.estateErshouData.enumZhekouShenheType.EJ
                Me.txtEJ_Min.Text = ""
                Me.txtEJ_Max.Text = ""
                If objsystemEstateErshou.getHetongZhekouSXX(strErrMsg, MyBase.UserId, MyBase.UserPassword, intSHLX, dblEJ(0), dblEJ(1)) = True Then
                    Me.txtEJ_Min.Text = (dblEJ(0) * 100).ToString("#.00")
                    Me.txtEJ_Max.Text = (dblEJ(1) * 100).ToString("#.00")
                End If

                intSHLX = Josco.JSOA.Common.Data.estateErshouData.enumZhekouShenheType.SJ
                Me.txtSJ_Min.Text = ""
                Me.txtSJ_Max.Text = ""
                If objsystemEstateErshou.getHetongZhekouSXX(strErrMsg, MyBase.UserId, MyBase.UserPassword, intSHLX, dblSJ(0), dblSJ(1)) = True Then
                    Me.txtSJ_Min.Text = (dblSJ(0) * 100).ToString("#.00")
                    Me.txtSJ_Max.Text = (dblSJ(1) * 100).ToString("#.00")
                End If

                Me.btnYJSH.Visible = Me.m_blnPrevilegeParams(5) And blnComplete = False And strQRSH <> ""
                Me.btnEJSH.Visible = Me.m_blnPrevilegeParams(6) And blnComplete = False And strQRSH <> ""
                Me.btnSJSH.Visible = Me.m_blnPrevilegeParams(7) And blnComplete = False And strQRSH <> ""
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    objControlProcess.doTranslateKey(Me.txtYJ_Min)
                    objControlProcess.doTranslateKey(Me.txtYJ_Max)
                    objControlProcess.doTranslateKey(Me.txtEJ_Min)
                    objControlProcess.doTranslateKey(Me.txtEJ_Max)
                    objControlProcess.doTranslateKey(Me.txtSJ_Min)
                    objControlProcess.doTranslateKey(Me.txtSJ_Max)
...
errProc:
        ...
        Private Sub doYJSH(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定要进行[一级审核]吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '签名
                    If objsystemEstateErshou.doZhekouShenHe_ES_HETONG( _
                        strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                        strQRSH, _
                        MyBase.UserId, _
                        Josco.JSOA.Common.Data.estateErshouData.enumZhekouShenheType.YJ) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub doEJSH(ByVal strControlId As String)
            ...
            Try
                ...
                '询问
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定要进行[二级审核]吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    If objsystemEstateErshou.doZhekouShenHe_ES_HETONG( _
                        ...
                        strQRSH, _
                        MyBase.UserId, _
                        Josco.JSOA.Common.Data.estateErshouData.enumZhekouShenheType.EJ) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub doSJSH(ByVal strControlId As String)
            ...
            Try
                ...
                '询问
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定要进行[三级审核]吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    If objsystemEstateErshou.doZhekouShenHe_ES_HETONG( _
                        ...
                        strQRSH, _
                        MyBase.UserId, _
                        Josco.JSOA.Common.Data.estateErshouData.enumZhekouShenheType.SJ) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub btnYJSH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnYJSH.Click
            Me.doYJSH("btnYJSH")
        End Sub

        Private Sub btnEJSH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnEJSH.Click
            Me.doEJSH("btnEJSH")
        End Sub

        Private Sub btnSJSH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSJSH.Click
            Me.doSJSH("btnSJSH")
        End Sub
