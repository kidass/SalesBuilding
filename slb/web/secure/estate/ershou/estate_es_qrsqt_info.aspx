<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_qrsqt_info.aspx.vb" Inherits="Josco.JSOA.web.estate_es_qrsqt_info" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
    <HEAD>
        <title>其他确认书查看与编辑</title>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmestate_es_qrsqt_info" method="post" runat="server">
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                    <TR id="trRow1">
                        <TD align="center">
                            <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                                <tr>
                                    <td class="title" align="center">其他委托代办业务确认书<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></td>
                                    <td width="20">&nbsp;</td>
                                </tr>
                                <TR>
                                    <TD vAlign="middle" align="right" class="labelNotNull"><span class="labelAuto">确认书号：</span><asp:TextBox id="txtQRSH" runat="server" Columns="14" CssClass="textbox"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;客源编号：<asp:TextBox id="txtKYBH" runat="server" Columns="24" CssClass="textbox"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;订购日期：<asp:TextBox id="txtDGRQ" runat="server" Columns="8" CssClass="textbox"></asp:TextBox><INPUT id="htxtWYBS" type="hidden" size="1" runat="server" NAME="htxtWYBS"></TD>
                                    <td width="20">&nbsp;</td>
                                </TR>
                            </TABLE>
                        </TD>
