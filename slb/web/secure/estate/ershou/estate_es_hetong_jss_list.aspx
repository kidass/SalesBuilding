					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow1">
									<TD class="title" align="center" colSpan="3" height="30">合同结算管理<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top">
																	...
																	<TR>
																		...
																		<TD class="label" align="left">
																			<asp:DropDownList id="ddlHTSearch_HTZT" runat="server" CssClass="textbox" Enabled="False">
																				...
																				<asp:ListItem Value="&1=1" Selected="True">已审</asp:ListItem>
																			</asp:DropDownList>
																		</TD>
					...
					<TR id="trRow5">
						<TD align="center" colSpan="3">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TR>
									<TD align="center">
										<asp:Button id="btnAddNew" Runat="server" CssClass="button" Text="新结算书" Height="36px"></asp:Button>
										<asp:Button id="btnUpdate" Runat="server" CssClass="button" Text="改结算书" Height="36px"></asp:Button>
										<asp:Button id="btnDelete" Runat="server" CssClass="button" Text="删结算书" Height="36px"></asp:Button>
										...
										<asp:Button id="btnSHQM"   Runat="server" CssClass="button" Text="审核处理" Height="36px"></asp:Button>
