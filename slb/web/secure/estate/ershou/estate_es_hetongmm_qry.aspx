<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="estate_es_hetongmm_qry.aspx.vb" Inherits="Josco.JSOA.web.estate_es_hetongmm_qry" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
    <HEAD>
        <title>买卖合同全屏查询</title>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmestate_es_hetongmm_qry" method="post" runat="server">
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                    <TR id="trRow1">
                        <TD align="center">
                            <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                                <TR>
                                    <TD class="title" align="center">房屋买卖合同全屏查询<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                                    <TD width="20">&nbsp;</TD>
                                </TR>
                            </TABLE>
                        </TD>
                                            ...
                                            <TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <TD align="left">合同类型：<asp:CheckBoxList id="cblHTLX" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Vertical" RepeatLayout="Flow">
                                                            <asp:ListItem Value="1">现楼买卖</asp:ListItem>
