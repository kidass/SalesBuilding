<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_hetongqt_info.aspx.vb" Inherits="Josco.JSOA.web.estate_es_hetongqt_info" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
    <HEAD>
        <title>其他代办合同查看与编辑</title>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmestate_es_hetongqt_info" method="post" runat="server">
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                    <TR id="trRow1">
                        <TD align="center">
                            <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                                <TR>
                                    <TD class="title" align="center">其他委托代办合同<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                                    <TD width="20">&nbsp;</TD>
                                </TR>
                                <TR>
                                    <TD class="labelNotNull" vAlign="middle" align="right"><span class="labelAuto">合同编号：</span><asp:TextBox id="txtHTBH" runat="server" CssClass="textbox" Columns="14"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;客源编号：<asp:TextBox id="txtKYBH" runat="server" Columns="24" CssClass="textbox"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;签订日期：<asp:TextBox id="txtHTRQ" runat="server" CssClass="textbox" Columns="8"></asp:TextBox>&nbsp;&nbsp;<span class="labelAuto">签约统计日期：</span><asp:TextBox id="txtTJRQ" runat="server" CssClass="textbox" Columns="8"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkHTJC" runat="server"  CssClass="labelAuto" Text="合同解除"/><asp:CheckBox ID="chkHTHZ" runat="server"  CssClass="labelAuto" Text="存在坏账"/><INPUT id="htxtHTWYBS" type="hidden" size="1" runat="server" NAME="htxtHTWYBS"><INPUT id="htxtHTZT" type="hidden" size="1" runat="server" NAME="htxtHTZT"><INPUT id="htxtWYBS" type="hidden" size="1" runat="server" NAME="htxtWYBS"><INPUT id="htxtQRSH" type="hidden" size="1" runat="server" NAME="htxtQRSH"><INPUT id="htxtDGRQ" type="hidden" size="1" runat="server" NAME="htxtDGRQ"><INPUT id="htxtHTBZ" type="hidden" size="1" runat="server"></TD>
                                    <TD width="20">&nbsp;</TD>
                                </TR>
                            </TABLE>
                        </TD>
                    ...
                    <TR>
                        <TD align="center">
                            <DIV id="divMain" style="BORDER-TOP: #99cccc 2px solid; OVERFLOW: auto; WIDTH: 964px; CLIP: rect(0px 964px 447px 0px); BORDER-BOTTOM: #99cccc 2px solid; HEIGHT: 447px">
                                <TABLE>
                                    <tr>
                                        <TD class="labelNotNull" align="left">合同类型：
                                            <asp:RadioButtonList id="rblHTLX" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Vertical" RepeatLayout="Flow">
                                                <asp:ListItem Value="1">代办过户</asp:ListItem>
                                                <asp:ListItem Value="2">代办按揭</asp:ListItem>
                                                <asp:ListItem Value="4" Selected="True">其他代办</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <TR>
                                                ...
                                                <TR>
                                                    <TD>
                                                        <DIV id="divWYXX" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 900px; CLIP: rect(0px 900px 260px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 260px">
                                                            ...
                                                            </asp:datagrid><INPUT id="htxtWYXXFixed" type="hidden" value="0" runat="server" NAME="htxtWYXXFixed">
                                                        </DIV>
                                                    </TD>
                                                </TR>
                                                <TR>
                                    ...
                                    <TR>
                                        <TD>
                                            <TABLE cellSpacing="0" cellPadding="2" width="100%" border="0">
                                                ...
                                                <TR>
                                                    <TD class="label" align="left">交楼日期：<asp:RadioButtonList id="rblJLRQYD" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Vertical" RepeatLayout="Flow">
                                                            <asp:ListItem Value="0">收到全部房款当天</asp:ListItem>
                                                            <asp:ListItem Value="1">自行交接</asp:ListItem>
                                                            <asp:ListItem Value="2">其他约定</asp:ListItem>
                                                        </asp:RadioButtonList>&nbsp;&nbsp;具体日期为：<asp:TextBox id="txtJLRQ" Runat="server" CssClass="textbox" Columns="12"></asp:TextBox>
                                                    </TD>
                                                </TR>
                                                <TR>
                                                    <TD class="label" align="left">交楼状况：<asp:RadioButtonList id="rblJLZKYD" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Vertical" RepeatLayout="Flow">
                                                ...
                                                <TR>
                                                    <TD class="label" align="left">托管房款：<asp:RadioButtonList id="rblTGFKYD" Runat="server" CssClass="textbox" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Flow">
                                                    ...
                                                    <TD>
                                                        <DIV id="divYWRY" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 900px; CLIP: rect(0px 900px 200px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 200px">
                                                            <asp:datagrid id="grdYWRY" runat="server" CssClass="label" CellPadding="4" AllowSorting="False"
                                                                ...
                                                                <PagerStyle Visible="False" NextPageText="下页" PrevPageText="上页" HorizontalAlign="Right" ForeColor="Black" Position="TopAndBottom" BackColor="SkyBlue"></PagerStyle>
                                                            </asp:datagrid><INPUT id="htxtYWRYFixed" type="hidden" value="0" runat="server" NAME="htxtYWRYFixed">
                                                        </DIV>
                                                    </TD>
                                                </TR>
                                                <TR>
            ...
            <TABLE cellSpacing="0" cellPadding="0" align="center" border="0">
                <TR>
                    <TD>
                        <INPUT id="htxtSessionId_WYXX" type="hidden" runat="server" NAME="htxtSessionId_WYXX">
                        <INPUT id="htxtSessionId_YWRY" type="hidden" runat="server" NAME="htxtSessionId_YWRY">
                        <INPUT id="htxtDivLeftWYXX" type="hidden" runat="server" NAME="htxtDivLeftWYXX">
                        <INPUT id="htxtDivTopWYXX" type="hidden" runat="server" NAME="htxtDivTopWYXX">
                        <INPUT id="htxtDivLeftYWRY" type="hidden" runat="server" NAME="htxtDivLeftYWRY">
                        <INPUT id="htxtDivTopYWRY" type="hidden" runat="server" NAME="htxtDivTopYWRY">
