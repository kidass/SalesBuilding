<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_hetong_sh.aspx.vb" Inherits="Josco.JSOA.web.estate_es_hetong_sh" %>
...
<HTML>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmestate_es_hetong_sh" method="post" runat="server">
                    ...
                    <TR>
                        ...
                        <TD vAlign="top" align="center">
                            <TABLE cellSpacing="0" cellPadding="0" border="0">
                                <TR id="trRow1">
                                    <TD class="title" align="center" colSpan="3" height="30">合同审核处理<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                                </TR>
                                <TR>
                                    <TD width="5"></TD>
                                    <TD vAlign="top">
                                        <TABLE cellSpacing="0" cellPadding="0" border="0">
                                            ...
                                            <TR id="trRow4">
                                                <TD class="label" align="left" bgColor="#ccff99"><B>&gt;&gt;&gt;&gt;合同审核情况</B></TD>
                                            </TR>
                                            <TR>
                                                <TD>
                            ...
                            <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                                ...
                                <TR>
                                    <TD align="center">
                                        ...
                                        <asp:Button id="btnTJRQ"   Runat="server" CssClass="button" Text="统计日期" Height="36px"></asp:Button>
            ...
            <table cellSpacing="0" cellPadding="0" align="center" border="0">
                <tr>
                    <td>
						<input id="htxtParam01" type="hidden" runat="server" NAME="htxtParam01">
