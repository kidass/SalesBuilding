...
Namespace Josco.JSOA.web
    ...
    '     zengxianglin 2011-01-02 更改
    '----------------------------------------------------------------

    Partial Class estate_es_hetongmm_list
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongMmList
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongMmList
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongMmList)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.htxtHTQueryDG.Value = .htxtHTQueryDG
                    Me.htxtHTQueryHT.Value = .htxtHTQueryHT
                    Me.htxtHTQueryDY.Value = .htxtHTQueryDY
                    Me.htxtHTQueryRY.Value = .htxtHTQueryRY
                    'zengxianglin 2011-01-03
                End With
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongMmList
                ...
                With Me.m_objSaveScence
                    ...
                    'zengxianglin 2011-01-03
                    .htxtHTQueryDG = Me.htxtHTQueryDG.Value
                    .htxtHTQueryHT = Me.htxtHTQueryHT.Value
                    .htxtHTQueryDY = Me.htxtHTQueryDY.Value
                    .htxtHTQueryRY = Me.htxtHTQueryRY.Value
                    'zengxianglin 2011-01-03
                End With
        ...
        Private Function getDataFromCallModule(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                End If
                '==========================================================================================================================================================
                Dim objIEstateEsHetongMmQry As Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry = Nothing
                Try
                    objIEstateEsHetongMmQry = CType(Session.Item(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId)), Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry)
                Catch ex As Exception
                    objIEstateEsHetongMmQry = Nothing
                End Try
                If Not (objIEstateEsHetongMmQry Is Nothing) Then
                    If objIEstateEsHetongMmQry.oExitMode = True Then
                        Me.htxtHTQueryDG.Value = objIEstateEsHetongMmQry.oQuery_DG
                        Me.htxtHTQueryHT.Value = objIEstateEsHetongMmQry.oQuery_HT
                        Me.htxtHTQueryDY.Value = objIEstateEsHetongMmQry.oQuery_DY
                        Me.htxtHTQueryRY.Value = objIEstateEsHetongMmQry.oQuery_RY
                    End If
                    Session.Remove(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId))
                    Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry.SafeRelease(objIEstateEsHetongMmQry)
                    Exit Try
                End If
                'zengxianglin 2010-01-03
                ...
                If Not (objISjcxCxtj Is Nothing) Then
                    If objISjcxCxtj.oExitMode = True Then
                        ...
                        'zengxianglin 2011-01-03
                        '清除全屏条件
                        Me.htxtHTQueryDG.Value = ""
                        Me.htxtHTQueryHT.Value = ""
                        Me.htxtHTQueryDY.Value = ""
                        Me.htxtHTQueryRY.Value = ""
                        'zengxianglin 2011-01-03
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongMmList)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongMmList)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_HT( _
            ...
            Try
                '按“确认书号”搜索
                Dim strQRSH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_JYBH
                ...
                '按“合同编号”搜索
                Dim strHTBH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_HTBH
                ...
                '按“甲方名称”搜索
                Dim strJFMC As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_YZMC
                ...
                '按“乙方名称”搜索
                Dim strYFMC As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_KHMC
                ...
                '按“房屋地址”搜索
                Dim strFWDZ As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_WYDZ
                ...
                '按“合同状态”搜索
                Dim strHTZT As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_HTZT
                ...
                '按“特殊条件”搜索
                Dim strJYBH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_JYBH
                ...
                '按“是否签约”搜索
                Dim strHTBH1 As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_HTBH
                ...
                strDGRQ = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_JYRQ
                ...
                strHTRQ = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_HTRQ
...
errProc:
        ...
        Private Function getModuleData_HT( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_V_QUANBUJIAOYI_MM
            ...
            Try
                ...
                '重新检索数据
                'zengxianglin 2010-01-03
                'If objsystemEstateErshou.getDataSet_ES_JYXX_MM( _
                '    strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                '    strWhere, _
                '    blnControl, Me.m_objDataSet_HT) = False Then
                '    GoTo errProc
                'End If
                If objsystemEstateErshou.getDataSet_ES_JYXX_MM( _
                    strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                    strWhere, _
                    Me.htxtHTQueryDG.Value, Me.htxtHTQueryHT.Value, Me.htxtHTQueryDY.Value, Me.htxtHTQueryRY.Value, _
                    blnControl, Me.m_objDataSet_HT) = False Then
                    GoTo errProc
                End If
                'zengxianglin 2010-01-03
...
errProc:
        ...
        Private Sub doOpen(ByVal strControlId As String)
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_JYLX)
                strYWLX = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_HTZT)
                intHTZT = objPulicParameters.getObjectValue(objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex), 0)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_HTBH)
                strHTBH = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_MM_JYBH)
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                '获取打印数据
                If objsystemEstateErshou.getDataSet_ES_JYXX_MM_PRN( _
                    strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                    Me.m_strQuery_HT, _
                    Me.htxtHTQueryDG.Value, Me.htxtHTQueryHT.Value, Me.htxtHTQueryDY.Value, Me.htxtHTQueryRY.Value, _
                    Me.m_blnQxControl, _
                    objDataSet) = False Then
                    GoTo errProc
                End If
                ...
                '准备Excel文件
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "广州兴业_合同管理_二手合同买卖.xls"
...
errProc:
        ...
        Private Sub doQPSS(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strUrl As String = ""
                Dim objIEstateEsHetongMmQry As Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry = Nothing
                objIEstateEsHetongMmQry = New Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry
                With objIEstateEsHetongMmQry
                    .iSourceControlId = strControlId
                    If Me.m_blnInterface = True Then
                        strUrl = ""
                        strUrl += Request.Url.AbsolutePath
                ...
                If strNewSessionId = "" Then
                    ...
                    GoTo errProc
                End If
                Session.Add(strNewSessionId, objIEstateEsHetongMmQry)
                strUrl = ""
                strUrl += "estate_es_hetongmm_qry.aspx"
                strUrl += "?"
                strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                strUrl += "="
                strUrl += strNewSessionId
...
errProc:
        ...
        Private Sub btnQPSS_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnQPSS.Click
            Me.doQPSS("btnQPSS")
        End Sub
