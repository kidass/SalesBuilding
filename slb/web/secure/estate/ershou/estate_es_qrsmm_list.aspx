<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_qrsmm_list.aspx.vb" Inherits="Josco.JSOA.web.estate_es_qrsmm_list" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>买卖确认书主窗口</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmestate_es_qrsmm_list" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow1">
									<TD class="title" align="center" colSpan="3" height="30">【<%=propRYMC%>】能查看的买卖确认书一览表<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
											...
											<TR>
												<TD>
													<DIV id="divQRS" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 405px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 405px">
														<asp:datagrid id="grdQRS" runat="server" CssClass="label" Width="6190px"
