...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_bb_esyjfpb_x2
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbEsYjfpbX2
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbEsYjfpbX2
        ...
        '其他模块私用参数
        '----------------------------------------------------------------
        Private m_intFZJBColIndex(2) As Integer
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Try
                        Me.ddlTJYD.SelectedIndex = .ddlTJYD_SelectedIndex
                    Catch ex As Exception
                    End Try
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbEsYjfpbX2
                ...
                With Me.m_objSaveScence
                    ...
                    .ddlTJYD_SelectedIndex = Me.ddlTJYD.SelectedIndex
        ...
        Private Function getDataFromCallModule(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                '==========================================================================================================================================================
                Dim objIEstateEsYjjt As Josco.JSOA.BusinessFacade.IEstateEsYjjt = Nothing
                Try
                    objIEstateEsYjjt = CType(Session.Item(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId)), Josco.JSOA.BusinessFacade.IEstateEsYjjt)
                Catch ex As Exception
                    objIEstateEsYjjt = Nothing
                End Try
                If Not (objIEstateEsYjjt Is Nothing) Then
                    Session.Remove(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId))
                    Josco.JSOA.BusinessFacade.IEstateEsYjjt.SafeRelease(objIEstateEsYjjt)
                    Exit Try
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbEsYjfpbX2)
                Catch ex As Exception
                ...
                '计算分组列索引
                Me.m_intFZJBColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_YJFPB_X2_XSJB)
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbEsYjfpbX2)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[显示级别]搜索
                Dim strXSJB As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_YJFPB_X2_XSJB
...
errProc:
        ...
        Private Function doCheckParam(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                '    strErrMsg = "错误：没有指定[统计年度]！"
                '    GoTo errProc
                'End If
                'If objPulicParameters.isIntegerString(Me.txtTJND.Text) = False Then
                '    strErrMsg = "错误：无效的[统计年度]！"
                '    GoTo errProc
                'End If
                'Dim intTJND As Integer = objPulicParameters.getObjectValue(Me.txtTJND.Text, 0)
                'If intTJND <= 0 Then
                '    strErrMsg = "错误：无效的[统计年度]！"
                '    GoTo errProc
                'End If
                ...
                '    strErrMsg = "错误：无效的[月截止日]！"
                '    GoTo errProc
                'End If
                'Dim intYJZR As Integer = objPulicParameters.getObjectValue(Me.txtYJZR.Text, 0)
                'If intYJZR < 1 Or intYJZR > 28 Then
                '    strErrMsg = "错误：无效的[月截止日]！"
                '    GoTo errProc
                'End If

                'If Me.ddlTJYD.SelectedIndex < 0 Then
                '    strErrMsg = "错误：没有指定[统计月度]！"
                '    GoTo errProc
                'End If
                'zengxianglin 2010-04-27
...
errProc:
        ...
        Private Function getReportParam( _
            ...
            Try
                ...
                intTJYD = Me.ddlTJYD.SelectedIndex + 1
...
errProc:
        ...
        Private Function getReportParam( _
            ...
            ByRef strZZRQ As String) As Boolean
            ...
            Try
                ...
                '计算
                strKSRQ = objPulicParameters.getObjectValue(Me.txtKSRQ.Text, "", "yyyy-MM-dd")
                strZZRQ = objPulicParameters.getObjectValue(Me.txtZZRQ.Text, "", "yyyy-MM-dd")
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_YJFPB_X2
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateErshouData(Josco.JSOA.Common.Data.estateErshouData.enumTableType.DC_VT_ES_BB_YJFPB_X2)
                    Else
                        'zengxianglin 2010-04-27
                        ''获取参数
                        'If Me.getReportParam(strErrMsg, intTJND, intTJYD, intYJZR) = False Then
                        '    GoTo errProc
                        'End If
                        ''重新检索数据
                        'If objsystemEstateErshou.getDataSet_BB_YJFPB_X2(strErrMsg, MyBase.UserId, MyBase.UserPassword, MyBase.UserId, intTJND, intTJYD, intYJZR, Me.m_objDataSet) = False Then
                        '    GoTo errProc
                        'End If
                        '获取参数
                        If Me.getReportParam(strErrMsg, strKSRQ, strZZRQ) = False Then
                            GoTo errProc
                        End If
                        '重新检索数据
                        If objsystemEstateErshou.getDataSet_BB_YJFPB_X2(strErrMsg, MyBase.UserId, MyBase.UserPassword, MyBase.UserId, strKSRQ, strZZRQ, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                        'zengxianglin 2010-04-27
                    End If
...
errProc:
        ...
        Private Function showMainData(ByRef strErrMsg As String) As Boolean
            ...
            Try
                Me.lnkMLQRJYJG.Visible = Me.m_blnPrevilegeParams(27)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    objControlProcess.doTranslateKey(Me.ddlTJYD)
                    'zengxianglin 2010-04-27
        ...
        Sub grdContent_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles grdContent.ItemDataBound
            ...
            Try
                ...
                Else
                    ...
                    intFZJB = Me.m_intFZJBColIndex(0)
                    ...
                    Select Case strFZJB
                        ...
                        Case "4"
                            e.Item.BackColor = System.Drawing.Color.FromArgb(170, 85, 85)
                        Case "5"
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                End If
                'zengxianglin 2010-04-27
                Dim strFName As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_YJFPB_X2_XSJB
                ...
                objColors.Add("4", System.Drawing.Color.FromArgb(170, 85, 85))

                '准备Excel文件
                Dim strDesExcelPath As String = Request.ApplicationPath + Me.m_cstrUrlBaseToDownloadFile
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手佣金分配表_X2.xls"
                ...
                strMacroName = "$Macro$TJND$,$Macro$TJYD$"
                'zengxianglin 2010-04-27
                strMacroValue = CType(strZZRQ, System.DateTime).Year.ToString + "," + CType(strZZRQ, System.DateTime).Month.ToString
                'zengxianglin 2010-04-27
...
errProc:
        ...
        Private Sub doQRJYJG(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.m_objDataSet.Tables(strTable) Is Nothing Then
                    ...
                    GoTo errProc
                End If
                If Me.m_objDataSet.Tables(strTable).Rows.Count < 1 Then
                    strErrMsg = "错误：没有数据！"
                    GoTo errProc
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确认本期的佣金计算结果吗（确定/取消）？", strControlId, intStep)
                    Exit Try
                End If
                ...
                '确认处理
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    If objsystemEstateErshou.doSaveData_ES_YJJT_X4(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ) = False Then
                        GoTo errProc
                    End If
                    objMessageProcess.doAlertMessage(Me.popMessageObject, "提示：数据确认成功！")
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
...
errProc:
        ...
        Private Sub doCKYYJL(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.grdContent.SelectedIndex >= 0 Then
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_YJFPB_X2_JBRY)
                    strRYDM = objDataGridProcess.getDataGridCellValue(Me.grdContent.Items(Me.grdContent.SelectedIndex), intColIndex)
                End If
                ...
                '准备调用接口
                Dim strUrl As String = ""
                objIEstateEsYjjt = New Josco.JSOA.BusinessFacade.IEstateEsYjjt
                With objIEstateEsYjjt
                    .iRYDM = strRYDM
                    .iYJBZ = 0
                ...
                If strNewSessionId = "" Then
                    ...
                    GoTo errProc
                End If
                Session.Add(strNewSessionId, objIEstateEsYjjt)
                strUrl = ""
                strUrl += "estate_es_yjjt.aspx"
                strUrl += "?"
                strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                strUrl += "="
...
errProc:
        ...
        Private Sub doCKSYYJ(ByVal strControlId As String)
...
errProc:
        ...
        Private Sub lnkMLQRJYJG_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLQRJYJG.Click
            Me.doQRJYJG("lnkMLQRJYJG")
        End Sub

        Private Sub lnkMLCKSYYJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLCKSYYJ.Click
            Me.doCKSYYJ("lnkMLCKSYYJ")
        End Sub

        Private Sub lnkMLCKYYJL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLCKYYJL.Click
            Me.doCKYYJL("lnkMLCKYYJL")
        End Sub
