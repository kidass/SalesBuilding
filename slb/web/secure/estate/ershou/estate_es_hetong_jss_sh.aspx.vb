...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_hetong_jss_sh
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongJssSh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongJssSh
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongJssSh)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtHTSearch_JSSH.Text = .txtHTSearch_JSSH
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongJssSh
                ...
                With Me.m_objSaveScence
                    ...
                    .txtHTSearch_JSSH = Me.txtHTSearch_JSSH.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongJssSh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongJssSh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_HT( _
            ...
            Try
                ...
                If Me.txtHTSearch_JSSH.Text.Length > 0 Then Me.txtHTSearch_JSSH.Text = Me.txtHTSearch_JSSH.Text.Trim()
                If Me.txtHTSearch_JSSH.Text <> "" Then
                    Me.txtHTSearch_JSSH.Text = objPulicParameters.getNewSearchString(Me.txtHTSearch_JSSH.Text)
                    If strQuery = "" Then
                        strQuery = strJSSH + " like '" + Me.txtHTSearch_JSSH.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strJSSH + " like '" + Me.txtHTSearch_JSSH.Text + "%'"
                    End If
                End If
                ...
                Select Case Me.ddlHTSearch_HTZT.SelectedIndex
                    Case Is > 0
                        If strQuery = "" Then
                            strQuery = strZTBZ + Me.ddlHTSearch_HTZT.SelectedValue
                        Else
                            strQuery = strQuery + " and " + strZTBZ + Me.ddlHTSearch_HTZT.SelectedValue
                        End If
                    Case Else
                End Select
                ...
                strJSRQ = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_HETONG_JIESUANSHU_JSRQ
                ...
                If Me.txtHTSearch_HTRQMin.Text <> "" And Me.txtHTSearch_HTRQMax.Text <> "" Then
                    ...
                    End If
                    If strQuery = "" Then
                        strQuery = strJSRQ + " between '" + Me.txtHTSearch_HTRQMin.Text + "' and '" + Me.txtHTSearch_HTRQMax.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strJSRQ + " between '" + Me.txtHTSearch_HTRQMin.Text + "' and '" + Me.txtHTSearch_HTRQMax.Text + "'"
                    End If
                ElseIf Me.txtHTSearch_HTRQMin.Text <> "" Then
                    ...
                    Me.txtHTSearch_HTRQMin.Text = dateMin.ToString("yyyy-MM-dd")
                    If strQuery = "" Then
                        strQuery = strJSRQ + " >= '" + Me.txtHTSearch_HTRQMin.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strJSRQ + " >= '" + Me.txtHTSearch_HTRQMin.Text + "'"
                    End If
                ElseIf Me.txtHTSearch_HTRQMax.Text <> "" Then
                    ...
                    Me.txtHTSearch_HTRQMax.Text = dateMax.ToString("yyyy-MM-dd")
                    If strQuery = "" Then
                        strQuery = strJSRQ + " <= '" + Me.txtHTSearch_HTRQMax.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strJSRQ + " <= '" + Me.txtHTSearch_HTRQMax.Text + "'"
                    End If
                Else
                End If
...
errProc:
        ...
        Private Function getModuleData_HT( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_HETONG_JSS(strErrMsg, MyBase.UserId, MyBase.UserPassword, strJSSH, strWhere, blnControl, Me.m_objDataSet_HT) = False Then
                    GoTo errProc
                End If
        ...
        Private Function getQRSH( _
            ...
            Try
                If Me.grdHT.SelectedIndex >= 0 Then
                    ...
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_HETONG_JIESUANSHU_QRSH)
        ...
        Private Function getJSSH( _
            ...
            Try
                If Me.grdHT.SelectedIndex >= 0 Then
                    Dim i As Integer = Me.grdHT.SelectedIndex
                    Dim intColIndex As Integer = 0
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_HETONG_JIESUANSHU_JSSH)
                    strJSSH = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
...
errProc:
        ...
        Private Function getModuleData_SHQK( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_B_ES_HETONG_JIESUANSHU_SHENHE
            Dim objsystemEstateErshou As New Josco.JSOA.BusinessFacade.systemEstateErshou
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_HETONG_JSS_SHQK(strErrMsg, MyBase.UserId, MyBase.UserPassword, strJSSH, strWhere, Me.m_objDataSet_SHQK) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function searchModuleData_HT( _
            ...
            Try
                ...
                '搜索数据
                If Me.getModuleData_HT(strErrMsg, strJSSH, strQuery, blnControl) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function showModuleData_Main( _
            ...
            Try
                ...
                '结算书已审？
                Dim blnYishen As Boolean = True
                Dim strJSSH As String = ""
                If Me.getJSSH(strErrMsg, strJSSH) = False Then
                    GoTo errProc
                End If
                If strJSSH <> "" Then
                    If objsystemEstateErshou.isJiesuanshuYiShen(strErrMsg, MyBase.UserId, MyBase.UserPassword, strJSSH, blnYishen) = False Then
                        GoTo errProc
                    End If
                End If

                Me.btnSHQM.Visible = Me.m_blnPrevilegeParams(4) And blnComplete = False And strQRSH <> "" And blnYishen = False And strJSSH <> ""
                Me.btnSDQM.Visible = Me.m_blnPrevilegeParams(4) And blnComplete = False And strQRSH <> "" And blnYishen = False And strJSSH <> ""
                Me.btnQXQM.Visible = Me.m_blnPrevilegeParams(4) And blnComplete = False And strQRSH <> "" And blnYishen = False And strJSSH <> ""
                Me.btnUpdate.Visible = Me.m_blnPrevilegeParams(4) And blnComplete = False And strQRSH <> "" And blnYishen = False And strJSSH <> ""
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    '********************************************************
                    objControlProcess.doTranslateKey(Me.txtHTSearch_JSSH)
                    ...
                    If Me.m_blnSaveScence = False Then
                        If Me.m_strJSSH = "" Then
                            ...
                            If Me.searchModuleData_HT(strErrMsg, Me.m_strJSSH, Me.m_blnQxControl) = False Then
                                GoTo errProc
                            End If
                        Else
                            If Me.getModuleData_HT(strErrMsg, Me.m_strJSSH, Me.m_strQuery_HT, Me.m_blnQxControl) = False Then
                                GoTo errProc
                            End If
                        End If
                    Else
...
errProc:
        ...
        Private Sub doUpdate(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strQRSH As String = ""
                Dim strJSSH As String = ""
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_HETONG_JIESUANSHU_ZTBZ)
                intHTZT = objPulicParameters.getObjectValue(objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex), 0)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_HETONG_JIESUANSHU_QRSH)
                strQRSH = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_HETONG_JIESUANSHU_JSSH)
                strJSSH = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                Select Case Josco.JSOA.Common.Data.estateErshouData.getJiesuanshuStatus(intHTZT)
                    Case Josco.JSOA.Common.Data.estateErshouData.enumJiesuanshuStatus.Weishen
                    Case Else
                        strErrMsg = "错误：[" + strQRSH + "]已经审核，不能更改！"
                        GoTo errProc
                End Select
...
errProc:
        ...
        Private Sub doSHQM(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '签名
                    If objsystemEstateErshou.doShenHe_ES_HETONG_JSS( _
...
errProc:
        ...
        Private Sub doSDQM(ByVal strControlId As String)
            ...
            Try
                ...
                If objsystemEstateErshou.isJssDoneYJFP(strErrMsg, MyBase.UserId, MyBase.UserPassword, strJSSH, blnIS) = False Then
                    GoTo errProc
                End If
                If blnIS = False Then
                    strErrMsg = "错误：结算书[" + strJSSH + "]没有确认[业绩分配]！"
                    GoTo errProc
                End If
                'zengxianglin 2008-11-22
