...
Namespace Josco.JSOA.web
    ...
    '
    ' 更改记录：
    '     zengxianglin 2011-01-02 创建
    '----------------------------------------------------------------
    Partial Public Class estate_es_hetongmm_qry
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongMmQry
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongMmQry
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongMmQry)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongMmQry)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
        ...
        Private Sub doOK(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.txtQRSH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtKYBH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KYBH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KYBH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtDGRQMin, Me.txtDGRQMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DGRQ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtCCDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_CCDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_CCDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtCCFMin, Me.txtCCFMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_CCF, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJYZJGMin, Me.txtJYZJGMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JYZJG, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJFDLFMin, Me.txtJFDLFMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFDLF, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtYFDLFMin, Me.txtYFDLFMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFDLF, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtSSYJMin, Me.txtSSYJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SSYJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtHZYJMin, Me.txtHZYJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_HZYJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtDLFZKMin, Me.txtDLFZKMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DLFZK + " * 100.0", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtAJJG.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJJG + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJJG + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtAJYH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJYH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJYH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFMC.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFMC + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFMC + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFDLR.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFDLR + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFDLR + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFZZHM.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFZZHM + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFZZHM + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFLXDH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFLXDH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFLXDH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYZQN.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZQN + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZQN + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYYQT.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YYQT + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YYQT + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJFLXDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFLXDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFLXDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYZDY.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZDY + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZDY + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFMC.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFMC + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFMC + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFDLR.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFDLR + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFDLR + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFZZHM.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFZZHM + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFZZHM + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFLXDH.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFLXDH + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFLXDH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtMJQN.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_MJQN + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_MJQN + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtKYQT.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KYQT + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KYQT + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtYFLXDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFLXDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFLXDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtKHDY.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KHDY + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KHDY + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtAJCSMin, Me.txtAJCSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJCS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtAJNXMin, Me.txtAJNXMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJNX, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJYZMJMin, Me.txtJYZMJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JYZMJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtHTFWDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDG = "" Then
                        strQueryDG = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FWDZ + " like '" + strValue + "'"
                    Else
                        strQueryDG = strQueryDG + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FWDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtJLRQMin, Me.txtJLRQMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JHJLRQ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblTGFKYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FKTGYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblSFZFYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SFZFYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJLZKYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JLZKYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJLRQYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JLRQYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblGMMD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_GMMD, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblKHLY, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KHLY, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblMJQC, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_MJQC, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblYFZJLB, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFZJLX, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJFZJLB, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFZJLX, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblSYWY, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SYWY, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblSHYX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SHYX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblYZLY, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZLY, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblYZQC, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZQC, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblFKFSYD, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FKFSYD, 0, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDG = "" Then
                ...
                If Me.txtFYBH.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FYBH + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FYBH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtFCZH.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FCZH + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FCZH + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtFWDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FWDZ + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FWDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtFCZDZ.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FCZDZ + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FCZDZ + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtLP.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LP + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LP + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtLD.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LD + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LD + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtDY.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_DY + " like '" + strValue + "'"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_DY + " like '" + strValue + "'"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtMJMin, Me.txtMJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_MJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtJCSJMin, Me.txtJCSJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JCSJ, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLLMin, Me.txtLLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLGMin, Me.txtLGMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LG, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtDTSLMin, Me.txtDTSLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_DTSL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLCHSMin, Me.txtLCHSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LCHS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLPQSMin, Me.txtLPQSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LPQS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtJGFSMin, Me.txtJGFSMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JGFS, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtLCMin, Me.txtLCMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LC, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtWSSLMin, Me.txtWSSLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_WSSL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringInteger(strErrMsg, Me.txtYTSLMin, Me.txtYTSLMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_YTSL, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtJYJEMin, Me.txtJYJEMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JYJE, strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJGLX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JGLX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblFWJG, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FWJG, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblLYJT, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_LYJT, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblJJSB, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JJSB, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZYYX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_ZYYX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZXNX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_ZXNX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblZXDC, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_ZXDC, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblWYSX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_WYXZ, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblCX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_ZX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblFWXZ, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_FWXZ, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                End If
                '********************************************************************************************************************************************************************************
                If objControlProcess.getQueryStringList(strErrMsg, Me.cblKJLX, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_KJLX, "", strValue) = False Then
                    GoTo errProc
                End If
                If strValue <> "" Then
                    If strQueryDY = "" Then
                ...
                If Me.txtSZQYList.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_SZQY + " in (" + strValue + ")"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_SZQY + " in (" + strValue + ")"
                    End If
                End If
                '********************************************************************************************************************************************************************************
                If Me.txtJGList.Text.Trim <> "" Then
                    ...
                    If strQueryDY = "" Then
                        strQueryDY = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JG + " in (" + strValue + ")"
                    Else
                        strQueryDY = strQueryDY + vbCr + " and " + "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_WUYE_MM_JG + " in (" + strValue + ")"
                    End If
                End If
