...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_hetongqt_info
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongQtInfo
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongQtInfo
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongQtInfo)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongQtInfo
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongQtInfo)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongQtInfo)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getModuleData_MAINQRS( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_QRS_QT(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, "", Me.m_objDataSet_MAINQRS) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function showEditPanel_MAIN( _
            ...
            Try
                ...
                If (Me.IsPostBack = False And Me.m_blnSaveScence = False) Or blnEnforced = True Then
                    ...
                    strTable = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_B_ES_QUERENSHU_QT
                    With Me.m_objDataSet_MAINQRS.Tables(strTable)
                        ...
                        Else
                            ...
                            '*****************************************************************************************************************
                            strValue = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_FKTGYD), "")
                            ...
                            Me.htxtQRSH.Value = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_QRSH), "")
                            Me.htxtDGRQ.Value = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_DGRQ), "", "yyyy-MM-dd")
                            '*****************************************************************************************************************
                            ...
                            Me.txtJFDLF.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFDLF), 0.0).ToString("#,###.00")
                            Me.txtYFDLF.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFDLF), 0.0).ToString("#,###.00")
                            Me.txtDLFZK.Text = (objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_DLFZK), 0.0) * 100).ToString("#.00")
                            ...
                            Me.txtJLRQ.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JHJLRQ), "", "yyyy-MM-dd")
                    ...
                    Select Case Me.m_objenumEditType
                        Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                            Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                            '设置初始值
                            If objsystemEstateErshou.getNewHTBH_QT(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.txtHTBH.Text) = False Then
                                GoTo errProc
                            End If
...
errProc:
        ...
        Private Sub doOK(ByVal strControlId As String)
            ...
            Try
                ...
                objNewDataQRS.Clear()
                '********************************************************************************************************************
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_WYBS, Me.htxtWYBS.Value.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_QRSH, Me.htxtQRSH.Value.Trim)
                '********************************************************************************************************************
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_FWDZ, Me.txtFWDZ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JYZJG, Me.txtJYZJG.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JYZMJ, Me.txtJYZMJ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFDLF, Me.txtJFDLF.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFDLF, Me.txtYFDLF.Text.Trim)
                dblValue = objPulicParameters.getObjectValue(Me.txtDLFZK.Text, 0.0) / 100.0
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_DLFZK, dblValue.ToString("#.00"))
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JHJLRQ, Me.txtJLRQ.Text)
                '********************************************************************************************************************
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFDLR, Me.txtJFDLR.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFLXDH, Me.txtJFLXDH.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFLXDZ, Me.txtJFLXDZ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFMC, Me.txtJFMC.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFZZHM, Me.txtJFZZHM.Text.Trim)
                '********************************************************************************************************************
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFDLR, Me.txtYFDLR.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFLXDH, Me.txtYFLXDH.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFLXDZ, Me.txtYFLXDZ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFMC, Me.txtYFMC.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFZZHM, Me.txtYFZZHM.Text.Trim)
                '********************************************************************************************************************
                If Me.rblTGFKYD.SelectedIndex > 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_FKTGYD, Me.rblTGFKYD.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_FKTGYD, "0")
                End If
                '********************************************************************************************************************
                If Me.rblJLRQYD.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JLRQYD, Me.rblJLRQYD.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JLRQYD, "0")
                End If
                '********************************************************************************************************************
                If Me.rblSFZFYD.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SFZFYD, Me.rblSFZFYD.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SFZFYD, "0")
                End If
                '********************************************************************************************************************
                If Me.rblJLZKYD.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JLZKYD, Me.rblJLZKYD.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JLZKYD, "0")
                End If
                '********************************************************************************************************************
                If Me.ddlJFZJLB.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFZJLX, Me.ddlJFZJLB.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_JFZJLX, "0")
                End If
                '********************************************************************************************************************
                If Me.ddlYFZJLB.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFZJLX, Me.ddlYFZJLB.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YFZJLX, "0")
                End If
                '********************************************************************************************************************
                'zengxianglin 2010-12-27
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_KYBH, Me.txtKYBH.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_CCDZ, Me.txtCCDZ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_CCF, Me.txtCCF.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SSYJ, Me.txtSSYJ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_HZYJ, Me.txtHZYJ.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_AJJG, Me.txtAJJG.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_AJYH, Me.txtAJYH.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_AJCS, Me.txtAJCS.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_AJNX, Me.txtAJNX.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YZQN, Me.txtYZQN.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YYQT, Me.txtYYQT.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YZDY, Me.txtYZDY.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_MJQN, Me.txtMJQN.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_KYQT, Me.txtKYQT.Text.Trim)
                objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_KHDY, Me.txtKHDY.Text.Trim)
                If Me.rblYZQC.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YZQC, Me.rblYZQC.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YZQC, "")
                End If
                If Me.rblYZLY.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YZLY, Me.rblYZLY.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_YZLY, "")
                End If
                If Me.rblSHYX.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SHYX, Me.rblSHYX.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SHYX, "")
                End If
                If Me.rblSYWY.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SYWY, Me.rblSYWY.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_SYWY, "")
                End If
                If Me.rblMJQC.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_MJQC, Me.rblMJQC.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_MJQC, "")
                End If
                If Me.rblKHLY.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_KHLY, Me.rblKHLY.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_KHLY, "")
                End If
                If Me.rblGMMD.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_GMMD, Me.rblGMMD.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_GMMD, "")
                End If
                If Me.rblFKFSYD.SelectedIndex >= 0 Then
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_FKFSYD, Me.rblFKFSYD.SelectedValue)
                Else
                    objNewDataQRS.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_QT_FKFSYD, "")
                End If
                'zengxianglin 2010-12-27
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                        ...
                        If objsystemEstateErshou.doSaveData_ES_HETONG(strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                            Josco.JSOA.Common.Data.estateErshouData.YWLX_ES_QT, _
                            objNewDataHT, Nothing, _
                            objNewDataQRS, _
                            Me.m_objDataSet_MAINQRS.Tables(Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_B_ES_QUERENSHU_QT).Rows(0), _
