<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_esyjfpb_x2.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_esyjfpb_x2" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_esyjfpb_x2" method="post" runat="server">
				...
				<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<tr valign="baseline">
									...
									<td class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;显示级别
										<asp:DropDownList ID="ddlSearch_XSJB" Runat="server" CssClass="textbox">
											...
											<asp:ListItem Value=" <= 2 ">显示到人员|标准汇总</asp:ListItem>
											<asp:ListItem Value=" =  2 ">仅显示人员|标准汇总</asp:ListItem>
											<asp:ListItem Value=" <= 3 ">显示到人员|标准|档级汇总</asp:ListItem>
											<asp:ListItem Value=" =  3 ">仅显示人员|标准|档级汇总</asp:ListItem>
											<asp:ListItem Value=" <= 4 ">显示到人员|标准|档级|团队汇总</asp:ListItem>
											<asp:ListItem Value=" =  4 ">仅显示人员|标准|档级|团队汇总</asp:ListItem>
											<asp:ListItem Value=" <= 5 ">显示到人员|标准|档级|团队|接案月度汇总</asp:ListItem>
											<asp:ListItem Value=" =  5 ">仅显示人员|标准|档级|团队|接案月度汇总</asp:ListItem>
											<asp:ListItem Value=" <= 6 ">显示到明细数据</asp:ListItem>
											<asp:ListItem Value=" =  6 ">仅显示明细数据</asp:ListItem>
										</asp:DropDownList>
									</td>
												...
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 994px; CLIP: rect(0px 994px 445px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 445px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															GridLines="Both" AutoGenerateColumns="False" Width="5460px">
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="计佣年月" SortExpression="计佣年月" HeaderText="计佣年月" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="接案年月" SortExpression="接案年月" HeaderText="接案年月" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="计佣标准" SortExpression="计佣标准" HeaderText="计佣标准" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="false" ItemStyle-Width="0px" DataTextField="计佣职级名称" SortExpression="计佣职级名称" HeaderText="计佣职级" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="false" ItemStyle-Width="0px" DataTextField="计佣职级" SortExpression="计佣职级" HeaderText="计佣职级代码" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="false" ItemStyle-Width="0px" DataTextField="计佣档级" SortExpression="计佣档级" HeaderText="计佣档级" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="佣金合计" SortExpression="佣金合计" HeaderText="计佣业绩" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="计提合计" SortExpression="计提合计" HeaderText="计提合计" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="月初佣金" SortExpression="月初佣金" HeaderText="月初佣金" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="总中介费" SortExpression="总中介费" HeaderText="总中介费" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="总律师费" SortExpression="总律师费" HeaderText="总律师费" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="本次计提" SortExpression="本次计提" HeaderText="本次计提" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="本次保留" SortExpression="本次保留" HeaderText="本次保留" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="月初业绩" SortExpression="月初业绩" HeaderText="月初业绩" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="月末佣金" SortExpression="月末佣金" HeaderText="月末佣金" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="月末日期" SortExpression="月末日期" HeaderText="月末日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="状态标志" SortExpression="状态标志" HeaderText="私佣?" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="直管标记" SortExpression="直管标记" HeaderText="直管" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="试用人员" SortExpression="试用人员" HeaderText="试用" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="团队人数" SortExpression="团队人数" HeaderText="团队人数" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="100px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="团队类型" SortExpression="团队类型" HeaderText="团队类型" CommandName="Select">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="160px" DataTextField="实际完成" SortExpression="实际完成" HeaderText="实际完成任务" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="160px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="160px" DataTextField="任务指标" SortExpression="任务指标" HeaderText="团队月度指标" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="160px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成比例" SortExpression="完成比例" HeaderText="完成比例(%)" CommandName="Select" DataTextFormatString="{0:##0.00%}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="人均业绩" SortExpression="人均业绩" HeaderText="人均业绩" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
					...
					<TR id="trRow01">
						...
						<TD style="BORDER-TOP: #99cccc 2px solid" align="center" height="32" valign="middle">
							...
							<asp:linkbutton id="lnkMLQRJYJG" runat="server">确认结果</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:linkbutton id="lnkMLCKYYJL" runat="server">查看公佣</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:linkbutton id="lnkMLCKSYYJ" runat="server">查看私佣</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;
