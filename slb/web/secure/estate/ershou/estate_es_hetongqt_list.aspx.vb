...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_hetongqt_list
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongQtList
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongQtList
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongQtList)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongQtList
        ...
        Private Function getDataFromCallModule(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                End If
                '==========================================================================================================================================================
                Dim objIEstateEsHetongQtQry As Josco.JSOA.BusinessFacade.IEstateEsHetongQtQry = Nothing
                Try
                    objIEstateEsHetongQtQry = CType(Session.Item(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId)), Josco.JSOA.BusinessFacade.IEstateEsHetongQtQry)
                Catch ex As Exception
                    objIEstateEsHetongQtQry = Nothing
                End Try
                If Not (objIEstateEsHetongQtQry Is Nothing) Then
                    If objIEstateEsHetongQtQry.oExitMode = True Then
                        Me.htxtHTQueryDG.Value = objIEstateEsHetongQtQry.oQuery_DG
                        Me.htxtHTQueryHT.Value = objIEstateEsHetongQtQry.oQuery_HT
                        Me.htxtHTQueryDY.Value = objIEstateEsHetongQtQry.oQuery_DY
                        Me.htxtHTQueryRY.Value = objIEstateEsHetongQtQry.oQuery_RY
                    End If
                    Session.Remove(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId))
                    Josco.JSOA.BusinessFacade.IEstateEsHetongQtQry.SafeRelease(objIEstateEsHetongQtQry)
                    Exit Try
                End If
                'zengxianglin 2010-01-04
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongQtList)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongQtList)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_HT( _
            ...
            Try
                '按“确认书号”搜索
                Dim strQRSH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYBH
                ...
                '按“合同编号”搜索
                Dim strHTBH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_HTBH
                ...
                '按“甲方名称”搜索
                Dim strJFMC As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_YZMC
                ...
                '按“乙方名称”搜索
                Dim strYFMC As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_KHMC
                ...
                '按“房屋地址”搜索
                Dim strFWDZ As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_WYDZ
                ...
                '按“合同状态”搜索
                Dim strHTZT As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_HTZT
                ...
                '按“特殊条件”搜索
                Dim strJYBH As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYBH
                ...
                '按“是否签约”搜索
                Dim strHTBH1 As String = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_HTBH
                ...
                strDGRQ = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYRQ
                ...
                strHTRQ = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_HTRQ
...
errProc:
        ...
        Private Function getModuleData_HT( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_V_QUANBUJIAOYI_QT
            ...
            Try
                ...
                '重新检索数据
                'zengxianglin 2010-01-04
                'If objsystemEstateErshou.getDataSet_ES_JYXX_QT( _
...
errProc:
        ...
        Private Sub doOpen(ByVal strControlId As String)
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYLX)
                strYWLX = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_HTZT)
                intHTZT = objPulicParameters.getObjectValue(objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex), 0)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_HTBH)
                strHTBH = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYBH)
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                '获取打印数据
                If objsystemEstateErshou.getDataSet_ES_JYXX_QT_PRN( _
                    strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                    Me.m_strQuery_HT, _
                    Me.htxtHTQueryDG.Value, Me.htxtHTQueryHT.Value, Me.htxtHTQueryDY.Value, Me.htxtHTQueryRY.Value, _
                    Me.m_blnQxControl, _
                ...
                '准备Excel模板文件
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "广州兴业_合同管理_二手合同其他.xls"
...
errProc:
        ...
        Private Sub doQPSS(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strUrl As String = ""
                Dim objIEstateEsHetongQtQry As Josco.JSOA.BusinessFacade.IEstateEsHetongQtQry = Nothing
                objIEstateEsHetongQtQry = New Josco.JSOA.BusinessFacade.IEstateEsHetongQtQry
                With objIEstateEsHetongQtQry
                    .iSourceControlId = strControlId
                    If Me.m_blnInterface = True Then
                        strUrl = ""
                        strUrl += Request.Url.AbsolutePath
                ...
                If strNewSessionId = "" Then
                    ...
                    GoTo errProc
                End If
                Session.Add(strNewSessionId, objIEstateEsHetongQtQry)
                strUrl = ""
                strUrl += "estate_es_hetongqt_qry.aspx"
                strUrl += "?"
                strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                strUrl += "="
                strUrl += strNewSessionId
