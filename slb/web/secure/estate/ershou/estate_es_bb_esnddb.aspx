<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_esnddb.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_esnddb" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>中介部二手业绩年度对比</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_esnddb" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" border="0">
					<TR id="trRow00">
						<TD width="4"></TD>
                        <TD height="30" class="title" vAlign="middle" align="center" style="BORDER-BOTTOM: #99cccc 2px solid">中介部二手业绩年度对比</TD>
                        <TD width="4"></TD>
                    </TR>					
					<tr id="trRow02">
						<TD width="4"></TD>
						<td style="BORDER-BOTTOM: #99cccc 1px solid">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td class="labelNotNull">&nbsp;&nbsp;开始年度<asp:TextBox ID="txtKSND" Runat="server" CssClass="textbox" Columns="3"></asp:TextBox></td>
									<td class="labelNotNull">&nbsp;&nbsp;终止年度<asp:TextBox ID="txtZZND" Runat="server" CssClass="textbox" Columns="3"></asp:TextBox></td>
									<td class="labelNotNull">&nbsp;&nbsp;月截止日<asp:TextBox ID="txtYJZR" Runat="server" CssClass="textbox" Columns="2">26</asp:TextBox></td>
									<td class="labelNotNull">&nbsp;&nbsp;统计类型<asp:DropDownList ID="ddlType" Runat="server" CssClass="textbox">
											<asp:ListItem Value="0">接案</asp:ListItem>
											<asp:ListItem Value="1">结案</asp:ListItem>
										</asp:DropDownList>
									</td>
									<td class="label">&nbsp;&nbsp;业务类型<asp:DropDownList ID="ddlYWLX" Runat="server" CssClass="textbox">
									...
									<td class="label">&nbsp;&nbsp;统计单位<asp:DropDownList ID="ddlZZDM" Runat="server" CssClass="textbox"></asp:DropDownList></td>
									<td class="labelNotNull">&nbsp;&nbsp;查看指标：<asp:DropDownList ID="ddlTJZB" Runat="server" CssClass="textbox">
													...
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 977px; CLIP: rect(0px 977px 408px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 408px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="统计年度" SortExpression="统计年度" HeaderText="年度" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="1月" SortExpression="1月" HeaderText="1月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="2月" SortExpression="2月" HeaderText="2月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="3月" SortExpression="3月" HeaderText="3月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="4月" SortExpression="4月" HeaderText="4月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="5月" SortExpression="5月" HeaderText="5月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="6月" SortExpression="6月" HeaderText="6月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="7月" SortExpression="7月" HeaderText="7月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="8月" SortExpression="8月" HeaderText="8月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="9月" SortExpression="9月" HeaderText="9月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="10月" SortExpression="10月" HeaderText="10月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="11月" SortExpression="11月" HeaderText="11月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="130px" DataTextField="12月" SortExpression="12月" HeaderText="12月" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="130px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
