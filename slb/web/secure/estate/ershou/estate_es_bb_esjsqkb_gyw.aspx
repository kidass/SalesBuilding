<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_esjsqkb_gyw.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_esjsqkb_gyw" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>中介部二手代理结算情况表（各业务）</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_esjsqkb_gyw" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" border="0">
					<TR id="trRow00">
						<TD width="4"></TD>
                        <TD height="30" class="title" vAlign="middle" align="center" style="BORDER-BOTTOM: #99cccc 2px solid">中介部二手代理结算情况表（各业务）</TD>
                        <TD width="4"></TD>
                    </TR>					
					<tr id="trRow02">
						<TD width="4"></TD>
													...
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 977px; CLIP: rect(0px 977px 408px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 408px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="交易名称" SortExpression="交易名称" HeaderText="交易名称" CommandName="Select">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="0px" Visible="False" DataTextField="显示序号" SortExpression="显示序号" HeaderText="显示序号" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成代理费" SortExpression="完成代理费" HeaderText="累计完成代理费" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成合同金额" SortExpression="完成合同金额" HeaderText="累计完成合同额" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成代理面积" SortExpression="完成代理面积" HeaderText="累计完成代理面积" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成宗数" SortExpression="完成宗数" HeaderText="累计完成宗数" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成套数" SortExpression="完成套数" HeaderText="累计完成套数" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="完成按揭返还" SortExpression="完成按揭返还" HeaderText="累计完成按揭返还" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本月代理费" SortExpression="本月代理费" HeaderText="本月完成代理费" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本月合同金额" SortExpression="本月合同金额" HeaderText="本月完成合同额" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本月代理面积" SortExpression="本月代理面积" HeaderText="本月完成代理面积" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本月宗数" SortExpression="本月宗数" HeaderText="本月完成宗数" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本月套数" SortExpression="本月套数" HeaderText="本月完成套数" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本月按揭返还" SortExpression="本月按揭返还" HeaderText="本月完成按揭返还" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>

																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="未结代理费" SortExpression="未结代理费" HeaderText="已接未结代理费" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="未结合同金额" SortExpression="未结合同金额" HeaderText="已接未结合同额" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="未结代理面积" SortExpression="未结代理面积" HeaderText="已接未结代理面积" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="未结宗数" SortExpression="未结宗数" HeaderText="已接未结宗数" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="未结套数" SortExpression="未结套数" HeaderText="已接未结套数" CommandName="Select" DataTextFormatString="{0:#,##0.0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="未结按揭返还" SortExpression="未结按揭返还" HeaderText="已接未结按揭返还" CommandName="Select" DataTextFormatString="{0:#,##0}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
