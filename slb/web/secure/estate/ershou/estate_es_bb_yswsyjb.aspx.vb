...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_bb_yswsyjb
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbYswsyjb
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbYswsyjb
        ...
        Private Function getPrevilegeParams( _
            ...
            Try
                ...
                '是否继续执行
                If Me.m_blnPrevilegeParams(0) = True And Me.m_blnPrevilegeParams(24) = True Then
                    blnContinueExecute = True
                Else
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtWSYJMin.Text = .txtWSYJMin
                    Me.txtWSYJMax.Text = .txtWSYJMax
                    ...
                    Me.ddlHTZT.SelectedIndex = .ddlHTZT_SelectedIndex
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbYswsyjb
                ...
                With Me.m_objSaveScence
                    ...
                    .txtWSYJMin = Me.txtWSYJMin.Text
                    .txtWSYJMax = Me.txtWSYJMax.Text
                    ...
                    .ddlHTZT_SelectedIndex = Me.ddlHTZT.SelectedIndex
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbYswsyjb)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbYswsyjb)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[合同日期]搜索
                If objControlProcess.getQueryStringDatetime(strErrMsg, Me.txtHTRQMin, Me.txtHTRQMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_HTRQ, strTempWhere) = False Then
                    GoTo errProc
                End If
                If strQuery = "" Then
                ...
                '按[未收佣金]搜索
                If objControlProcess.getQueryStringFloat(strErrMsg, Me.txtWSYJMin, Me.txtWSYJMax, "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_YSWSYJB_WSYJ, strTempWhere) = False Then
                    GoTo errProc
                End If
                If strQuery = "" Then
                    strQuery = strTempWhere
                ...
                If Me.txtQRSH.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_JYBH + " like '" + Me.txtQRSH.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtHTBH.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_HTBH + " like '" + Me.txtHTBH.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                '按[物业地址]搜索
                If Me.txtWYDZ.Text.Trim <> "" Then
                    Me.txtWYDZ.Text = objPulicParameters.getNewSearchString(Me.txtWYDZ.Text)
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_WYDZ + " like '" + Me.txtWYDZ.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                If Me.txtYZMC.Text.Trim <> "" Then
                    ...
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_YZMC + " like '" + Me.txtYZMC.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                '按[客户名称]搜索
                If Me.txtKHMC.Text.Trim <> "" Then
                    Me.txtKHMC.Text = objPulicParameters.getNewSearchString(Me.txtKHMC.Text)
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_KHMC + " like '" + Me.txtKHMC.Text + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
                ...
                '按[合同状态]搜索
                If Me.ddlHTZT.SelectedIndex >= 0 Then
                    strTempWhere = "a." + Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_HTZTMC + " = '" + Me.ddlHTZT.SelectedItem.Value + "'" + vbCr
                    If strQuery = "" Then
                        strQuery = strTempWhere
                    Else
                        strQuery = strQuery + vbCr + " and " + strTempWhere
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_YSWSYJB
            ...
            Try
                ...
                Else
                    ...
                    Josco.JSOA.Common.Data.estateErshouData.SafeRelease(Me.m_objDataSet)
                    '重新检索数据
                    If objsystemEstateErshou.getDataSet_BB_YSWSYJB(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    '=======================================================================
                    objControlProcess.doTranslateKey(Me.txtWSYJMin)
                    objControlProcess.doTranslateKey(Me.txtWSYJMax)
                    ...
                    objControlProcess.doTranslateKey(Me.ddlHTZT)
                    '=======================================================================
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                '准备Excel文件
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "广州兴业_二手报表_中介部二手应收未收佣金表.xls"
