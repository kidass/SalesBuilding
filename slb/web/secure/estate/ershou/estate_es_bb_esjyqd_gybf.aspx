<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_esjyqd_gybf.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_esjyqd_gybf" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>中介部二手计佣清单(公佣补发)</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_esjyqd_gybf" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" border="0">
					<TR id="trRow00">
						<TD width="4"></TD>
                        <TD height="30" class="title" vAlign="middle" align="center" style="BORDER-BOTTOM: #99cccc 2px solid">中介部二手计佣清单(公佣补发)</TD>
                        <TD width="4"></TD>
                    </TR>					
					<tr id="trRow02">
						<TD width="4"></TD>
						<td style="BORDER-BOTTOM: #99cccc 1px solid">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<tr>
									...
									<td class="labelNotNull">&nbsp;&nbsp;月截止日：<asp:TextBox ID="txtYJZR" Runat="server" CssClass="textbox" Columns="10">26</asp:TextBox></td>
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 994px; CLIP: rect(0px 994px 446px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 446px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="补发月度" SortExpression="补发月度" HeaderText="补发月度" CommandName="Select">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="人员代码" SortExpression="人员代码" HeaderText="人员代码" CommandName="Select">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="人员名称" SortExpression="人员名称" HeaderText="人员名称" CommandName="Select">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="补发金额" SortExpression="补发金额" HeaderText="可补发金额" CommandName="Select" DataTextFormatString="{0:#,##0.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="140px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:TemplateColumn HeaderText="实际补发">
																	<HeaderStyle HorizontalAlign="Center" Width="140px"></HeaderStyle>
																	<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																	<ItemTemplate>
																		<asp:TextBox ID="txtBF_SJBF" Runat="server" CssClass="textbox_right" Width="140px"></asp:TextBox>
																	</ItemTemplate>
																</asp:TemplateColumn>
															</Columns>
					...
					<TR id="trRow01">
						...
						<TD style="BORDER-TOP: #99cccc 2px solid" align="center" height="32" valign="middle">
							...
							<asp:linkbutton id="lnkMLGybfqr" runat="server">补发确认</asp:linkbutton>&nbsp;&nbsp;&nbsp;&nbsp;
