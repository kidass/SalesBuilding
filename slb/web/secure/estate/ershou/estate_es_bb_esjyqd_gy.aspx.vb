...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_bb_esjyqd_gy
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGy
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbEsjyqdGy
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGy
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbEsjyqdGy)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbEsjyqdGy)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[显示级别]搜索
                Dim strXSJB As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESJYQD_GY_XSJB
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_ESJYQD_GY
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateErshouData(Josco.JSOA.Common.Data.estateErshouData.enumTableType.DC_VT_ES_BB_ESJYQD_GY)
                    Else
                        '获取参数
                        ...
                        End If
                        '重新检索数据
                        If objsystemEstateErshou.getDataSet_BB_ESJYQD_GY(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ, strBMDM, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        Private Function getModuleData01( _
            ...
            Try
                ...
                '获取参数
                If Me.getReportParam01(strErrMsg, strKSRQ, strZZRQ) = False Then
                    GoTo errProc
                End If
                '重新检索数据
                If objsystemEstateErshou.getDataSet_BB_ESJYQD_GY(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ, strBMDM, objDataSet) = False Then
                    GoTo errProc
                End If
        ...
        Sub grdContent_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles grdContent.ItemDataBound
            ...
            Try
                ...
                Else
                    ...
                    intFZJB = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESJYQD_GY_XSJB)
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.getReportParam(strErrMsg, strKSRQ, strZZRQ, strBMDM) = False Then
                    GoTo errProc
                End If
                Dim strFName As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESJYQD_GY_XSJB
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手计佣清单(公佣).xls"
...
errProc:
        ...
        Private Sub doExportSelect(ByVal strControlId As String)
            ...
            Try
                ...
                Dim intCount As Integer
                Dim i As Integer
                strSrcExcelSpec = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手计佣清单(公佣).xls"
                strSrcExcelSpec = Server.MapPath(strSrcExcelSpec)
                ...
                For i = 0 To intCount - 1 Step 1
                    If Me.tvwTJBM.Nodes(i).Checked = True Then
                        ...
                        '表头参数
                        strMacroName = "$Macro$YYYY$" + strSep + "$Macro$MM$" + strSep + "$Macro$BMMC$" + strSep + "$Macro$KSRQ$" + strSep + "$Macro$ZZRQ$"
                        strMacroValue = objZZRQ.Year.ToString + strSep + objZZRQ.Month.ToString + strSep + strBMMC + strSep + strKSRQ + strSep + strZZRQ
