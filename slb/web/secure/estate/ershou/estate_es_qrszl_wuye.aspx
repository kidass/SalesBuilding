<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_qrszl_wuye.aspx.vb" Inherits="Josco.JSOA.web.estate_es_qrszl_wuye" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
    <HEAD>
        <title>租赁确认书物业信息查看与编辑</title>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmestate_es_qrszl_wuye" method="post" runat="server">
                ...
                <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                    <TR id="trRow1">
                        <TD align="center">
                            <TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
                                <TR>
                                    <TD class="title" align="center">租赁确认书物业信息查看与编辑<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                                    <TD width="20">&nbsp;</TD>
                                </TR>
                                <TR>
                                    <TD class="labelNotNull" vAlign="middle" align="right">确认书号：<asp:TextBox id="txtQRSH" runat="server" CssClass="textbox" Columns="14"></asp:TextBox><INPUT id="htxtWYBS" type="hidden" size="1" runat="server"><INPUT id="htxtWYBM" type="hidden" size="1" runat="server"></TD>
                                    <TD width="20">&nbsp;</TD>
                                </TR>
                            </TABLE>
                        </TD>
                                    ...
                                    <TR>
                                        <TD>
                                            <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                                                ...
                                                <tr height="26" valign="middle">
                                                    <TD class="labelNotNull" align="right">月租金：</TD>
                                                    <TD width="8">&nbsp;</TD>
                                                    <TD align="left" colspan="4"><asp:TextBox id="txtYZJ" runat="server" CssClass="textbox" Columns="24"></asp:TextBox>元人民币</TD>
                                                </TR>
                                                <tr height="26" valign="middle">
