...
Namespace Josco.JSOA.web
    ...
    '----------------------------------------------------------------
    ' 命名空间：Josco.JSOA.web
    ' 类名    ：estate_es_bb_eswcqkb_gfh
    ' 
    ' 调用性质：
    '     独立运行
    '
    ' 功能描述： 
    '   　中介部二手代理结案情况表（各分行）处理模块
    '----------------------------------------------------------------

    Partial Class estate_es_bb_eswcqkb_gfh
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbEsdlwcqkbGfh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbEsdlwcqkbGfh
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbEsdlwcqkbGfh
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbEsdlwcqkbGfh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbEsdlwcqkbGfh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[显示级别]搜索
                Dim strFZJB As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESDLWCQKB_GFH_XSJB
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_ESDLWCQKB_GFH
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateErshouData(Josco.JSOA.Common.Data.estateErshouData.enumTableType.DC_VT_ES_BB_ESDLWCQKB_GFH)
                    Else
                        '获取参数
                        ...
                        End If
                        '重新检索数据
                        If objsystemEstateErshou.getDataSet_BB_ESDLWCQKB_GFH(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
        ...
        Sub grdContent_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles grdContent.ItemDataBound
            ...
            Try
                ...
                Else
                    ...
                    intFZJB = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESDLWCQKB_GFH_XSJB)
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strFName As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESDLWCQKB_GFH_XSJB

                '准备Excel文件
                Dim strDesExcelPath As String = Request.ApplicationPath + Me.m_cstrUrlBaseToDownloadFile
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手代理结案情况表(各分行).xls"
