<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_bb_kyxxb.aspx.vb" Inherits="Josco.JSOA.web.estate_es_bb_kyxxb" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>中介部客源信息表</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_es_bb_kyxxb" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" border="0">
					<TR id="trRow00">
						<TD width="4"></TD>
                        <TD height="30" class="title" vAlign="middle" align="center" style="BORDER-BOTTOM: #99cccc 2px solid">中介部客源信息表</TD>
                        <TD width="4"></TD>
                    </TR>					
					<tr id="trRow02">
						<TD width="4"></TD>
						<td style="BORDER-BOTTOM: #99cccc 1px solid">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
							    <tr>
								    ...
								    <td class="label" nowrap>&nbsp;&nbsp;联系地址<asp:TextBox ID="txtKHDZ" runat="server" CssClass="textbox" Columns="28"></asp:TextBox></td>
								    <td class="label" nowrap>&nbsp;&nbsp;确认书号<asp:TextBox ID="txtQRSH" runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
								    <td class="label" nowrap>&nbsp;&nbsp;物业地址<asp:TextBox ID="txtWYDZ" runat="server" CssClass="textbox" Width="170px"></asp:TextBox></td>
								    <td></td>
							    </tr>
								<tr>
								    <td class="label" nowrap>&nbsp;&nbsp;客户电话<asp:TextBox ID="txtLXDH" runat="server" CssClass="textbox" Columns="24"></asp:TextBox>
												...
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 977px; CLIP: rect(0px 977px 408px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 408px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															GridLines="Vertical" AutoGenerateColumns="False" Width="4910px">
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="260px" DataTextField="客户名称" SortExpression="客户名称" HeaderText="客户名称" CommandName="OpenDocument">
																	<HeaderStyle Width="160px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="160px" DataTextField="客源编号" SortExpression="客源编号" HeaderText="客源编号" CommandName="Select">
																	<HeaderStyle Width="160px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="乙方联系电话" SortExpression="乙方联系电话" HeaderText="联系电话" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="300px" DataTextField="乙方联系地址" SortExpression="乙方联系地址" HeaderText="联系地址" CommandName="Select">
																	<HeaderStyle Width="300px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="220px" DataTextField="乙方证照号码" SortExpression="乙方证照号码" HeaderText="证照号码" CommandName="Select">
																	<HeaderStyle Width="220px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="180px" DataTextField="乙方代理人" SortExpression="乙方代理人" HeaderText="代理人" CommandName="Select">
																	<HeaderStyle Width="180px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="乙方证件类型" SortExpression="乙方证件类型" HeaderText="证件类型" CommandName="Select">
