        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.ddlZZDM.SelectedIndex >= 0 Then
                    ...
                    End If
                End If
                If strBMMC = "" Then strBMMC = "所有部门"
                Dim strYWMC As String = ""
                If Me.ddlYWLX.SelectedIndex >= 0 Then
                    strYWMC = Me.ddlYWLX.SelectedItem.Text
                End If
                If strYWMC = "" Then strYWMC = "全部"

                '准备Excel文件
                Dim strDesExcelPath As String = Request.ApplicationPath + Me.m_cstrUrlBaseToDownloadFile
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手业绩年度对比.xls"
                ...
                With objDataTable.Columns
                    .Add("开始年度", GetType(System.Int32))
                    .Add("终止年度", GetType(System.Int32))
                    .Add("统计类型", GetType(System.String))
                    .Add("业务类型", GetType(System.String))
                    .Add("统计部门", GetType(System.String))
                End With
                objDataRow = objDataTable.NewRow
                objDataRow.Item("开始年度") = intKSND
                objDataRow.Item("终止年度") = intZZND
                objDataRow.Item("统计类型") = strType
                objDataRow.Item("业务类型") = strYWMC
                objDataRow.Item("统计部门") = strBMMC
