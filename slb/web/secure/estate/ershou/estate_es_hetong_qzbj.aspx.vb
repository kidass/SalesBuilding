...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_hetong_qzbj
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsHetongQzbj
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsHetongQzbj
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsHetongQzbj)
...
errProc:
        ...
        Private Function getPrevilegeParams( _
            ...
            Try
                ...
                '是否继续执行
                If Me.m_blnPrevilegeParams(0) = True And Me.m_blnPrevilegeParams(13) = True Then
                    blnContinueExecute = True
                Else
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsHetongQzbj
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsHetongQzbj)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsHetongQzbj)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        '----------------------------------------------------------------
        ' 获取grdJSS要显示的数据信息(根据合同列表的当前合同获取)
        '     strErrMsg      ：返回错误信息
        '     strWhere       ：搜索条件
        ' 返回
        '     True           ：成功
...
errProc:
        ...
        Private Function showModuleData_Main( _
            ...
            Try
                ...
                '控制操作
                Me.btnGGFPBL.Visible = Me.m_blnPrevilegeParams(13) And (strQRSH <> "")
                Me.btnGGJSYJ.Visible = Me.m_blnPrevilegeParams(13) And (strQRSH <> "")
                Me.btnGGHTBZ.Visible = Me.m_blnPrevilegeParams(13) And (strQRSH <> "")
                'zengxianglin 2009-05-19
                Me.btnZDTZXD.Visible = Me.m_blnPrevilegeParams(13) And (strQRSH <> "")
                'zengxianglin 2009-05-19
                'zengxianglin 2009-05-21
                Me.btnZDTZQB.Visible = Me.m_blnPrevilegeParams(13) And (strQRSH <> "")
                'zengxianglin 2009-05-21
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
                ...
                Try
                    ...
                    If Me.m_blnSaveScence = False Then
                        If Me.m_strQRSH = "" Then
                            'zengxianglin 2009-05-19
                            Me.txtHTSearch_HTRQMin.Text = Now.AddDays(-45).ToString("yyyy-MM-dd")
                            Me.txtHTSearch_HTRQMax.Text = Now.ToString("yyyy-MM-dd")
                            'zengxianglin 2009-05-19
...
errProc:
        ...
        Private Sub doGGJSYJ(ByVal strControlId As String)
...
errProc:
        ...
        Private Sub doGGFPBL(ByVal strControlId As String)
...
errProc:
        ...
        Private Sub doGGHTBZ(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.txtBZXX.Text.Trim = "" Then
                    strBZXX = "[" + Now.ToString("yyyy-MM-dd") + "]" + MyBase.UserXM + "强行调整了业绩分配"
                Else
                    strBZXX = "[" + Now.ToString("yyyy-MM-dd") + "]" + MyBase.UserXM + Me.txtBZXX.Text.Trim
                End If

                '更改
                If objsystemEstateErshou.doUpdateData_ES_HETONG_BZXX(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, strBZXX) = False Then
                    GoTo errProc
                End If

                '提示成功
                objMessageProcess.doAlertMessage(Me.popMessageObject, "提示：成功写入合同的[备注]中！")
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Sub doZDTZXD(ByVal strControlId As String)
            ...
            Try
                ...
                Dim intCount As Integer
                Dim i As Integer
                intCount = Me.grdHT.Items.Count
                For i = 0 To intCount - 1 Step 1
                    If objDataGridProcess.isDataGridItemChecked(Me.grdHT.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_HT) = True Then
                        intSelected = intSelected + 1
                    End If
                Next
                If intSelected < 1 Then
                    strErrMsg = "错误：没有打钩要自动调整的合同！"
                    GoTo errProc
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备自动调整选定[" + intSelected.ToString + "]份合同吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strQRSH As String = ""
                    intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdHT, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYBH)
                    intCount = Me.grdHT.Items.Count
                    For i = 0 To intCount - 1 Step 1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdHT.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_HT) = True Then
                            strQRSH = objDataGridProcess.getDataGridCellValue(Me.grdHT.Items(i), intColIndex(0))
                            If objsystemEstateErshou.doUpdate_ES_HETONG_FPBL_JSYJ(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, Me.txtBZXX.Text.Trim) = False Then
                                strErrMsg = strErrMsg + "确认书号为[" + strQRSH + "]！"
                                GoTo errProc
                            End If
                        End If
                    Next
                    ...
                    '提示成功
                    objMessageProcess.doAlertMessage(Me.popMessageObject, "提示：操作成功完成！")
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
...
errProc:
        ...
        Private Sub doZDTZQB(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.getModuleData_HT(strErrMsg, Me.m_strQRSH, Me.m_strQuery_HT, Me.m_blnQxControl) = False Then
                    GoTo errProc
                End If
                intSelected = Me.m_objDataSet_HT.Tables(strTable).Rows.Count

                '询问
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备自动调整搜索到的[" + intSelected.ToString + "]份合同吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    With Me.m_objDataSet_HT.Tables(strTable)
                        intCount = .Rows.Count
                        For i = 0 To intCount - 1 Step 1
                            strQRSH = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_V_QUANBUJIAOYI_QT_JYBH), "")
                            If objsystemEstateErshou.doUpdate_ES_HETONG_FPBL_JSYJ(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, Me.txtBZXX.Text.Trim) = False Then
                                strErrMsg = strErrMsg + "确认书号为[" + strQRSH + "]！"
                                GoTo errProc
                            End If
...
errProc:
        ...
        Private Sub btnGGFPBL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGGFPBL.Click
            Me.doGGFPBL("btnGGFPBL")
        End Sub

        Private Sub btnGGJSYJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGGJSYJ.Click
            Me.doGGJSYJ("btnGGJSYJ")
        End Sub

        Private Sub btnGGHTBZ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGGHTBZ.Click
            Me.doGGHTBZ("btnGGHTBZ")
        End Sub

        'zengxianglin 2009-05-19
        Private Sub btnZDTZXD_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnZDTZXD.Click
            Me.doZDTZXD("btnZDTZXD")
        End Sub
        'zengxianglin 2009-05-19

        'zengxianglin 2009-05-21
        Private Sub btnZDTZQB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnZDTZQB.Click
            Me.doZDTZQB("btnZDTZQB")
        End Sub
        'zengxianglin 2009-05-21
