...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_qrsmm_info
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsQrsMmInfo
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsQrsMmInfo
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateEsQrsMmInfo)
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsQrsMmInfo
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsQrsMmInfo)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsQrsMmInfo)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getModuleData_MAIN( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemEstateErshou.getDataSet_ES_QRS_MM(strErrMsg, MyBase.UserId, MyBase.UserPassword, strQRSH, "", Me.m_objDataSet_MAIN) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
                ...
                If Me.IsPostBack = False And Me.m_blnSaveScence = False Then
                    With Me.m_objDataSet_MAIN.Tables(strTable)
                        ...
                        Else
                            ...
                            Me.txtQRSH.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH), "")
                            Me.txtDGRQ.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DGRQ), "", "yyyy-MM-dd")
                            ...
                            Me.txtJYRQ.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JHJYRQ), "", "yyyy-MM-dd")
                            ...
                            Me.txtJFDLF.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFDLF), 0.0).ToString("#,##0.00")
                            Me.txtYFDLF.Text = objPulicParameters.getObjectValue(.Rows(0).Item(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFDLF), 0.0).ToString("#,##0.00")
                        ...
                        Select Case Me.m_objenumEditType
                            Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                                Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                                If objsystemEstateErshou.getNewQRSH_MM(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.txtQRSH.Text) = False Then
                                    GoTo errProc
                                End If
...
errProc:
        ...
        Private Sub doOK(ByVal strControlId As String)
            ...
            Try
                ...
                '********************************************************************************************************************
                '本界面不处理的内容
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JHJLRQ, "")
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FKTGYD, "0")
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DJRDM, MyBase.UserId)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DJRMC, MyBase.UserZM)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DJRQ, Now.ToString("yyyy-MM-dd"))
                '********************************************************************************************************************
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_WYBS, Me.htxtWYBS.Value.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH, Me.txtQRSH.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DGRQ, Me.txtDGRQ.Text.Trim)
                '********************************************************************************************************************
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FWDZ, Me.txtFWDZ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JYZJG, Me.txtJYZJG.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JYZMJ, Me.txtJYZMJ.Text.Trim)
                '********************************************************************************************************************
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JHJYRQ, Me.txtJYRQ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_BZXX, Me.txtBZXX.Text.Trim)
                '********************************************************************************************************************
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFDLR, Me.txtJFDLR.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFLXDH, Me.txtJFLXDH.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFLXDZ, Me.txtJFLXDZ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFMC, Me.txtJFMC.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFZZHM, Me.txtJFZZHM.Text.Trim)
                '********************************************************************************************************************
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFDLR, Me.txtYFDLR.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFLXDH, Me.txtYFLXDH.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFLXDZ, Me.txtYFLXDZ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFMC, Me.txtYFMC.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFZZHM, Me.txtYFZZHM.Text.Trim)
                '********************************************************************************************************************
                Dim intValue As Integer = 0
                If Me.rblFKFSYD.SelectedIndex > 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FKFSYD, Me.rblFKFSYD.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_FKFSYD, "0")
                End If
                '********************************************************************************************************************
                If Me.rblJLRQYD.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JLRQYD, Me.rblJLRQYD.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JLRQYD, "0")
                End If
                '********************************************************************************************************************
                If Me.rblSFZFYD.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SFZFYD, Me.rblSFZFYD.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SFZFYD, "0")
                End If
                '********************************************************************************************************************
                If Me.rblJLZKYD.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JLZKYD, Me.rblJLZKYD.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JLZKYD, "0")
                End If
                '********************************************************************************************************************
                If Me.ddlJFZJLB.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFZJLX, Me.ddlJFZJLB.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFZJLX, "0")
                End If
                '********************************************************************************************************************
                If Me.ddlYFZJLB.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFZJLX, Me.ddlYFZJLB.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFZJLX, "0")
                End If
                'zengxianglin 2010-12-27
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KYBH, Me.txtKYBH.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_CCDZ, Me.txtCCDZ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_CCF, Me.txtCCF.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_JFDLF, Me.txtJFDLF.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YFDLF, Me.txtYFDLF.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SSYJ, Me.txtSSYJ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_HZYJ, Me.txtHZYJ.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJJG, Me.txtAJJG.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJYH, Me.txtAJYH.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJCS, Me.txtAJCS.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_AJNX, Me.txtAJNX.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZQN, Me.txtYZQN.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YYQT, Me.txtYYQT.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZDY, Me.txtYZDY.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_MJQN, Me.txtMJQN.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KYQT, Me.txtKYQT.Text.Trim)
                objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KHDY, Me.txtKHDY.Text.Trim)
                If Me.rblYZQC.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZQC, Me.rblYZQC.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZQC, "")
                End If
                If Me.rblYZLY.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZLY, Me.rblYZLY.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_YZLY, "")
                End If
                If Me.rblSHYX.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SHYX, Me.rblSHYX.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SHYX, "")
                End If
                If Me.rblSYWY.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SYWY, Me.rblSYWY.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_SYWY, "")
                End If
                If Me.rblMJQC.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_MJQC, Me.rblMJQC.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_MJQC, "")
                End If
                If Me.rblKHLY.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KHLY, Me.rblKHLY.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_KHLY, "")
                End If
                If Me.rblGMMD.SelectedIndex >= 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_GMMD, Me.rblGMMD.SelectedValue)
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_GMMD, "")
                End If
                'zengxianglin 2010-12-27
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                        Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                        objNewData(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_DGZT) = CType(Josco.JSOA.Common.Data.estateErshouData.enumQuerenshuStatus.Yishen, Integer).ToString
                        objNewData(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_WYBS) = ""
                        objNewData(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH) = ""
                        If objsystemEstateErshou.doSaveData_ES_QRS_MM( _
                        ...
                        End If
                        '记录审计日志
                        strQRSH = objNewData(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH)
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[二手_买卖确认书]中增加了[" + strQRSH + "]！")
                    ...
                    Case Else
                        ...
                        '保存数据
                        Dim objDataRow As System.Data.DataRow = Nothing
                        With Me.m_objDataSet_MAIN.Tables(Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_B_ES_QUERENSHU_MM)
                            If .Rows.Count < 1 Then
                                strErrMsg = "错误：没有确认书！"
                                GoTo errProc
                            Else
                        ...
                        '记录审计日志
                        strQRSH = objNewData(Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_B_ES_QUERENSHU_MM_QRSH)
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[二手_买卖确认书]中[修改]了[" + strQRSH + "]！")
                End Select
