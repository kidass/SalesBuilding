...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_es_bb_esdlqyqkb
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateEsBbEsdlqyqkb
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateEsBbEsdlqyqkb
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateEsBbEsdlqyqkb
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateEsBbEsdlqyqkb)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateEsBbEsdlqyqkb)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按[显示级别]搜索
                Dim strXSJB As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESDLQYQKB_XSJB
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateErshouData.TABLE_DC_VT_ES_BB_ESDLQYQKB
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateErshouData(Josco.JSOA.Common.Data.estateErshouData.enumTableType.DC_VT_ES_BB_ESDLQYQKB)
                    Else
                        '获取参数
                        ...
                        End If
                        '重新检索数据
                        If objsystemEstateErshou.getDataSet_BB_ESDLQYQKB(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ, intType, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
        ...
        Sub grdContent_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles grdContent.ItemDataBound
            ...
            Try
                ...
                Else
                    ...
                    intFZJB = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESDLQYQKB_XSJB)
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.getReportParam(strErrMsg, strKSRQ, strZZRQ, intType) = False Then
                    GoTo errProc
                End If
                Dim strFName As String = Josco.JSOA.Common.Data.estateErshouData.FIELD_DC_VT_ES_BB_ESDLQYQKB_XSJB
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_二手报表_中介部二手代理区域情况表.xls"
                ...
                strMacroName = "$Macro$YYYY$,$Macro$MM$,$Macro$TYPE$,$Macro$KSRQ$,$Macro$ZZRQ$"
                strMacroValue = objZZRQ.Year.ToString + "," + objZZRQ.Month.ToString + "," + strType + "," + strKSRQ + "," + strZZRQ
