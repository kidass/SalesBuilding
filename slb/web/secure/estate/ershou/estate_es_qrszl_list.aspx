<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_es_qrszl_list.aspx.vb" Inherits="Josco.JSOA.web.estate_es_qrszl_list" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>租赁确认书主窗口</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmestate_es_qrszl_list" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow1">
									<TD class="title" align="center" colSpan="3" height="30">【<%=propRYMC%>】能查看的租赁确认书一览表<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
											...
											<TR>
												<TD>
													<DIV id="divQRS" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 405px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 405px">
														<asp:datagrid id="grdQRS" runat="server" CssClass="label" Width="7290px"
															...
															<Columns>
																...
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="订购状态" SortExpression="订购状态" HeaderText="订购状态" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="交易总租金" SortExpression="交易总租金" HeaderText="交易总租金" CommandName="Select" DataTextFormatString="{0:#,###.00}" ItemStyle-HorizontalAlign="Right">
																...
																<asp:ButtonColumn ItemStyle-Width="160px" DataTextField="交易月租金" SortExpression="交易月租金" HeaderText="交易月租金" CommandName="Select" DataTextFormatString="{0:#,###.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="160px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="160px" DataTextField="租赁保证金" SortExpression="租赁保证金" HeaderText="租赁保证金" CommandName="Select" DataTextFormatString="{0:#,###.00}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="160px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="缴租日" SortExpression="缴租日" HeaderText="缴租日" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="租期月数" SortExpression="租期月数" HeaderText="租期月数" CommandName="Select">
																...
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="代理费折扣" SortExpression="代理费折扣" HeaderText="代理费折扣" CommandName="Select" DataTextFormatString="{0:#.00%}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="0px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="滞纳金比例" SortExpression="滞纳金比例" HeaderText="滞纳金比例" CommandName="Select" DataTextFormatString="{0:#.00%}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="0px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="年递增比例" SortExpression="年递增比例" HeaderText="年递增比例" CommandName="Select" DataTextFormatString="{0:#.00%}" ItemStyle-HorizontalAlign="Right">
																	<HeaderStyle Width="0px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="交楼状况说明" SortExpression="交楼状况说明" HeaderText="交楼状况说明" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="付租方式约定" SortExpression="付租方式约定" HeaderText="付租方式约定" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="租期约定" SortExpression="租期约定" HeaderText="租期约定" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="租金托管约定" SortExpression="租金托管约定" HeaderText="租金托管约定" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
														...
														</asp:datagrid><INPUT id="htxtQRSFixed" type="hidden" value="0" runat="server"></DIV>
												</TD>
											</TR>
											<TR id="trRow3">
												<TD class="label">
			...
			<table cellSpacing="0" cellPadding="0" align="center" border="0">
				<tr>
					<td>
						...
						<input id="htxtQRSQuery" type="hidden" runat="server">
						<input id="htxtQRSRows" type="hidden" runat="server">
						<input id="htxtQRSSort" type="hidden" runat="server">
						<input id="htxtQRSSortColumnIndex" type="hidden" runat="server">
						<input id="htxtQRSSortType" type="hidden" runat="server">
						<input id="htxtDivLeftQRS" type="hidden" runat="server">
						<input id="htxtDivTopQRS" type="hidden" runat="server">
