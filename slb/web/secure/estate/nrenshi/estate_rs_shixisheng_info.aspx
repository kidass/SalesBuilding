<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_shixisheng_info.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_shixisheng_info" %>
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>人事实习生审批单的显示或编辑窗</title>
                                            ...
                                            <TABLE cellSpacing="0" cellPadding="0" align="center" border="0">
                                                <TR>
                                                    <TD>
                                                        <TABLE cellSpacing="0" cellPadding="0"  border="0">
                                                            <TR>
                                                                <TD vAlign="middle" align="center" height="32"><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: 28px; COLOR: red; FONT-FAMILY: 宋体"><%=Josco.JsKernal.Common.jsoaConfiguration.LicencingTo%>实习生审批表</SPAN></TD>
                                                            </TR>
                                                            <TR>
                                                                <TD height="10"></TD>
                                                            </TR>
                                                                        ...
                                                                        <TR>
                                                                            ...
                                                                            <td align="left">
								                                                <asp:RadioButtonList id="rblRYZT" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Horizontal" RepeatLayout="Table">
									                                                ...
									                                                <asp:ListItem Value="4" Selected="True">实习生</asp:ListItem>									                                                
								                                                </asp:RadioButtonList><asp:TextBox ID="txtZPSM" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox>
							                                                </td>   
							                                                 <td class="label" align="right">网络技能分数</td>
                                                                            <td align="left" ><asp:TextBox ID="txtWLJNFS" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                            <td class="label" align="right">招聘渠道</td>
                                                                            <td align="left"><asp:DropDownList ID="ddlZPQD" Runat="server" CssClass="textbox" Columns="16"></asp:DropDownList></td>        
                                                                        </TR>
                                                                         <TR>
                                                                            <TD class="label" align="right">标题：</TD>
                                                                            <TD align="left" colspan="5"><asp:TextBox id="txtWJBT" Runat="server" CssClass="textbox" >实习生申请单</asp:TextBox></TD>
                                                                           <td> <asp:RadioButtonList id="rblSFZB" Runat="server" CssClass="textbox" RepeatColumns="2" RepeatDirection="Horizontal" RepeatLayout="Table">
                                                                         ...
                                                                         <TR>
                                                                            <TD >
                                                                                <DIV id="divRYXX" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 860px; CLIP: rect(0px 860px 200px 0px); HEIGHT: 200px">
                                                                                    <asp:datagrid id="grdRYXX" runat="server" Width="2400px" CssClass="labelGrid" 
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:ButtonColumn ItemStyle-Width="140px" DataTextField="拟分配部门" SortExpression="拟分配部门" HeaderText="拟分配部门" CommandName="Select">
                                                                                             ...
                                                                                             <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="部门经理" SortExpression="部门经理" HeaderText="所属团队经理" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>
                                                                                            ...
                                                                                            <asp:ButtonColumn ItemStyle-Width="80px" DataTextField="团队编号" SortExpression="团队编号" HeaderText="团队编号" CommandName="Select">
                                                                                                <HeaderStyle Width="80px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>
                                                                                            <asp:ButtonColumn ItemStyle-Width="80px" DataTextField="人员代码" SortExpression="人员代码" HeaderText="人员代码" CommandName="Select">
                                                                                                <HeaderStyle Width="80px"></HeaderStyle>
                                                                                            </asp:ButtonColumn> 
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="联系电话" SortExpression="联系电话" HeaderText="联系电话" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>  
                                                                                             <asp:ButtonColumn ItemStyle-Width="120px" DataTextField="身份证号码" SortExpression="身份证号码" HeaderText="身份证号码" CommandName="Select">
                                                                                            ...
                                                                                            <asp:ButtonColumn ItemStyle-Width="120px" DataTextField="就读学校" SortExpression="就读学校" HeaderText="就读学校" CommandName="Select">
                                                                                                <HeaderStyle Width="120px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>
                                                                                             <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="专业" SortExpression="专业" HeaderText="专业" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>     
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="人员学历" SortExpression="人员学历" HeaderText="学历" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>        
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="人员类型名称" SortExpression="人员类型名称" HeaderText="入职类型" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn> 
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="人员状态名称" SortExpression="人员状态名称" HeaderText="人员状态" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>     
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="招聘说明" SortExpression="招聘说明" HeaderText="招聘说明" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>                                                                                                 
                                                                                            <asp:ButtonColumn ItemStyle-Width="60px" DataTextField="占编" SortExpression="占编" HeaderText="是否占编" CommandName="Select">
                                                                                                <HeaderStyle Width="60px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>                                                                                  
                                                                                            ...
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="工资待遇" SortExpression="工资待遇" HeaderText="工资待遇" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>                                                                                                
                                                                                            </asp:ButtonColumn>  
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="审批说明" SortExpression="审批说明" HeaderText="审核说明" CommandName="Select">
                                                                                             ...
                                                                                             <asp:ButtonColumn ItemStyle-Width="80px" DataTextField="审批状态" SortExpression="审批状态" HeaderText="审核状态" CommandName="Select">
                                                                                                <HeaderStyle Width="80px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>
                                                                                            <asp:ButtonColumn ItemStyle-Width="80px" DataTextField="审批人" SortExpression="审批人" HeaderText="审核人" CommandName="Select">
                                                                                                <HeaderStyle Width="80px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0"  border="1" width="100%" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                                    <tr>
                                                                                        <td class="labelNotNull" align="right">姓名</td>
                                                                                        ...
                                                                                        <td align="left"><asp:TextBox ID="txtRYDM" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                                        <td class="labelNotNull" align="right">联系电话</td>
                                                                                        <td align="left"><asp:TextBox ID="txtLXDH" runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                                        <td class="labelNotNull" align="right">身份证号码</td>
                                                                                        <td align="left"><asp:TextBox ID="txtSFZHM" Runat="server" CssClass="textbox" Columns="20" OnTextChanged="txtSFZHM_TextChanged" AutoPostBack="true"></asp:TextBox></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="labelNotNull" align="right">入职类型</td>
													                                    <td align="left" ><asp:DropDownList id="ddlYDYY" Runat="server" CssClass="textbox" Columns="12"></asp:DropDownList></td>
												                                        <td class="label" align="right">性别</td>
                                                                                        <td align="left"><asp:RadioButtonList ID="rblRYXB" Runat="server" CssClass="textbox" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Flow"><asp:ListItem Value="男" Selected="True">男</asp:ListItem><asp:ListItem Value="女">女</asp:ListItem></asp:RadioButtonList></td>
                                                                                        <td class="label" align="right">年龄</td>
                                                                                        <td align="left"><asp:TextBox ID="txtRYNN" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                                        <td class="label" align="right">学历</td>
                                                                                        <td align="left"><asp:DropDownList ID="ddlXL" Runat="server" CssClass="textbox" Columns="16"></asp:DropDownList></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left"><asp:DropDownList id="ddlZPSM" Runat="server" CssClass="textbox" Columns="12">
                                                                                                 <asp:ListItem Value="补员" Selected="True">补员</asp:ListItem>
															                                    <asp:ListItem Value="增员">增员</asp:ListItem>
															                                    <asp:ListItem Value="置换">置换</asp:ListItem>
                                                                                                </asp:DropDownList></td>
                                                                                         <td class="label" align="right">就读学校</td>
                                                                                        <td align="left"><asp:TextBox ID="txtJDXX" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                                         <td class="label" align="right">专业</td>
                                                                                        <td align="left"><asp:TextBox ID="txtZY" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                                                                                                                             
                                                                                    </tr>
                                                                                    <tr>
                                                                                         <td class="label" align="right">拟担任职位</td>
                                                                                        <td align="left" ><asp:DropDownList id="ddlZJDM" Runat="server" CssClass="textbox" Columns="16"></asp:DropDownList></td>
                                                                                         <td class="label" align="right">所属团队经理</td>                                                                                        
                                                                                        <td align="left" ><asp:TextBox ID="txtBMJL" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox><asp:Button id="btnSelect_ZZDM" Runat="server" CssClass="button" Text="…"></asp:Button></td>
                                                                                         <td class="label" align="right">拟分配部门</td>
                                                                                        <td align="left" ><asp:TextBox ID="txtNFPBM" Runat="server" CssClass="textbox" Columns="16" ReadOnly="true"></asp:TextBox><input id="htxtSSDW" type="hidden" size="1" runat="server" name="htxtSSDW" /><asp:Button id="btnFPBM" Runat="server" CssClass="button" Text="…"></asp:Button></td>
                                                                                   ...
                                                                                   <tr>                                                                                            
													                                    ...
													                                    <td class="label" align="right">现有人员</td>
                                                                                        <td align="left"><asp:TextBox ID="txtXYRYS" Runat="server" CssClass="textbox" Columns="16" ReadOnly="true"></asp:TextBox></td>
                                                                                        <td class="label" align="right">定编人数</td>
                                                                                        <td align="left"><asp:TextBox ID="txtDBRYS" Runat="server" CssClass="textbox" Columns="16" ReadOnly="true"></asp:TextBox></td> 
                                                                                    </tr>                                           
                                                                                    <tr>
                                                                                        <td colspan="8" align="right"><asp:CheckBox id="chkQZTJ" Runat="server" CssClass="textbox" Text="强制"  AutoPostBack="True"></asp:CheckBox><asp:Button ID="btnRYXX_NewJLBH" Runat="server" CssClass="button" Text=" 清 空 "></asp:Button><asp:Button ID="btnRYXX_AddNew" Runat="server" CssClass="button" Text="增加人员"></asp:Button><asp:Button ID="btnRYXX_Update" Runat="server" CssClass="button" Text="更改人员"></asp:Button><asp:Button ID="btnRYXX_Delete" Runat="server" CssClass="button" Text="删除人员"></asp:Button></td>
                                                                                    </tr>
                                                                                </table>
                                                                                ...
                                                                                <table cellpadding="0"  cellspacing="0" width="100%"  border="1" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                                    <tr>
                                                                                        <td>&nbsp;</td>
                                                                                        <td class="labelNotNull" align="right">审批说明
                                                                                ...
                                                                                <% If propTGMode = False Then Response.Write("<div style='display:none'>")%>
                                                                                    <table cellpadding="0" cellspacing="0" width="100%"  border="1" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                                        <tr>
                                                                                            <td >&nbsp;</td>
                                                                                            <td class="label" align="right">工资待遇<asp:TextBox ID="txtGZDY" Runat="server" CssClass="textbox" Columns="30"></asp:TextBox>报到日期                                                                                                
                                                                                            <asp:TextBox ID="txtNBDRQ" Runat="server" CssClass="textbox" Columns="20"></asp:TextBox>   
												                                            <asp:CheckBox id="chkSFJZ" Runat="server" CssClass="textbox" Text="兼职"  AutoPostBack="True"></asp:CheckBox>
                                                                                    ...
                                                                                    <tr>
																                        ...
																                        <td  valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_FH" Runat="server" CssClass="button">营业经理意见</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_FHBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="30"></td>
																			                        <td><div id="divFHYJ" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 180px; CLIP: rect(0px 180px 100px 0px); HEIGHT: 100px"><asp:label id="lblFHYJ" Runat="server" CssClass="label">lblFHYJ</asp:label></DIV></td>
																		                        </tr>	
																	                        </table>
																                        </td>
																                        ...
																                        <td valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_QF" Runat="server" CssClass="button">区域经理审批</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_QFBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="20"></td>
																                        ...
																                        <td valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_SH" Runat="server" CssClass="button">中介部审批</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_SHBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="20"></td>
																                        ...
																                        <td valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_HQ" Runat="server" CssClass="button">办公室审批</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_HQBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="20"></td>
