<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_lztz_info.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_lztz_info" %>
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>人事离职审批单的显示或编辑窗</title>
                                            ...
                                            <TABLE cellSpacing="0" cellPadding="0" align="center" border="0">
                                                <TR>
                                                    <TD>
                                                        <TABLE cellSpacing="0" cellPadding="0"  border="0">
                                                            <TR>
                                                                <TD vAlign="middle" align="center" height="32"><SPAN style="FONT-WEIGHT: bold; FONT-SIZE: 28px; COLOR: red; FONT-FAMILY: 宋体">兴业公司人员离职审批表</SPAN></TD>
                                                            </TR>
                                                            <TR>
                                                                <TD height="10"></TD>
                                                            </TR>
                                                                    ...
                                                                    <TABLE cellSpacing="0" cellPadding="0"  border="0">
                                                                        <tr>
                                                                         ...
                                                                         <tr>
                                                                            ...
                                                                            <td><asp:TextBox ID="txtSJLDMC" runat="server"></asp:TextBox></td>
                                                                         </tr> 
                                                                         <tr>
                                                                            <td class="labelNotNull" align="right" rowspan="2">新的职级：</TD>
						                                                    <td align="left" rowspan="2"><asp:DropDownList id="ddlZJDM" Runat="server" CssClass="textbox" Width="120px"></asp:DropDownList></TD>
					                                                        <td class="labelNotNull" align="right" rowspan="2">新的单位：</TD>
						                                                    <td class="label" align="left" rowspan="2"><asp:TextBox id="txtSSDW" Runat="server" CssClass="textbox" Columns="12" ReadOnly="True"></asp:TextBox><INPUT id="htxtSSDW" type="hidden" size="1" runat="server" NAME="htxtSSDW"><asp:Button id="btnSelectZZDM" Runat="server" CssClass="button" Text="…"></asp:Button></TD>
					                                                        <td class="labelNotNull" align="right" rowspan="2">新的团队：</TD>
						                                                    <td class="label" align="left" rowspan="2"><asp:TextBox id="txtTDBH" Runat="server" CssClass="textbox" Columns="12"></asp:TextBox><asp:Button id="btnSelectTDBH" Runat="server" CssClass="button" Text="…"></asp:Button></TD>
                                                            ...
                                                            <TR>
                                                                <TD align="center">
                                                                    <table cellspacing="0" cellpadding="0" border="1" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                         <TR>
                                                                            <TD >
                                                                                <DIV id="divRYXX" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 860px; CLIP: rect(0px 860px 300px 0px); HEIGHT: 300px">
                                                                                    <asp:datagrid id="grdRYXX" runat="server" Width="1200px" CssClass="labelGrid" 
                                                                                        ...
                                                                                        <Columns>
																                            ...
																                            <asp:ButtonColumn ItemStyle-Width="120px" DataTextField="离职日期" SortExpression="离职日期" HeaderText="离职日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
                                                                                            ...
                                                                                            <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="单位名称" SortExpression="单位名称" HeaderText="单位名称" CommandName="OpenDocument">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn> 
                                                                                            ...
                                                                                            <asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="上级领导名称" SortExpression="上级领导名称" HeaderText="上级领导名称" CommandName="Select">
                                                                                                <HeaderStyle Width="0px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>  
                                                                        ...
                                                                        <tr>
                                                                            <td align="left">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0"  border="1" width="100%" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                                    <tr>
                                                                                        <td class="label" align="right">离职日期</td>
								                                                        <td><asp:TextBox ID="txtNBDRQ" Runat="server" CssClass="textbox" Columns="20"></asp:TextBox></td> 
                                                                                        ...
                                                                                        <td class="label" align="right">人员状态</td>
								                                                    ...
								                                                    <tr>
								                                                        ...
								                                                        <td class="label" align="right">职级名称</td>
                                                                                        ...
                                                                                        <td class="label" align="right">团队</td>
                                                                                        <td align="left"><asp:TextBox ID="txtYTD" Runat="server" CssClass="textbox" Columns="16" ReadOnly="true"></asp:TextBox></td>                                                                                        
                                                                                    </tr>                                                                                                                  
                                                                                    <tr>
                                                                                        <td colspan="8" align="right"><asp:Button ID="btnRYXX_AddNew" Runat="server" CssClass="button" Text="增加人员"></asp:Button><asp:Button ID="btnRYXX_Delete" Runat="server" CssClass="button" Text="删除人员"></asp:Button></td>
                                                                                    </tr>
                                                                                </table>
                                                                                ...
                                                                                <% If propTGMode = False Then Response.Write("<div style='display:none'>")%>
                                                                                    <table cellpadding="0" cellspacing="0" width="100%"  border="1" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                                        <tr>
                                                                                            ...
                                                                                            <asp:Button ID="btnBTG" Runat="server" CssClass="button" Text="不通过"></asp:Button>
                                                                                            <asp:Button ID="btnTG" Runat="server" CssClass="button" Text=" 通过 "></asp:Button>
                                                                                            </td>                                                                                 
                                                                                        </tr>                                                                                        
                                                                                     </table> 
                                                                                       ...
                                                                                       <td>&nbsp;</td>
																                        <td  valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_FH" Runat="server" CssClass="button">处理意见</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_FHBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="30"></td>
																			                        <td><div id="divFHYJ" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 540px; CLIP: rect(0px 540px 100px 0px); HEIGHT: 100px"><asp:label id="lblFHYJ" Runat="server" CssClass="label">lblFHYJ</asp:label></div></td>
																		                        </tr>	
																	                        </table>
																                        </td>
                                                                                    </tr>
                                                                                    ...
                                                                                    <tr>
																                        ...
																                        <td valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_QF" Runat="server" CssClass="button">售楼部经理审批</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_QFBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="20"></td>
																                        ...
																                        <td valign="top">
																	                        <table cellspacing="0" cellpadding="0" border="0">
																		                        ...
																		                        <tr>
																			                        <td colspan="2" height="20">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton id="lnkCZQSYJ_SH" Runat="server" CssClass="button">销售中心审批</asp:LinkButton><asp:LinkButton id="lnkCZQSYJ_SHBJ" Runat="server" CssClass="button">(有便笺)</asp:LinkButton></td>
																		                        </tr>
																		                        <tr>
																			                        <td width="20"></td>
