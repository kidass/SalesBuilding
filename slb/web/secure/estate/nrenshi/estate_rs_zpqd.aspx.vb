...
Partial Public Class estate_rs_zpqd
...
#End Region
        ...
        Private m_strQuery As String '记录m_objestateRenshiXingyeData的搜索串
        Private m_intRows As Integer '记录m_objestateRenshiXingyeData的DefaultView记录数
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                With objPulicParameters
                    ...
                    'm_objestateRenshiXingyeData的搜索串
                    Me.m_strQuery = Me.htxtQuery.Value

                    '记录m_objestateRenshiXingyeData的DefaultView记录数
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strKHLXDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_DM
                ...
                '按名称搜索
                Dim strKHLXMC As String = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_MC
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                '释放资源
                If Not (Me.m_objestateRenshiXingyeData Is Nothing) Then
                    Me.m_objestateRenshiXingyeData.Dispose()
                    Me.m_objestateRenshiXingyeData = Nothing
                End If

                '重新检索数据
                With New Josco.JSOA.BusinessFacade.systemEstateRenshiXingye
                    If .getZhaopinqudaoData(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateRenshiXingyeData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_DM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_MC)
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_DM, Me.txtKHLXDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_MC, Me.txtKHLXMC.Text)
                ...
                Select Case Me.m_objenumEditType
                    ...
                    Case Else
                        ...
                        End With
                        With Me.m_objestateRenshiXingyeData.Tables(Josco.JSOA.Common.Data.estateRenshiXingyeData.TABLE_DC_B_RS_ZHAOPINQUDAO)
                ...
                '保存信息
                With New Josco.JSOA.BusinessFacade.systemEstateRenshiXingye
                    If .doSaveZhaopinqudaoData(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHAOPINQUDAO_MC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            ...
                            '删除处理
                            If objsystemEstateRenshiXingye.doDeleteZhaopinqudaoData(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If
