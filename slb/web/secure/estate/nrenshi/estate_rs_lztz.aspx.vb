...
Namespace Josco.JSOA.web
    ...
    '
    ' 接口参数：
    '     参见接口类IEstateRsTiaozhengMain描述
    '----------------------------------------------------------------

    Partial Class estate_rs_lztz
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_WJBT
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_BLZT
                ...
                strQFRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_RUZHISHENPI_QFRQ + ",120)"
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.TABLE_DC_B_RS_LIZHISHENPI
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectRenshiLiZhi.getDataSet_Main(strErrMsg, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL) = False Then
                    GoTo errProc
                End If
