...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_shixisheng
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBT
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_BLZT
                ...
                strQFRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_QFRQ + ",120)"
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.TABLE_DC_B_RS_SHIXISHENGSHENPI
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getDataSet_Main(strErrMsg, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL) = False Then
                    GoTo errProc
                End If
