...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_lztz_info
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objsystemFlowObjectRenshiLiZhi As Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi
                        ...
                        Case "btnSelectXM".ToUpper()
                            ...
                            If objIDmxzRyjg.oExitMode = True Then
                                ...
                                With objDataSet_RYJG.Tables(0).DefaultView
                                    ...
                                    End If
                                    'Me.txtYZBQK.Text = objPulicParameters.getObjectValue(.Item(0).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YZB), "")
...
errProc:
        ...
        Private Function getModuleData_Main( _
            ...
            Try
                '创建工作流对象
                Dim strType As String = Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.FLOWCODE
                Dim strName As String = Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.FLOWNAME
                ...
                Me.m_objsystemFlowObjectRenshiLiZhi = CType(objsystemFlowObject, Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi)

                '工作流对象初始化并填充数据
                If Me.m_objsystemFlowObjectRenshiLiZhi.doInitialize(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWJBS, True) = False Then
                    GoTo errProc
                End If

                '计算可执行的操作
                If Me.m_objsystemFlowObjectRenshiLiZhi.getCanExecuteCommand(strErrMsg, MyBase.UserId, MyBase.UserXM, MyBase.UserBmdm) = False Then
                    GoTo errProc
                End If
        ...
        Private Function getModuleData_FJ( _
            ...
            Try
                ...
                Else
                    ...
                    '重新检索数据
                    If Me.m_objsystemFlowObjectRenshiLiZhi.getFujianData(strErrMsg, Me.m_objDataSet_FJ) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function getModuleData_XGWJ( _
            ...
            Try
                ...
                Else
                    ...
                    '重新检索数据
                    If Me.m_objsystemFlowObjectRenshiLiZhi.getXgwjData(strErrMsg, Me.m_objDataSet_XGWJ) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function getModuleData_RYXX( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.TABLE_DC_B_RS_LIZHI_RENYUANXINXI
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            ...
            Try
                ...
                Else
                    ...
                    Select Case Me.m_objenumEditType
                        Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                            If Me.m_objsystemFlowObjectRenshiLiZhi.getDataSet_RYXX(strErrMsg, MyBase.UserXM, Me.m_objDataSet_RYXX) = False Then
                                GoTo errProc
                            End If
                        Case Else
                            If Me.txtJBRY.Text.Trim = MyBase.UserXM Then
                                If Me.m_objsystemFlowObjectRenshiLiZhi.getDataSet_RYXX(strErrMsg, Me.m_objDataSet_RYXX, blnSFJB) = False Then
                                    GoTo errProc
                                End If
                            Else
                                If Me.m_objsystemFlowObjectRenshiLiZhi.getDataSet_RYXX(strErrMsg, MyBase.UserXM, Me.m_objDataSet_RYXX) = False Then
...
errProc:
        ...
        Private Function showEditPanelInfo( _
            ...
            Try
                objBaseFlowRenshiLiZhi = CType(Me.m_objsystemFlowObjectRenshiLiZhi.FlowData, Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi)
                ...
                Else
                    If Me.IsPostBack = False Or (Me.IsPostBack = True And Me.m_blnEditMode = False) Then
                        ...
                        Me.ddlJJCD.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlJJCD, objBaseFlowRenshiLiZhi.JJCD)
                        Me.ddlMMDJ.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlMMDJ, objBaseFlowRenshiLiZhi.MMDJ)
                        Me.txtJGDZ.Text = objBaseFlowRenshiLiZhi.JGDZ
                        Me.txtWJNF.Text = objBaseFlowRenshiLiZhi.WJNF
                        Me.txtWJXH.Text = objBaseFlowRenshiLiZhi.WJXH
                        Me.txtWJBT.Text = objBaseFlowRenshiLiZhi.WJBT
                        'Me.txtDBRS.Text = objBaseFlowRenshiLiZhi.DBRS.ToString
                        Me.txtBZXX.Text = objBaseFlowRenshiLiZhi.BEIZ
                        If objBaseFlowRenshiLiZhi.DDSZ = 1 Then
                            Me.chkDDSZ.Checked = True
                        Else
                            Me.chkDDSZ.Checked = False
                        End If
                        Me.txtJBDW.Text = objBaseFlowRenshiLiZhi.ZBDW
                        Me.txtJBRY.Text = objBaseFlowRenshiLiZhi.NGR
                        Me.txtJBRQ.Text = objPulicParameters.doDateToString(objBaseFlowRenshiLiZhi.NGRQ, "yyyy-MM-dd")
                        Me.txtLSH.Text = objBaseFlowRenshiLiZhi.LSH
                        Me.htxtWJBS.Value = objBaseFlowRenshiLiZhi.WJBS
                        ...
                        Dim strTemp As String = objBaseFlowRenshiLiZhi.WJBT
                        Dim lendf As Integer

                        intTemp_start = InStr(1, objBaseFlowRenshiLiZhi.WJBT, "(")
                        intTemp_end = InStr(1, objBaseFlowRenshiLiZhi.WJBT, ")")
                        ...
                        Select Case Me.m_objenumEditType
                            Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                                ...
                                If Me.m_objsystemFlowObjectRenshiLiZhi.getNewWjxh(strErrMsg, Me.txtJGDZ.Text, Me.txtWJNF.Text, strWJXH) = False Then
                                Else
                                ...
                                If Me.m_objsystemFlowObjectRenshiLiZhi.getNewLSH(strErrMsg, strLSH) = False Then
                                    Me.txtLSH.Text = ""
                                Else
                                ...
                                Me.txtWJBT.Text = Now.ToString("yyyyMMdd") & strLSH & MyBase.UserBmmc & "离职申请单"

                                strLSH = ""
                                If Me.m_objsystemFlowObjectRenshiLiZhi.getNewWJBS(strErrMsg, strLSH) = False Then
                                    Me.htxtWJBS.Value = ""
                                Else
                ...
                '根据文件内容随时更新
                'Me.lblQFR.Text = objBaseFlowRenshiLiZhi.QFR
...
errProc:
        ...
        Private Function showModuleData_ReadMode(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                'Me.lnkCZCYQPWJ.Enabled = Not blnEditMode And (objBaseFlowRenshiLiZhi.HJWJ <> "")
                'Me.lnkCZCYZSWJ.Enabled = Not blnEditMode And (objBaseFlowRenshiLiZhi.PJYJ <> "")
                ...
                '必须先接收？
                '
                If Me.m_objsystemFlowObjectRenshiLiZhi.pmMustJieshou = True Then
                    '接收文件
                ...
                '正常操作
                '
                With Me.m_objsystemFlowObjectRenshiLiZhi
                    '********************************************************
                    ...
                    If .mlWYYZ = True Then
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doIReadFile(strErrMsg, MyBase.UserXM) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        Private Function showModuleData_EditMode(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                'Me.lnkCZCYQPWJ.Enabled = blnEditMode And (objBaseFlowRenshiLiZhi.HJWJ <> "")
                'Me.lnkCZCYZSWJ.Enabled = blnEditMode And (objBaseFlowRenshiLiZhi.PJYJ <> "")
...
errProc:
        ...
        Private Function showOpinion( _
            ...
            Try
                ...
                '获取可查看的意见
                If Me.m_objsystemFlowObjectRenshiLiZhi.getOpinionData(strErrMsg, MyBase.UserXM, objOpinionData) = False Then
                    GoTo errProc
                End If

                '显示区域经理意见
                strYJLX = objBaseFlowRenshiLiZhi.TASK_QFWJ
                If Me.m_objsystemFlowObjectRenshiLiZhi.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                ...
                '显示部门经理
                strYJLX = objBaseFlowRenshiLiZhi.TASK_FHWJ
                If Me.m_objsystemFlowObjectRenshiLiZhi.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                strQSYJ = objPulicParameters.doConvertToHtml(strQSYJ)
                ...
                '显示中介部意见
                strYJLX = objBaseFlowRenshiLiZhi.TASK_SHWJ
                If Me.m_objsystemFlowObjectRenshiLiZhi.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                strQSYJ = objPulicParameters.doConvertToHtml(strQSYJ)
                ...
                '显示办公室意见
                strYJLX = objBaseFlowRenshiLiZhi.TASK_HQWJ
                If Me.m_objsystemFlowObjectRenshiLiZhi.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                strQSYJ = objPulicParameters.doConvertToHtml(strQSYJ)
...
errProc:
        ...
        Private Function doDeleteCacheFile(ByRef strErrMsg As String) As Boolean
            ...
            If Me.doDeleteCacheFile_GJ(strErrMsg) = False Then
                '可以不成功，形成垃圾文件！
            End If
            If Me.m_objsystemFlowObjectRenshiLiZhi.doDeleteCacheFile_FJ(strErrMsg, Me.m_objDataSet_FJ) = False Then
                '可以不成功，形成垃圾文件！
            End If
            If Me.m_objsystemFlowObjectRenshiLiZhi.doDeleteCacheFile_XGWJ(strErrMsg, Me.m_objDataSet_XGWJ) = False Then
                '可以不成功，形成垃圾文件！
            End If
...
errProc:
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            Try
                Dim strWJBS As String = Me.m_objsystemFlowObjectRenshiLiZhi.FlowData.WJBS
                ...
                If Me.IsPostBack = False And Me.m_blnSaveScence = False Then
                    ...
                    If Me.m_blnEditMode = False Then
                        ...
                        If Me.m_objInterface.iWJBS <> "" Then
                            '自动解除自己的文件封锁
                            If Me.m_objsystemFlowObjectRenshiLiZhi.doLockFile(strErrMsg, MyBase.UserId, False) = False Then
                                GoTo errProc
                            End If
                        End If
                        If Me.m_objsystemFlowObjectRenshiLiZhi.mlJSWJ = True Then
                            '自动接收文件
...
errProc:
        ...
        Private Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Unload
            Josco.JSOA.BusinessFacade.systemFlowObjectRenshiLiZhi.SafeRelease(Me.m_objsystemFlowObjectRenshiLiZhi)
        End Sub
                ...
                Select Case e.CommandName.ToUpper
                    Case "OpenDocument".ToUpper
                        ...
                        Else
                            ...
                            If Me.m_objsystemFlowObjectRenshiLiZhi.getCanAutoEnterEditMode( _
                                strErrMsg, _
                                MyBase.UserId, _
                                Me.m_blnEditMode, _
...
errProc:
        ...
        Private Function doOpenFJ( _
            ...
            Try
                ...
                If Me.m_objsystemFlowObjectRenshiLiZhi.isFileSendOnce(strErrMsg, blnHasSendOnce) = False Then
                    GoTo errProc
                End If
                ...
                With objIFlowFujianInfo
                    ...
                    .iTrackRevisions = Me.m_objsystemFlowObjectRenshiLiZhi.swgjShowTrackRevisions And blnHasSendOnce
                    .iFlowTypeName = Me.m_objsystemFlowObjectRenshiLiZhi.FlowData.FlowTypeName
                    .iWJBS = Me.m_objsystemFlowObjectRenshiLiZhi.FlowData.WJBS
                    .iRow = objDataRow
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    Select Case Me.m_objInterface.iEditMode
                        ...
                        Case Else
                            '解除文件编辑封锁
                            If Me.m_objsystemFlowObjectRenshiLiZhi.doLockFile(strErrMsg, "", False) = False Then
                                GoTo errProc
                            End If
        ...
        Private Function doModify(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strRYMC As String
                    Dim blnDo As Boolean
                    If Me.m_objsystemFlowObjectRenshiLiZhi.getFileLocked(strErrMsg, blnDo, strBMMC, strRYMC) = False Then
                        GoTo errProc
                    End If
                    If blnDo = True Then
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    If blnOK = True Then
                        '进行编辑封锁
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doLockFile(strErrMsg, MyBase.UserId, True) = False Then
                            GoTo errProc
                        End If
...
errProc:
        ...
        Private Function doSave(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                '获取记录旧值
                objOldData = Me.m_objsystemFlowObjectRenshiLiZhi.FlowData
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                        Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                    Case Else
                        If Me.m_objsystemFlowObjectRenshiLiZhi.getFujianData(strErrMsg, objOldFJData) = False Then
                            GoTo errProc
                        End If
                        If Me.m_objsystemFlowObjectRenshiLiZhi.getXgwjData(strErrMsg, objOldXGWJData) = False Then
                            GoTo errProc
                        End If
                End Select
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                        Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "创建了[" + strWJBS + "]文件！") = False Then
                            '忽略
                        End If
                    Case Else
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "改动了[" + strWJBS + "]文件！") = False Then
                            '忽略
                        End If
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doWriteUserLog_Fujian(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Me.m_objDataSet_FJ, objOldFJData) = False Then
                            '忽略
                        End If
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doWriteUserLog_XGWJ(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Me.m_objDataSet_XGWJ, objOldXGWJData) = False Then
                            '忽略
                        End If
                End Select

                '进入查看状态
                Me.m_objsystemFlowObjectRenshiLiZhi.FlowData.WJBS = strWJBS
                Me.m_objInterface.iEditMode = Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eSelect
...
errProc:
        ...
        Private Sub doOpenGJ(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.m_objsystemFlowObjectRenshiLiZhi.getGJFile(strErrMsg, Me.m_blnEditMode, strCacheFile, strMBPath, strGJPath, strGJFile) = False Then
                    GoTo errProc
                End If
                ...
                With objIFlowEditWord
                    ...
                    .iobjNewData = Nothing
                    '************************************************************************************************
                    .iCanQSYJ = Me.m_objsystemFlowObjectRenshiLiZhi.mlTXYJ
                    If .iCanQSYJ = False Then
                        .iCanQSYJ = Me.m_objsystemFlowObjectRenshiLiZhi.mlBDPS
                        If .iCanQSYJ = False Then
                            '不能签署意见，接口缺省参数
                        Else
                            '补登领导批示
                    ...
                    '稿件界面控制参数
                    .iTrackRevisions = Me.m_objsystemFlowObjectRenshiLiZhi.swgjShowTrackRevisions And blnHasSendOnce
                    .iCanExportGJ = Me.m_objsystemFlowObjectRenshiLiZhi.swgjExportFile
                    .iCanImportGJ = Me.m_objsystemFlowObjectRenshiLiZhi.swgjImportFile
                    .iCanSelectTGWJ = Me.m_objsystemFlowObjectRenshiLiZhi.swgjSelectGJ
...
errProc:
        ...
        Private Function doSendFile(ByRef strErrMsg As String, ByVal strControlId As String, ByVal blnWTFS As Boolean) As Boolean
            ...
            Try
                ...
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备发送离职人员申请吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    'objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_LZRQ, Me.txtNBDRQ.Text)
                    ...
                    For i = intRows - 1 To 0 Step -1
                        With Me.m_objDataSet_RYXX.Tables(strTable)
                            ...
                            If Not (objDataRow Is Nothing) Then
                                objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPSM, Me.txtSPSM.Text)
                                objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPR, MyBase.UserXM)
                                objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPRQ, Now.ToString())
                                objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPJG, "1")


                                strWYBS = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WYBS), "")
                                objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WYBS, strWYBS)

                                intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYXM)
                                strRYMC = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_LZRQ)
                                strRQ = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YYDM)
                                strYDYY = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YYMC)
                                strYDMC = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPR)
                                ...
                                '通过审批
                                If objsystemEstateRenshiXingye.doSaveRyxx_TG(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.htxtWJBS.Value, objNewData_RY, strLZ) = False Then
                                    GoTo errProc
                                End If
                                ...
                                objEnvInfo.Add("BDLX", "0")
                                objEnvInfo.Add("BDSJ", strRQ)
                                ...
                                If objsystemEstateRenshiXingye.doDelete_RenyuanJiagou( _
                                    ...
                                    objEnvInfo, objNewData_Save) = False Then
                                    GoTo errProc
                                End If
...
goBreak:
                    ...
                    If blnComplete = True Then
                        '处理业务
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doCompleteFile(strErrMsg, MyBase.UserXM) = False Then
                            GoTo errProc
                        End If
                        ...
                        '记录日志
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]对[" + strRYMC + "]进行了[人事离职调整]！")
...
errProc:
        ...
        Private Function doIDoNotProcess(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doIDoNotProcess(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doICompleteTask(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doICompleteTask(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIStopFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doIStopFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIContinueFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doIContinueFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIZuofeiFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doIZuofeiFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIQiyongFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doIQiyongFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function doCompleteFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    If Me.m_objsystemFlowObjectRenshiLiZhi.getUncompleteTaskRY(strErrMsg, MyBase.UserXM, strUserList) = False Then
                        GoTo errProc
                    End If
                    If strUserList <> "" Then
        ...
        Public Function doBuyueComplete(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                For i = 0 To intRows - 1
                    ...
                    If strValue.Trim <> "" Then
                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPZT)
                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                        If strValue.Trim = "已通过" Then
                            blnC = True
                        Else
                            blnC = False
                        End If
...
goBreak:
                ...
                If blnC = True Then
                    ...
                    Dim strJJSM As String = "离职"
                    Dim strName As String = "杨先知"
                    Dim strJSRList As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.RS_LIZHI_RYMC
                    strArray = strJSRList.Split(Josco.JsKernal.Common.Utilities.PulicParameters.CharSeparate.ToCharArray)

                    '获取“发送序号”
                    Dim strFSXH As String
                    If Me.m_objsystemFlowObjectRenshiLiZhi.getNewFSXH(strErrMsg, strFSXH) = False Then
                        GoTo errProc
                    End If
                    ...
                    For i = 0 To intCount - 1 Step 1
                        If Me.m_objsystemFlowObjectRenshiLiZhi.doSendBuyueTongzhi(strErrMsg, strFSXH, strFSR, strArray(i), strJJSM) = False Then
                            GoTo errProc
                        End If
                    Next
...
errProc:
        ...
        Private Function doPrintGZ( _
            ...
            Try
                ...
                'strUrl = ""
                'strUrl += "estate_rs_lztz_info_bpjgz.aspx"
                'strUrl += "?"
                'strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                'strUrl += "="
                'strUrl += strNewSessionId
...
errProc:
        ...
        Private Function doPrintBJGZ( _
            ...
            Try
                ...
                'Session.Add(strNewSessionId, objIEstateRsLuyongInfobpwj)
                'strUrl = ""
                'strUrl += "estate_rs_lztz_info_bjgz.aspx"
                'strUrl += "?"
                'strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                'strUrl += "="
                'strUrl += strNewSessionId
...
errProc:
        ...
        Private Function doSetBwtx(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiLiZhi.doSetTaskBWTX(strErrMsg, MyBase.UserXM, True) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub lnkCZQSYJ_SH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_SH.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_SH", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_SHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_HQ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_HQ.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_HQ", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_HQWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_QF_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_QF.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_QF", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_QFWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_FH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_FH.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_FH", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_FHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_SHBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_SHBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_SHBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_SHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_HQBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_HQBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_HQBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_HQWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_FHBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_FHBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_FHBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_FHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_QFBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_QFBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_QFBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi.TASK_QFWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub doOpenPJYJ(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objBaseFlowRenshiLiZhi As Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi
                objBaseFlowRenshiLiZhi = CType(Me.m_objsystemFlowObjectRenshiLiZhi.FlowData, Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi)
                If objBaseFlowRenshiLiZhi.HJWJ = "" Then
                ...
                If objsystemCommon.doFTPDownLoadFile(strErrMsg, MyBase.UserId, MyBase.UserPassword, objBaseFlowRenshiLiZhi.HJWJ, strFileSpec, strFilePath, strFileName) = False Then
                    GoTo errProc
                End If
                Dim strUrl As String
                ...
                '记录访问审计日志
                If Me.m_objsystemFlowObjectRenshiLiZhi.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "访问了文件[" + Me.m_objsystemFlowObjectRenshiLiZhi.FlowData.WJBS + "]的[签批件的电子文件]！") = False Then
                    '忽略
                End If
...
errProc:
        ...
        Private Sub doOpenZSWJ(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objBaseFlowRenshiLiZhi As Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi
                objBaseFlowRenshiLiZhi = CType(Me.m_objsystemFlowObjectRenshiLiZhi.FlowData, Josco.JSOA.Common.Workflow.BaseFlowRenshiLiZhi)
                If objBaseFlowRenshiLiZhi.PJYJ = "" Then
                ...
                Dim strFileName As String = ""
                strFilePath = Server.MapPath(Request.ApplicationPath + Me.m_cstrUrlBaseToFileCache)
                If objsystemCommon.doFTPDownLoadFile(strErrMsg, MyBase.UserId, MyBase.UserPassword, objBaseFlowRenshiLiZhi.PJYJ, strFileSpec, strFilePath, strFileName) = False Then
                    GoTo errProc
                End If
                Dim strUrl As String
                strUrl = MyBase.UrlBase + Me.m_cstrUrlBaseToFileCache + strFileName
                ...
                '记录访问审计日志
                If Me.m_objsystemFlowObjectRenshiLiZhi.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "访问了文件[" + Me.m_objsystemFlowObjectRenshiLiZhi.FlowData.WJBS + "]的[签批件的扫描件]！") = False Then
                    '忽略
                End If
...
errProc:
        ...
        Private Sub doRYXX_AddNew(ByVal strControlId As String)
            ...
            Try
                ...
                '判断报到日期是否大于生效日期
                strRYLX = Me.txtRTLX.Text
                strRYDM = Me.txtRYDM.Text.Trim
                strZZDM = Me.htxtYBMDM.Value
                ...
                If blnSJ = False Then
                    strErrMsg = "错误：[" + strRYDM + "]无效的离职日期，请查证！"
                    GoTo errProc
                End If
                ...
                With Me.m_objDataSet_RYXX.Tables(strTable)
                    ...
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYXH) = .Rows.Count + 1
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WYBS) = ""
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WJBS) = Me.htxtWJBS.Value
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYDM) = Me.txtRYDM.Text
                    'objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_JLBH) = Me.txtJLBH.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYXM) = Me.txtRYXM.Text

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_ZJDM) = Me.htxtYZJDM.Value
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_ZJMC) = Me.txtYZJMC.Text
                    
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_DWDM) = Me.htxtYBMDM.Value
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_DWMC) = Me.txtYBMMC.Text

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_TDBH) = Me.txtYTD.Text

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYZT) = Me.htxtYRYZTDM.Value
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYZTMC) = Me.txtYRYZT.Text
                    
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SFZB) = Me.htxtYZBQKDM.Value
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_ZB) = Me.txtYZBQK.Text
                    
                    If Me.ddlYDYY.SelectedIndex < 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YYDM) = ""
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YYMC) = ""
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YYDM) = objPulicParameters.getObjectValue(Me.ddlYDYY.SelectedValue, "")
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_YYMC) = Me.ddlYDYY.SelectedItem.Text
                    End If


                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SFJZ) = Me.txtSFJZ.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYLX) = Me.txtRTLX.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYLXMC) = Me.txtRTLXMC.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_BZXL) = Me.txtBZXL.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_ZGDWDM) = Me.txtZGDWDM.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_ZGDWMC) = Me.txtZGDWMC.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SJLD) = Me.txtSJLD.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SJLDMC) = Me.txtSJLDMC.Text

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_LZRQ) = Me.txtNBDRQ.Text
        ...
        Private Sub doRyxx_BTG(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPSM, Me.txtSPSM.Text)
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPR, MyBase.UserXM)
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPRQ, Now.ToString())
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_SPJG, "0")
                    ...
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdRYXX.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RYXX) = True Then
                            ...
                            With Me.m_objDataSet_RYXX.Tables(strTable)
                                ...
                                objDataRow = .DefaultView.Item(intPos).Row
                                If Not (objDataRow Is Nothing) Then
                                    strWYBS = objPulicParameters.getObjectValue(.Rows(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WYBS), "")
                                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_WYBS, strWYBS)
                                    ...
                                    If objsystemEstateRenshiXingye.doSaveRyxx_BTG(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.htxtWJBS.Value, objNewData, strLZ) = False Then
                                        GoTo errProc
                                    End If

                                    '记录日志
                                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]对[" + strRYMC + "]进行了[人事离职审批]！")
...
errProc:
        ...
        Private Function doRyxx_TG(ByVal strControlId As String) As Boolean
...
errProc:
        ...
        Private Sub doAccept(ByVal strControlId As String)
            ...
            Try
                ...
                intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_BZXL)
                intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYDM)
                intColIndex(2) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_RYXM)
                intColIndex(3) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_LIZHI_RENYUANXINXI_DWDM)
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
