<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_zpqd.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_zpqd" %>
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>招聘渠道设置代码编辑窗</title>
													...
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 100%; CLIP: rect(0px 100% 300px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 300px">
														<asp:datagrid id="grdObjects" runat="server"  CssClass="labelGrid"  CellPadding="4" 
															...
															<Columns>
																...
																<asp:ButtonColumn DataTextField="招聘渠道代码" SortExpression="招聘渠道代码" HeaderText="招聘渠道代码" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn DataTextField="招聘渠道名称" SortExpression="招聘渠道名称" HeaderText="招聘渠道名称" CommandName="Select">
											...
											<TR>
												<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20"><B>招聘渠道设置代码编辑窗</B></TD>
														</TR>
														<TR>
															<TD class="label" align="center">
																<TABLE cellSpacing="0" cellPadding="0" border="0">
																	...
																	<TR>
																		<TD class="labelNotNull" align="right" width="40%">招聘渠道代码：</TD>
																	...
																	<TR>
																		<TD class="labelNotNull" align="right">招聘渠道型名称：</TD>
