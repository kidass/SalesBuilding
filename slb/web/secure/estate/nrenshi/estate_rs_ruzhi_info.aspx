<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_ruzhi_info.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_ruzhi_info" %>
<%@ Register TagPrefix="ComponentArt" Namespace="ComponentArt.Web.UI" Assembly="ComponentArt.Web.UI" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
    <head>
        <title>人事入职审批单的显示或编辑窗</title>
                                                                    ...
                                                                    <TABLE cellSpacing="0" cellPadding="0"  border="0">
                                                                        <TR>
                                                                            ...
                                                                            <td align="left"><asp:TextBox ID="txtJLBH" Runat="server" CssClass="textbox" Columns="12" ReadOnly="true" ></asp:TextBox></td>
                                                                                  <td><asp:TextBox ID="txtZPSM" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox></td>
                                                                        </TR>
                                                                         <TR>
                                                                                    ...
                                                                                    <asp:datagrid id="grdRYXX" runat="server" Width="2400px" CssClass="labelGrid" 
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <asp:ButtonColumn ItemStyle-Width="140px" DataTextField="拟分配部门" SortExpression="拟分配部门" HeaderText="拟分配部门" CommandName="Select">
                                                                                             ...
                                                                                             <asp:ButtonColumn ItemStyle-Width="100px" DataTextField="部门经理" SortExpression="部门经理" HeaderText="上级经理" CommandName="Select">
                                                                                                <HeaderStyle Width="100px"></HeaderStyle>
                                                                                            </asp:ButtonColumn>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0"  border="1" width="100%" bordercolordark="#99cccc" bordercolorlight="#ffffff">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left"><asp:DropDownList id="ddlZPSM" Runat="server" CssClass="textbox" Columns="12">
															                                    ...
															                                    <asp:ListItem Value="实习生转正式员工">实习生转正式员工</asp:ListItem>
                                                                                                </asp:DropDownList></td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" ><asp:TextBox ID="txtBMJL" Runat="server" CssClass="textbox" Columns="16"></asp:TextBox><asp:Button id="btnSelect_ZZDM" Runat="server" CssClass="button" Text="…"></asp:Button></td>
                                                                                         <td class="labelNotNull" align="right">拟分配部门</td>
                                                                                        ...
                                                                                        <td class="labelNotNull" align="right">团队编号</td>
                                                                                   ...
                                                                                   <tr>                                                                                            
								                                                        ...
								                                                        <asp:RadioButtonList id="rblRYZT" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Horizontal" RepeatLayout="Table">
									                                                        <asp:ListItem Value="1" Selected="True">试用人员待遇</asp:ListItem>
									                                                        <asp:ListItem Value="2">正式职工待遇</asp:ListItem>
								                                                        </asp:RadioButtonList>
							                                                        </td>                                                                                       
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="8" align="right"><% if propEditMode = False then response.write("<div style='display:none'>") %><asp:CheckBox id="chkQZTJ" Runat="server" CssClass="textbox" Text="强制"  AutoPostBack="True"></asp:CheckBox><asp:Button ID="btnRYXX_NewJLBH" Runat="server" CssClass="button" Text="清空"></asp:Button><asp:Button ID="btnRYXX_AddNew" Runat="server" CssClass="button" Text="增加人员"></asp:Button><asp:Button ID="btnRYXX_Update" Runat="server" CssClass="button" Text="更改人员"></asp:Button><asp:Button ID="btnRYXX_Delete" Runat="server" CssClass="button" Text="删除人员"></asp:Button> <% if propEditMode = False then response.write("</div>") %></td>
                                                                                    </tr>
                                                                                </table>  
