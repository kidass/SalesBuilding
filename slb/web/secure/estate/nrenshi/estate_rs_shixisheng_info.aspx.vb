...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_shixisheng_info
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objsystemFlowObjectRenshiShiXisheng As Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng
...
errProc:
        ...
        Private Function getModuleData_Main( _
            ...
            Try
                '创建工作流对象
                Dim strType As String = Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.FLOWCODE
                Dim strName As String = Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.FLOWNAME
                ...
                Me.m_objsystemFlowObjectRenshiShiXisheng = CType(objsystemFlowObject, Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng)

                '工作流对象初始化并填充数据
                If Me.m_objsystemFlowObjectRenshiShiXisheng.doInitialize(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWJBS, True) = False Then
                    GoTo errProc
                End If

                '计算可执行的操作
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getCanExecuteCommand(strErrMsg, MyBase.UserId, MyBase.UserXM, MyBase.UserBmdm) = False Then
                    GoTo errProc
                End If
        ...
        Private Function getModuleData_FJ( _
            ...
            Try
                ...
                Else
                    ...
                    '重新检索数据
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.getFujianData(strErrMsg, Me.m_objDataSet_FJ) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function getModuleData_XGWJ( _
            ...
            Try
                ...
                Else
                    ...
                    '重新检索数据
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.getXgwjData(strErrMsg, Me.m_objDataSet_XGWJ) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function getModuleData_RYXX( _
            ...
            Try
                ...
                Else
                    ...
                    Select Case Me.m_objenumEditType
                        Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                            If Me.m_objsystemFlowObjectRenshiShiXisheng.getDataSet_RYXX(strErrMsg, MyBase.UserXM, Me.m_objDataSet_RYXX) = False Then
                                GoTo errProc
                            End If
                        Case Else
                            If Me.txtJBRY.Text.Trim = MyBase.UserXM Then
                                If Me.m_objsystemFlowObjectRenshiShiXisheng.getDataSet_RYXX(strErrMsg, Me.m_objDataSet_RYXX, blnSFJB) = False Then
                                    GoTo errProc
                                End If
                            Else
                                If Me.m_objsystemFlowObjectRenshiShiXisheng.getDataSet_RYXX(strErrMsg, MyBase.UserXM, Me.m_objDataSet_RYXX) = False Then
...
errProc:
        ...
        Private Function showEditPanelInfo( _
            ...
            Try
                objBaseFlowRenshiShiXiSheng = CType(Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData, Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng)
                ...
                Else
                    If Me.IsPostBack = False Or (Me.IsPostBack = True And Me.m_blnEditMode = False) Then
                        ...
                        Me.ddlJJCD.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlJJCD, objBaseFlowRenshiShiXiSheng.JJCD)
                        Me.ddlMMDJ.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlMMDJ, objBaseFlowRenshiShiXiSheng.MMDJ)
                        Me.txtJGDZ.Text = objBaseFlowRenshiShiXiSheng.JGDZ
                        Me.txtWJNF.Text = objBaseFlowRenshiShiXiSheng.WJNF
                        Me.txtWJXH.Text = objBaseFlowRenshiShiXiSheng.WJXH
                        Me.txtWJBT.Text = objBaseFlowRenshiShiXiSheng.WJBT
                        'Me.txtDBRS.Text = objBaseFlowRenshiShiXiSheng.DBRS.ToString
                        Me.txtBZXX.Text = objBaseFlowRenshiShiXiSheng.BEIZ
                        If objBaseFlowRenshiShiXiSheng.DDSZ = 1 Then
                            Me.chkDDSZ.Checked = True
                        Else
                            Me.chkDDSZ.Checked = False
                        End If
                        Me.txtJBDW.Text = objBaseFlowRenshiShiXiSheng.ZBDW
                        Me.txtJBRY.Text = objBaseFlowRenshiShiXiSheng.NGR
                        Me.txtJBRQ.Text = objPulicParameters.doDateToString(objBaseFlowRenshiShiXiSheng.NGRQ, "yyyy-MM-dd")
                        Me.txtLSH.Text = objBaseFlowRenshiShiXiSheng.LSH
                        Me.htxtWJBS.Value = objBaseFlowRenshiShiXiSheng.WJBS
                        ...
                        Dim strTemp As String = objBaseFlowRenshiShiXiSheng.WJBT
                        Dim lendf As Integer

                        intTemp_start = InStr(1, objBaseFlowRenshiShiXiSheng.WJBT, "(")
                        intTemp_end = InStr(1, objBaseFlowRenshiShiXiSheng.WJBT, ")")
                        ...
                        Select Case Me.m_objenumEditType
                            Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                                ...
                                If Me.m_objsystemFlowObjectRenshiShiXisheng.getNewWjxh(strErrMsg, Me.txtJGDZ.Text, Me.txtWJNF.Text, strWJXH) = False Then
                                Else
                                ...
                                If Me.m_objsystemFlowObjectRenshiShiXisheng.getNewLSH(strErrMsg, strLSH) = False Then
                                    Me.txtLSH.Text = ""
                                Else
                                ...
                                Me.txtWJBT.Text = Now.ToString("yyyyMMdd") & strLSH & MyBase.UserBmmc & "实习生申请单"

                                strLSH = ""
                                If Me.m_objsystemFlowObjectRenshiShiXisheng.getNewWJBS(strErrMsg, strLSH) = False Then
                                    Me.htxtWJBS.Value = ""
                                Else
                ...
                '根据文件内容随时更新
                'Me.lblQFR.Text = objBaseFlowRenshiShiXiSheng.QFR
                ...
                With objControlProcess
                    ...
                    .doEnabledControl(Me.txtJDXX, blnEditMode)
                    .doEnabledControl(Me.txtZY, blnEditMode)
...
errProc:
        ...
        Private Function showModuleData_ReadMode(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                'Me.lnkCZCYQPWJ.Enabled = Not blnEditMode And (objBaseFlowRenshiShiXiSheng.HJWJ <> "")
                'Me.lnkCZCYZSWJ.Enabled = Not blnEditMode And (objBaseFlowRenshiShiXiSheng.PJYJ <> "")
                ...
                '必须先接收？
                '
                If Me.m_objsystemFlowObjectRenshiShiXisheng.pmMustJieshou = True Then
                    '接收文件
                ...
                '正常操作
                '
                With Me.m_objsystemFlowObjectRenshiShiXisheng
                    '********************************************************
                    ...
                    If .mlWYYZ = True Then
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.doIReadFile(strErrMsg, MyBase.UserXM) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        Private Function showModuleData_EditMode(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                'Me.lnkCZCYQPWJ.Enabled = blnEditMode And (objBaseFlowRenshiShiXiSheng.HJWJ <> "")
                'Me.lnkCZCYZSWJ.Enabled = blnEditMode And (objBaseFlowRenshiShiXiSheng.PJYJ <> "")
...
errProc:
        ...
        Private Function showOpinion( _
            ...
            Try
                ...
                '获取可查看的意见
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getOpinionData(strErrMsg, MyBase.UserXM, objOpinionData) = False Then
                    GoTo errProc
                End If

                '显示区域经理意见
                strYJLX = objBaseFlowRenshiShiXiSheng.TASK_QFWJ
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                ...
                '显示部门经理意见
                strYJLX = objBaseFlowRenshiShiXiSheng.TASK_FHWJ
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                strQSYJ = objPulicParameters.doConvertToHtml(strQSYJ)
                ...
                '显示中介部意见
                strYJLX = objBaseFlowRenshiShiXiSheng.TASK_SHWJ
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                strQSYJ = objPulicParameters.doConvertToHtml(strQSYJ)
                ...
                '显示办公室意见
                strYJLX = objBaseFlowRenshiShiXiSheng.TASK_HQWJ
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getOpinion(strErrMsg, objOpinionData, strYJLX, strQSYJ, strBJYJ) = False Then
                    GoTo errProc
                End If
                strQSYJ = objPulicParameters.doConvertToHtml(strQSYJ)
...
errProc:
        ...
        Private Function getCurrentRecordNew( _
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBS, Me.htxtWJBS.Value)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_LSH, Me.txtLSH.Text)

                If Me.chkDDSZ.Checked = True Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_DDSZ, "1")
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_DDSZ, "0")
                End If

                If Me.ddlJJCD.SelectedIndex < 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JJCD, "")
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JJCD, Me.ddlJJCD.SelectedItem.Text)
                End If

                If Me.ddlMMDJ.SelectedIndex < 0 Then
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_MMDJ, "")
                Else
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_MMDJ, Me.ddlMMDJ.SelectedItem.Text)
                End If

                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JGDZ, Me.txtJGDZ.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJNF, Me.txtWJNF.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJXH, Me.txtWJXH.Text)

                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBRY, Me.txtJBRY.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBRQ, Me.txtJBRQ.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBDW, Me.txtJBDW.Text)

                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBT, Me.txtWJBT.Text)
                'objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_DBRS, Me.txtDBRS.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_BZXX, Me.txtBZXX.Text)
...
errProc:
        ...
        Private Function setCurrentRecordNew( _
            ...
            Try
                Me.htxtWJBS.Value = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBS), "")
                Me.txtLSH.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_LSH), "")
                If objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_DDSZ), 0) = 1 Then
                    Me.chkDDSZ.Checked = True
                Else
                    Me.chkDDSZ.Checked = False
                End If

                Me.ddlJJCD.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlJJCD, objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JJCD), ""))
                Me.ddlMMDJ.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlMMDJ, objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_MMDJ), ""))

                Me.txtJGDZ.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JGDZ), "")
                Me.txtWJNF.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJNF), "")
                Me.txtWJXH.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJXH), "")

                Me.txtJBRY.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBRY), "")
                Me.txtJBRQ.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBRQ), "")
                Me.txtJBDW.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_JBDW), "")

                Me.txtWJBT.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBT), "")
                'Me.txtDBRS.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_DBRS), "")
                Me.txtBZXX.Text = objPulicParameters.getObjectValue(objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_BZXX), "")
...
errProc:
        ...
        Private Function doDeleteCacheFile(ByRef strErrMsg As String) As Boolean
            ...
            If Me.doDeleteCacheFile_GJ(strErrMsg) = False Then
                '可以不成功，形成垃圾文件！
            End If
            If Me.m_objsystemFlowObjectRenshiShiXisheng.doDeleteCacheFile_FJ(strErrMsg, Me.m_objDataSet_FJ) = False Then
                '可以不成功，形成垃圾文件！
            End If
            If Me.m_objsystemFlowObjectRenshiShiXisheng.doDeleteCacheFile_XGWJ(strErrMsg, Me.m_objDataSet_XGWJ) = False Then
                '可以不成功，形成垃圾文件！
            End If
...
errProc:
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            Try
                Dim strWJBS As String = Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData.WJBS
                ...
                If Me.IsPostBack = False Then
                    ...
                    With New Josco.JsKernal.web.ControlProcess
                        ...
                        .doTranslateKey(Me.txtJDXX)
                        .doTranslateKey(Me.txtZY)
                ...
                If Me.IsPostBack = False And Me.m_blnSaveScence = False Then
                    ...
                    If Me.m_blnEditMode = False Then
                        ...
                        If Me.m_objInterface.iWJBS <> "" Then
                            '自动解除自己的文件封锁
                            If Me.m_objsystemFlowObjectRenshiShiXisheng.doLockFile(strErrMsg, MyBase.UserId, False) = False Then
                                GoTo errProc
                            End If
                        End If
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.mlJSWJ = True Then
                            '自动接收文件
...
errProc:
        ...
        Private Sub Page_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Unload
            Josco.JSOA.BusinessFacade.systemFlowObjectRenshiShiXisheng.SafeRelease(Me.m_objsystemFlowObjectRenshiShiXisheng)
        End Sub
                ...
                Select Case e.CommandName.ToUpper
                    Case "OpenDocument".ToUpper
                        ...
                        Else
                            ...
                            If Me.m_objsystemFlowObjectRenshiShiXisheng.getCanAutoEnterEditMode( _
                                strErrMsg, _
                                MyBase.UserId, _
                                Me.m_blnEditMode, _
...
errProc:
        ...
        Private Function doOpenFJ( _
            ...
            Try
                ...
                If Me.m_objsystemFlowObjectRenshiShiXisheng.isFileSendOnce(strErrMsg, blnHasSendOnce) = False Then
                    GoTo errProc
                End If
                ...
                With objIFlowFujianInfo
                    ...
                    .iTrackRevisions = Me.m_objsystemFlowObjectRenshiShiXisheng.swgjShowTrackRevisions And blnHasSendOnce
                    .iFlowTypeName = Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData.FlowTypeName
                    .iWJBS = Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData.WJBS
                    .iRow = objDataRow
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    Select Case Me.m_objInterface.iEditMode
                        ...
                        Case Else
                            '解除文件编辑封锁
                            If Me.m_objsystemFlowObjectRenshiShiXisheng.doLockFile(strErrMsg, "", False) = False Then
                                GoTo errProc
                            End If
        ...
        Private Function doModify(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strRYMC As String
                    Dim blnDo As Boolean
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.getFileLocked(strErrMsg, blnDo, strBMMC, strRYMC) = False Then
                        GoTo errProc
                    End If
                    If blnDo = True Then
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    If blnOK = True Then
                        '进行编辑封锁
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.doLockFile(strErrMsg, MyBase.UserId, True) = False Then
                            GoTo errProc
                        End If
...
errProc:
        ...
        Private Function doSave(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                '获取记录旧值
                objOldData = Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                        Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                    Case Else
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.getFujianData(strErrMsg, objOldFJData) = False Then
                            GoTo errProc
                        End If
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.getXgwjData(strErrMsg, objOldXGWJData) = False Then
                            GoTo errProc
                        End If
                End Select
                ...
                With Me.m_objsystemFlowObjectRenshiShiXisheng
                    ...
                    End If
                End With
                strWJBS = objNewData(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_WJBS)

                '写审计日志
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew, _
                        Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eCpyNew
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "创建了[" + strWJBS + "]文件！") = False Then
                            '忽略
                        End If
                    Case Else
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "改动了[" + strWJBS + "]文件！") = False Then
                            '忽略
                        End If
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.doWriteUserLog_Fujian(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Me.m_objDataSet_FJ, objOldFJData) = False Then
                            '忽略
                        End If
                        If Me.m_objsystemFlowObjectRenshiShiXisheng.doWriteUserLog_XGWJ(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Me.m_objDataSet_XGWJ, objOldXGWJData) = False Then
                            '忽略
                        End If
                End Select

                '进入查看状态
                Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData.WJBS = strWJBS
                Me.m_objInterface.iEditMode = Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eSelect
...
errProc:
        ...
        Private Sub doOpenGJ(ByVal strControlId As String)
            ...
            Try
                ...
                If Me.m_objsystemFlowObjectRenshiShiXisheng.getGJFile(strErrMsg, Me.m_blnEditMode, strCacheFile, strMBPath, strGJPath, strGJFile) = False Then
                    GoTo errProc
                End If
                ...
                With objIFlowEditWord
                    ...
                    .iobjNewData = Nothing
                    '************************************************************************************************
                    .iCanQSYJ = Me.m_objsystemFlowObjectRenshiShiXisheng.mlTXYJ
                    If .iCanQSYJ = False Then
                        .iCanQSYJ = Me.m_objsystemFlowObjectRenshiShiXisheng.mlBDPS
                        If .iCanQSYJ = False Then
                            '不能签署意见，接口缺省参数
                        Else
                            '补登领导批示
                    ...
                    '稿件界面控制参数
                    .iTrackRevisions = Me.m_objsystemFlowObjectRenshiShiXisheng.swgjShowTrackRevisions And blnHasSendOnce
                    .iCanExportGJ = Me.m_objsystemFlowObjectRenshiShiXisheng.swgjExportFile
                    .iCanImportGJ = Me.m_objsystemFlowObjectRenshiShiXisheng.swgjImportFile
                    .iCanSelectTGWJ = Me.m_objsystemFlowObjectRenshiShiXisheng.swgjSelectGJ
...
errProc:
        ...
        Private Function doIDoNotProcess(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doIDoNotProcess(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doICompleteTask(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doICompleteTask(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIStopFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doIStopFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIContinueFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doIContinueFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIZuofeiFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doIZuofeiFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doIQiyongFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doIQiyongFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
        ...
        Private Function doCompleteFile(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.getUncompleteTaskRY(strErrMsg, MyBase.UserXM, strUserList) = False Then
                        GoTo errProc
                    End If
                    If strUserList <> "" Then
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doCompleteFile(strErrMsg, MyBase.UserXM) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Function doSetBwtx(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '处理业务
                    If Me.m_objsystemFlowObjectRenshiShiXisheng.doSetTaskBWTX(strErrMsg, MyBase.UserXM, True) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub lnkCZQSYJ_SH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_SH.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_SH", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_SHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_HQ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_HQ.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_HQ", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_HQWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_QF_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_QF.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_QF", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_QFWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_FH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_FH.Click
            ...
            Try
                If Me.doTianxieYijian(strErrMsg, "lnkCZQSYJ_FH", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_FHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_SHBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_SHBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_SHBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_SHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_HQBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_HQBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_HQBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_HQWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_FHBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_FHBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_FHBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_FHWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub lnkCZQSYJ_QFBJ_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCZQSYJ_QFBJ.Click
            ...
            Try
                If Me.doChakanBianjianyijian(strErrMsg, "lnkCZQSYJ_QFBJ", Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng.TASK_QFWJ) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub doOpenPJYJ(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objBaseFlowRenshiShiXiSheng As Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng
                objBaseFlowRenshiShiXiSheng = CType(Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData, Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng)
                If objBaseFlowRenshiShiXiSheng.HJWJ = "" Then
                ...
                If objsystemCommon.doFTPDownLoadFile(strErrMsg, MyBase.UserId, MyBase.UserPassword, objBaseFlowRenshiShiXiSheng.HJWJ, strFileSpec, strFilePath, strFileName) = False Then
                    GoTo errProc
                End If
                Dim strUrl As String
                ...
                '记录访问审计日志
                If Me.m_objsystemFlowObjectRenshiShiXisheng.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "访问了文件[" + Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData.WJBS + "]的[签批件的电子文件]！") = False Then
                    '忽略
                End If
...
errProc:
        ...
        Private Sub doOpenZSWJ(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objBaseFlowRenshiShiXiSheng As Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng
                objBaseFlowRenshiShiXiSheng = CType(Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData, Josco.JSOA.Common.Workflow.BaseFlowRenshiShiXiSheng)
                If objBaseFlowRenshiShiXiSheng.PJYJ = "" Then
                ...
                Dim strFileName As String = ""
                strFilePath = Server.MapPath(Request.ApplicationPath + Me.m_cstrUrlBaseToFileCache)
                If objsystemCommon.doFTPDownLoadFile(strErrMsg, MyBase.UserId, MyBase.UserPassword, objBaseFlowRenshiShiXiSheng.PJYJ, strFileSpec, strFilePath, strFileName) = False Then
                    GoTo errProc
                End If
                Dim strUrl As String
                strUrl = MyBase.UrlBase + Me.m_cstrUrlBaseToFileCache + strFileName
                ...
                '记录访问审计日志
                If Me.m_objsystemFlowObjectRenshiShiXisheng.doWriteUserLog(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "访问了文件[" + Me.m_objsystemFlowObjectRenshiShiXisheng.FlowData.WJBS + "]的[签批件的扫描件]！") = False Then
                    '忽略
                End If
...
errProc:
        ...
        Private Sub doRYXX_AddNew(ByVal strControlId As String)
            ...
            Try
                    ...
                    Else
                        ...
                        Else
                            ...
                            Else
                                ...
                                If lenSfzhm = 18 Then
                                    strRYXM = strRYXM + strSFZHM.Substring(9, 2)
                                Else
                                    strRYXM = strRYXM + strSFZHM.Substring(7, 2)
                                End If
                ...
                '    strNewFilter = Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_JLBH + " = '" + Me.txtJLBH.Text.Trim + "'"
                ...
                With Me.m_objDataSet_RYXX.Tables(strTable)
                    ...
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXH) = .Rows.Count + 1
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WYBS) = ""
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WJBS) = Me.htxtWJBS.Value

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYDM) = Me.txtRYDM.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_JDXX) = Me.txtJDXX.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZY) = Me.txtZY.Text


                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_JLBH) = Me.txtJLBH.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXM) = Me.txtRYXM.Text
                    If Me.rblRYXB.SelectedIndex >= 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXB) = Me.rblRYXB.SelectedValue
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXB) = "男"
                    End If
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYNN) = objPulicParameters.getObjectValue(Me.txtRYNN.Text, 0)
                    If Me.ddlXL.SelectedIndex >= 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXL) = Me.ddlXL.SelectedValue
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXL) = ""
                    End If
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NFPBM) = Me.txtNFPBM.Text

                    If Me.ddlYDYY.SelectedIndex < 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_YYDM) = ""
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_YYMC) = ""
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_YYDM) = objPulicParameters.getObjectValue(Me.ddlYDYY.SelectedValue, "")
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_YYMC) = Me.ddlYDYY.SelectedItem.Text
                    End If

                    If Me.ddlZJDM.SelectedIndex < 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJDM) = ""
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJMC) = ""
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJDM) = objPulicParameters.getObjectValue(Me.ddlZJDM.SelectedValue, "")
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_b_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJMC) = Me.ddlZJDM.SelectedItem.Text
                    End If

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NDRZW) = Me.ddlZJDM.SelectedItem.Text
                    'objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPSM) = Me.txtZPSM.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_XYRYS) = objPulicParameters.getObjectValue(Me.txtXYRYS.Text, 0)
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_DBRYS) = objPulicParameters.getObjectValue(Me.txtDBRYS.Text, 0)

                    If Me.ddlZPQD.SelectedIndex >= 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPQD) = Me.ddlZPQD.SelectedItem.Text
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPQD) = ""
                    End If
                    If Me.ddlZPSM.SelectedIndex >= 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPSM) = Me.ddlZPSM.SelectedItem.Text
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPSM) = ""
                    End If

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFZHM) = Me.txtSFZHM.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_BMJL) = Me.txtBMJL.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WLJN) = Me.txtWLJNFS.Text


                    If Me.rblRYLX.SelectedIndex < 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYLX) = 1
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYLX) = objPulicParameters.getObjectValue(Me.rblRYLX.SelectedValue, 1)
                    End If
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYLXMC) = Me.rblRYLX.SelectedItem.Text

                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_TDBH) = objPulicParameters.getObjectValue(Me.txtTDBH.Text, 0)
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_BZXL) = objPulicParameters.getObjectValue(Me.htxtBZXL.Value, 0)
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_LXDH) = Me.txtLXDH.Text
                    objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_DWDM) = Me.htxtSSDW.Value

                    If Me.rblRYZT.SelectedIndex < 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYZT) = 1
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYZTMC) = "试用人员"
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYZT) = objPulicParameters.getObjectValue(Me.rblRYZT.SelectedValue, 1)
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYZTMC) = Me.rblRYZT.SelectedItem.Text
                    End If

                    If Me.rblSFZB.SelectedIndex < 0 Then
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFZB) = "1"
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZB) = "编内人员"
                    Else
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFZB) = objPulicParameters.getObjectValue(Me.rblSFZB.SelectedValue, 1)
                        objDataRow.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZB) = Me.rblSFZB.SelectedItem.Text
                    End If
        ...
        Private Sub doRyxx_BTG(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPSM, Me.txtSPSM.Text)
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPR, MyBase.UserXM)
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPRQ, Now.ToString())
                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPJG, "0")
                    ...
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdRYXX.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RYXX) = True Then
                            ...
                            With Me.m_objDataSet_RYXX.Tables(strTable)
                                ...
                                objDataRow = .DefaultView.Item(intPos).Row
                                If Not (objDataRow Is Nothing) Then
                                    strWYBS = objPulicParameters.getObjectValue(.Rows(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WYBS), "")
                                    objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WYBS, strWYBS)
                                    ...
                                    If Trim(strValue) <> "" Then
                                        ...
                                        End If
                                    End If
                                    If objsystemEstateRenshiXingye.doSaveRyxx_BTG(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.htxtWJBS.Value, objNewData, intSXS) = False Then
                                        GoTo errProc
                                    End If
                                End If
goNext:
                        ...
                        If objDataGridProcess.isDataGridItemChecked(Me.grdRYXX.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RYXX) = True Then
                            ...
                            With Me.m_objDataSet_RYXX.Tables(strTable)
                                ...
                                If Not (objDataRow Is Nothing) Then
                                    ...
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPSM, Me.txtSPSM.Text)
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPR, MyBase.UserXM)
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPRQ, Now.ToString())
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPJG, "1")
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NBDRQ, Me.txtNBDRQ.Text)
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_GZDY, Me.txtGZDY.Text)

                                    If Me.chkSFJZ.Checked = True Then
                                        objNewData_RY.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFJZ) = "1"
                                    Else
                                        objNewData_RY.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFJZ) = "0"
                                    End If

                                    strWYBS = objPulicParameters.getObjectValue(.Rows(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WYBS), "")
                                    objNewData_RY.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WYBS, strWYBS)


                                    intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXM)
                                    strRYMC = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                    intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_YYDM)
                                    strYDYY = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                    intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYLX)
                                    strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                    strRYLX = strValue
                                    intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPR)
                                    ...
                                    If objsystemEstateRenshiXingye.doSaveRyxx_TG(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.htxtWJBS.Value, objNewData_RY, intSXS) = False Then
                                        GoTo errProc
                                    End If
                                    ...
                                    If strRYLX = "1" Then
                                        ...
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYDM)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        strRYDM = strValue
                                        ...
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJDM)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_GUANLIJIAGOU_ZJDM, strValue)
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_b_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJMC)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_GUANLIJIAGOU_ZJMC, strValue)


                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYZT)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_GUANLIJIAGOU_RYZT, strValue)

                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_DWDM)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_GUANLIJIAGOU_SSDW, strValue)
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NFPBM)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        ...
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFZB)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_GUANLIJIAGOU_SFZB, strValue)

                                        'intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_BMJL)
                                        'strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        strSJLD = ""
                                        ...
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_BZXL)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                        objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_GUANLIJIAGOU_BZXL, strValue)
                                        intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_TDBH)
                                        strValue = objDataGridProcess.getDataGridCellValue(Me.grdRYXX.Items(i), intIndex)
                                    ...
                                    Else
                                        ...
                                        strValue = objNewData_RY.Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFJZ)
...
errProc:
        ...
        Private Sub doAccept(ByVal strControlId As String)
            ...
            Try
                ...
                intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_JLBH)
                intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYDM)
                intColIndex(2) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXM)
                intColIndex(3) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYXX, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NFPBM)
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
            ...
            Try
                ...
                Else
                    ...
                    With Me.m_objDataSet_RYXX.Tables(strTable).DefaultView
                        Me.txtRYDM.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYDM), "")

                        Me.txtJLBH.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_JLBH), "")
                        Me.txtRYXM.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXM), "")
                        strXB = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXB), "")
                        Me.rblRYXB.SelectedIndex = objRadioButtonListProcess.getCheckedItem(Me.rblRYXB, strXB)

                        Me.txtRYNN.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYNN), "")
                        strLX = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYXL), "")
                        Me.ddlXL.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlXL, strLX)

                        Me.txtNFPBM.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_NFPBM), "")
                        strYDYY = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_YYDM), "")
                        Me.ddlYDYY.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlYDYY, strYDYY)
                        strZJDM = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZJDM), "")
                        Me.ddlZJDM.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlZJDM, strZJDM)
                        'strZPQD = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPQD), "")
                        ''Me.ddlZPQD.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlZPQD, strZPQD)
                        'Me.ddlZPQD.SelectedItem.Text = strZPQD

                        'Me.ddlZPQD.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlZPQD, strZPQD)
                        strZPQD = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPSM), "")
                        Me.ddlZPSM.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlZPSM, strZPQD)
                        'Me.ddlZPSM.SelectedItem.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPSM), "")

                        'Me.txtZPSM.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZPSM), "")
                        Me.txtXYRYS.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_XYRYS), "")
                        Me.txtDBRYS.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_DBRYS), "")
                        Me.txtSFZHM.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFZHM), "")
                        Me.txtBMJL.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_BMJL), "")
                        Me.txtWLJNFS.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_WLJN), "")
                        Me.txtTDBH.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_TDBH), "")
                        strRYLX = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYLX), "")
                        Me.rblRYLX.SelectedIndex = objRadioButtonListProcess.getCheckedItem(Me.rblRYLX, strRYLX)

                        Me.htxtBZXL.Value = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_BZXL), "")
                        Me.txtLXDH.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_LXDH), "")
                        Me.htxtSSDW.Value = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_DWDM), "")
                        strRYZT = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_RYZT), "")
                        Me.rblRYZT.SelectedIndex = objRadioButtonListProcess.getCheckedItem(Me.rblRYZT, strRYZT)
                        strSFZB = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SFZB), "")
                        Me.rblSFZB.SelectedIndex = objRadioButtonListProcess.getCheckedItem(Me.rblSFZB, strSFZB)
                        Me.txtJDXX.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_JDXX), "")
                        Me.txtZY.Text = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_ZY), "")
                        strSPR = objPulicParameters.getObjectValue(.Item(intPos).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_SHIXISHENGSHENPI_RENYUANXINXI_SPR), "")
