...
Namespace Josco.JSOA.web
    ...
    '
    ' 接口参数：
    '     参见接口类IEstateCwPiaojuShiyong描述
    '----------------------------------------------------------------

    Partial Class estate_cw_piaoju_shiyong
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateCwPiaojuShiyong
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateCwPiaojuShiyong
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateCwPiaojuShiyong)
...
errProc:
        ...
        Private Function getPrevilegeParams( _
            ...
            Try
                ...
                '是否继续执行
                If Me.m_blnPrevilegeParams(0) = True And Me.m_blnPrevilegeParams(2) = True Then
                    blnContinueExecute = True
                Else
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtYWBH.Text = .txtYWBH
                    Me.htxtYWBH.Value = .htxtYWBH
                    Me.txtKPJE.Text = .txtKPJE
                    Me.txtZYSM.Text = .txtZYSM
                    'zengxianglin 2008-11-18
                    Me.txtKPRQ.Text = .txtKPRQ
                    Try
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateCwPiaojuShiyong
                ...
                With Me.m_objSaveScence
                    ...
                    .txtYWBH = Me.txtYWBH.Text
                    .htxtYWBH = Me.htxtYWBH.Value
                    .txtKPJE = Me.txtKPJE.Text
                    .txtZYSM = Me.txtZYSM.Text
                    'zengxianglin 2008-11-18
                    .txtKPRQ = Me.txtKPRQ.Text
        ...
        Private Function getDataFromCallModule(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                '==========================================================================================================================================================
                Dim objIEstateEsXzJyxx As Josco.JSOA.BusinessFacade.IEstateEsXzJyxx
                Try
                ...
                If Not (objIEstateEsXzJyxx Is Nothing) Then
                    If objIEstateEsXzJyxx.oExitMode = True Then
                        Select Case objIEstateEsXzJyxx.iSourceControlId.ToUpper
                            Case "btnSelect_YWBH".ToUpper
                                Me.txtYWBH.Text = objIEstateEsXzJyxx.oJYBH
                                Me.htxtYWBH.Value = objIEstateEsXzJyxx.oWYBS
                        End Select
                    End If
                ...
                '==========================================================================================================================================================
                Dim objIDmxzRyxx As Josco.JsKernal.BusinessFacade.IDmxzRyxx
                Try
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateCwPiaojuShiyong)
                Catch ex As Exception
                ...
                Me.m_strFixQuery = "a." + Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_ZTBZ + " in (0,1,2)" + vbCr
                ...
                If blnFHBZ = True And strList <> "" Then
                    Me.m_strFixQuery += " and a." + Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_FGFH + " in (" + strList + ")" + vbCr
                End If
                'zengxianglin 2008-11-22
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateCwPiaojuShiyong)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
...
errProc:
        ...
        Private Function getModuleData_PIAOJU( _
            ...
            Try
                ...
                '默认搜索条件
                Dim strQuery As String = Me.m_strFixQuery
                If strWhere = "" Then
                    strWhere = strQuery
                Else
...
errProc:
        ...
        Private Function showModuleData_MAIN(ByRef strErrMsg As String) As Boolean
            ...
            Try
                Me.btnMarkUsed.Visible = Me.m_blnPrevilegeParams(2)
                Me.btnMarkZuofei.Visible = Me.m_blnPrevilegeParams(2)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                ...
                objControlProcess.doTranslateKey(Me.txtYWBH)
                objControlProcess.doTranslateKey(Me.txtJBRY)
                objControlProcess.doTranslateKey(Me.txtKPJE)
                '************************************************
                'zengxianglin 2008-11-18
                objControlProcess.doTranslateKey(Me.txtKPRQ)
...
errProc:
        ...
        Private Sub doMarkZuofei(ByVal strControlId As String)
            ...
            Try
                intStep = 1
                '检查选择
                If Me.grdPIAOJU.SelectedIndex < 0 Then
                    strErrMsg = "错误：没有当前票据！"
                    GoTo errProc
                End If
                Dim intColIndex As Integer = 0
                Dim strWYBS As String = ""
                Dim strZTBZ As String = ""
                Dim strPJHM As String = ""
                Dim i As Integer = 0
                i = Me.grdPIAOJU.SelectedIndex
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_ZTBZ)
                strZTBZ = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_WYPJHM)
                strPJHM = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                Dim intUsed As Integer = Josco.JSOA.Common.Data.estateCaiwuData.enumPiaojuStatus.Used
                Select Case strZTBZ
                    Case intUsed.ToString
                    Case Else
                        strErrMsg = "错误：只能作废[已使用]的票据！"
                        GoTo errProc
                End Select
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备作废[" + strPJHM + "]票据吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                ...
                intStep = 3
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_WYBS)
                    strWYBS = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)

                    '处理
                    If objsystemEstateCaiwu.doPiaoju_Mark(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWYBS, Josco.JSOA.Common.Data.estateCaiwuData.enumPiaojuStatus.Zuofei, Nothing) = False Then
                        GoTo errProc
                    End If

                    '记录审计日志
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[财务_票据使用]中[作废]了[" + strPJHM + "]的资料！")
...
errProc:
        ...
        Private Sub doMarkUsed(ByVal strControlId As String)

            Dim objsystemEstateCaiwu As New Josco.JSOA.BusinessFacade.systemEstateCaiwu
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            Dim objParams As New System.Collections.Specialized.NameValueCollection
            Dim objDataGridProcess As New Josco.JsKernal.web.DataGridProcess
            Dim objMessageProcess As New Josco.JsKernal.web.MessageProcess
            Dim strErrMsg As String = ""
            ...
            Try
                ...
                If Me.htxtJBRY.Value.Trim = "" Then
                    strErrMsg = "错误：没有输入[开票人员]！"
                    GoTo errProc
                End If
                If Me.txtYWBH.Text.Trim = "" Then
                    strErrMsg = "错误：没有输入[业务编号]！"
                    GoTo errProc
                End If
                If Me.txtKPJE.Text.Trim = "" Then
                    strErrMsg = "错误：没有输入[开票金额]！"
                    GoTo errProc
                End If
                If objPulicParameters.isIntegerString(Me.txtKPJE.Text) = False Then
                    strErrMsg = "错误：无效的[开票金额]！"
                    GoTo errProc
                End If
                If Me.grdPIAOJU.SelectedIndex < 0 Then
                    strErrMsg = "错误：没有当前票据！"
                ...
                End If
                'zengxianglin 2008-11-18
                If Me.txtKPRQ.Text.Trim = "" Then
                    strErrMsg = "错误：没有输入[开票日期]！"
                    GoTo errProc
                End If
                If objPulicParameters.isDatetimeString(Me.txtKPRQ.Text) = False Then
                    strErrMsg = "错误：无效的[开票日期]！"
                    GoTo errProc
                End If
                If Me.ddlSFDM.SelectedIndex < 0 Then
                    strErrMsg = "错误：没有输入[税费类型]！"
                    GoTo errProc
                End If
                If Me.rblSFDX.SelectedIndex < 0 Then
                    strErrMsg = "错误：没有输入[收付对象]！"
                    GoTo errProc
                End If
                If Me.rblSFBZ.SelectedIndex < 0 Then
                    strErrMsg = "错误：没有输入[收付标志]！"
                    GoTo errProc
                End If
                'zengxianglin 2008-11-18
                '是否未用？
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_ZTBZ)
                strZTBZ = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                Dim intUnused As Integer = Josco.JSOA.Common.Data.estateCaiwuData.enumPiaojuStatus.Unused
                Select Case strZTBZ
                    Case intUnused.ToString
                    Case Else
                        strErrMsg = "错误：只能标记[未使用]的票据！"
                        GoTo errProc
                End Select
                '是否跳开？
                ...
                i = Me.grdPIAOJU.SelectedIndex
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_PJPH)
                strPJPH = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_PJHM)
                strPJHM = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_FGFH)
                strFGFH = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                Dim blnIS As Boolean = False
                If objsystemEstateCaiwu.isPjhmContinue(strErrMsg, MyBase.UserId, MyBase.UserPassword, strFGFH, strPJPH, strPJHM, blnIS) = False Then
                    GoTo errProc
                End If
                If blnIS = False Then
                    strErrMsg = "错误：不能跳开标记！"
                ...
                intStep = 3
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    Dim strWYPJHM As String = ""
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdPIAOJU, Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_WYPJHM)
                    strWYPJHM = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(i), intColIndex)
                    objParams.Clear()
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_YWBS, Me.htxtYWBH.Value)
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_KPJE, Me.txtKPJE.Text)
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_JBRY, Me.htxtJBRY.Value)
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_ZYSM, Me.txtZYSM.Text)
                    'zengxianglin 2008-11-18
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_KPRQ, Me.txtKPRQ.Text)
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_BJRY, MyBase.UserId)
                    objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_BJRQ, Now.ToString("yyyy-MM-dd HH:mm:ss"))
                    If Me.ddlSFDM.SelectedIndex < 0 Then
                        objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_SFDM, "")
                    Else
                        objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_SFDM, Me.ddlSFDM.SelectedItem.Value)
                    End If
                    If Me.rblSFDX.SelectedIndex < 0 Then
                        objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_SFDX, "")
                    Else
                        objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_SFDX, Me.rblSFDX.SelectedItem.Value)
                    End If
                    If Me.rblSFBZ.SelectedIndex < 0 Then
                        objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_SFBZ, "")
                    Else
                        objParams.Add(Josco.JSOA.Common.Data.estateCaiwuData.FIELD_DC_B_CW_PIAOJUSHIYONG_SFBZ, Me.rblSFBZ.SelectedItem.Value)
                    End If
                    'zengxianglin 2008-11-18

                    '处理
                    If objsystemEstateCaiwu.doPiaoju_Mark( _
                        strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                        strWYBS, _
                        Josco.JSOA.Common.Data.estateCaiwuData.enumPiaojuStatus.Used, _
                        objParams) = False Then
                        GoTo errProc
                    End If

                    '记录审计日志
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[财务_票据使用]中[使用]了[" + strWYPJHM + "]的票据！")
...
errProc:
        ...
        Private Sub doSelect_YWBH(ByVal strControlId As String)
...
errProc:
        ...
        Private Sub btnSelect_YWBH_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSelect_YWBH.Click
            Me.doSelect_YWBH("btnSelect_YWBH")
        End Sub
        ...
        Private Sub btnMarkUsed_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnMarkUsed.Click
            Me.doMarkUsed("btnMarkUsed")
        End Sub

        Private Sub btnMarkZuofei_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnMarkZuofei.Click
            Me.doMarkZuofei("btnMarkZuofei")
        End Sub
