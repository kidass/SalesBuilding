<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_cw_piaoju_jiankong.aspx.vb" Inherits="Josco.JSOA.web.estate_cw_piaoju_jiankong" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>票据使用情况监控台</title>
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmestate_cw_piaoju_jiankong" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
									<TD class="title" align="center" colSpan="3" height="30">票据使用情况监控台<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;业务号&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_YWBH" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="12"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;开票人&nbsp;</TD>
															...
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;批次&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_PJPC" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="5"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;票据号&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_PJHM" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="6"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;分行&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_FGFH" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="8"></asp:textbox></TD>
											...
											<TR>
												<TD>
													<DIV id="divPIAOJU" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 436px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 436px">
														<asp:datagrid id="grdPIAOJU" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体"
															...
															UseAccessibleHeader="True" Width="2460px">
															...
															<Columns>
																...
																<asp:ButtonColumn  ItemStyle-Width="160px" DataTextField="发给分行名称" SortExpression="发给分行名称" HeaderText="分行" CommandName="Select">
																...
																<asp:ButtonColumn  ItemStyle-Width="120px" DataTextField="开票日期" SortExpression="开票日期" HeaderText="开票日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
																...
																<asp:ButtonColumn  ItemStyle-Width="120px" DataTextField="作废日期" SortExpression="作废日期" HeaderText="作废日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
