<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_cw_piaoju_shiyong.aspx.vb" Inherits="Josco.JSOA.web.estate_cw_piaoju_shiyong" %>
...
<HTML>
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmestate_cw_piaoju_shiyong" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
									<TD class="title" align="center" colSpan="3" height="30">票据使用管理<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_KPRQMin" runat="server" Font-Size="12px" CssClass="textbox" Columns="11" Font-Names="宋体"></asp:textbox>~<asp:textbox id="txtPIAOJUSearch_KPRQMax" runat="server" Font-Size="12px" CssClass="textbox" Columns="11" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;票据状态&nbsp;</TD>
															<TD class="label" align="left"><asp:DropDownList id="ddlPIAOJUSearch_ZTBZ" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体"><asp:ListItem Value=""></asp:ListItem><asp:ListItem Value="0">未使用</asp:ListItem><asp:ListItem Value="1">已使用</asp:ListItem><asp:ListItem Value="2">已作废</asp:ListItem><asp:ListItem Value="4">已收回</asp:ListItem></asp:DropDownList></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;业务编号&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_YWBH" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="24"></asp:textbox></TD>
															...
															<TD class="label" align="left"><asp:textbox id="txtPIAOJUSearch_PJHM" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="16"></asp:textbox></TD>
											...
											<TR>
												<TD>
													<DIV id="divPIAOJU" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 368px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 368px">
														<asp:datagrid id="grdPIAOJU" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="核销人员名称" SortExpression="核销人员名称" HeaderText="核销人员" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="核销日期" SortExpression="核销日期" HeaderText="核销日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="核销标志名称" SortExpression="核销标志名称" HeaderText="核销" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
											...
											<tr id="trRow04">
											    <td style="BORDER-RIGHT: #66cccc 1px solid; BORDER-TOP: #66cccc 1px solid; BORDER-LEFT: #66cccc 1px solid; BORDER-BOTTOM: #66cccc 1px solid">
											        <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
											            <tr>
											                <td colspan="8" align="left" bgcolor="#ccff99" height="20" valign="middle">标记票据使用时需指定以下信息(只能顺序标记，不能跳开)：</td>
											            </tr>
											            <tr>
											                <TD class="labelNotNull" vAlign="middle" align="right">开票人员</td>
											                <TD class="label" vAlign="middle" align="left"><asp:TextBox ID="txtJBRY" Runat="server" CssClass="textbox" Columns="30"></asp:TextBox><asp:Button id="btnSelect_RYDM" Runat="server" CssClass="button" Text="…"></asp:Button><input type="hidden" id="htxtJBRY" runat="server" size="1"></td>
											                <!-- zengxianglin 2008-11-18-->
											                <TD class="labelNotNull" vAlign="middle" align="right">开票日期</td>
											                <TD class="label" vAlign="middle" align="left"><asp:TextBox ID="txtKPRQ" Runat="server" CssClass="textbox" Columns="14"></asp:TextBox></td>
											                <TD class="labelNotNull" vAlign="middle" align="right">收付对象</td>
											                <TD class="label" vAlign="middle" align="left">
																<asp:RadioButtonList ID="rblSFDX" Runat="server" CssClass="textbox" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Flow">
																	...
																	<asp:ListItem Value="乙" Selected="True">乙方</asp:ListItem>
																</asp:RadioButtonList>
											                </td>
											                <!-- zengxianglin 2008-11-18-->
											                <TD class="labelNotNull" vAlign="middle" align="right">税费类型</td>
											                <TD class="label" vAlign="middle" align="left"><asp:DropDownList ID="ddlSFDM" Runat="server" CssClass="textbox" Width="280px"></asp:DropDownList></td>
											            </tr>
											            <tr>
											                <TD class="labelNotNull" vAlign="middle" align="right">业务编号</td>
											                <TD class="label" vAlign="middle" align="left"><asp:TextBox ID="txtYWBH" Runat="server" CssClass="textbox" Columns="30" ReadOnly="True"></asp:TextBox><asp:Button id="btnSelect_YWBH" Runat="server" CssClass="button" Text="…"></asp:Button><input type="hidden" id="htxtYWBH" runat="server" size="1" NAME="htxtYWBH"></td>
											                <TD class="labelNotNull" vAlign="middle" align="right">开票金额(元)</td>
											                <TD class="label" vAlign="middle" align="left"><asp:TextBox ID="txtKPJE" Runat="server" CssClass="textbox" Columns="14"></asp:TextBox></td>
											                <!-- zengxianglin 2008-11-18-->
											                <TD class="labelNotNull" vAlign="middle" align="right">收付标志</td>
											                <TD class="label" vAlign="middle" align="left">
																<asp:RadioButtonList ID="rblSFBZ" Runat="server" CssClass="textbox" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Flow" Enabled="False">
																	<asp:ListItem Value="收" Selected="True">收款</asp:ListItem>
																	<asp:ListItem Value="付">付款</asp:ListItem>
																</asp:RadioButtonList>
											                </td>
											                <!-- zengxianglin 2008-11-18-->
											                <TD class="label" vAlign="middle" align="right">摘要</td>
											                <TD class="label" vAlign="middle" align="left"><asp:TextBox ID="txtZYSM" Runat="server" CssClass="textbox" Width="280px"></asp:TextBox></td>
											            </tr>
											        </table>
											    </td>
											</tr>
					...
					<TR id="trRow05">
						<TD align="center" colSpan="3">
						    <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
						        ...
						        <tr>
						            <td align="center">
							            <asp:Button id="btnMarkUsed" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 标记使用 " Height="36px"></asp:Button>
							            <asp:Button id="btnMarkZuofei" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text=" 票据作废 " Height="36px"></asp:Button>
