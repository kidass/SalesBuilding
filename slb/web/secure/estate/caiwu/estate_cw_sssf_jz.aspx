<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_cw_sssf_jz.aspx.vb" Inherits="Josco.JSOA.web.estate_cw_sssf_jz" %>
...
<HTML>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
        <form id="frmestate_cw_sssf_jz" method="post" runat="server">
                    ...
                    <TR>
                        ...
                        <TD vAlign="top" align="center">
                            <TABLE cellSpacing="0" cellPadding="0" border="0">
                                <TR id="trRow01">
                                    <TD class="title" align="center" colSpan="3" height="30">费用结转处理<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                                </TR>
                                <TR>
                                    <TD width="5"></TD>
                                    <TD vAlign="top">
                                        <DIV id="divMain">
                                            <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                                                                ...
                                                                <TD>
                                                                    <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                                                                        <TR>
                                                                            ...
                                                                            <TD class="label" align="left">
                                                                                <asp:DropDownList id="ddlSJSZSearch_SFBZ" runat="server" CssClass="textbox" Enabled="False">
                                                                                    <asp:ListItem Value=""></asp:ListItem>
                                                                                    <asp:ListItem Value="收" Selected="True">收</asp:ListItem>
                                                ...
                                                <TR>
                                                    <TD align="center">
                                                        <DIV id="divSJSZ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 251px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 251px">
                                                ...
                                                <TR id="trRow06">
                                                    <td>
                                                        <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                                                            <tr>
                                                                <TD class="label" align="left" bgColor="#ccff99"><B>&gt;&gt;&gt;&gt;费用结转时需指定以下信息</B></TD>
                                                            </tr>
                                                            <TR>
                                                                <TD align="center">
                                                                    <TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
                                                                        <TR>
                                                                            ...
                                                                            <TD class="label" style="BORDER-BOTTOM: #99cccc 1px solid" align="left" width="35%"><asp:DropDownList id="ddlSFDM" Runat="server" Width="100%" CssClass="textbox"></asp:DropDownList></TD>
