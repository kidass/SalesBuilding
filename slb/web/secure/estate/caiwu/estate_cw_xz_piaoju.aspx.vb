...
Namespace Josco.JSOA.web
    ...
    '
    ' 接口参数：
    '     参见接口类IEstateCwXzPiaoju描述
    '----------------------------------------------------------------

    Partial Class estate_cw_xz_piaoju
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateCwXzPiaoju
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateCwXzPiaoju
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateCwXzPiaoju)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    'zengxianglin 2008-11-22
                    Me.ddlPIAOJUSearch_YKPZ.SelectedIndex = .ddlPIAOJUSearch_YKPZ_SelectedIndex
                    'zengxianglin 2008-11-22
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateCwXzPiaoju
                ...
                With Me.m_objSaveScence
                    ...
                    'zengxianglin 2008-11-22
                    .ddlPIAOJUSearch_YKPZ_SelectedIndex = Me.ddlPIAOJUSearch_YKPZ.SelectedIndex
                    'zengxianglin 2008-11-22
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateCwXzPiaoju)
                Catch ex As Exception
                ...
                If Me.m_blnInterface = False Then
                    blnContinue = False
                    Me.lblMessage.Text = "错误：本模块必须提供接口！"
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateCwXzPiaoju)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
...
errProc:
        ...
        Private Function getQueryString_PIAOJU( _
            ...
            Try
                ...
                'zengxianglin 2008-11-22
                '按“已开凭证”搜索
                Select Case Me.ddlPIAOJUSearch_YKPZ.SelectedIndex
                    Case 1
                        If strQuery = "" Then
                            strQuery = "dbo.uf_estate_cw_YikaiCwpz(" + strPJHM + ") = 0"
                        Else
                            strQuery = strQuery + " and " + "dbo.uf_estate_cw_YikaiCwpz(" + strPJHM + ") = 0"
                        End If
                    Case 2
                        If strQuery = "" Then
                            strQuery = "dbo.uf_estate_cw_YikaiCwpz(" + strPJHM + ") = 1"
                        Else
                            strQuery = strQuery + " and " + "dbo.uf_estate_cw_YikaiCwpz(" + strPJHM + ") = 1"
                        End If
                End Select
                'zengxianglin 2008-11-22
            Catch ex As Exception
...
errProc:
        ...
        Private Function showModuleData_MAIN(ByRef strErrMsg As String) As Boolean
            ...
            Try
                If Me.m_objInterface.iAllowNull = True Then
                    Me.btnNull.Visible = True
                Else
...
errProc:
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                ...
                'zengxianglin 2008-11-22
                objControlProcess.doTranslateKey(Me.ddlPIAOJUSearch_YKPZ)
                'zengxianglin 2008-11-22
                ...
                If Me.m_blnSaveScence = False Then
                    '显示数据
                    Me.txtPIAOJUSearch_YWBH.Text = Me.m_objInterface.iYWBH
...
errProc:
        ...
        Private Sub doOK(ByVal strControlId As String)
            ...
            Try
                '检查
                If Me.grdPIAOJU.Items.Count < 1 Then
                    strErrMsg = "错误：没有[票据]！"
                    GoTo errProc
                End If
                If Me.grdPIAOJU.SelectedIndex < 0 Then
                    ...
                    GoTo errProc
                End If
                Dim intIndex As Integer = Me.grdPIAOJU.SelectedIndex
                ...
                strWYBS = objDataGridProcess.getDataGridCellValue(Me.grdPIAOJU.Items(intIndex), intColIndex)
                ...
                If Me.m_blnInterface = True Then
                    '设置返回参数
                    Me.m_objInterface.oExitMode = True
                    Me.m_objInterface.oWYBS = strWYBS
                    '返回到调用模块，并附加返回参数
                    '要返回的SessionId
                    strSessionId = Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId)
                    'SessionId附加到返回的Url
