...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_gg_wuyejiange
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_gg_wuyejiange_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateGgWuyeJiange
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateGgWuyeJiange
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateGgWuyeJiange)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtWYJGDM.Text = .txtWYJGDM
                    Me.txtWYJGMC.Text = .txtWYJGMC

                    Me.txtSearch_WYJGDM.Text = .txtSearch_WYJGDM
                    Me.txtSearch_WYJGMC.Text = .txtSearch_WYJGMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateGgWuyeJiange
                ...
                With Me.m_objSaveScence
                    ...
                    .txtWYJGDM = Me.txtWYJGDM.Text
                    .txtWYJGMC = Me.txtWYJGMC.Text

                    .txtSearch_WYJGDM = Me.txtSearch_WYJGDM.Text
                    .txtSearch_WYJGMC = Me.txtSearch_WYJGMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateGgWuyeJiange)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateGgWuyeJiange)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strWYJGDM As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGDM
                If Me.txtSearch_WYJGDM.Text.Length > 0 Then Me.txtSearch_WYJGDM.Text = Me.txtSearch_WYJGDM.Text.Trim()
                If Me.txtSearch_WYJGDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strWYJGDM + " like '" + Me.txtSearch_WYJGDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strWYJGDM + " like '" + Me.txtSearch_WYJGDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strWYJGMC As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGMC
                If Me.txtSearch_WYJGMC.Text.Length > 0 Then Me.txtSearch_WYJGMC.Text = Me.txtSearch_WYJGMC.Text.Trim()
                If Me.txtSearch_WYJGMC.Text <> "" Then
                    Me.txtSearch_WYJGMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_WYJGMC.Text)
                    If strQuery = "" Then
                        strQuery = strWYJGMC + " like '" + Me.txtSearch_WYJGMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strWYJGMC + " like '" + Me.txtSearch_WYJGMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With objsystemEstateCommon
                    If .getDataSet_WuyeJiange(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateCommonData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGMC)
                        Me.txtWYJGDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtWYJGMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                Else
                    '编辑状态
                    '自动恢复数据
                ...
                With objControlProcess
                    .doEnabledControl(Me.txtWYJGDM, blnEditMode)
                    .doEnabledControl(Me.txtWYJGMC, blnEditMode)
                End With
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateCommonData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_WYJGDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_WYJGMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_WYJGDM)
                        .doTranslateKey(Me.txtSearch_WYJGMC)
                        .doTranslateKey(Me.txtWYJGDM)
                        .doTranslateKey(Me.txtWYJGMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[地产_物业间隔]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGDM, Me.txtWYJGDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGMC, Me.txtWYJGMC.Text)
                ...
                '保存信息
                With objsystemEstateCommon
                    If .doSaveData_WuyeJiange(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_物业间隔]字典中增加了[" + Me.txtWYJGMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[地产_物业间隔]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strWYJGMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_WUYEJIANGE_WYJGMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strWYJGMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateCommon.doDeleteData_WuyeJiange(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_物业间隔]字典中删除了[" + strWYJGMC + "]！")
                        End If
                    Next
