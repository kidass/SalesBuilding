...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_gg_quyuhuafen
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_gg_quyuhuafen_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateGgQuyuHuafen
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateGgQuyuHuafen
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateGgQuyuHuafen)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtQYDM.Text = .txtQYDM
                    Me.txtQYMC.Text = .txtQYMC

                    Me.txtSearch_QYDM.Text = .txtSearch_QYDM
                    Me.txtSearch_QYMC.Text = .txtSearch_QYMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateGgQuyuHuafen
                ...
                With Me.m_objSaveScence
                    ...
                    .txtQYDM = Me.txtQYDM.Text
                    .txtQYMC = Me.txtQYMC.Text

                    .txtSearch_QYDM = Me.txtSearch_QYDM.Text
                    .txtSearch_QYMC = Me.txtSearch_QYMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateGgQuyuHuafen)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateGgQuyuHuafen)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strQYDM As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYDM
                If Me.txtSearch_QYDM.Text.Length > 0 Then Me.txtSearch_QYDM.Text = Me.txtSearch_QYDM.Text.Trim()
                If Me.txtSearch_QYDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strQYDM + " like '" + Me.txtSearch_QYDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strQYDM + " like '" + Me.txtSearch_QYDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strQYMC As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYMC
                If Me.txtSearch_QYMC.Text.Length > 0 Then Me.txtSearch_QYMC.Text = Me.txtSearch_QYMC.Text.Trim()
                If Me.txtSearch_QYMC.Text <> "" Then
                    Me.txtSearch_QYMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_QYMC.Text)
                    If strQuery = "" Then
                        strQuery = strQYMC + " like '" + Me.txtSearch_QYMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strQYMC + " like '" + Me.txtSearch_QYMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With objsystemEstateCommon
                    If .getDataSet_QuyuHuafen(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateCommonData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYMC)
                        Me.txtQYDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtQYMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                Else
                    '编辑状态
                    '自动恢复数据
                ...
                With objControlProcess
                    .doEnabledControl(Me.txtQYDM, blnEditMode)
                    .doEnabledControl(Me.txtQYMC, blnEditMode)
                End With
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateCommonData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_QYDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_QYMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_QYDM)
                        .doTranslateKey(Me.txtSearch_QYMC)
                        .doTranslateKey(Me.txtQYDM)
                        .doTranslateKey(Me.txtQYMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[地产_区域划分]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYDM, Me.txtQYDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYMC, Me.txtQYMC.Text)
                ...
                '保存信息
                With objsystemEstateCommon
                    If .doSaveData_QuyuHuafen(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_区域划分]字典中增加了[" + Me.txtQYMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[地产_区域划分]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strQYMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_QUYUHUAFEN_QYMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strQYMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateCommon.doDeleteData_QuyuHuafen(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_区域划分]字典中删除了[" + strQYMC + "]！")
                        End If
                    Next
