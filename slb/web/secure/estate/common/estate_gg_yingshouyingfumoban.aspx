<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_gg_yingshouyingfumoban.aspx.vb" Inherits="Josco.JSOA.web.estate_gg_yingshouyingfumoban" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>应收应付模版编辑窗</title>
		...
		<!--
			function window_onresize() 
			{
				...
				dblHeight = 250 + dblDeltaY + document.body.clientHeight - 570; //default state : 250px
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()" background="../../../images/bgmain.gif">
		<form id="frmestate_gg_yingshouyingfumoban" method="post" runat="server">
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtSearch_MBDM" runat="server" Font-Size="11pt" Columns="20" CssClass="textbox" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;名称&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_MBMC" runat="server" Font-Size="11pt" Columns="48" CssClass="textbox" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label">&nbsp;&nbsp;<asp:button id="btnSearch" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text="搜索"></asp:button><asp:button id="btnSearchFull" Runat="server" Font-Size="11pt" Font-Name="宋体" CssClass="button" Text="全文搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 100%; CLIP: rect(0px 100% 250px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 250px">
														<asp:datagrid id="grdObjects" runat="server" Font-Size="11pt" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="模版代码" SortExpression="模版代码" HeaderText="代码" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="320px" DataTextField="模版名称" SortExpression="模版名称" HeaderText="名称" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="240px" DataTextField="税费名称" SortExpression="税费名称" HeaderText="税费名称" CommandName="Select">
																	<HeaderStyle Width="240px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="收付对象" SortExpression="收付对象" HeaderText="对象" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="收付标志" SortExpression="收付标志" HeaderText="收付" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="是否明细" SortExpression="是否明细" HeaderText="是否明细" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="是否明细名称" SortExpression="是否明细名称" HeaderText="明细" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
								...
								<TR>
									...
									<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="center" height="20"><B>应收应付模版编辑窗</B></TD>
											</TR>
											<TR>
												<TD class="label" align="center">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															...
															<TD class="label" align="left" width="60%" nowrap><asp:textbox id="txtMBDM" Runat="server" Font-Size="11pt" Font-Name="宋体" Columns="23" CssClass="textbox"></asp:textbox><SPAN class="label" style="COLOR: red">(nnn.nnn.nnn.nnn.nnn.nnn)</SPAN></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtMBMC" Runat="server" Font-Size="11pt" Font-Name="宋体" Columns="48" CssClass="textbox"></asp:textbox></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															<TD class="labelNotNull" align="right">税费(*)：</TD>
															<TD class="label" align="left" nowrap><asp:DropDownList ID="ddlSFDM" Runat="server" CssClass="textbox" Font-Name="宋体" Font-Size="11pt"></asp:DropDownList></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															<TD class="labelNotNull" align="right">对象(*)：</TD>
															<TD class="label" align="left" nowrap><asp:RadioButtonList ID="rblSFDX" Runat="server" CssClass="textbox" Font-Name="宋体" Font-Size="11pt" RepeatColumns="3" RepeatLayout="Flow" RepeatDirection="Horizontal"><asp:ListItem Value="甲">甲方</asp:ListItem><asp:ListItem Value="乙">乙方</asp:ListItem><asp:ListItem Value="">空</asp:ListItem></asp:RadioButtonList></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															<TD class="labelNotNull" align="right">收付(*)：</TD>
															<TD class="label" align="left" nowrap><asp:RadioButtonList ID="rblSFBZ" Runat="server" CssClass="textbox" Font-Name="宋体" Font-Size="11pt" RepeatColumns="3" RepeatLayout="Flow" RepeatDirection="Horizontal"><asp:ListItem Value="收">收</asp:ListItem><asp:ListItem Value="付">付</asp:ListItem><asp:ListItem Value="">空</asp:ListItem></asp:RadioButtonList></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															<TD class="labelNotNull" align="right">明细项目(*)：</TD>
															<TD class="label" align="left" nowrap><asp:RadioButtonList ID="rblSFMX" Runat="server" CssClass="textbox" Font-Name="宋体" Font-Size="11pt" RepeatColumns="2" RepeatLayout="Flow" RepeatDirection="Horizontal"><asp:ListItem Value="1">是</asp:ListItem><asp:ListItem Value="0">否</asp:ListItem></asp:RadioButtonList></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
