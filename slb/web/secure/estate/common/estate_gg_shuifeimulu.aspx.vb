...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_gg_shuifeimulu
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_gg_shuifeimulu_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateGgShuifeiMulu
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateGgShuifeiMulu
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateGgShuifeiMulu)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtSFDM.Text = .txtSFDM
                    Me.txtSFMC.Text = .txtSFMC

                    Me.txtSearch_SFDM.Text = .txtSearch_SFDM
                    Me.txtSearch_SFMC.Text = .txtSearch_SFMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateGgShuifeiMulu
                ...
                With Me.m_objSaveScence
                    ...
                    .txtSFDM = Me.txtSFDM.Text
                    .txtSFMC = Me.txtSFMC.Text

                    .txtSearch_SFDM = Me.txtSearch_SFDM.Text
                    .txtSearch_SFMC = Me.txtSearch_SFMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateGgShuifeiMulu)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateGgShuifeiMulu)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strSFDM As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFDM
                If Me.txtSearch_SFDM.Text.Length > 0 Then Me.txtSearch_SFDM.Text = Me.txtSearch_SFDM.Text.Trim()
                If Me.txtSearch_SFDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strSFDM + " like '" + Me.txtSearch_SFDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strSFDM + " like '" + Me.txtSearch_SFDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strSFMC As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFMC
                If Me.txtSearch_SFMC.Text.Length > 0 Then Me.txtSearch_SFMC.Text = Me.txtSearch_SFMC.Text.Trim()
                If Me.txtSearch_SFMC.Text <> "" Then
                    Me.txtSearch_SFMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_SFMC.Text)
                    If strQuery = "" Then
                        strQuery = strSFMC + " like '" + Me.txtSearch_SFMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strSFMC + " like '" + Me.txtSearch_SFMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With objsystemEstateCommon
                    If .getDataSet_ShuifeiMulu(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateCommonData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFMC)
                        Me.txtSFDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtSFMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                Else
                    '编辑状态
                    '自动恢复数据
                ...
                With objControlProcess
                    .doEnabledControl(Me.txtSFDM, blnEditMode)
                    .doEnabledControl(Me.txtSFMC, blnEditMode)
                End With
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateCommonData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_SFDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_SFMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_SFDM)
                        .doTranslateKey(Me.txtSearch_SFMC)
                        .doTranslateKey(Me.txtSFDM)
                        .doTranslateKey(Me.txtSFMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[地产_税费目录]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFDM, Me.txtSFDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFMC, Me.txtSFMC.Text)
                ...
                '保存信息
                With objsystemEstateCommon
                    If .doSaveData_ShuifeiMulu(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_税费目录]字典中增加了[" + Me.txtSFMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[地产_税费目录]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strSFMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_SHUIFEIMULU_SFMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strSFMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateCommon.doDeleteData_ShuifeiMulu(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_税费目录]字典中删除了[" + strSFMC + "]！")
                        End If
                    Next
