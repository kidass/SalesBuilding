...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_gg_baxm_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateGgBaxm
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateGgBaxm
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateGgBaxm)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtXMDM.Text = .txtXMDM
                    Me.txtXMMC.Text = .txtXMMC

                    Me.txtSearch_XMDM.Text = .txtSearch_XMDM
                    Me.txtSearch_XMMC.Text = .txtSearch_XMMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateGgBaxm
                ...
                With Me.m_objSaveScence
                    ...
                    .txtXMDM = Me.txtXMDM.Text
                    .txtXMMC = Me.txtXMMC.Text

                    .txtSearch_XMDM = Me.txtSearch_XMDM.Text
                    .txtSearch_XMMC = Me.txtSearch_XMMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateGgBaxm)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateGgBaxm)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strXMDM As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMDM
                If Me.txtSearch_XMDM.Text.Length > 0 Then Me.txtSearch_XMDM.Text = Me.txtSearch_XMDM.Text.Trim()
                If Me.txtSearch_XMDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strXMDM + " like '" + Me.txtSearch_XMDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strXMDM + " like '" + Me.txtSearch_XMDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strXMMC As String = "a." + Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMMC
                If Me.txtSearch_XMMC.Text.Length > 0 Then Me.txtSearch_XMMC.Text = Me.txtSearch_XMMC.Text.Trim()
                If Me.txtSearch_XMMC.Text <> "" Then
                    Me.txtSearch_XMMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_XMMC.Text)
                    If strQuery = "" Then
                        strQuery = strXMMC + " like '" + Me.txtSearch_XMMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strXMMC + " like '" + Me.txtSearch_XMMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateCommonData.TABLE_DC_B_GG_BAXM
            ...
            Try
                ...
                With objsystemEstateCommon
                    If .getDataSet_BAXM(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateCommonData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMMC)
                        Me.txtXMDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtXMMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                Else
                    '编辑状态
                    '自动恢复数据
                ...
                With objControlProcess
                    .doEnabledControl(Me.txtXMDM, blnEditMode)
                    .doEnabledControl(Me.txtXMMC, blnEditMode)
                End With
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateCommonData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_XMDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_XMMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_XMDM)
                        .doTranslateKey(Me.txtSearch_XMMC)
                        .doTranslateKey(Me.txtXMDM)
                        .doTranslateKey(Me.txtXMMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[地产_办案项目]字典！")
                End If
            End If
normExit:
            Josco.JsKernal.web.MessageProcess.SafeRelease(objMessageProcess)
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMDM, Me.txtXMDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMMC, Me.txtXMMC.Text)
                ...
                '保存信息
                With objsystemEstateCommon
                    If .doSaveData_BAXM(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_办案项目]字典中增加了[" + Me.txtXMMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[地产_办案项目]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateCommonData.FIELD_DC_B_GG_BAXM_XMMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strXMMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateCommon.doDeleteData_BAXM(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[地产_办案项目]字典中删除了[" + strXMMC + "]！")
                        End If
                    Next
