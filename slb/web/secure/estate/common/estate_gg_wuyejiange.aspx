<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_gg_wuyejiange.aspx.vb" Inherits="Josco.JSOA.web.estate_gg_wuyejiange" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>物业间隔代码编辑窗</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()" background="../../../images/bgmain.gif">
		<form id="frmestate_gg_wuyejiange" method="post" runat="server">
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right">物业间隔代码&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_WYJGDM" runat="server" Font-Size="11pt" Columns="20" CssClass="textbox" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;物业间隔名称&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearch_WYJGMC" runat="server" Font-Size="11pt" Columns="48" CssClass="textbox" Font-Names="宋体"></asp:textbox></TD>
													...
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 100%; CLIP: rect(0px 100% 330px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 330px">
														<asp:datagrid id="grdObjects" runat="server" Font-Size="11pt" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="间隔代码" SortExpression="间隔代码" HeaderText="物业间隔代码" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="780px" DataTextField="间隔名称" SortExpression="间隔名称" HeaderText="物业间隔名称" CommandName="Select">
								...
								<TR>
									...
									<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="center" height="20"><B>物业间隔代码编辑窗</B></TD>
											</TR>
											<TR>
												<TD class="label" align="center">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="labelNotNull" align="right" width="40%">物业间隔代码(*)：</TD>
															<TD class="label" align="left" width="60%" nowrap><asp:textbox id="txtWYJGDM" Runat="server" Font-Size="11pt" Font-Name="宋体" Columns="23" CssClass="textbox"></asp:textbox><SPAN class="label" style="COLOR: red">(nnn.nnn.nnn.nnn)</SPAN></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															<TD class="labelNotNull" align="right">物业间隔名称(*)：</TD>
															<TD class="label" align="left"><asp:textbox id="txtWYJGMC" Runat="server" Font-Size="11pt" Font-Name="宋体" Columns="48" CssClass="textbox"></asp:textbox></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
