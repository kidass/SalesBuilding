...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_bb_eszszgkh
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsBbEsZszgkh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsBbEsZszgkh
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    End Try
                    Try
                        Me.ddlJD.SelectedIndex = .ddlJD_SelectedIndex
                    Catch ex As Exception
                    End Try
                    Me.txtND.Text = .txtND
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsBbEsZszgkh
                ...
                With Me.m_objSaveScence
                    ...
                    .ddlJD_SelectedIndex = Me.ddlJD.SelectedIndex
                    .txtND = Me.txtND.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsBbEsZszgkh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsBbEsZszgkh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
        ...
        Private Function doCheckParam(ByRef strErrMsg As String) As Boolean
            ...
            Try
                If Me.txtND.Text.Trim = "" Then
                    strErrMsg = "错误：没有指定[考核年度]！"
                    GoTo errProc
                End If
                If objPulicParameters.isIntegerString(Me.txtND.Text) = False Then
                    strErrMsg = "错误：无效的[考核年度]！"
                    GoTo errProc
                End If
                Dim intND As Integer = objPulicParameters.getObjectValue(Me.txtND.Text, 0)
                If intND < 1 Or intND > 9999 Then
                    strErrMsg = "错误：无效的[考核年度]！"
                    GoTo errProc
                End If
                ...
                If Me.ddlJD.SelectedIndex < 0 Then
                    strErrMsg = "错误：必须选定[考核季度]！"
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function getReportParam( _
            ...
            Try
                ...
                intND = objPulicParameters.getObjectValue(Me.txtND.Text, 0)
                intJD = objPulicParameters.getObjectValue(Me.ddlJD.SelectedItem.Value, 0)
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.TABLE_DC_VT_RS_ZSZGKH
            Dim objsystemEstateRenshiXingye As New Josco.JSOA.BusinessFacade.systemEstateRenshiXingye
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateRenshiXingyeData(Josco.JSOA.Common.Data.estateRenshiXingyeData.enumTableType.DC_VT_RS_ZSZGKH)
                    Else
                        '获取参数
                        If Me.getReportParam(strErrMsg, intND, intJD, strBMDM, intYJZR) = False Then
                            GoTo errProc
                        End If
                        '重新检索数据
                        If objsystemEstateRenshiXingye.getDataSet_BB_RSRYKH_ZSZG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strBMDM, intND, intJD, intYJZR, "<br>", Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        Private Function getModuleData01( _
            ...
            Try
                ...
                '计算数据
                '获取参数
                If Me.getReportParam01(strErrMsg, intND, intJD, intYJZR) = False Then
                    GoTo errProc
                End If
                '重新检索数据
                If objsystemEstateRenshiXingye.getDataSet_BB_RSRYKH_ZSZG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strBMDM, intND, intJD, intYJZR, "<br>", objDataSet) = False Then
                    GoTo errProc
                End If
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    objControlProcess.doTranslateKey(Me.ddlJD)
                    '=======================================================================
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                End If
                Dim strBMMC As String = ""
                strBMMC = Me.ddlZZDM.SelectedItem.Text.Split("|".ToCharArray)(1)

                '准备Excel文件
                Dim strDesExcelPath As String = Request.ApplicationPath + Me.m_cstrUrlBaseToDownloadFile
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_人事报表_分行人员职级考核表.xls"
                ...
                strMacroName = "$Macro$BMMC$"
                strMacroValue = strBMMC
                strMacroName = strMacroName + strSep + "$Macro$ND$"
                strMacroValue = strMacroValue + strSep + intND.ToString
                strMacroName = strMacroName + strSep + "$Macro$JD$"
                strMacroValue = strMacroValue + strSep + intJD.ToString

                '输出数据
                If objsystemEstateRenshiXingye.doPrint_BB_RSRYKH_ZSZG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strBMDM, intND, intJD, intYJZR, Me.m_objDataSet, strDesExcelSpec, strMacroName, strMacroValue) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doExportSelect(ByVal strControlId As String)
            ...
            Try
                ...
                Dim intCount As Integer
                Dim i As Integer
                strSrcExcelSpec = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_人事报表_分行人员职级考核表.xls"
                strSrcExcelSpec = Server.MapPath(strSrcExcelSpec)
                ...
                For i = 0 To intCount - 1 Step 1
                    If Me.tvwTJBM.Nodes(i).Checked = True Then
                        ...
                        '输出数据
                        If objsystemEstateRenshiXingye.doPrint_BB_RSRYKH_ZSZG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strBMDM, intND, intJD, intYJZR, objDataSet, strDesExcelSpec, strMacroName, strMacroValue) = False Then
                            GoTo errProc
                        End If
                        Josco.JSOA.Common.Data.estateRenshiXingyeData.SafeRelease(objDataSet)

                        '写入统一的输出文件
                        If objsystemEstateRenshiXingye.doExcelAddCopy(strErrMsg, strDesExcelSpec, "数据", strFinalSpec, strBMMC) = False Then
                            GoTo errProc
                        End If
                    End If
                Next
                ...
                If strFinalSpec <> "" Then
                    If objsystemEstateRenshiXingye.doExcelSheetDelete(strErrMsg, strFinalSpec, "Sheet1") = False Then
                        '忽略
                    End If
                End If
