<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_renyuanjiagou_mdfy_x2.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_renyuanjiagou_mdfy_x2" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>人员内部变动处理(模式二)</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" background="../../../images/bgmain.gif" onresize="javascript:window_onresize()">
		<form id="frmestate_rs_renyuanjiagou_mdfy_x2" method="post" runat="server">
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
						...
						<TD vAlign="top" align="center">
							<DIV id="divMain" style="OVERFLOW: auto; WIDTH: 996px; CLIP: rect(0px 464px 996px 0px); HEIGHT: 464px">
								<TABLE cellSpacing="0" cellPadding="0" border="0">
									<TR>
										<TD class="title" align="left" bgColor="#ccff99">&gt;&gt;&gt;&gt;现有人员一览表 (共计<asp:Label id="lblRYSM" Runat="server" CssClass="label"></asp:Label>人)</TD>
									</TR>
									<TR>
										<TD align="center">
									...
									<TR>
										<TD vAlign="middle" align="right">&nbsp;人员代码&nbsp;
											<asp:TextBox id="txtSearch_RY_RYDM" Runat="server" CssClass="textbox" Columns="11"></asp:TextBox>&nbsp;人员名称&nbsp;
											<asp:TextBox id="txtSearch_RY_RYMC" Runat="server" CssClass="textbox" Columns="11"></asp:TextBox>&nbsp;单位名称&nbsp;
											<asp:TextBox id="txtSearch_RY_DWMC" Runat="server" CssClass="textbox" Columns="11"></asp:TextBox>&nbsp;职级代码&nbsp;
											<asp:TextBox id="txtSearch_RY_ZJDM" Runat="server" CssClass="textbox" Columns="11"></asp:TextBox>
											<asp:Button  id="btnSearch"         Runat="server" CssClass="button" Text="快速搜索"></asp:Button>
                                            <asp:Button  id="btnSearchFull_RY"  Runat="server" CssClass="button" Text="全文搜索"></asp:Button>
									...
									<TR>
										<TD class="title" align="left" bgColor="#ccff99">&gt;&gt;&gt;&gt;可以调整以下内容<input id="htxtBZXL" type="hidden" runat="server" name="htxtBZXL" value="2"></TD>
									</TR>
									<TR>
										<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" align="center">
											<TABLE cellSpacing="0" cellPadding="0" border="0">
												<TR>
													<TD class="labelNotNull" align="right">调整时间：</TD>
													<TD class="label" align="left"><asp:TextBox id="txtSXSJ" Runat="server" CssClass="textbox" Width="350px"></asp:TextBox>&nbsp;必须大于(<asp:TextBox ID="txtKSSJ" Runat="server" CssClass="textbox" Width="90px" ReadOnly="True"></asp:TextBox>)</TD>
												</TR>
												<TR>
													<TD class="labelNotNull" align="right">调整原因：</TD>
													<TD class="label" align="left"><asp:DropDownList id="ddlYDYY" Runat="server" CssClass="textbox" Width="350px"></asp:DropDownList></TD>
												</TR>
												<TR>
												...
												<TR>
													...
													<TD align="left"><asp:DropDownList id="ddlZJDM" Runat="server" CssClass="textbox" Width="350px"></asp:DropDownList></TD>
												</TR>
												<TR>
													<TD class="labelNotNull" align="right">新的单位：</TD>
													<TD class="label" align="left"><asp:TextBox id="txtSSDW" Runat="server" CssClass="textbox" Width="350px" ReadOnly="True"></asp:TextBox><INPUT id="htxtSSDW" type="hidden" size="1" runat="server" NAME="htxtSSDW"><asp:Button id="btnSelectZZDM" Runat="server" CssClass="button" Text="…"></asp:Button></TD>
												</TR>
												<TR>
													<TD class="label" align="right">新的团队：</TD>
													<TD class="label" align="left"><asp:TextBox id="txtTDBH" Runat="server" CssClass="textbox" Width="350px"></asp:TextBox><asp:Button id="btnSelectTDBH" Runat="server" CssClass="button" Text="…"></asp:Button><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务人员，请指定占编部门所在团队</font></TD>
												</TR>
												<TR>
													<TD class="label" align="right">直管团队：</TD>
													<TD class="label" align="left"><asp:ListBox ID="lstZGTD" Runat="server" CssClass="textbox" Rows="4" SelectionMode="Multiple" Width="350px"></asp:ListBox><input type="hidden" id="htxtZGTD" runat="server" name="htxtZGTD"><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务经理以上人员，根据实际填写本项内容</font></TD>
												</TR>
												<tr>
													<td></td>
													<td class="label" align="left"><asp:Button id="btnSelectZGTD" Runat="server" CssClass="button" Text="重选"></asp:Button><asp:Button id="btnAddnewZGTD" Runat="server" CssClass="button" Text="增加"></asp:Button><asp:Button id="btnDeleteZGTD" Runat="server" CssClass="button" Text="删除"></asp:Button></td>
												</tr>
												<TR height="148">
													<TD class="label" align="right">协管团队：</TD>
													<TD class="label" align="left"><asp:ListBox ID="lstXGTD" Runat="server" CssClass="textbox" Rows="8" SelectionMode="Multiple" Width="350px"></asp:ListBox><input type="hidden" id="htxtXGTD" runat="server" name="htxtXGTD"><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务经理以上人员，根据实际填写本项内容</font></TD>
												</TR>
												<tr>
													<td></td>
													<td class="label" align="left"><asp:Button id="btnSelectXGTD" Runat="server" CssClass="button" Text="重选"></asp:Button><asp:Button id="btnAddnewXGTD" Runat="server" CssClass="button" Text="增加"></asp:Button><asp:Button id="btnDeleteXGTD" Runat="server" CssClass="button" Text="删除"></asp:Button></td>
												</tr>
												<TR>
													<TD class="label" align="right"><span style="display:none">服务分组：</span></TD>
													<TD class="label" align="left"><span style="display:none"><asp:DropDownList id="ddlSSFZ" runat="server" CssClass="textbox" Width="350px"></asp:DropDownList><asp:Button ID="btnJSFZLB" Runat="server" CssClass="button" Text="…"></asp:Button><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务人员，根据实际填写本项内容</font></span></TD>
												</TR>
												<TR>
													<TD class="label" align="right"><span style="display:none">直管单位：</span></TD>
													<TD class="label" align="left"><span style="display:none"><asp:TextBox id="txtZGDW" Runat="server" CssClass="textbox" Width="350px" ReadOnly="True"></asp:TextBox><INPUT id="htxtZGDW" type="hidden" size="1" runat="server" NAME="htxtZGDW"><asp:Button id="btnSelectZGDW" Runat="server" CssClass="button" Text="…"></asp:Button><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务经理以上的人员，根据实际填写本项内容</font></span></TD>
												</TR>
												<TR>
													<TD class="label" align="right"><span style="display:none">规谁领导：</span></TD>
													<TD class="label" align="left"><span style="display:none"><asp:TextBox id="txtSJLD" Runat="server" CssClass="textbox" Width="350px" ReadOnly="True"></asp:TextBox><INPUT id="htxtSJLD" type="hidden" size="1" runat="server" NAME="htxtSJLD"><asp:Button id="btnSelectSJLD" Runat="server" CssClass="button" Text="…"></asp:Button><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务人员，请别忘记填写本项内容</font></span></TD>
												</TR>
											</TABLE>
										</TD>
									</TR>
					...
					<TR id="trRow2">
						<TD style="BORDER-TOP: #99cccc 2px solid" vAlign="middle" align="center" height="36">
							<input      id="btnViewJG"     type="button"  class   ="button" value=" 查看架构 " style="HEIGHT: 32px" onclick="onclick_btnViewJG()">
