...
Namespace Josco.JSOA.web
    ...
    '----------------------------------------------------------------
    ' 命名空间：Josco.JSOA.web
    ' 类名    ：estate_rs_renyuanjiagou_add_mn
    ' 
    ' 调用性质：
    '     独立运行
    '
    ...
    Partial Class estate_rs_renyuanjiagou_add_mn
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Else
                Select Case intBZXL
                    Case 1    '模式一
                        Response.Redirect("estate_rs_renyuanjiagou_add.aspx" + Request.Url.Query)
                    Case 2    '模式二
                        Response.Redirect("estate_rs_renyuanjiagou_add_x2.aspx" + Request.Url.Query)
                    Case Else '其他
                        Response.Redirect("estate_rs_renyuanjiagou_add_x2.aspx" + Request.Url.Query)
                End Select
            End If
