...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_bb_esrlzyxxhzb
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsBbEsRlzyxxhzb
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsBbEsRlzyxxhzb
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsBbEsRlzyxxhzb
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsBbEsRlzyxxhzb)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsBbEsRlzyxxhzb)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function doCheckParam(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                If objPulicParameters.isIntegerString(Me.txtYJZR.Text) = False Then
                    ...
                    Exit Try
                End If
                intValue = CType(Me.txtYJZR.Text, Integer)
                If intValue <= 0 Or intValue > 28 Then
                    strErrMsg = "错误：无效的[月截止日]！"
                    Exit Try
                End If
        ...
        Private Function getReportParam( _
            ...
            ByRef strYJZR As String) As Boolean
            ...
            Try
                ...
                strKSRQ = intND.ToString + "-" + intYD.ToString + "-01"
                objDate = CType(strKSRQ, System.DateTime)
                strZZRQ = objDate.AddMonths(1).AddDays(-1).ToString("yyyy-MM-dd")
                strYJZR = Me.txtYJZR.Text
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiGeneralData.TABLE_RS_VT_RLZYXXHZB
            Dim objsystemEstateRenshiGeneral As New Josco.JSOA.BusinessFacade.systemEstateRenshiGeneral
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            ...
            Try
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateRenshiGeneralData(Josco.JSOA.Common.Data.estateRenshiGeneralData.enumTableType.RS_VT_RLZYXXHZB)
                    Else
                        '获取参数
                        If Me.getReportParam(strErrMsg, strKSRQ, strZZRQ, strYJZR) = False Then
                            GoTo errProc
                        End If
                        '重新检索数据
                        If objsystemEstateRenshiGeneral.getDataSet_BB_RLZYXXHZB(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ, strYJZR, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_人事管理_人力资源信息汇总表.xls"
                ...
                strMacroName = "$Macro$KSRQ$"
                strMacroValue = strKSRQ
                strMacroName = strMacroName + strSep + "$Macro$ZZRQ$"
                strMacroValue = strMacroValue + strSep + strZZRQ
