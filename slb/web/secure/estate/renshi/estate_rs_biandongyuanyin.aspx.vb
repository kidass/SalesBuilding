...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_biandongyuanyin
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_rs_biandongyuanyin_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsBiandongYuanyin
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsBiandongYuanyin
        ...
        '当前处理的数据集
        '----------------------------------------------------------------
        Private m_objestateRenshiGeneralData As Josco.JSOA.Common.Data.estateRenshiGeneralData
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateRsBiandongYuanyin)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtYYDM.Text = .txtYYDM
                    Me.txtYYMC.Text = .txtYYMC

                    Me.txtSearch_YYDM.Text = .txtSearch_YYDM
                    Me.txtSearch_YYMC.Text = .txtSearch_YYMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsBiandongYuanyin
                ...
                With Me.m_objSaveScence
                    ...
                    .txtYYDM = Me.txtYYDM.Text
                    .txtYYMC = Me.txtYYMC.Text

                    .txtSearch_YYDM = Me.txtSearch_YYDM.Text
                    .txtSearch_YYMC = Me.txtSearch_YYMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsBiandongYuanyin)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsBiandongYuanyin)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strYYDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYDM
                If Me.txtSearch_YYDM.Text.Length > 0 Then Me.txtSearch_YYDM.Text = Me.txtSearch_YYDM.Text.Trim()
                If Me.txtSearch_YYDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strYYDM + " like '" + Me.txtSearch_YYDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strYYDM + " like '" + Me.txtSearch_YYDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strYYMC As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYMC
                If Me.txtSearch_YYMC.Text.Length > 0 Then Me.txtSearch_YYMC.Text = Me.txtSearch_YYMC.Text.Trim()
                If Me.txtSearch_YYMC.Text <> "" Then
                    Me.txtSearch_YYMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_YYMC.Text)
                    If strQuery = "" Then
                        strQuery = strYYMC + " like '" + Me.txtSearch_YYMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strYYMC + " like '" + Me.txtSearch_YYMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                '释放资源
                Josco.JSOA.Common.Data.estateRenshiGeneralData.SafeRelease(Me.m_objestateRenshiGeneralData)

                '重新检索数据
                With objsystemEstateRenshiGeneral
                    If .getDataSet_BiandongYuanyin(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateRenshiGeneralData) = False Then
                        GoTo errProc
                    End If
                End With

                '恢复Sort字符串
                With Me.m_objestateRenshiGeneralData.Tables(strTable)
...
errProc:
        ...
        Private Function showDataGridInfo( _
            ...
            Try
                ...
                '设置数据源
                If Me.m_objestateRenshiGeneralData Is Nothing Then
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYMC)
                        Me.txtYYDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtYYMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                End If

                '使能控件
                With objControlProcess
                    .doEnabledControl(Me.txtYYDM, blnEditMode)
                    .doEnabledControl(Me.txtYYMC, blnEditMode)
                End With
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
...
errProc:
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                '显示与网格紧密相关的操作或信息提示
                With Me.m_objestateRenshiGeneralData.Tables(strTable).DefaultView
                    '显示网格位置信息
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_YYDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_YYMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_YYDM)
                        .doTranslateKey(Me.txtSearch_YYMC)
                        .doTranslateKey(Me.txtYYDM)
                        .doTranslateKey(Me.txtYYMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[人事_人事变动类型]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYDM, Me.txtYYDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYMC, Me.txtYYMC.Text)
                ...
                '保存信息
                With objsystemEstateRenshiGeneral
                    If .doSaveData_BiandongYuanyin(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_人事变动类型]字典中增加了[" + Me.txtYYMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[人事_人事变动类型]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strYYMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_BIANDONGYUANYIN_YYMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strYYMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateRenshiGeneral.doDeleteData_BiandongYuanyin(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_人事变动类型]字典中删除了[" + strYYMC + "]！")
                        End If
                    Next
