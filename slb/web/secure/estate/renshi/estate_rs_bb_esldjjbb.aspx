<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_bb_esldjjbb.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_bb_esldjjbb" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>人事-劳动局季报表</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_rs_bb_esldjjbb" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" border="0">
					<TR id="trRow00">
						<TD width="4"></TD>
                        <TD height="30" class="title" vAlign="middle" align="left" style="BORDER-BOTTOM: #99cccc 2px solid">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;人事统计报表&nbsp;&gt;&gt;&gt;&gt;&nbsp;劳动局季报表</TD>
                        <TD width="4"></TD>
                    </TR>					
					<tr id="trRow02">
						<TD width="4"></TD>
						<td style="BORDER-BOTTOM: #99cccc 1px solid">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<tr>
									...
									<td class="labelNotNull">&nbsp;&nbsp;统计季度：<asp:DropDownList ID="ddlJD" Runat="server" CssClass="textbox">
												...
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 977px; CLIP: rect(0px 977px 408px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 408px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															BorderWidth="1px" BorderColor="#DEDFDE" PageSize="40" AllowPaging="True" CellPadding="3" BorderStyle="Solid"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="统计年季" SortExpression="统计年季" HeaderText="年季" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>

																<asp:ButtonColumn ItemStyle-Width="320px" DataTextField="指标名称" SortExpression="指标名称" HeaderText="指标名称" CommandName="Select">
																	<HeaderStyle Width="320px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="指标单位" SortExpression="指标单位" HeaderText="单位" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="指标代码" SortExpression="指标代码" HeaderText="代码" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="本季实际" SortExpression="本季实际" HeaderText="本季实际" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0}">
																	<HeaderStyle Width="140px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="180px" DataTextField="年初至本季止" SortExpression="年初至本季止" HeaderText="年初至本季止" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0}">
												...
												<TD>
													<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR align="center">
															...
															<TD class="labelBlack" vAlign="middle" align="left">【<asp:linkbutton id="lnkCZSetPageSize" runat="server" CssClass="labelBlack">每页</asp:linkbutton>】<asp:textbox id="txtPageSize" runat="server" Columns="1" CssClass="textbox">40</asp:textbox>条</TD>
