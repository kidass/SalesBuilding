<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_bb_kh_jy.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_bb_kh_jy"%>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()" onreadystatechange="document_onreadystatechange()" >
		<form id="frmestate_rs_bb_kh_jy" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR id="trRow01">
						<TD width="4"><asp:LinkButton id="lnkBlank" Runat="server" Height="5px" Width="0px"></asp:LinkButton></TD>
						<TD align="left" class="title" height="30" style="BORDER-BOTTOM: #0099cc 2px solid">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;职员业绩考核&nbsp;&gt;&gt;&gt;&gt;&nbsp;业务精英考核</TD>
						<TD width="4"></TD>
					</TR>
					<tr>
												...
												<TD>
													<DIV id="divTJSJ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 967px; CLIP: rect(0px 967px 410px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 410px">
														<asp:datagrid id="grdTJSJ" runat="server" CssClass="label" UseAccessibleHeader="True" CellPadding="3" BorderColor="#DEDFDE" BorderStyle="Solid" BorderWidth="1px" BackColor="White" AutoGenerateColumns="False" 
															GridLines="Both" PageSize="30" AllowSorting="True" AllowPaging="True" Width="3400px" >
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="显示名称" SortExpression="显示名称" HeaderText="项目" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="考核业绩" SortExpression="考核业绩" HeaderText="考核业绩" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="月度指标" SortExpression="月度指标" HeaderText="考核指标" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="40px" DataTextField="月度达标" SortExpression="月度达标" HeaderText="达标" CommandName="Select">
																	<HeaderStyle Width="40px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="代理费额" SortExpression="代理费额" HeaderText="结算代理费" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="律师费额" SortExpression="律师费额" HeaderText="结算律师费" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px" HorizontalAlign="Right"></HeaderStyle>
																</asp:ButtonColumn>
