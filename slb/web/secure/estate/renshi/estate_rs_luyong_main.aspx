		...
		<form id="frmestate_rs_luyong_main" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD width="4">
                        <TD id="trRow0" height="30" class="title" vAlign="middle" align="left">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;人员录用审批</TD>
                        <TD width="4">
                    </TR>					
                    <TR id="trRow1">
						                ...
						                <ComponentArt:Menu id="mnuMain" runat="server" width="100%" Orientation="Horizontal" CssClass="TopGroup"
											...
											<ITEMS>
												...
												<COMPONENTART:MENUITEM id="mnuXXCY" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="查阅信息">
													<COMPONENTART:MENUITEM id="mnuXXCY_CYYJ" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="查看领导批示" ClientSideCommand="doMenuItemClick('mnuXXCY_CYYJ','');"></COMPONENTART:MENUITEM>
													...
													<COMPONENTART:MENUITEM id="mnuXXCY_CKBY" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="查看补阅情况" ClientSideCommand="doMenuItemClick('mnuXXCY_CKBY','');"></COMPONENTART:MENUITEM>
													<COMPONENTART:MENUITEM id="mnuXXCY_CKRZ" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="查看操作日志" ClientSideCommand="doMenuItemClick('mnuXXCY_CKRZ','');"></COMPONENTART:MENUITEM>
													<COMPONENTART:MENUITEM id="mnuXXCY_CKCB" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="查看催办情况" ClientSideCommand="doMenuItemClick('mnuXXCY_CKCB','');"></COMPONENTART:MENUITEM>
													<COMPONENTART:MENUITEM id="mnuXXCY_CKDB" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="查看督办情况" ClientSideCommand="doMenuItemClick('mnuXXCY_CKDB','');"></COMPONENTART:MENUITEM>
												</COMPONENTART:MENUITEM>
												<COMPONENTART:MENUITEM id="mnuBWTX" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="备忘提醒">
													<COMPONENTART:MENUITEM id="mnuBWTX_SZTX" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="设置备忘提醒" ClientSideCommand="doMenuItemClick('mnuBWTX_SZTX','');"></COMPONENTART:MENUITEM>
													<COMPONENTART:MENUITEM id="mnuBWTX_QCTX" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="清除备忘提醒" ClientSideCommand="doMenuItemClick('mnuBWTX_QCTX','');"></COMPONENTART:MENUITEM>
												</COMPONENTART:MENUITEM>
												<COMPONENTART:MENUITEM id="mnuPrint" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="检索打印">
													<COMPONENTART:MENUITEM id="mnuPrint_QWJS" DisabledLookId="MenuItemDisabledLook" Target="mainFrame" Text="全文检索" ClientSideCommand="doMenuItemClick('mnuPrint_QWJS','');"></COMPONENTART:MENUITEM>
											...
											<TR>
												<TD>
													<DIV id="divRSLYGL" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 800px; CLIP: rect(0px 800px 420px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 420px">
														<asp:datagrid id="grdRSLYGL" runat="server" Width="1700px" CssClass="label" Font-Size="12px" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="备忘提醒" SortExpression="备忘提醒" HeaderText="备忘" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="紧急程度" SortExpression="紧急程度" HeaderText="紧急" CommandName="OpenDocument">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="秘密等级" SortExpression="秘密等级" HeaderText="密级" CommandName="OpenDocument">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="签发日期" SortExpression="签发日期" HeaderText="签批日期" CommandName="Select" DataTextFormatString="{0:yyyy-MM-dd}">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="签发人" SortExpression="签发人" HeaderText="签批人" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="定编人数" SortExpression="定编人数" HeaderText="定编人数" CommandName="Select">
