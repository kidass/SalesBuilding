				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<TABLE cellSpacing="0" cellPadding="0" border="0">
									...
									<TR>
										<TD vAlign="middle" align="right">&nbsp;人员代码&nbsp;
											...
											<asp:Button id="btnSelAll_RY" Runat="server" CssClass="button" Text="全选"></asp:Button>
											</div>
											<!--zengxianglin 2008-10-14 -->
											<!--zengxianglin 2008-10-14 -->
											<div style="display:none">
											<asp:Button id="btnDeSelAll_RY" Runat="server" CssClass="button" Text="不选"></asp:Button>
											</div>
											<!--zengxianglin 2008-10-14 -->
										</TD>
									</TR>
									...
									<TR>
										<TD class="title" align="left" bgcolor="#ccff99">&gt;&gt;&gt;&gt;人员入职时需要填写的内容(如果行政助理，请注意选择[行政助理])</TD>
									</TR>
									<TR>
										<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" align="center">
											<table cellspacing="0" cellpadding="0" border="0">
												<TR>
													<TD class="labelNotNull" align="right">入职时间[必填]：</TD>
												...
												<TR>
													<TD class="labelNotNull" align="right">变动原因[必填]：</TD>
												...
												<TR>
													<TD class="label" align="right">服务分组：</TD>
													<TD class="label" align="left" colspan="7"><asp:DropDownList id="ddlSSFZ" runat="server" CssClass="textbox" Width="350px"></asp:DropDownList><asp:Button ID="btnJSFZLB" Runat="server" CssClass="button" Text="…"></asp:Button><font style="FONT-WEIGHT: bold; COLOR: red; TEXT-DECORATION: underline">如果是业务人员，根据实际填写本项内容</font></TD>
												</TR>
												<TR>
					...
					<TR id="trRow2">
						<TD style="BORDER-TOP: #99cccc 2px solid" vAlign="middle" align="center" height="36">
							<asp:Button id="btnWriteParam" Runat="server" CssClass="button" Text="写入信息到当前行人员" Height="32px"></asp:Button>
							<!-- zengxianglin 2008-10-14-->
