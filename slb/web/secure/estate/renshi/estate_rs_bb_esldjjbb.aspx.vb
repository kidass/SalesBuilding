...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_bb_esldjjbb
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsBbEsLdjjbb
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsBbEsLdjjbb
        ...
        '当前处理的数据集
        '----------------------------------------------------------------
        Private m_objDataSet As Josco.JSOA.Common.Data.estateRenshiGeneralData
        ...
        Private Function getPrevilegeParams( _
            ...
            Try
                ...
                '是否继续执行
                If Me.m_blnPrevilegeParams(0) = True And Me.m_blnPrevilegeParams(8) = True Then
                    blnContinueExecute = True
                Else
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsBbEsLdjjbb
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsBbEsLdjjbb)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsBbEsLdjjbb)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function doCheckParam(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                If objPulicParameters.isIntegerString(Me.txtND.Text) = False Then
                    ...
                    Exit Try
                End If
                Dim intValue As Integer = CType(Me.txtND.Text, Integer)
        ...
        Private Function getReportParam( _
            ByRef strErrMsg As String, _
            ByRef strTJND As String, _
            ByRef strTJJD As String) As Boolean
            ...
            Try
                ...
                intJD = CType(Me.ddlJD.SelectedItem.Value, Integer)

                strTJND = intND.ToString
                strTJJD = intJD.ToString
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiGeneralData.TABLE_RS_VT_LDJJBB
            Dim objsystemEstateRenshiGeneral As New Josco.JSOA.BusinessFacade.systemEstateRenshiGeneral
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            ...
            Try
                Dim strTJND As String = ""
                Dim strTJJD As String = ""
                ...
                If blnEnfored = True Then
                    If Me.htxtSessionIdBuffer.Value.Trim <> "" Then
                        Try
                            Me.m_objDataSet = CType(Session(Me.htxtSessionIdBuffer.Value), Josco.JSOA.Common.Data.estateRenshiGeneralData)
                        Catch ex As Exception
                            Me.m_objDataSet = Nothing
                        End Try
                        Josco.JSOA.Common.Data.estateRenshiGeneralData.SafeRelease(Me.m_objDataSet)
                        Session.Remove(Me.htxtSessionIdBuffer.Value)
                        Me.htxtSessionIdBuffer.Value = ""
                    End If
                End If
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateRenshiGeneralData(Josco.JSOA.Common.Data.estateRenshiGeneralData.enumTableType.RS_VT_LDJJBB)
                    Else
                        '获取参数
                        If Me.getReportParam(strErrMsg, strTJND, strTJJD) = False Then
                            GoTo errProc
                        End If
                        '重新检索数据
                        If objsystemEstateRenshiGeneral.getDataSet_BB_LDJJBB(strErrMsg, MyBase.UserId, MyBase.UserPassword, strTJND, strTJJD, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        Private Sub doExport(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_人事管理_劳动局季报表.xls"
                ...
                strMacroName = "$Macro$TJND$"
                strMacroValue = strTJND
                strMacroName = strMacroName + strSep + "$Macro$TJJD$"
                strMacroValue = strMacroValue + strSep + strTJJD

                '输出数据
                If objsystemEstateRenshiGeneral.doExportToExcel(strErrMsg, Me.m_objDataSet, strDesExcelSpec, strMacroName, strMacroValue) = False Then
                    GoTo errProc
                End If
