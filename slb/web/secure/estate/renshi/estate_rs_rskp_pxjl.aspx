<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_rskp_pxjl.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_rskp_pxjl" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>人员培训情况查看与编辑窗</title>
	...
	<body background="../../images/oabk.gif" bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmestate_rs_rskp_pxjl" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow1">
									<TD class="title" align="left" colSpan="3" height="30">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;员工培训管理【<%=propRYMC%>】<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
												...
												<TD class="label" align="left" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;培训时间&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtRYLISTSearch_PXSJMin" runat="server" Font-Size="12px" CssClass="textbox" Columns="10" Font-Names="宋体"></asp:textbox>~<asp:textbox id="txtRYLISTSearch_PXSJMax" runat="server" Font-Size="12px" CssClass="textbox" Columns="10" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;培训名称&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtRYLISTSearch_PXMC" runat="server" Font-Size="12px" CssClass="textbox" Columns="12" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;培训类型&nbsp;</TD>
															<TD class="label" align="left"><asp:DropDownList id="ddlRYLISTSearch_PXLX" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体"><asp:ListItem Value=""></asp:ListItem><asp:ListItem Value="0">外部培训</asp:ListItem><asp:ListItem Value="1">内部培训</asp:ListItem></asp:DropDownList></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;培训效果&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtRYLISTSearch_PXXG" runat="server" Font-Size="12px" CssClass="textbox" Font-Names="宋体" Columns="12"></asp:textbox></TD>
											...
											<TR>
												<TD>
													<DIV id="divRYLIST" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 368px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 368px">
														<asp:datagrid id="grdRYLIST" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="人员真名" SortExpression="人员真名" HeaderText="姓名" CommandName="Select">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="240px" DataTextField="培训名称" SortExpression="培训名称" HeaderText="培训名称" CommandName="Select">
																	<HeaderStyle Width="240px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="开始时间" SortExpression="开始时间" HeaderText="开始时间" CommandName="Select"  DataTextFormatString="{0:yyyy-MM-dd}">
																	<HeaderStyle Width="140px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="140px" DataTextField="终止时间" SortExpression="终止时间" HeaderText="终止时间" CommandName="Select"  DataTextFormatString="{0:yyyy-MM-dd}">
																	<HeaderStyle Width="140px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="内部培训" SortExpression="内部培训" HeaderText="内部培训码" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="内部培训名称" SortExpression="内部培训名称" HeaderText="内部培训" CommandName="Select">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="培训效果" SortExpression="培训效果" HeaderText="培训效果" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="培训课时" SortExpression="培训课时" HeaderText="培训课时" CommandName="Select">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>
							                        ...
							                        <TABLE cellSpacing="0" cellPadding="0" border="0">
								                        <TR>
									                        <TD class="label" align="center">
										                        <TABLE cellSpacing="0" cellPadding="0" border="0">
											                        <TR>
											                            <td class="labelNotNull" align="right" nowrap>&nbsp;&nbsp;员工号码</td>
											                            ...
											                            <td class="labelNotNull" align="right" nowrap>&nbsp;&nbsp;培训名称</td>
												                        <TD class="label" align="left"><asp:textbox id="txtPXMC" Runat="server" Font-Size="12px" Font-Name="宋体" Columns="30" CssClass="textbox"></asp:textbox></td>
											                            <td class="labelNotNull" align="right" nowrap>&nbsp;&nbsp;培训时间</td>
											                        ...
											                        <TR>
											                            <td class="labelNotNull" align="right">&nbsp;&nbsp;培训类型</td>
												                        <TD class="label" align="left"><asp:RadioButtonList id="rblPXLX" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="textbox" Width="100%" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Flow"><asp:ListItem Value="0">外部培训</asp:ListItem><asp:ListItem Value="1">内部培训</asp:ListItem></asp:RadioButtonList></td>
											                            <td class="label" align="right">&nbsp;&nbsp;培训效果</td>
												                        <TD class="label" align="left"><asp:textbox id="txtPXXG" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="textbox" Width="100%"></asp:textbox></td>
												                        
											                            <td class="label" align="right">&nbsp;&nbsp;培训课时</td>
												                        <TD class="label" align="left"><asp:textbox id="txtPXKS" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="textbox" Width="100%"></asp:textbox></td>
											                        ...
											                        <tr>
											                           <td class="label" align="right">&nbsp;&nbsp;备注信息</td>
												                       <TD class="label" align="left" colspan =5><asp:textbox id="txtBZXX" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="textbox" Width="100%"></asp:textbox></td>
											                        </tr>
										                        </TABLE>
									                        </TD>
								                        </TR>
