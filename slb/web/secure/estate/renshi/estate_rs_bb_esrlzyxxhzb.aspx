<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_bb_esrlzyxxhzb.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_bb_esrlzyxxhzb" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>人事-人力资源信息汇总表</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="onresize_body()" onreadystatechange="onreadystatechange_body()" onscroll="onscroll_body()">
		<form id="frmestate_rs_bb_esrlzyxxhzb" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" border="0">
					<TR id="trRow00">
						<TD width="4"></TD>
                        <TD height="30" class="title" vAlign="middle" align="left" style="BORDER-BOTTOM: #99cccc 2px solid">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;人事统计报表&nbsp;&gt;&gt;&gt;&gt;&nbsp;人力资源信息汇总表</TD>
                        <TD width="4"></TD>
                    </TR>					
					<tr id="trRow02">
						<TD width="4"></TD>
						<td style="BORDER-BOTTOM: #99cccc 1px solid">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<tr>
									<td class="labelNotNull">&nbsp;&nbsp;统计年度：<asp:TextBox ID="txtND" Runat="server" CssClass="textbox" Columns="4"></asp:TextBox></td>
												...
												<TD>
													<DIV id="divContent" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 977px; CLIP: rect(0px 977px 408px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 408px" onscroll="onscroll_divContent()">
														<asp:datagrid id="grdContent" runat="server" CssClass="label" UseAccessibleHeader="True" AllowSorting="True"
															...
															GridLines="Vertical" AutoGenerateColumns="False" Width="1660px">
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="单位序号" SortExpression="单位序号" HeaderText="单位序号" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="入职人数" SortExpression="入职人数" HeaderText="入职人数" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0}">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="调入人数" SortExpression="调入人数" HeaderText="调入人数" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0}">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="调出人数" SortExpression="调出人数" HeaderText="调出人数" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0}">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="离职人数" SortExpression="离职人数" HeaderText="离职人数" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0}">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="平均人数月" SortExpression="平均人数月" HeaderText="平均人数月" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="平均人数季" SortExpression="平均人数季" HeaderText="平均人数季" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="平均人数年" SortExpression="平均人数年" HeaderText="平均人数年" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>

																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="平均创收月" SortExpression="平均创收月" HeaderText="平均创收月" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="平均创收季" SortExpression="平均创收季" HeaderText="平均创收季" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="平均创收年" SortExpression="平均创收年" HeaderText="平均创收年" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>

																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="单位创收月" SortExpression="单位创收月" HeaderText="单位创收月" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="单位创收季" SortExpression="单位创收季" HeaderText="单位创收季" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="单位创收年" SortExpression="单位创收年" HeaderText="单位创收年" CommandName="Select" ItemStyle-HorizontalAlign="Right" DataTextFormatString="{0:#,##0.00}">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
