...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_zhigongshuxing
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_rs_zhigongshuxing_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsZhigongShuxing
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsZhigongShuxing
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateRsZhigongShuxing)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtSXDM.Text = .txtSXDM
                    Me.txtSXMC.Text = .txtSXMC

                    Me.txtSearch_SXDM.Text = .txtSearch_SXDM
                    Me.txtSearch_SXMC.Text = .txtSearch_SXMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsZhigongShuxing
                ...
                With Me.m_objSaveScence
                    ...
                    .txtSXDM = Me.txtSXDM.Text
                    .txtSXMC = Me.txtSXMC.Text

                    .txtSearch_SXDM = Me.txtSearch_SXDM.Text
                    .txtSearch_SXMC = Me.txtSearch_SXMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsZhigongShuxing)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsZhigongShuxing)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strSXDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXDM
                If Me.txtSearch_SXDM.Text.Length > 0 Then Me.txtSearch_SXDM.Text = Me.txtSearch_SXDM.Text.Trim()
                If Me.txtSearch_SXDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strSXDM + " like '" + Me.txtSearch_SXDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strSXDM + " like '" + Me.txtSearch_SXDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strSXMC As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXMC
                If Me.txtSearch_SXMC.Text.Length > 0 Then Me.txtSearch_SXMC.Text = Me.txtSearch_SXMC.Text.Trim()
                If Me.txtSearch_SXMC.Text <> "" Then
                    Me.txtSearch_SXMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_SXMC.Text)
                    If strQuery = "" Then
                        strQuery = strSXMC + " like '" + Me.txtSearch_SXMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strSXMC + " like '" + Me.txtSearch_SXMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With objsystemEstateRenshiGeneral
                    If .getDataSet_ZhigongShuxing(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateRenshiGeneralData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXMC)
                        Me.txtSXDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtSXMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                End If

                '使能控件
                With objControlProcess
                    .doEnabledControl(Me.txtSXDM, blnEditMode)
                    .doEnabledControl(Me.txtSXMC, blnEditMode)
                End With
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateRenshiGeneralData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_SXDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_SXMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_SXDM)
                        .doTranslateKey(Me.txtSearch_SXMC)
                        .doTranslateKey(Me.txtSXDM)
                        .doTranslateKey(Me.txtSXMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[人事_人事上岗类型]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXDM, Me.txtSXDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXMC, Me.txtSXMC.Text)
                ...
                '保存信息
                With objsystemEstateRenshiGeneral
                    If .doSaveData_ZhigongShuxing(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_人事上岗类型]字典中增加了[" + Me.txtSXMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[人事_人事上岗类型]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strSXMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_ZHIGONGSHUXING_SXMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strSXMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateRenshiGeneral.doDeleteData_ZhigongShuxing(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_人事上岗类型]字典中删除了[" + strSXMC + "]！")
                        End If
                    Next
