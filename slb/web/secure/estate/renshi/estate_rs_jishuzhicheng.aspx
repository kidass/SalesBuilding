...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_jishuzhicheng.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_jishuzhicheng" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>技术职称代码编辑窗</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()"
		...
		<form id="frmestate_rs_jishuzhicheng" method="post" runat="server">
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									...
									<TD vAlign="middle" align="center" width="100">
										<asp:linkbutton id="lnkMLAddNew" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../../images/new.gif" border="0" width="16" height="16">增加代码</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100">
										<asp:linkbutton id="lnkMLUpdate" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../../images/modify.ico" border="0" width="16" height="16">更改代码</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100">
										<asp:linkbutton id="lnkMLDelete" runat="server" Font-Name="宋体" Font-Size="11pt"><img src="../../../images/delete.gif" border="0" width="16" height="16">删除代码</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100">
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right">职称代码&nbsp;</TD>
															<TD class="label" align="left">
																<asp:textbox id="txtSearch_ZCDM" runat="server" Font-Size="11pt" Font-Names="宋体" CssClass="textbox"
																	Columns="20"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;职称名称&nbsp;</TD>
															<TD class="label" align="left">
																<asp:textbox id="txtSearch_ZCMC" runat="server" Font-Size="11pt" Font-Names="宋体" CssClass="textbox"
																	Columns="48"></asp:textbox></TD>
															<TD class="label">&nbsp;&nbsp;
													...
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 100%; CLIP: rect(0px 100% 330px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 330px">
														<asp:datagrid id="grdObjects" runat="server" Font-Size="11pt" Font-Names="宋体" CssClass="label"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="职称代码" SortExpression="职称代码" HeaderText="职称代码" CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="780px" DataTextField="职称名称" SortExpression="职称名称" HeaderText="职称名称" CommandName="Select">
								...
								<TR>
									...
									<TD class="label" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid"
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="center" height="20"><B>技术职称代码编辑窗</B></TD>
											</TR>
											<TR>
													...
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															...
															<TD class="label" align="left" width="60%">
																<asp:textbox id="txtZCDM" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="23"></asp:textbox><SPAN class="label" style="COLOR: red">(nnn.nnn.nnn.nnn)</SPAN></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															...
															<TD class="label" align="left">
																<asp:textbox id="txtZCMC" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="48"></asp:textbox></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
			...
			<table cellSpacing="0" cellPadding="0" align="center" border="0">
				<tr>
					<td>
						<input id="htxtCurrentPage" type="hidden" runat="server"> <input id="htxtCurrentRow" type="hidden" runat="server">
						<input id="htxtEditMode" type="hidden" runat="server"> <input id="htxtEditType" type="hidden" runat="server">
						<input id="htxtQuery" type="hidden" runat="server"> <input id="htxtRows" type="hidden" runat="server">
						<input id="htxtSort" type="hidden" runat="server"> <input id="htxtSortColumnIndex" type="hidden" runat="server">
						<input id="htxtSortType" type="hidden" runat="server"> <input id="htxtDivLeftObject" type="hidden" runat="server">
						<input id="htxtDivTopObject" type="hidden" runat="server"> <input id="htxtDivLeftBody" type="hidden" runat="server">
