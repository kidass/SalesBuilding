<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_yongjinjitibiaozhun_x4.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_yongjinjitibiaozhun_x4" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
    <HEAD>
        <title>佣金计提标准(四)</title>
		...
		<style>
			...
			TD.grdGYXGZJLocked { ; LEFT: expression(divGYXGZJ.scrollLeft); POSITION: relative }
			TH.grdGYXGZJLocked { ; LEFT: expression(divGYXGZJ.scrollLeft); POSITION: relative }
			TH.grdGYXGZJLocked { Z-INDEX: 99 }
        ...
        <script language="javascript">
			...
			function window_onresize() 
			{
                ...
                //
				strWidth = divSYZJ.style.width;
				divSYZJ.style.width = strWidth;
				divSYZJ.style.height = strHeight;
				divSYZJ.style.clip = "rect(0px " + strWidth + " " + strHeight + " 0px)";
                //
				strWidth = (dblWidth - tdCol01.clientWidth - tdColSYZJ.clientWidth - 8).toString() + "px";
				divSY.style.width = strWidth;
				divSY.style.height = strHeight;
				divSY.style.clip   = "rect(0px " + strWidth + " " + strHeight + " 0px)";

				//*************************************************************************************************************************************************
				strHeight = (dblHeight - trRowGYZG01.clientHeight - trRowGYZG02.clientHeight - trRowGYZG03.clientHeight - trRowGYZG04.clientHeight).toString() + "px";
				//
				...
				//
				strWidth = (dblWidth - tdCol01.clientWidth - tdColGYZGZJ.clientWidth - 8).toString() + "px";
				...
				//
				strWidth = divGYXGZJ.style.width;
				divGYXGZJ.style.width = strWidth;
				divGYXGZJ.style.height = strHeight;
				divGYXGZJ.style.clip = "rect(0px " + strWidth + " " + strHeight + " 0px)";
				//
				strWidth = (dblWidth - tdCol01.clientWidth - tdColGYXGZJ.clientWidth - 4).toString() + "px";
				divGYXG.style.width = strWidth;
				divGYXG.style.height = strHeight;
				divGYXG.style.clip = "rect(0px " + strWidth + " " + strHeight + " 0px)";

				//*************************************************************************************************************************************************
				strHeight = (dblHeight - trRowGYZT01.clientHeight - trRowGYZT02.clientHeight - trRowGYZT03.clientHeight - trRowGYZT04.clientHeight).toString() + "px";
				//
                ...
                //
				strWidth  = (dblWidth - tdCol01.clientWidth - tdColGYZTZJ.clientWidth - 4).toString() + "px";
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()">
		<form id="frmestate_rs_yongjinjitibiaozhun_x4" method="post" runat="server">
								...
								<tr>
									<TD id="tdCol01" vAlign="top" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" width="200px">
										<TABLE cellSpacing="0" cellPadding="0" border="0" width="200">
											<TR>
												<TD class="labelTitle" colspan="2" align="center" valign="middle"><br>佣金计提标准<br>(四)</TD>
											</TR>
											<tr>
									...
									<TD style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid" vAlign="top">							
                                        ...
                                        %>
                                            <TABLE cellSpacing="0" cellPadding="0" border="0">
												<TR id="trRowSY01">
													<TD colspan="3" class="typeTitle" align="left" background="../../../images/yj/bg_title.gif" height="30px"><img src="../../../images/yj/titleicon.gif">&nbsp;个人完成业绩的佣金计提标准(私佣标准)</TD>
												</TR>
												<TR id="trRowSY02">
													<TD colspan="3" class="label" align="left" height="10px"></TD>
												</TR>
                                                <TR>
                                                    <td id="tdColSYZJ">
														<DIV id="divSYZJ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 260px; CLIP: rect(0px 260px 296px 0px); BORDER-BOTTOM: #aed3f0 2px inset; HEIGHT: 296px">
															<asp:datagrid id="grdSYZJ" runat="server" CssClass="labelGrid" Width="100%"
															...
															</asp:datagrid><INPUT id="htxtSYZJFixed" type="hidden" value="0" runat="server" NAME="htxtSYZJFixed"/>
														</DIV>													
                                                    </td>
                                                    <td width="8">&nbsp;</td>
                                                    <TD>
                                                        <DIV id="divSY" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 520px; CLIP: rect(0px 520px 296px 0px); BORDER-BOTTOM: #aed3f0 2px inset; HEIGHT: 296px">
                                                ...
                                                <tr id="trRowSY03">
                                                    <td align="center" valign="middle">
											            <asp:Button id="btnSelAll_SYZJ"   Runat="server" Text="全部选定"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
											            <asp:Button id="btnDeSelAll_SYZJ" Runat="server" Text="全部不选"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnAddNew_SYZJ"   Runat="server" Text="加入新的职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_SYZJ"   Runat="server" Text="删除选定职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
                                                    </td>
                                                    <td></td>
                                                    <TD align="right" valign="middle">
                                                        <asp:Button id="btnCpyNew_SY"     Runat="server" Text="复制到选定职级" Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
                                                        <asp:Button id="btnAddNew_SY"     Runat="server" Text="添加末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
                                                        <asp:Button id="btnDelete_SY"     Runat="server" Text="删除末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnSave_SY"       Runat="server" Text="保存私佣指标"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>																	
                                                    </TD>
                                                </TR>
                                                <tr id="trRowSY04">
                                                    <TD align="left" colspan="3">
														<table cellpadding="0" cellspacing="0" border="0" width="100%">
															...
															<tr>
																<td align="left" class="label">&nbsp;&nbsp;&nbsp;&nbsp;(4) 区间范围、额度范围是个人各接案月度的累计结算业绩。
															</tr>
														</table>
													</TD>
                                                </tr>
                                        ...
                                        %>
											<TABLE cellSpacing="0" cellPadding="0" border="0">
															...
															<asp:datagrid id="grdGYZGZJ" runat="server" CssClass="labelGrid" Width="100%"
																...
																<Columns>
																	<asp:TemplateColumn HeaderText="选" ItemStyle-Width="20px">
																		...
																		<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																		<ItemTemplate>
																			<asp:CheckBox id="chkGYZGZJ" runat="server" AutoPostBack="False"></asp:CheckBox>
																		</ItemTemplate>
																	</asp:TemplateColumn>
																	<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="唯一标识" SortExpression="唯一标识" HeaderText="唯一标识" CommandName="Select">
																		<HeaderStyle Width="0px"></HeaderStyle>
												...
												<tr id="trRowGYZG03">
                                                    <td align="center" valign="middle">
														<asp:Button id="btnSelAll_GYZGZJ"   Runat="server" Text="全部选定"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnDeSelAll_GYZGZJ" Runat="server" Text="全部不选"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnAddNew_GYZGZJ"   Runat="server" Text="加入新的职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_GYZGZJ"   Runat="server" Text="删除选定职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
												    </td>
												    <td></td>
                                                    <td align="right" valign="middle">
                                                        <asp:Button id="btnCpyNew_GYZG"     Runat="server" Text="复制到选定职级" Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnAddNew_GYZG"     Runat="server" Text="添加末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_GYZG"     Runat="server" Text="删除末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnSave_GYZG"       Runat="server" Text="保存直管指标"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>																	
												    </td>
												</tr>
												<tr id="trRowGYZG04">
													<TD align="left" colspan="3">
														<table cellpadding="0" cellspacing="0" border="0" width="100%">
															...
															<tr>
																<td align="left" class="label">&nbsp;&nbsp;&nbsp;&nbsp;(2) 区间范围、额度范围是团队接案月度的累计结算业绩。
															</tr>
														</table>
													</TD>
												</tr>												
										...
										%>
											<TABLE cellSpacing="0" cellPadding="0" border="0">
												<TR id="trRowGYXG01">
													<TD colspan="3" class="typeTitle" align="left" background="../../../images/yj/bg_title.gif" height="30px"><img src="../../../images/yj/titleicon.gif">&nbsp;营业经理协管团队业绩的佣金计提标准(协管公佣)</TD>
												</TR>
												<TR id="trRowGYXG02">
													<TD class="label" align="left" height="10px" colspan="3"></TD>
												</TR>
												<tr>
												    <td id="tdColGYXGZJ">
														<DIV id="divGYXGZJ" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 260px; CLIP: rect(0px 260px 296px 0px); BORDER-BOTTOM: #aed3f0 2px inset; HEIGHT: 296px">
															<asp:datagrid id="grdGYXGZJ" runat="server" CssClass="labelGrid" Width="100%"
																AllowPaging="False" AutoGenerateColumns="False" GridLines="Both" BackColor="White"
																PageSize="30" BorderColor="#dfdfdf" BorderWidth="1px" AllowSorting="True" CellPadding="4"  UseAccessibleHeader="True" BorderStyle="Solid">
																<SelectedItemStyle  Font-Bold="False" VerticalAlign="top" ForeColor="blue" ></SelectedItemStyle>
																<EditItemStyle   BackColor="#FFCC00" VerticalAlign="top"></EditItemStyle>
																...
																<Columns>
																	<asp:TemplateColumn HeaderText="选" ItemStyle-Width="20px">
																		...
																		<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																		<ItemTemplate>
																			<asp:CheckBox id="chkGYXGZJ" runat="server" AutoPostBack="False"></asp:CheckBox>
																		</ItemTemplate>
																	</asp:TemplateColumn>
																	<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="唯一标识" SortExpression="唯一标识" HeaderText="唯一标识" CommandName="Select">
																		<HeaderStyle Width="0px"></HeaderStyle>
																...
																<PagerStyle Visible="False" NextPageText="下页" Font-Size="12px" Font-Names="宋体" PrevPageText="上页" HorizontalAlign="Right" ForeColor="Black" Position="TopAndBottom" BackColor="SkyBlue"></PagerStyle>
															</asp:datagrid><INPUT id="htxtGYXGZJFixed" type="hidden" value="0" runat="server" NAME="htxtGYXGZJFixed"/>
														</DIV>													
												    </td>
												    <td width="8px">&nbsp;</td>
												    <td>
													    <DIV id="divGYXG" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 520px; CLIP: rect(0px 520px 296px 0px); BORDER-BOTTOM: #aed3f0 2px inset; HEIGHT: 296px">
												...
												<TR id="trRowGYXG03">
                                                    <td align="center" valign="middle">
														<asp:Button id="btnSelAll_GYXGZJ"   Runat="server" Text="全部选定"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnDeSelAll_GYXGZJ" Runat="server" Text="全部不选"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnAddNew_GYXGZJ"   Runat="server" Text="加入新的职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_GYXGZJ"   Runat="server" Text="删除选定职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
												    </td>
												    <td></td>
                                                    <td align="right" valign="middle">
                                                        <asp:Button id="btnCpyNew_GYXG"     Runat="server" Text="复制到选定职级" Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnAddNew_GYXG"     Runat="server" Text="添加末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_GYXG"     Runat="server" Text="删除末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnSave_GYXG"       Runat="server" Text="保存协管指标"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>																	
													</TD>
												</TR>
												<TR id="trRowGYXG04">
													<TD align="left" colspan="3">
										...
										%>
											<TABLE cellSpacing="0" cellPadding="0" border="0">
															...
															<asp:datagrid id="grdGYZTZJ" runat="server" CssClass="labelGrid" Width="100%"
																...
																<Columns>
																	<asp:TemplateColumn HeaderText="选" ItemStyle-Width="20px">
																		...
																		<ItemStyle Wrap="False" HorizontalAlign="Left" VerticalAlign="Middle"></ItemStyle>
																		<ItemTemplate>
																			<asp:CheckBox id="chkGYZTZJ" runat="server" AutoPostBack="False"></asp:CheckBox>
																		</ItemTemplate>
																	</asp:TemplateColumn>
																	<asp:ButtonColumn Visible="False" ItemStyle-Width="0px" DataTextField="唯一标识" SortExpression="唯一标识" HeaderText="唯一标识" CommandName="Select">
																		<HeaderStyle Width="0px"></HeaderStyle>
												...
												<TR id="trRowGYZT03">
                                                    <td align="center" valign="middle">
														<asp:Button id="btnSelAll_GYZTZJ"   Runat="server" Text="全部选定"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnDeSelAll_GYZTZJ" Runat="server" Text="全部不选"       Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px" Visible="false"></asp:Button>
														<asp:Button id="btnAddNew_GYZTZJ"   Runat="server" Text="加入新的职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_GYZTZJ"   Runat="server" Text="删除选定职级"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
												    </td>
												    <td></td>
                                                    <td align="right" valign="middle">
                                                        <asp:Button id="btnCpyNew_GYZT"     Runat="server" Text="复制到选定职级" Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnAddNew_GYZT"     Runat="server" Text="添加末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnDelete_GYZT"     Runat="server" Text="删除末尾区间"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
														<asp:Button id="btnSave_GYZT"       Runat="server" Text="保存直提指标"   Font-Size="12px" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>																	
												    </td>
												</TR>
												<tr id="trRowGYZT04">
													<TD align="left" colspan="3">
			...
			<table cellSpacing="0" cellPadding="0" align="center" border="0">
				<tr>
					<td>
						...
						<input id="htxtSessionId_SYZJ" type="hidden" runat="server" NAME="htxtSessionId_SYZJ"/>
                        ...
                        <input id="htxtSessionId_GYXGZJ" type="hidden" runat="server" NAME="htxtSessionId_GYXGZJ"/>
                        ...
                        <input id="htxtSYZJSort" type="hidden" runat="server" NAME="htxtSYZJSort"/>
						<input id="htxtSYZJSortColumnIndex" type="hidden" runat="server" NAME="htxtSYZJSortColumnIndex"/>
						<input id="htxtSYZJSortType" type="hidden" runat="server" NAME="htxtSYZJSortType"/>
                        ...
                        <input id="htxtGYXGZJSort" type="hidden" runat="server" NAME="htxtGYXGZJSort"/>
						<input id="htxtGYXGZJColumnIndex" type="hidden" runat="server" NAME="htxtGYXGZJColumnIndex"/>
						<input id="htxtGYXGZJSortType" type="hidden" runat="server" NAME="htxtGYXGZJSortType"/>
						...
						<input id="htxtDivLeftSYZJ" type="hidden" runat="server" NAME="htxtDivLeftSYZJ"/>
						<input id="htxtDivTopSYZJ" type="hidden" runat="server" NAME="htxtDivTopSYZJ"/>	
						...
						<input id="htxtDivLeftGYXGZJ" type="hidden" runat="server" NAME="htxtDivLeftGYXGZJ"/>	
						<input id="htxtDivTopGYXGZJ" type="hidden" runat="server" NAME="htxtDivTopGYXGZJ"/>	
				...
				<tr>
					<td>
						<script language="javascript">
							...
							function ScrollProc_divSYZJ() {
							    var oText;
							    oText = null;
							    oText = document.getElementById("htxtDivTopSYZJ");
							    if (oText != null) oText.value = divSYZJ.scrollTop;
							    oText = null;
							    oText = document.getElementById("htxtDivLeftSYZJ");
							    if (oText != null) oText.value = divSYZJ.scrollLeft;
							    return;
							}
							...
							function ScrollProc_divGYXGZJ() {
							    var oText;
							    oText = null;
							    oText = document.getElementById("htxtDivTopGYXGZJ");
							    if (oText != null) oText.value = divGYXGZJ.scrollTop;
							    oText = null;
							    oText = document.getElementById("htxtDivLeftGYXGZJ");
							    if (oText != null) oText.value = divGYXGZJ.scrollLeft;
							    return;
							}
							...
							try {
								...
								oText = null;
								oText = document.getElementById("htxtDivTopSYZJ");
								if (oText != null) divSYZJ.scrollTop = oText.value;
								oText = null;
								oText = document.getElementById("htxtDivLeftSYZJ");
								if (oText != null) divSYZJ.scrollLeft = oText.value;
								...
								oText = null;
								oText = document.getElementById("htxtDivTopGYXGZJ");
								if (oText != null) divGYXGZJ.scrollTop = oText.value;
								oText = null;
								oText = document.getElementById("htxtDivLeftGXGZJ");
								if (oText != null) divGYXGZJ.scrollLeft = oText.value;
