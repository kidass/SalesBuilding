...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_bb_essyzgkh
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsBbEsSyzgkh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsBbEsSyzgkh
        ...
        '当前处理的数据集
        '----------------------------------------------------------------
        Private m_objDataSet As Josco.JSOA.Common.Data.estateRenshiXingyeData
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Try
                        Me.ddlRYDM.SelectedIndex = .ddlRYDM_SelectedIndex
                    Catch ex As Exception
                    End Try
                    Try
                        Me.ddlXSJB.SelectedIndex = .ddlXSJB_SelectedIndex
                    Catch ex As Exception
                    End Try
                    Me.txtKSRQ.Text = .txtKSRQ
                    Me.txtZZRQ.Text = .txtZZRQ
                    Me.txtSYQY.Text = .txtSYQY
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsBbEsSyzgkh
                ...
                With Me.m_objSaveScence
                    ...
                    .ddlRYDM_SelectedIndex = Me.ddlRYDM.SelectedIndex
                    .ddlXSJB_SelectedIndex = Me.ddlXSJB.SelectedIndex
                    .txtKSRQ = Me.txtKSRQ.Text
                    .txtZZRQ = Me.txtZZRQ.Text
                    .txtSYQY = Me.txtSYQY.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsBbEsSyzgkh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsBbEsSyzgkh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '[显示级别]
                Dim strXSJB As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_SYZGKH_XSJB
                Select Case Me.ddlXSJB.SelectedIndex
                    Case Is > 0
                        If strQuery = "" Then
                            strQuery = strXSJB + Me.ddlXSJB.SelectedValue
                        Else
                            strQuery = strQuery + " and " + strXSJB + Me.ddlXSJB.SelectedValue
                        End If
                End Select
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function doCheckParam(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                If Me.txtSYQY.Text.Trim = "" Then
                    strErrMsg = "错误：没有指定[试用期]！"
                    Exit Try
                End If
                If objPulicParameters.isIntegerString(Me.txtSYQY.Text) = False Then
                    strErrMsg = "错误：无效的[试用期]！"
                    Exit Try
                End If
                Dim intSYQY As Integer = objPulicParameters.getObjectValue(Me.txtSYQY.Text, 0)
                If intSYQY < 1 Then
                    strErrMsg = "错误：无效的[试用期]！"
                    Exit Try
                End If

                If Me.ddlRYDM.SelectedIndex < 0 Then
                    strErrMsg = "错误：必须选定[考核人员]！"
                    Exit Try
                End If
        ...
        Private Function getReportParam( _
            ...
            ByRef strRYDM As String, _
            ByRef intSYQY As Integer) As Boolean
            ...
            Try
                ...
                '计算
                strRYDM = Me.ddlRYDM.SelectedItem.Value
                strKSRQ = Me.txtKSRQ.Text
                strZZRQ = Me.txtZZRQ.Text
                intSYQY = objPulicParameters.getObjectValue(Me.txtSYQY.Text, 0)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.TABLE_DC_VT_RS_SYZGKH
            Dim objsystemEstateRenshiXingye As New Josco.JSOA.BusinessFacade.systemEstateRenshiXingye
            Dim objPulicParameters As New Josco.JsKernal.Common.Utilities.PulicParameters
            ...
            Try
                ...
                If blnEnfored = True Then
                    If Me.htxtSessionIdBuffer.Value.Trim <> "" Then
                        Try
                            Me.m_objDataSet = CType(Session(Me.htxtSessionIdBuffer.Value), Josco.JSOA.Common.Data.estateRenshiXingyeData)
                        Catch ex As Exception
                            Me.m_objDataSet = Nothing
                        End Try
                        Josco.JSOA.Common.Data.estateRenshiXingyeData.SafeRelease(Me.m_objDataSet)
                        Session.Remove(Me.htxtSessionIdBuffer.Value)
                        Me.htxtSessionIdBuffer.Value = ""
                    End If
                End If
                ...
                Else
                    ...
                    If Me.IsPostBack = False Then
                        '不计算数据
                        Me.m_objDataSet = New Josco.JSOA.Common.Data.estateRenshiXingyeData(Josco.JSOA.Common.Data.estateRenshiXingyeData.enumTableType.DC_VT_RS_SYZGKH)
                    Else
                        '获取参数
                        If Me.getReportParam(strErrMsg, strKSRQ, strZZRQ, strRYDM, intSYQY) = False Then
                            GoTo errProc
                        End If
                        '重新检索数据
                        If objsystemEstateRenshiXingye.getDataSet_BB_RSRYKH_SYZG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strRYDM, strKSRQ, strZZRQ, intSYQY, Me.m_objDataSet) = False Then
                            GoTo errProc
                        End If
                    End If
...
errProc:
        ...
        '     False          ：失败
        '----------------------------------------------------------------
        Private Function doFillRydmList( _
            ByRef strErrMsg As String, _
            ...
            doFillRydmList = False
            strErrMsg = ""

            Try
                '检查
                If objDropDownList Is Nothing Then
                    strErrMsg = "错误：[doFillRydmList]接口参数不正确！"
                    GoTo errProc
                End If
                Dim strKSRQ As String = ""
                Dim strZZRQ As String = ""
                ...
                If Me.doCheckParam01(strErrMsg) = False Then
                    GoTo errProc
                End If
                If Me.getReportParam01(strErrMsg, strKSRQ, strZZRQ, intSYQY) = False Then
                    GoTo errProc
                End If

                '获取数据
                Dim strWhere As String = ""
                If objsystemEstateRenshiXingye.getDataSet_BB_RSRYKH_SYZG_RY(strErrMsg, MyBase.UserId, MyBase.UserPassword, strKSRQ, strZZRQ, intSYQY, objDataSet) = False Then
                    GoTo errProc
                End If
                ...
                Dim strRZRQ As String = ""
                Dim intCount As Integer = 0
                Dim i As Integer = 0
                With objDataSet.Tables(intTable)
                    intCount = .Rows.Count
                    For i = 0 To intCount - 1 Step 1
                        strRYDM = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_SYZGKH_RYDM), "")
                        strRYMC = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_SYZGKH_RYMC), "")
                        strRZRQ = objPulicParameters.getObjectValue(.Rows(i).Item(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_SYZGKH_RZRQ), "", "yyyy-MM-dd")
                        objListItem = New System.Web.UI.WebControls.ListItem
                        objListItem.Text = strRZRQ + "|" + strRYMC
                        objListItem.Value = strRYDM
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    objControlProcess.doTranslateKey(Me.txtSYQY)
                    objControlProcess.doTranslateKey(Me.ddlRYDM)
                    objControlProcess.doTranslateKey(Me.ddlXSJB)
                    '=======================================================================
        ...
        Sub grdContent_ItemDataBound(ByVal sender As Object, ByVal e As DataGridItemEventArgs) Handles grdContent.ItemDataBound
            ...
            Try
                ...
                Else
                    ...
                    Dim intXSJB As Integer
                    intXSJB = objDataGridProcess.getDataGridColumnIndex(Me.grdContent, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_SYZGKH_XSJB)
                    strXSJB = objDataGridProcess.getDataGridCellValue(e.Item, intXSJB)
                    Select Case strXSJB
                        Case "1"
...
errProc:
        ...
        Private Sub doJssyry(ByVal strControlId As String)
            ...
            Try
                ...
                '获取数据
                If Me.doFillRydmList(strErrMsg, Me.ddlRYDM, False) = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Sub btnJS_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnJS.Click
            Me.doJssyry("btnJS")
        End Sub
