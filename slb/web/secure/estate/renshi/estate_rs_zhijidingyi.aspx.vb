...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_zhijidingyi
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_rs_zhijidingyi_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsZhijiDingyi
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsZhijiDingyi
        ...
        '当前处理的数据集
        '----------------------------------------------------------------
        Private m_objestateRenshiXingyeData As Josco.JSOA.Common.Data.estateRenshiXingyeData
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateRsZhijiDingyi)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtZJDM.Text = .txtZJDM
                    Me.txtZJMC.Text = .txtZJMC
                    Me.txtJBSZ.Text = .txtJBSZ

                    Me.txtSearch_ZJDM.Text = .txtSearch_ZJDM
                    Me.txtSearch_ZJMC.Text = .txtSearch_ZJMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsZhijiDingyi
                ...
                With Me.m_objSaveScence
                    ...
                    .txtZJDM = Me.txtZJDM.Text
                    .txtZJMC = Me.txtZJMC.Text
                    .txtJBSZ = Me.txtJBSZ.Text

                    .txtSearch_ZJDM = Me.txtSearch_ZJDM.Text
                    .txtSearch_ZJMC = Me.txtSearch_ZJMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsZhijiDingyi)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsZhijiDingyi)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strZJDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJDM
                If Me.txtSearch_ZJDM.Text.Length > 0 Then Me.txtSearch_ZJDM.Text = Me.txtSearch_ZJDM.Text.Trim()
                If Me.txtSearch_ZJDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strZJDM + " like '" + Me.txtSearch_ZJDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strZJDM + " like '" + Me.txtSearch_ZJDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strZJMC As String = "a." + Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJMC
                If Me.txtSearch_ZJMC.Text.Length > 0 Then Me.txtSearch_ZJMC.Text = Me.txtSearch_ZJMC.Text.Trim()
                If Me.txtSearch_ZJMC.Text <> "" Then
                    Me.txtSearch_ZJMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_ZJMC.Text)
                    If strQuery = "" Then
                        strQuery = strZJMC + " like '" + Me.txtSearch_ZJMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strZJMC + " like '" + Me.txtSearch_ZJMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                '释放资源
                Josco.JSOA.Common.Data.estateRenshiXingyeData.SafeRelease(Me.m_objestateRenshiXingyeData)

                '重新检索数据
                With objsystemEstateRenshiXingye
                    If .getDataSet_ZhijiDingyi(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateRenshiXingyeData) = False Then
                        GoTo errProc
                    End If
                End With

                '恢复Sort字符串
                With Me.m_objestateRenshiXingyeData.Tables(strTable)
...
errProc:
        ...
        Private Function showDataGridInfo( _
            ...
            Try
                ...
                '设置数据源
                If Me.m_objestateRenshiXingyeData Is Nothing Then
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJMC)
                        intColIndex(2) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_JBSZ)
                        Me.txtZJDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtZJMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                        Me.txtJBSZ.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(2))
                    End If
                End If

                '使能控件
                With objControlProcess
                    .doEnabledControl(Me.txtZJDM, blnEditMode)
                    .doEnabledControl(Me.txtZJMC, blnEditMode)
                    .doEnabledControl(Me.txtJBSZ, blnEditMode)
                End With
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
...
errProc:
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                '显示与网格紧密相关的操作或信息提示
                With Me.m_objestateRenshiXingyeData.Tables(strTable).DefaultView
                    '显示网格位置信息
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_ZJDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_ZJMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_ZJDM)
                        .doTranslateKey(Me.txtSearch_ZJMC)
                        .doTranslateKey(Me.txtZJDM)
                        .doTranslateKey(Me.txtZJMC)
                        .doTranslateKey(Me.txtJBSZ)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[人事_职级定义]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJDM, Me.txtZJDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJMC, Me.txtZJMC.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_JBSZ, Me.txtJBSZ.Text)
                ...
                '保存信息
                With objsystemEstateRenshiXingye
                    If .doSaveData_ZhijiDingyi(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_职级定义]字典中增加了[" + Me.txtZJMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[人事_职级定义]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_B_RS_ZHIJIDINGYI_ZJMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strZJMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateRenshiXingye.doDeleteData_ZhijiDingyi(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_职级定义]字典中删除了[" + strZJMC + "]！")
                        End If
                    Next
