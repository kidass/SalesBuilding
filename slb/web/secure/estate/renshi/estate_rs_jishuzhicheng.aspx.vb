...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_jishuzhicheng
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_rs_jishuzhicheng_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsJishuZhicheng
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsJishuZhicheng
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateRsJishuZhicheng)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtZCDM.Text = .txtZCDM
                    Me.txtZCMC.Text = .txtZCMC

                    Me.txtSearch_ZCDM.Text = .txtSearch_ZCDM
                    Me.txtSearch_ZCMC.Text = .txtSearch_ZCMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsJishuZhicheng
                ...
                With Me.m_objSaveScence
                    ...
                    .txtZCDM = Me.txtZCDM.Text
                    .txtZCMC = Me.txtZCMC.Text

                    .txtSearch_ZCDM = Me.txtSearch_ZCDM.Text
                    .txtSearch_ZCMC = Me.txtSearch_ZCMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsJishuZhicheng)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsJishuZhicheng)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strZCDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCDM
                If Me.txtSearch_ZCDM.Text.Length > 0 Then Me.txtSearch_ZCDM.Text = Me.txtSearch_ZCDM.Text.Trim()
                If Me.txtSearch_ZCDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strZCDM + " like '" + Me.txtSearch_ZCDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strZCDM + " like '" + Me.txtSearch_ZCDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strZCMC As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCMC
                If Me.txtSearch_ZCMC.Text.Length > 0 Then Me.txtSearch_ZCMC.Text = Me.txtSearch_ZCMC.Text.Trim()
                If Me.txtSearch_ZCMC.Text <> "" Then
                    Me.txtSearch_ZCMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_ZCMC.Text)
                    If strQuery = "" Then
                        strQuery = strZCMC + " like '" + Me.txtSearch_ZCMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strZCMC + " like '" + Me.txtSearch_ZCMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With objsystemEstateRenshiGeneral
                    If .getDataSet_JishuZhicheng(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateRenshiGeneralData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCMC)
                        Me.txtZCDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtZCMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                End If

                '使能控件
                With objControlProcess
                    .doEnabledControl(Me.txtZCDM, blnEditMode)
                    .doEnabledControl(Me.txtZCMC, blnEditMode)
                End With
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateRenshiGeneralData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_ZCDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_ZCMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_ZCDM)
                        .doTranslateKey(Me.txtSearch_ZCMC)
                        .doTranslateKey(Me.txtZCDM)
                        .doTranslateKey(Me.txtZCMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[人事_技术职称]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCDM, Me.txtZCDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCMC, Me.txtZCMC.Text)
                ...
                '保存信息
                With objsystemEstateRenshiGeneral
                    If .doSaveData_JishuZhicheng(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_技术职称]字典中增加了[" + Me.txtZCMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[人事_技术职称]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strZCMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_JISHUZHICHENG_ZCMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strZCMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateRenshiGeneral.doDeleteData_JishuZhicheng(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_技术职称]字典中删除了[" + strZCMC + "]！")
                        End If
                    Next
