<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_renyuanjiagou.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_renyuanjiagou" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
    <HEAD>
        <title>人员管理架构查看与编辑窗(模式一)</title>
		...
		<!--
		    function btnPrint_onClick()
		    {
		        ...
		        objwindow.document.writeln("  <TR height='40' valign='middle'>");
		        objwindow.document.writeln("    <TD align='center' style='FONT-SIZE: 32px; FONT-FAMILY: 黑体; BORDER-BOTTOM: black 2px solid;'>");
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="javascript:window_onresize()">
        <form id="frmestate_rs_renyuanjiagou" method="post" runat="server">
            <asp:panel id="panelMain" Runat="server">
                <TABLE cellSpacing="0" cellPadding="0" border="0">
                    <TR id="trRow01">
                        <TD height="30" class="title" style="BORDER-BOTTOM: #99cccc 2px solid" vAlign="middle" align="left">当前位置：人事管理&nbsp;&gt;&gt;&gt;&gt;&nbsp;二手业务人员管理架构<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
                    </TR>
                    <TR>
                                        ...
                                        <td align="center">
                                            <TABLE cellSpacing="0" cellPadding="0" border="0" style="BORDER-RIGHT: black 2px solid; BORDER-TOP: black 2px solid; BORDER-LEFT: black 2px solid; BORDER-BOTTOM: black 2px solid">
                                                <tr height="24" valign="middle">
                                                    ...
                                                    <td colspan="4" align="center" style="BORDER-BOTTOM: black 1px solid">物业顾问</td>
                    ...
                    <TR id="trRow02">
                        <TD style="BORDER-TOP: #99cccc 2px solid" vAlign="middle" align="center" height="36">
                            <asp:Button id="btnViewGX" Runat="server" Text=" 查看关系 " Font-Size="11pt" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
                            <asp:Button id="btnTongbu" Runat="server" Text=" 信息同步 " Font-Size="11pt" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
                            <asp:Button id="btnAddNew" Runat="server" Text=" 人员入职 " Font-Size="11pt" Font-Name="宋体" CssClass="button" Height="32px" Visible="False"></asp:Button>
                            <asp:Button id="btnAdjust" Runat="server" Text=" 内部调整 " Font-Size="11pt" Font-Name="宋体" CssClass="button" Height="32px" Visible="False"></asp:Button>
                            <asp:Button id="btnLikai"  Runat="server" Text=" 离开岗位 " Font-Size="11pt" Font-Name="宋体" CssClass="button" Height="32px" Visible="False"></asp:Button>
                            <input id="btnPrint" type="button" class="button" value=" 打印人员架构表 " style="HEIGHT: 32px" onclick="javascript:btnPrint_onClick();">
                            <asp:Button id="btnClose" Runat="server" Text=" 返回 " Font-Size="11pt" Font-Name="宋体" CssClass="button" Height="32px"></asp:Button>
                        </TD>
                    </TR>
                </TABLE>
            </asp:panel>
            ...
            <table cellSpacing="0" cellPadding="0" align="center" border="0">
                <tr>
                    <td>
                        <input id="htxtCanPrint" type="hidden" runat="server">
