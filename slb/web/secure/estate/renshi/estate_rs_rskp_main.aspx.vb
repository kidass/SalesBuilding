...
Namespace Josco.JSOA.web
    ...
    '
    ' 接口参数：
    '     参见接口类IEstateRsRskpMain描述
    ' 更改记录：
    '     zengxianglin 2009-05-15 更改
    '----------------------------------------------------------------

    Partial Class estate_rs_rskp_main
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsRskpMain
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsRskpMain
        ...
        '要访问的数据
        '----------------------------------------------------------------
        Private m_objDataSet_RYLIST As Josco.JSOA.Common.Data.estateRenshiGeneralData
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateRsRskpMain)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtRYLISTSearch_DRZW.Text = .txtRYLISTSearch_DRZW
                    ...
                    End Try
                    Try
                        Me.ddlRYLISTSearch_ZJMC.SelectedIndex = .ddlRYLISTSearch_ZJMC_SelectedIndex
                    Catch ex As Exception
                    End Try
                    Try
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsRskpMain
                ...
                With Me.m_objSaveScence
                    ...
                    .txtRYLISTSearch_DRZW = Me.txtRYLISTSearch_DRZW.Text
                    ...
                    .ddlRYLISTSearch_ZJMC_SelectedIndex = Me.ddlRYLISTSearch_ZJMC.SelectedIndex
        ...
        Private Function getDataFromCallModule(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                '==========================================================================================================================================================
                Dim objIEstateRsRskpInfo As Josco.JSOA.BusinessFacade.IEstateRsRskpInfo = Nothing
                Try
                    objIEstateRsRskpInfo = CType(Session.Item(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId)), Josco.JSOA.BusinessFacade.IEstateRsRskpInfo)
                Catch ex As Exception
                    objIEstateRsRskpInfo = Nothing
                End Try
                If Not (objIEstateRsRskpInfo Is Nothing) Then
                    Session.Remove(Request.QueryString(Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId))
                    Josco.JSOA.BusinessFacade.IEstateRsRskpInfo.SafeRelease(objIEstateRsRskpInfo)
                    Exit Try
                End If
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsRskpMain)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsRskpMain)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
...
errProc:
        ...
        Private Function getQueryString_RYLIST( _
            ...
            Try
                ...
                strRYDM = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_RYDM
                ...
                If Me.txtRYLISTSearch_RYDM.Text <> "" Then
                    Me.txtRYLISTSearch_RYDM.Text = objPulicParameters.getNewSearchString(Me.txtRYLISTSearch_RYDM.Text)
                    If strQuery = "" Then
                ...
                strRYXM = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_XM
                ...
                '按“民族”搜索
                Dim strMZ As String
                strMZ = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_MZ
                ...
                Dim strJG As String
                Dim strHJ As String
                strJG = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_JG
                strHJ = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_HJDZ
                ...
                '按“担任职务”搜索
                Dim strDRZW As String
                strDRZW = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_DRZW
                If Me.txtRYLISTSearch_DRZW.Text.Length > 0 Then Me.txtRYLISTSearch_DRZW.Text = Me.txtRYLISTSearch_DRZW.Text.Trim()
                If Me.txtRYLISTSearch_DRZW.Text <> "" Then
                    Me.txtRYLISTSearch_DRZW.Text = objPulicParameters.getNewSearchString(Me.txtRYLISTSearch_DRZW.Text)
                    If strQuery = "" Then
                        strQuery = strDRZW + " like '" + Me.txtRYLISTSearch_DRZW.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strDRZW + " like '" + Me.txtRYLISTSearch_DRZW.Text + "%'"
                    End If
                End If
                ...
                strNN = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_NN
                ...
                '按“性别”搜索
                Dim strXB As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_XB
                ...
                '按“学历”搜索
                Dim strXL As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_ZGXL
                ...
                '按“职称”搜索
                Dim strZC As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_JSZC
                ...
                '按“职业资格”搜索
                Dim strZYZG As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_ZYZG
                ...
                '按“政治面貌”搜索
                Dim strZZMM As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_ZZMM
                ...
                '按“职级”搜索
                Dim strZJDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_ZJDM
                Select Case Me.ddlRYLISTSearch_ZJMC.SelectedIndex
                    Case 0, -1
                    Case Else
                        If strQuery = "" Then
                            strQuery = strZJDM + " = '" + Me.ddlRYLISTSearch_ZJMC.SelectedValue + "'"
                        Else
                            strQuery = strQuery + " and " + strZJDM + " = '" + Me.ddlRYLISTSearch_ZJMC.SelectedValue + "'"
                        End If
                End Select
...
errProc:
        ...
        Private Function getModuleData_RYLIST( _
            ...
            Try
                ...
                '释放资源
                Josco.JSOA.Common.Data.estateRenshiGeneralData.SafeRelease(Me.m_objDataSet_RYLIST)

                '重新检索数据
                If objsystemEstateRenshiGeneral.getDataSet_RSKP(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet_RYLIST) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function showModuleData_MAIN(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Me.btnUpdate.Visible = Me.m_blnPrevilegeParams(1)
...
errProc:
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                ...
                objControlProcess.doTranslateKey(Me.txtRYLISTSearch_DRZW)
                ...
                objControlProcess.doTranslateKey(Me.ddlRYLISTSearch_ZJMC)
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                ...
                If Me.doFillXueliList(strErrMsg, Me.ddlRYLISTSearch_XL) = False Then
                    GoTo errProc
                End If
                If Me.doFillZjdmList(strErrMsg, Me.ddlRYLISTSearch_ZJMC) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doClose(ByVal strControlId As String)
            ...
            Try
                ...
                Me.releaseInterfaceParameters()
                '返回
                strUrl = "http://128.168.2.11/webapp/testTZ/web/secure/main.aspx"
                If strUrl <> "" Then
                    Response.Redirect(strUrl)
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                '检查模版文件
                Dim strMBURL As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "广州兴业_人事管理_入职员工管理.xls"
                ...
                If objsystemEstateRenshiGeneral.doExportToExcel(strErrMsg, Me.m_objDataSet_RYLIST, strTempSpec, strMacroName, strMacroValue, "yyyy-MM-dd") = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doAddNew(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objIEstateRsRskpInfo As Josco.JSOA.BusinessFacade.IEstateRsRskpInfo = Nothing
                Dim strUrl As String = ""
                objIEstateRsRskpInfo = New Josco.JSOA.BusinessFacade.IEstateRsRskpInfo
                With objIEstateRsRskpInfo
                ...
                If strNewSessionId = "" Then
                    ...
                    GoTo errProc
                End If
                Session.Add(strNewSessionId, objIEstateRsRskpInfo)

                strUrl = ""
                strUrl += "estate_rs_rskp_info.aspx"
                strUrl += "?"
                strUrl += Josco.JsKernal.Common.Utilities.PulicParameters.ISessionId
                strUrl += "="
                strUrl += strNewSessionId
...
errProc:
        ...
        Private Sub doUpdate(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strRYDM As String = ""
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRYLIST, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_RYDM)
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strRYDM As String = ""
                    intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYLIST, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_WYBS)
                    intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdRYLIST, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_RENSHIKAPIAN_RYDM)
                    intRows = Me.grdRYLIST.Items.Count
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdRYLIST.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RYLIST) = True Then
                            ...
                            '删除处理
                            If objsystemEstateRenshiGeneral.doDeleteData_RSKP(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWYBS, Server, strPrefix) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_人事卡片]字典中删除了[" + strRYDM + "]的资料！")
                        End If
                    Next
...
errProc:
        ...
        Private Sub btnPXJL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPXJL.Click
            Me.doOpen_PXJL("btnPXJL")
        End Sub

        Private Sub btnYDJL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnYDJL.Click
            Me.doOpen_YDJL("btnYDJL")
        End Sub

        Private Sub btnLDHT_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLDHT.Click
            Me.doOpen_LDHT("btnLDHT")
        End Sub
