...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="estate_rs_biandongyuanyin.aspx.vb" Inherits="Josco.JSOA.web.estate_rs_biandongyuanyin" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>人事变动类型编辑窗</title>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()"
		...
		<form id="frmestate_rs_biandongyuanyin" method="post" runat="server">
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left">
																<asp:textbox id="txtSearch_YYDM" runat="server" Font-Size="11pt" Font-Names="宋体" CssClass="textbox"
																	Columns="20"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;名称&nbsp;</TD>
															<TD class="label" align="left">
																<asp:textbox id="txtSearch_YYMC" runat="server" Font-Size="11pt" Font-Names="宋体" CssClass="textbox"
													...
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 100%; CLIP: rect(0px 100% 330px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 330px">
														<asp:datagrid id="grdObjects" runat="server" Font-Size="11pt" Font-Names="宋体" CssClass="label"
															...
															<Columns>
																...
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="原因代码" SortExpression="原因代码" HeaderText="代码"
																	CommandName="Select">
																	<HeaderStyle Width="200px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="780px" DataTextField="原因名称" SortExpression="原因名称" HeaderText="名称"
																	CommandName="Select">
								...
								<TR>
									...
									<TD class="label" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid"
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD class="label" align="center" height="20"><B>人事变动类型编辑窗</B></TD>
											</TR>
											<TR>
													...
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															...
															<TD class="label" align="left" width="60%">
																<asp:textbox id="txtYYDM" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="23"></asp:textbox><SPAN class="label" style="COLOR: red">(nnn.nnn.nnn.nnn)</SPAN></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
														<TR>
															...
															<TD class="label" align="left">
																<asp:textbox id="txtYYMC" Runat="server" Font-Name="宋体" Font-Size="11pt" CssClass="textbox" Columns="48"></asp:textbox></TD>
														</TR>
														<TR>
															<TD class="label" align="center" colSpan="2" height="2"></TD>
														</TR>
