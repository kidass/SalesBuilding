...
Namespace Josco.JSOA.web
    ...
    Partial Class estate_rs_xuelihuafen
...
#End Region
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "estate_rs_xuelihuafen_previlege_param"
        Private m_blnPrevilegeParams(4) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsXueliHuafen
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsXueliHuafen
        ...
        Private Sub doGoBack(ByVal strControlId As String)
            ...
            Try
                ...
                If strSessionId <> "" Then
                    Try
                        Me.m_objInterface = CType(Session(strSessionId), Josco.JSOA.BusinessFacade.IEstateRsXueliHuafen)
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtXLDM.Text = .txtXLDM
                    Me.txtXLMC.Text = .txtXLMC

                    Me.txtSearch_XLDM.Text = .txtSearch_XLDM
                    Me.txtSearch_XLMC.Text = .txtSearch_XLMC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsXueliHuafen
                ...
                With Me.m_objSaveScence
                    ...
                    .txtXLDM = Me.txtXLDM.Text
                    .txtXLMC = Me.txtXLMC.Text

                    .txtSearch_XLDM = Me.txtSearch_XLDM.Text
                    .txtSearch_XLMC = Me.txtSearch_XLMC.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsXueliHuafen)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsXueliHuafen)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString( _
            ...
            Try
                '按代码搜索
                Dim strXLDM As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLDM
                If Me.txtSearch_XLDM.Text.Length > 0 Then Me.txtSearch_XLDM.Text = Me.txtSearch_XLDM.Text.Trim()
                If Me.txtSearch_XLDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strXLDM + " like '" + Me.txtSearch_XLDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strXLDM + " like '" + Me.txtSearch_XLDM.Text + "%'"
                    End If
                End If

                '按名称搜索
                Dim strXLMC As String = "a." + Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLMC
                If Me.txtSearch_XLMC.Text.Length > 0 Then Me.txtSearch_XLMC.Text = Me.txtSearch_XLMC.Text.Trim()
                If Me.txtSearch_XLMC.Text <> "" Then
                    Me.txtSearch_XLMC.Text = objPulicParameters.getNewSearchString(Me.txtSearch_XLMC.Text)
                    If strQuery = "" Then
                        strQuery = strXLMC + " like '" + Me.txtSearch_XLMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strXLMC + " like '" + Me.txtSearch_XLMC.Text + "%'"
                    End If
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With objsystemEstateRenshiGeneral
                    If .getDataSet_XueliHuafen(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objestateRenshiGeneralData) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLDM)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLMC)
                        Me.txtXLDM.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtXLMC.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                    End If
                Else
                    '编辑状态
                    '自动恢复数据
                ...
                With objControlProcess
                    .doEnabledControl(Me.txtXLDM, blnEditMode)
                    .doEnabledControl(Me.txtXLMC, blnEditMode)
                End With
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                With Me.m_objestateRenshiGeneralData.Tables(strTable).DefaultView
                    ...
                    With objControlProcess
                        .doEnabledControl(Me.txtSearch_XLDM, Not blnEditMode)
                        .doEnabledControl(Me.txtSearch_XLMC, Not blnEditMode)
                    End With
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With objControlProcess
                        ...
                        .doTranslateKey(Me.txtSearch_XLDM)
                        .doTranslateKey(Me.txtSearch_XLMC)
                        .doTranslateKey(Me.txtXLDM)
                        .doTranslateKey(Me.txtXLMC)
                    End With
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[人事_学历划分]字典！")
                End If
            End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLDM, Me.txtXLDM.Text)
                objNewData.Add(Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLMC, Me.txtXLMC.Text)
                ...
                '保存信息
                With objsystemEstateRenshiGeneral
                    If .doSaveData_XueliHuafen(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Josco.JsKernal.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_学历划分]字典中增加了[" + Me.txtXLMC.Text + "]！")
                    Case Else
                        Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]更改了[人事_学历划分]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strXLMC As String = ""
                    Dim intPos As Integer
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Josco.JSOA.Common.Data.estateRenshiGeneralData.FIELD_RS_B_XUELIHUAFEN_XLMC)
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdObjects.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid) = True Then
                            strXLMC = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(i), intColIndex)
                            ...
                            '删除处理
                            If objsystemEstateRenshiGeneral.doDeleteData_XueliHuafen(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                                GoTo errProc
                            End If

                            '记录审计日志
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[人事_学历划分]字典中删除了[" + strXLMC + "]！")
                        End If
                    Next
