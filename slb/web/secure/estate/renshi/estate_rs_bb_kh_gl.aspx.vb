...
Namespace Josco.JSOA.web
    ...
    '
    ' 接口参数：
    '     参见接口类IEstateRsBbKhGl描述
    '
    ' 更改记录
    '     zengxianglin 2010-01-14 创建
    '     zengxianglin 2010-05-06 创建
    '----------------------------------------------------------------

    Partial Class estate_rs_bb_kh_gl
...
#End Region
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Josco.JSOA.BusinessFacade.IMEstateRsBbKhGl
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Josco.JSOA.BusinessFacade.IEstateRsBbKhGl
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Josco.JSOA.BusinessFacade.IMEstateRsBbKhGl
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Josco.JSOA.BusinessFacade.IEstateRsBbKhGl)
                Catch ex As Exception
                ...
                '计算列索引
                Me.m_intColIndex_TJSJ(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdTJSJ, Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_X2_KHJG_GL_XSJB)
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Josco.JSOA.BusinessFacade.IMEstateRsBbKhGl)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_TJSJ( _
            ...
            Try
                ...
                strXSJB = Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_X2_KHJG_GL_XSJB
            ...
            Try
                ...
                If blnEnforced = True Then
                    ...
                    If Me.getReportParams(strErrMsg, strJDKS, strJDJS) = False Then
                        GoTo errProc
                    End If
                    If objsystemEstateRenshiXingye.getDataSet_TJBB_X2_KHJG_GL(strErrMsg, MyBase.UserId, MyBase.UserPassword, strJDKS, strJDJS, "", Me.m_objDataSet_TJSJ) = False Then
                        GoTo errProc
                    End If
                ...
                Else
                    If Me.htxtTJSJSessionId.Value.Trim = "" Then
                        '初始数据
                        Me.m_objDataSet_TJSJ = New Josco.JSOA.Common.Data.estateRenshiXingyeData(Josco.JSOA.Common.Data.estateRenshiXingyeData.enumTableType.DC_VT_RS_X2_KHJG_GL)
                        '缓存数据
                        Me.htxtTJSJSessionId.Value = objPulicParameters.getNewGuid()
...
errProc:
        ...
        Private Sub doOK(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrUrlBaseToExcelMB + "广州兴业_人事管理_业务主管考核表.xls"
                ...
                '导出文件
                Dim strFName As String = Josco.JSOA.Common.Data.estateRenshiXingyeData.FIELD_DC_VT_RS_X2_KHJG_GL_XSJB
