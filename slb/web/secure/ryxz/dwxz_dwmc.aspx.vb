...
Namespace Josco.JSOA.web
    ...
    Partial Public Class dwxz_dwmc
        ...
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objIDmxzZzjg As Josco.JsKernal.BusinessFacade.IDmxzZzjg
        ...
        Private Sub releaseInterfaceParameters()
            ...
            Try
                If Not (Me.m_objIDmxzZzjg Is Nothing) Then
                    If Me.m_objIDmxzZzjg.iInterfaceType = Josco.JSOA.BusinessFacade.ICallInterface.enumInterfaceType.InputOnly Then
                        '释放Session
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            '    m_objIDmxzZzjg = CType(objTemp, Josco.JsKernal.BusinessFacade.IDmxzZzjg)
            'Catch ex As Exception
...
errProc:
        ...
        Private Function getQueryString_SELBM( _
            ...
            Try
                '单位/范围的名称搜索
                Dim strDWMC As String = Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMC
        ...
        Private Function getModuleData_SELBM( _
            ...
            Try
                If Me.IsPostBack = False Then
                    ...
                    '    strValue = Me.m_objIDmxzZzjg.iBumenList.Split(Josco.JsKernal.Common.Utilities.PulicParameters.CharSeparate.ToCharArray())
...
errProc:
        ...
        Private Sub doCancel(ByVal strControlId As String)
            ...
            'SessionId附加到返回的Url
            Dim strUrl As String
            strUrl = Me.m_objIDmxzZzjg.getReturnUrl(Server, Josco.JsKernal.Common.Utilities.PulicParameters.OSessionId, strSessionId)
            '返回
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    ...
                    If blnChecked = True Then
                        ...
                        If Me.m_objIDmxzZzjg.iSelectFFFW = True Then '可以直接选择范围
                            ...
                            If blnFound = False Then
                                ...
                                With objDataGridProcess
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_XZLX) = Josco.JsKernal.Common.Data.FenfafanweiData.CYLX_FANWEI
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMC) = .getDataGridCellValue(Me.grdFWLIST.Items(i), intColIndex(0))
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWQC) = ""
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWJB) = ""
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMS) = ""
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_SJHM) = .getDataGridCellValue(Me.grdFWLIST.Items(i), intColIndex(6))
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_LXDH) = .getDataGridCellValue(Me.grdFWLIST.Items(i), intColIndex(7))
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_FTPDZ) = .getDataGridCellValue(Me.grdFWLIST.Items(i), intColIndex(8))
                                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_YXDZ) = .getDataGridCellValue(Me.grdFWLIST.Items(i), intColIndex(9))
                                End With
                                With Me.m_objDataSet_SELBM.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU_SELECT)
                                    .Rows.Add(objDataRow)
                                End With
                        ...
                        Else '只能选择范围下的部门
                            Dim objBumenDataInFanwei As Josco.JsKernal.Common.Data.CustomerData
                            ...
                            With objBumenDataInFanwei.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU_SELECT)
                                intCYCount = .Rows.Count
                                For j = 0 To intCYCount - 1 Step 1
                                    '计算成员名称
                                    strCYMC = objPulicParameters.getObjectValue(.Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMC), "")
                                    ...
                                    If blnFound = False Then
                                        ...
                                        With Me.m_objDataSet_SELBM.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU_SELECT)
                                            objDataRow = .NewRow()
                                        End With
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_XZLX) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_XZLX)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMC) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMC)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWQC) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWQC)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWJB) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWJB)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMS) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMS)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_SJHM) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_SJHM)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_LXDH) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_LXDH)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_FTPDZ) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_FTPDZ)
                                        objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_YXDZ) = .Rows(j).Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_YXDZ)
                                        With Me.m_objDataSet_SELBM.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU_SELECT)
                                            .Rows.Add(objDataRow)
                                        End With
            ...
            Try
                ...
                If blnFound = False Then
                    ...
                    With Me.m_objDataSet_SELBM.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU_SELECT)
                        objDataRow = .NewRow()
                    End With
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_XZLX) = objListItem.Text
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMC) = Me.txtNewDWMC.Text
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWQC) = ""
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWJB) = ""
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_DWMS) = ""
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_SJHM) = ""
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_LXDH) = ""
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_FTPDZ) = ""
                    objDataRow.Item(Josco.JsKernal.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_SELECT_YXDZ) = ""
                    With Me.m_objDataSet_SELBM.Tables(Josco.JsKernal.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU_SELECT)
                        .Rows.Add(objDataRow)
                    End With
