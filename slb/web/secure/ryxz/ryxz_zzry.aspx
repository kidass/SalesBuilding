<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ryxz_zzry.aspx.vb" Inherits="Josco.JSOA.web.ryxz_zzry" %>
												...
												<TR>
													<TD>
														<DIV id="divBMRY" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 586px; CLIP: rect(0px 586px 340px 0px); HEIGHT: 340px;">
															<asp:datagrid id="grdBMRY" runat="server" Cssclass="label" Width="700px" Font-Size="12px" Font-Names="宋体"
																UseAccessibleHeader="True" CellPadding="4" AllowSorting="True" BorderWidth="0px" BorderColor="#DEDFDE"
																PageSize="40" BorderStyle="None" BackColor="White" GridLines="Vertical" AutoGenerateColumns="False"
																AllowPaging="True">
																...
																<Columns>
																	...
																	<asp:ButtonColumn Visible="False" DataTextField="级别名称" SortExpression="级别名称" HeaderText="级别" CommandName="Select">
																		<HeaderStyle Width="0px"></HeaderStyle>
																	</asp:ButtonColumn>
																	<asp:ButtonColumn Visible="False" DataTextField="秘书名称" SortExpression="秘书名称" HeaderText="秘书" CommandName="Select">
																		<HeaderStyle Width="0px"></HeaderStyle>
																	</asp:ButtonColumn>
																	<asp:ButtonColumn DataTextField="联系电话" SortExpression="联系电话" HeaderText="分机号" CommandName="Select">
																		<HeaderStyle Width="100px"></HeaderStyle>
																	</asp:ButtonColumn>
												...
												<TR>
													<TD>
														<DIV id="divJCLXR" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 236px; CLIP: rect(0px 236px 151px 0px); HEIGHT: 151px;">
															<asp:datagrid id="grdJCLXR" runat="server" Cssclass="label" Font-Size="12px" Font-Names="宋体" UseAccessibleHeader="True"
																CellPadding="4" AllowSorting="True" BorderWidth="0px" BorderColor="#DEDFDE" PageSize="30"
																BorderStyle="None" BackColor="White" GridLines="Vertical" AutoGenerateColumns="False" width="1040px">
																 <SelectedItemStyle  Font-Bold="False" VerticalAlign="top" ForeColor="blue" ></SelectedItemStyle>
																	<EditItemStyle   BackColor="#FFCC00" VerticalAlign="top"></EditItemStyle>
																	<AlternatingItemStyle  BorderWidth="1px" BorderStyle="Solid" BorderColor="Gold" VerticalAlign="top" BackColor="White"></AlternatingItemStyle>
																	<ItemStyle  BorderWidth="1px" BorderStyle="Solid" BorderColor="Gold" VerticalAlign="top" BackColor="#F7F7F7" ForeColor="Black"></ItemStyle>
												...
												<TR>
													<TD>
														<DIV id="divSELRY" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 586px; CLIP: rect(0px 586px 145px 0px); HEIGHT: 145px; BACKGROUND-COLOR: white">
															<asp:datagrid id="grdSELRY" runat="server" Cssclass="label" Width="700px" Font-Size="12px" Font-Names="宋体"
																UseAccessibleHeader="True" CellPadding="4" AllowSorting="True" BorderWidth="0px" BorderColor="#DEDFDE"
																PageSize="40" BorderStyle="None" BackColor="White" GridLines="Vertical" AutoGenerateColumns="False"
																AllowPaging="True">
																 <SelectedItemStyle  Font-Bold="False" VerticalAlign="top" ForeColor="blue" ></SelectedItemStyle>
																	...
																	<asp:ButtonColumn Visible="False"  DataTextField="级别" SortExpression="级别" HeaderText="级别" CommandName="Select">
																		<HeaderStyle Width="0px"></HeaderStyle>
																	</asp:ButtonColumn>
