 <%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dwxz_bmmc.aspx.vb" Inherits="Josco.JSOA.web.dwxz_bmmc" %>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 1px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left">
									<TD class="label" vAlign="middle" align="center" height="24"><B>部门选择窗<asp:Label id="BMlTitle" Runat="server" CssClass="label"></asp:Label></B></TD>
								</TR>
							</TABLE>
						</TD>
						<TD width="3"></TD>
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<div id="divMAIN" style="OVERFLOW: auto; WIDTH: 320px; CLIP: rect(0px 320px 300px 0px); HEIGHT: 300px">
								<TABLE cellSpacing="0" cellPadding="0" border="0">
									...
									<TR>
										...
										<TD vAlign="top" align="left" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
											<iewc:treeview id="tvwBMLIST" runat="server" CssClass="label" Width="200px" Height="200px" Font-Size="12px" Font-Name="宋体" AutoPostBack="true"></iewc:treeview></TD>
										<TD width="3"></TD>
										<TD vAlign="top" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
											<TABLE cellSpacing="0" cellPadding="0" border="0">
												<TR>
													<TD>
														<DIV id="divSELBM" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 110px; CLIP: rect(0px 110px 200px 0px); HEIGHT: 200px">
															<asp:datagrid id="grdSELBM" runat="server" CssClass="labelGrid" Width="110px"
																...
																AllowPaging="True">
																	...
																	<asp:TemplateColumn  Visible="False" HeaderText="多">
																	...
																	<asp:ButtonColumn Text="↑" HeaderStyle-ForeColor="White" ButtonType="PushButton" CommandName="DeleteOneRow" HeaderText="单"></asp:ButtonColumn>
																	<asp:ButtonColumn DataTextField="单位名称" SortExpression="单位名称" HeaderText="单位名称" CommandName="Select">
