<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="kqgl_kqjl_bgs.aspx.vb" Inherits="Josco.JSOA.web.kqgl_kqjl_bgs" %>
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR id="trRow3">
															...
															<td class="label" align="left"><asp:textbox id="txtBM" runat="server" CssClass="textbox" Font-Size="12px" Columns="48" Font-Names="宋体"></asp:textbox><input id="htxtBM" type="hidden" size="1" runat="server" name="htxtBM" />
											                ...
											                <td>
											                    <table >											                  
											                        ...
											                        <tr>
											                            ...
											                            <td><asp:textbox ID="txtDR" runat="server" CssClass="textbox"  Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox></td>											                            											                        
											                        </tr>
											                        <tr>
											                            ...
											                            <td><asp:textbox ID="txtDC" runat="server" CssClass="textbox"  Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox></td>											                            											                        
											                        </tr>	
											                        <tr>
