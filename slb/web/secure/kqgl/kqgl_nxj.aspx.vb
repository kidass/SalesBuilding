...
#End Region
        ...
        '其他数据
        '----------------------------------------------------------------
        Private m_blnSearch As Boolean    '查询员-行助，区助，文员
        Private m_blnApprove As Boolean   '审批员-人事

        Public ReadOnly Property propEditMode() As Boolean
            Get
                propEditMode = Me.m_blnApprove
            End Get
        End Property
...
errProc:
        ...
        Private Function getPrevilegeParams( _
            ...
            Try
                ...
                '是否管理员
                If Me.m_blnPrevilegeParams(2) = True Then
                    m_blnApprove = True
                Else
                    m_blnApprove = False
                End If
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtBM.Text = .txtDay
                    Me.txtGZSJ.Text = .txtGZSJ
                    Me.txtNXJ.Text = .txtNXJ
                    'Me.txtGZNX.Text = .txtWC
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    .txtDay = Me.txtBM.Text
                    .txtGZSJ = Me.txtGZSJ.Text
                    .txtNXJ = Me.txtNXJ.Text
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.kaoqinguanliData.TABLE_KQ_VT_NIANXIUJIA
            ...
            Try
                ...
                If m_objsystemKaoqinguanli.getDataNianxiujia(strErrMsg, MyBase.UserId, MyBase.UserPassword, strZZDM, m_objDataSet_RSLYGL) = False Then
                    GoTo errProc
                End If
        ...
        Private Function initializeControls(ByRef strErrMsg As String) As Boolean
            ...
            If Me.IsPostBack = False Then
                ...
                If Me.m_blnSaveScence = False Then
                    ...
                    'If objPulicParameters.getChineseMonth(strErrMsg, Month(Now), strTemp) = True Then
                    '    Me.ddlYF.SelectedIndex = objDropDownListProcess.getSelectedItem(Me.ddlYF, strTemp)
                    'End If]
...
errProc:
        ...
        Private Sub btnAllBM_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAllBM.Click
            Me.doDisplayAll("btnAllBM")
        End Sub
...
errProc:
        ...
        Private Function doAdd(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                If Me.txtGZSJ.Text.Trim = "" And Me.txtNXJ.Text = "" Then
                    strErrMsg = "提示:您没有填写要更新的内容！请查证!"
                    GoTo errProc
                End If
                ...
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备更新选定的[" + intSelect.ToString() + "]个的人员吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim strZZDM As String = MyBase.UserBmdm
                    ...
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdKQJLG.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RSLYGL) = True Then
                            ...
                            intIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdKQJLG, Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_NIANXIUJIA_RYDM)
                            strRYDM = objDataGridProcess.getDataGridCellValue(Me.grdKQJLG.Items(i), intIndex)

                            objNewData.Clear()
                            objNewData.Add(Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_NIANXIUJIA_RZSJ, Me.txtGZSJ.Text.Trim)
                            objNewData.Add(Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_NIANXIUJIA_NXJ, Me.txtNXJ.Text.Trim)
                            objNewData.Add(Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_NIANXIUJIA_RYDM, strRYDM)
                            objNewData.Add(Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_NIANXIUJIA_NF, Now.Year.ToString)

                            '相应处理
                            If objsystemKaoqinguanli.doAdd_NXJ( _
                            ...
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]对[" + strRYDM + "]更新了[年休假]！")
...
errProc:
        ...
        Private Function doUpdate(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备同步选定的[" + intSelect.ToString() + "]个的人员吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    For i = intRows - 1 To 0 Step -1
                        If objDataGridProcess.isDataGridItemChecked(Me.grdKQJLG.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_RSLYGL) = True Then
                            ...
                            '相应处理
                            If objsystemKaoqinguanli.doUpdate_NXJ( _
                                strErrMsg, MyBase.UserId, MyBase.UserPassword, _
                                 objNewData) = False Then
                                GoTo errProc
                            End If
                            ...
                            Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]对[" + strRYDM + "]同步了[年休假]！")
...
errProc:
        ...
        '     False          ：失败
        '----------------------------------------------------------------
        Private Function doAllUpdate(ByRef strErrMsg As String, ByVal strControlId As String) As Boolean
            ...
            Try
                ...
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备同步全部人员吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    '相应处理
                    If objsystemKaoqinguanli.doUpdate_NXJ( _
                        strErrMsg, MyBase.UserId, MyBase.UserPassword) = False Then
                        GoTo errProc
                    End If

                    '记录日志

                    Josco.JsKernal.SystemFramework.ApplicationLog.WriteInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]对所有人员同步了[年休假]！")
...
errProc:
        ...
        Private Sub btnAllUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAllUpdate.Click
            Dim objMessageProcess As New Josco.JsKernal.web.MessageProcess
            Dim strErrMsg As String

            Try
                If doAllUpdate(strErrMsg, "btnAllUpdate") = False Then
                    GoTo errProc
                End If
            Catch ex As Exception
                strErrMsg = ex.Message
