...
errProc:
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                '初始化工作流
                If Me.doInitializeWorkflow(strErrMsg, "", False, Me.m_objsystemFlowObjectKqglQJD) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        '     strWJBS                         ：文件标识
        '     blnFill                         ：填充数据
        '     objsystemFlowObjectKqglQJD ：工作流对象
        ' 返回
        '     True                            ：成功
        '     False                           ：失败
        '----------------------------------------------------------------
        Private Function doInitializeWorkflow( _
            ...
            ByRef objsystemFlowObjectKqglQJD As Josco.JSOA.BusinessFacade.systemFlowObjectKqglQJD) As Boolean
            ...
            Try
                '释放现有资源
                Josco.JSOA.BusinessFacade.systemFlowObjectKqglQJD.SafeRelease(objsystemFlowObjectKqglQJD)
                ...
                objsystemFlowObject = Josco.JSOA.BusinessFacade.systemFlowObjectKqglQJD.Create(strType, strName)
                ...
                '返回
                objsystemFlowObjectKqglQJD = CType(objsystemFlowObject, Josco.JSOA.BusinessFacade.systemFlowObjectKqglQJD)
            Catch ex As Exception
                strErrMsg = ex.Message
                GoTo errProc
            End Try
...
errProc:
        ...
        Private Function getQueryString_RSLYGL( _
            ...
            Try
                ...
                strWJBT = "a." + Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_XIUJIASHENQINGDAN_WJBT
                ...
                strBLZT = "a." + Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_XIUJIASHENQINGDAN_BLZT
                ...
                strJBRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_XIUJIASHENQINGDAN_JBRQ + ",120)"
                ...
                strQFRQ = "convert(varchar(10),a." + Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_XIUJIASHENQINGDAN_QFRQ + ",120)"
...
errProc:
        ...
        Private Function getModuleData_RSLYGL( _
            ...
            Dim strTable As String = Josco.JSOA.Common.Data.kaoqinguanliData.TABLE_KQ_B_XIUJIASHENQINGDAN
            ...
            Try
                ...
                '重新检索数据
                If Me.m_objsystemFlowObjectKqglQJD.getDataSet_Main(strErrMsg, MyBase.UserXM, strWhere, Me.m_objDataSet_RSLYGL) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function doCreateWorkflow( _
            ...
            Try
                ...
                intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdRSLYGL, Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_XIUJIASHENQINGDAN_WJBS)
...
errProc:
        ...
        Private Function getPrintWjbs(ByRef strErrMsg As String, ByRef strWJBS As String) As Boolean
            ...
            Dim objsystemFlowObjectKqglQJD As New Josco.JSOA.BusinessFacade.systemFlowObjectKqglQJD
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                '获取数据集
                strWhere = "a." + Josco.JSOA.Common.Data.kaoqinguanliData.FIELD_KQ_B_XIUJIASHENQINGDAN_JIAQI_WJBS + " in (" + strWYBS + ")"
                'If objsystemFlowObjectKqglQJD.getPrintRyxxData(strErrMsg, MyBase.UserId, MyBase.UserPassword, MyBase.UserXM, strWhere, objDateSet) = False Then
                '    GoTo errProc
                'End If
        ...
        Private Sub lnkMenu_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMenu.Click
            ...
            Try
                ...
                Select Case strMenuId.ToUpper()
                    Case "mnuNew".ToUpper()
                        If Me.doNewFile(strErrMsg, "lnkMenu", Josco.JSOA.Common.Workflow.BaseFlowKqglQJD.FLOWNAME) = False Then
                            GoTo errProc
                        End If
