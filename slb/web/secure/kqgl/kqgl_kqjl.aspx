<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="kqgl_kqjl.aspx.vb" Inherits="Josco.JSOA.web.kqgl_kqjl" %>
...
<HTML>
	<HEAD>
      ...
      <link rel="stylesheet" type="text/css" href="../../css/jscal2.css" />
        ...
        function openBMXZDR(){ 
        var k = window.showModalDialog("../ryxz/dwxz_bmmc.aspx",window,"dialogWidth:350px;status:no;dialogHeight:300px"); 
        if(k != null)         
                document.getElementById("txtDR").value = k;
        } 
        
        function openBMXZDC(){ 
        var k = window.showModalDialog("../ryxz/dwxz_bmmc.aspx",window,"dialogWidth:350px;status:no;dialogHeight:300px"); 
        if(k != null) 
                document.getElementById("txtDC").value = k; 
        } 
        </script> 
        <script language="javascript">
            //比较日期大小   
											                ...
											                <td>
											                    <table >											                  
											                        ...
											                        <tr>
											                            ...
											                            <td><asp:textbox ID="txtDR" runat="server" CssClass="textbox"  Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox><input type ="button" value="…" onclick="openBMXZDR()" /> </td>											                            											                        
											                        </tr>
											                        <tr>
											                            ...
											                            <td><asp:textbox ID="txtDC" runat="server" CssClass="textbox"  Font-Size="12px" Columns="20" Font-Names="宋体"></asp:textbox><input type ="button" value="…" onclick="openBMXZDC()" /></td>											                            											                        
											                        </tr>	
											                        <tr>
